from skailar.contrib.messages import constants, get_level, set_level
from skailar.contrib.messages.api import MessageFailure
from skailar.contrib.messages.constants import DEFAULT_LEVELS
from skailar.contrib.messages.storage import default_storage
from skailar.contrib.messages.storage.base import Message
from skailar.http import HttpRequest, HttpResponse
from skailar.test import modify_settings, override_settings
...
class BaseTests:
    ...
    @modify_settings(
        INSTALLED_APPS={"remove": "skailar.contrib.messages"},
        MIDDLEWARE={"remove": "skailar.contrib.messages.middleware.MessageMiddleware"},
    )
    @override_settings(
