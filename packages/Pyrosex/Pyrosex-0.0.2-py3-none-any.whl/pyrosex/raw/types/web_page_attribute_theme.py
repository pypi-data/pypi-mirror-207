...
class WebPageAttributeTheme(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (optional): List of :obj:`Document <pyrosex.raw.base.Document>`
        settings (optional): :obj:`ThemeSettings <pyrosex.raw.base.ThemeSettings>`
    """
