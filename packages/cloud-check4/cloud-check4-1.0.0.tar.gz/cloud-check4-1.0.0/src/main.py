...
class Main:
    ...
    def generate_aws_audit_report():
        ...
        try:
            ...
            parser.add_argument("--config_path", help="Config.json's directory", default=os.getcwd())
            parser.add_argument("--report_path", help="Report's directory", default=os.getcwd())
            parser.add_argument("--access_key", help="Enter the AWS Access Key ID",default=None)
            parser.add_argument("--secret_key", help="Enter the AWS Secret Access Key", default=None)
            parser.add_argument("--session_token", help="Enter the AWS Session Token", default=None)
