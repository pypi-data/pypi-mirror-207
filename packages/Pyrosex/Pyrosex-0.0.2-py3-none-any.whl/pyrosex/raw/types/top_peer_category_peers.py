...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category: :obj:`TopPeerCategory <pyrosex.raw.base.TopPeerCategory>`
        count: ``int`` ``32-bit``
        peers: List of :obj:`TopPeer <pyrosex.raw.base.TopPeer>`
    """
