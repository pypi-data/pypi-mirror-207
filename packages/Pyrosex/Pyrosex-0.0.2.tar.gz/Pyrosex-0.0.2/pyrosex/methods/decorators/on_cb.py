...
class OnCallbackQuery:
    def on_cb(
        ...
        :obj:`~pyrosex.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrosex.Client):
                self.add_handler(pyrosex.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrosex.handlers.CallbackQueryHandler(func, self),
