...
class ChatOnlines:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatOnlines <pyrosex.raw.types.ChatOnlines>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetOnlines <pyrosex.raw.functions.messages.GetOnlines>`
    """

    QUALNAME = "pyrosex.raw.base.ChatOnlines"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-onlines")
