...
SchemaFor200ResponseBodyApplicationJson = EmploymentList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_customer_employment_oapg(
        self,
...
class GetAllCustomerEmployment(BaseApi):
    ...
    def get_all_customer_employment(
        ...
        return self._get_all_customer_employment_oapg(
