...
class PasswordSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        email (optional): ``str``
        secure_settings (optional): :obj:`SecureSecretSettings <pyrosex.raw.base.SecureSecretSettings>`
