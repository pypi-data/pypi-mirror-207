...
from msb_env import (Config, NameConst, PathConst, EnvDefaults)
from msb_logging import LogConfig
from msb_auth.defaults import DefaultJwtAuthSettings
...
JWT_AUTH_CONFIG = DefaultJwtAuthSettings(
	...
	access_token_lifetime=Config.get("JWT_ACCESS_TOKEN_VALIDITY").as_int(),
)
...
MSB CONFIGURATIONS
"""
MSB_DB_ENCRYPT_PRIVATE_FIELDS = True
MSB_DB_PK_IS_PRIVATE_FIELD = False
MSB_JWT_TRUSTED_OWNERS = ["127.0.0.1"]
MSB_JWT_VERIFY_OWNER = True
