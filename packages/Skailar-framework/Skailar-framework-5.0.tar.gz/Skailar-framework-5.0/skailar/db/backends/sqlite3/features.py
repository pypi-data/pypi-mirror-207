...
from skailar.db.backends.base.features import BaseDatabaseFeatures
from skailar.db.utils import OperationalError
...
class DatabaseFeatures(BaseDatabaseFeatures):
    ...
    skailar_test_expected_failures = {
        # The skailar_format_dtdelta() function doesn't properly handle mixed
