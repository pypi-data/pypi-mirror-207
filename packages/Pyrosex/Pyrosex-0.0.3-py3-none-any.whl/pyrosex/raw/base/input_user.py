...
class InputUser:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputUser <pyrosex.raw.types.InputUser>`
            - :obj:`InputUserEmpty <pyrosex.raw.types.InputUserEmpty>`
            - :obj:`InputUserFromMessage <pyrosex.raw.types.InputUserFromMessage>`
            - :obj:`InputUserSelf <pyrosex.raw.types.InputUserSelf>`
    """

    QUALNAME = "pyrosex.raw.base.InputUser"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-user")
