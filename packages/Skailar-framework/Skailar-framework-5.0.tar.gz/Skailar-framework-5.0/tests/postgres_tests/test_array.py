...
from skailar.contrib.admin.utils import display_for_field
from skailar.core import checks, exceptions, serializers, validators
from skailar.core.exceptions import FieldError
from skailar.core.management import call_command
from skailar.db import IntegrityError, connection, models
from skailar.db.models.expressions import Exists, OuterRef, RawSQL, Value
from skailar.db.models.functions import Cast, JSONObject, Upper
from skailar.test import TransactionTestCase, override_settings, skipUnlessDBFeature
...
try:
    from skailar.contrib.postgres.aggregates import ArrayAgg
    from skailar.contrib.postgres.expressions import ArraySubquery
    from skailar.contrib.postgres.fields import ArrayField
    from skailar.contrib.postgres.fields.array import IndexTransform, SliceTransform
    from skailar.contrib.postgres.forms import (
        SimpleArrayField,
        SplitArrayField,
        SplitArrayWidget,
    )
    from skailar.db.backends.postgresql.psycopg_any import NumericRange
except ImportError:
    pass
...
class TestMigrations(TransactionTestCase):
    ...
    def test_subclass_deconstruct(self):
        field = ArrayField(models.IntegerField())
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.contrib.postgres.fields.ArrayField")
