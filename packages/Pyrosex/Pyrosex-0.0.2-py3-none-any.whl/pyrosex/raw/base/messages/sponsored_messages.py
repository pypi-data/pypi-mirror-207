...
class SponsoredMessages:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.SponsoredMessages <pyrosex.raw.types.messages.SponsoredMessages>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetSponsoredMessages <pyrosex.raw.functions.channels.GetSponsoredMessages>`
    """

    QUALNAME = "pyrosex.raw.base.messages.SponsoredMessages"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/sponsored-messages")
