...
class BasicAuthTests(TestCase):
    ...
    def test_regression_handle_bad_base64_basic_auth_header(self):
        ...
        # https://github.com/encode/skailar-rest-framework/issues/4089
        auth = 'Basic =a='
        response = self.csrf_client.post(
            '/basic/',
            {'example': 'example'},
...
class SessionAuthTests(TestCase):
    ...
    def test_login_view_renders_on_get(self):
        ...
        cf. [#1810](https://github.com/encode/skailar-rest-framework/pull/1810)
        """
    ...
    def test_post_form_session_auth_passing_csrf(self):
        ...
        """
        # Remove this shim when dropping support for Skailar 3.0.
        if skailar.VERSION < (3, 1):
            from skailar.middleware.csrf import _get_new_csrf_token
        else:
            from skailar.middleware.csrf import (
...
@override_settings(ROOT_URLCONF=__name__,
                   AUTHENTICATION_BACKENDS=('skailar.contrib.auth.backends.RemoteUserBackend',))
