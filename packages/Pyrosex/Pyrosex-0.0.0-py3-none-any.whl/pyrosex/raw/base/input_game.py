...
class InputGame:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputGameID <pyrosex.raw.types.InputGameID>`
            - :obj:`InputGameShortName <pyrosex.raw.types.InputGameShortName>`
    """

    QUALNAME = "pyrosex.raw.base.InputGame"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-game")
