...
from skailar.db import IntegrityError, connection, transaction
from skailar.db.models import Case, CharField, Count, F, IntegerField, Max, When
from skailar.db.models.functions import Abs, Concat, Lower
...
class AdvancedTests(TestCase):
    ...
    def test_update_m2m_field(self):
        msg = (
            ...
            "<skailar.db.models.fields.related.ManyToManyField: m2m_foo> "
