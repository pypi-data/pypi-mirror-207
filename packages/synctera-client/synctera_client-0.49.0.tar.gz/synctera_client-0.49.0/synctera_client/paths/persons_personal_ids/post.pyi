...
# body param
SchemaForRequestBodyApplicationJson = PostPersonalIdWCust


request_body_post_personal_id_w_cust = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_personal_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_post_personal_id_w_cust.serialize(body, content_type)
...
class CreatePersonalId(BaseApi):
    ...
    def create_personal_id(
        ...
        return self._create_personal_id_oapg(
            body=body,
