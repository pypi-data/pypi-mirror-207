...
class VotesList(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.VotesList`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        votes: List of :obj:`MessageUserVote <pyrosex.raw.base.MessageUserVote>`
