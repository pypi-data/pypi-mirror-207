...
from skailar.contrib.auth import (
    BACKEND_SESSION_KEY,
    SESSION_KEY,
    _clean_credentials,
    authenticate,
...
from skailar.contrib.auth.backends import BaseBackend, ModelBackend
from skailar.contrib.auth.hashers import MD5PasswordHasher
from skailar.contrib.auth.models import AnonymousUser, Group, Permission, User
from skailar.contrib.contenttypes.models import ContentType
from skailar.core.exceptions import ImproperlyConfigured, PermissionDenied
from skailar.http import HttpRequest
...
from skailar.views.debug import technical_500_response
from skailar.views.decorators.debug import sensitive_variables
...
class BaseModelBackendTest:
    ...
    backend = "skailar.contrib.auth.backends.ModelBackend"
...
class SelectingBackendTests(TestCase):
    ...
    def test_non_string_backend(self):
        ...
        expected_message = (
            ...
            "<class 'skailar.contrib.auth.backends.ModelBackend'>)."
        )
