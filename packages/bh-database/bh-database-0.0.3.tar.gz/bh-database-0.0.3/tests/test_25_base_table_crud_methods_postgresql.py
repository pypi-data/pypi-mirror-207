...
To run only tests in this module: pytest -m base_table_crud_postgresql
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_write_to_database_commit_01():
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_write_to_database_commit_02():
    """Test transaction atomicity.
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_write_to_database_commit_03():
    """Test transaction atomicity.
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_write_to_database_rollback():
    """Test transaction atomicity.
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_run_execute_sql():
...
@pytest.mark.base_table_crud_postgresql
def test_postgresql_run_stored_proc():
