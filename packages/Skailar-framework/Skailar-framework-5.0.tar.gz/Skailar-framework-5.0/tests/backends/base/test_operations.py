...
from skailar.db import NotSupportedError, connection, transaction
from skailar.db.backends.base.operations import BaseDatabaseOperations
from skailar.db.models import DurationField, Value
...
class SimpleDatabaseOperationTests(SimpleTestCase):
    ...
    def test_adapt_timefield_value(self):
        msg = "Skailar does not support timezone-aware times."
