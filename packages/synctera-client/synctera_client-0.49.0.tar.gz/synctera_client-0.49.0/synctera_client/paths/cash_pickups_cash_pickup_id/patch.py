...
# Path params
CashPickupIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'cash_pickup_id': typing.Union[CashPickupIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_cash_pickup_id = api_client.PathParameter(
    name="cash_pickup_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CashPickupIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CashPickupPatchRequest


request_body_cash_pickup_patch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CashPickup
...
class BaseApi(api_client.Api):
    ...
    def _patch_cash_pickup_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cash_pickup_patch_request.serialize(body, content_type)
...
class PatchCashPickup(BaseApi):
    ...
    def patch_cash_pickup(
        ...
        return self._patch_cash_pickup_oapg(
            body=body,
