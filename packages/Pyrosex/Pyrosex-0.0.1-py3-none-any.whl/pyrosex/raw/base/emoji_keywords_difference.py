...
class EmojiKeywordsDifference:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EmojiKeywordsDifference <pyrosex.raw.types.EmojiKeywordsDifference>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetEmojiKeywords <pyrosex.raw.functions.messages.GetEmojiKeywords>`
            - :obj:`messages.GetEmojiKeywordsDifference <pyrosex.raw.functions.messages.GetEmojiKeywordsDifference>`
    """

    QUALNAME = "pyrosex.raw.base.EmojiKeywordsDifference"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/emoji-keywords-difference")
