...
class DocumentAttributeSticker(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.DocumentAttribute`.
    ...
    Parameters:
        alt: ``str``
        stickerset: :obj:`InputStickerSet <pyrosex.raw.base.InputStickerSet>`
        mask (optional): ``bool``
        mask_coords (optional): :obj:`MaskCoords <pyrosex.raw.base.MaskCoords>`
    """
