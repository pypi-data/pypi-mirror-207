...
IsEnabledOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'is_enabled_only': typing.Union[IsEnabledOnlySchema, bool, ],
    },
    total=False
)
...
request_query_is_enabled_only = api_client.QueryParameter(
    name="is_enabled_only",
    style=api_client.ParameterStyle.FORM,
    schema=IsEnabledOnlySchema,
    explode=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = WebhookList
