...
Arch). <https://github.com/git-foysal-1/devxhub-terminal/wiki/Installation>`__
...
tcsh). <https://github.com/git-foysal-1/devxhub-terminal/wiki/Shell-aliases>`__
...
`More examples of
rules <https://github.com/git-foysal-1/devxhub-terminal/tree/master/devxhub/rules>`__,
`utility functions for
rules <https://github.com/git-foysal-1/devxhub-terminal/tree/master/devxhub/utils.py>`__,
`app/os-specific
helpers <https://github.com/git-foysal-1/devxhub-terminal/tree/master/devxhub/specific/>`__.
...
.. |Build Status| image:: https://github.com/git-foysal-1/devxhub-terminal/workflows/Tests/badge.svg
   :target: https://github.com/git-foysal-1/devxhub-terminal/actions?query=workflow%3ATests
.. |Coverage| image:: https://img.shields.io/coveralls/git-foysal-1/devxhub-terminal.svg
   :target: https://coveralls.io/github/git-foysal-1/devxhub-terminal
