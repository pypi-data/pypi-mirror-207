...
# Path params
SpendControlIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'spend_control_id': typing.Union[SpendControlIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_spend_control_id = api_client.PathParameter(
    name="spend_control_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SpendControlIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = SpendControlUpdateRequest


request_body_spend_control_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SpendControlResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_spend_control_oapg(
        self,
    ...
    def _update_spend_control_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_spend_control_update_request.serialize(body, content_type)
...
class UpdateSpendControl(BaseApi):
    ...
    def update_spend_control(
        ...
        return self._update_spend_control_oapg(
            body=body,
