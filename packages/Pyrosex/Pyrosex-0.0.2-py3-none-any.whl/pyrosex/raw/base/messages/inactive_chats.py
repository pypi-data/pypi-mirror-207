...
class InactiveChats:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.InactiveChats <pyrosex.raw.types.messages.InactiveChats>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetInactiveChannels <pyrosex.raw.functions.channels.GetInactiveChannels>`
    """

    QUALNAME = "pyrosex.raw.base.messages.InactiveChats"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/inactive-chats")
