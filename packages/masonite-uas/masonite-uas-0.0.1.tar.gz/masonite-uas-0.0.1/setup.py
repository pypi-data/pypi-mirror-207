...
setup(
    ...
    package_dir={"": "src"},
    description="A simple user account system for Masonite with email-verifications, password-resets, two-factor authentication, etc.",
