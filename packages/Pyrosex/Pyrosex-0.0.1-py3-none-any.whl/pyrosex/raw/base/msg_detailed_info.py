...
class MsgDetailedInfo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MsgDetailedInfo <pyrosex.raw.types.MsgDetailedInfo>`
            - :obj:`MsgNewDetailedInfo <pyrosex.raw.types.MsgNewDetailedInfo>`
    """

    QUALNAME = "pyrosex.raw.base.MsgDetailedInfo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/msg-detailed-info")
