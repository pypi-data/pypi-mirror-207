...
class InputTheme:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputTheme <pyrosex.raw.types.InputTheme>`
            - :obj:`InputThemeSlug <pyrosex.raw.types.InputThemeSlug>`
    """

    QUALNAME = "pyrosex.raw.base.InputTheme"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-theme")
