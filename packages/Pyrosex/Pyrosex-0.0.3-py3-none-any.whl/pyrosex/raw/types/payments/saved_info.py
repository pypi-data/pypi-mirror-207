...
class SavedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.payments.SavedInfo`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetSavedInfo <pyrosex.raw.functions.payments.GetSavedInfo>`
    """
