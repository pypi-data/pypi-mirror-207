...
from skailar.test.utils import isolate_lru_cache
...
class FieldDeconstructionTests(SimpleTestCase):
    ...
    def test_auto_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.AutoField")
        self.assertEqual(args, [])
    ...
    def test_big_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.BigIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_boolean_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.BooleanField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_char_field(self):
        field = models.CharField(max_length=65)
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.CharField")
        self.assertEqual(args, [])
    ...
    def test_csi_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.CommaSeparatedIntegerField")
        self.assertEqual(args, [])
    ...
    def test_date_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.DateField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_datetime_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.DateTimeField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_decimal_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.DecimalField")
        self.assertEqual(args, [])
    ...
    def test_email_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.EmailField")
        self.assertEqual(args, [])
    ...
    def test_file_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.FileField")
        self.assertEqual(args, [])
    ...
    def test_file_path_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.FilePathField")
        self.assertEqual(args, [])
    ...
    def test_float_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.FloatField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})

    def test_foreign_key(self):
        # Test basic pointing
        from skailar.contrib.auth.models import Permission

        field = models.ForeignKey("auth.Permission", models.CASCADE)
        field.remote_field.model = Permission
        field.remote_field.field_name = "id"
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.ForeignKey")
        self.assertEqual(args, [])
    ...
    def test_one_to_one(self):
        ...
        field.remote_field.field_name = "id"
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.OneToOneField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {"to": "auth.permission", "on_delete": models.CASCADE})
        self.assertFalse(hasattr(kwargs["to"], "setting_name"))
        # Test swap detection for swappable model
    ...
    def test_image_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.ImageField")
        self.assertEqual(args, [])
        self.assertEqual(
            kwargs,
            {
    ...
    def test_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.IntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.IPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_generic_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.GenericIPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_many_to_many_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.ManyToManyField")
        self.assertEqual(args, [])
    ...
    def test_positive_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.PositiveIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.PositiveSmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_big_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.PositiveBigIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_slug_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.SlugField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.SmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_text_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.TextField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_time_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.TimeField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_url_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.URLField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_binary_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "skailar.db.models.BinaryField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
