    ...
    def _query_gaia_dr3_id(self):
        ...
        with warnings.catch_warnings():
            ...
            if simbad_result is not None:
                self.meta["SIMBAD_RESULT"] = simbad_result[0]
            ...
            if gaia_dr3_source_id == "":
                ...
                if len(simbad_result) > 1:
                    ...
                    if distance.value.argmin() != 0:
                        print(self.label)
                        raise ValueError("Multiple SIMBAD objects found within 3 arcsec.")
                else:
                    simbad_result = simbad_result[0]
                self.meta["SIMBAD_RESULT"] = simbad_result
                gaia_dr3_source_id = get_gaia_dr3_source_id_from_simbad(simbad_result)
