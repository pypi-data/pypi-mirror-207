...
from skailar.core.checks import Warning as SkailarWarning
...
from skailar.test.utils import isolate_apps, override_settings
...
class AutoFieldTests(SimpleTestCase):
    ...
    def test_primary_key(self):
        ...
        class Model(models.Model):
            ...
            # Prevent Skailar from autocreating `id` AutoField, which would
...
class CharFieldTests(TestCase):
    ...
    def test_too_long_char_field_under_mysql(self):
        from skailar.db.backends.mysql.validation import DatabaseValidation
        ...
        self.assertEqual(
            ...
            [
                SkailarWarning(
                    ...
                    hint=(
                        "See: https://docs.skailarproject.com/en/%s/ref/databases/"
