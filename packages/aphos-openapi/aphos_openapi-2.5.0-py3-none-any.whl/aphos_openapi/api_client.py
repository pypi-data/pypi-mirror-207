...
from aphos_openapi import rest
from aphos_openapi.configuration import Configuration
from aphos_openapi.exceptions import ApiTypeError, ApiValueError, ApiException
from aphos_openapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_catalogs  # this is an instance of the class Endpoint
        api_instance.get_catalogs()  # this invokes api_instance.get_catalogs.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_catalogs.callable or self.callable in this class
