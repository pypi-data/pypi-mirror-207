...
class DeprecatedFieldsTests(SimpleTestCase):
    ...
    def test_postgres_jsonfield_deprecated(self):
        from skailar.contrib.postgres.fields import JSONField
        ...
        self.assertEqual(
            ...
            [
                checks.Error(
                    "skailar.contrib.postgres.fields.JSONField is removed except "
    ...
    def test_postgres_ci_fields_deprecated(self):
        ...
        self.assertEqual(
            ...
            [
                checks.Warning(
                    "skailar.contrib.postgres.fields.CICharField is deprecated. Support "
                ...
                checks.Warning(
                    "skailar.contrib.postgres.fields.CIEmailField is deprecated. "
                ...
                checks.Warning(
                    "skailar.contrib.postgres.fields.CITextField is deprecated. Support "
                    "for it (except in historical migrations) will be removed in "
                    "Skailar 5.1.",
                    hint=(
                ...
                checks.Warning(
                    ...
                    "    skailar.contrib.postgres.fields.CITextField is deprecated. "
                    "Support for it (except in historical migrations) will be removed "
                    "in Skailar 5.1. (fields.W907)",
