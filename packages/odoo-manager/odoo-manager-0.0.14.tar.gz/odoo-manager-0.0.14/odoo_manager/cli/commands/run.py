...
class Run(BaseCommand):
    ...
    def run(self):
        ...
        # FIXME: This seems bad. It'll likely break any repo using combined
        # docker-compose files unless the user passes the `--compose` argument
        # every time.
        ...
        try:
            ...
            # TODO: remove manual output here, leverage `run(..., echo=True)`
