...
class ExportedGroupCallInvite:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`phone.ExportedGroupCallInvite <pyrosex.raw.types.phone.ExportedGroupCallInvite>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.ExportGroupCallInvite <pyrosex.raw.functions.phone.ExportGroupCallInvite>`
    """

    QUALNAME = "pyrosex.raw.base.phone.ExportedGroupCallInvite"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-group-call-invite")
