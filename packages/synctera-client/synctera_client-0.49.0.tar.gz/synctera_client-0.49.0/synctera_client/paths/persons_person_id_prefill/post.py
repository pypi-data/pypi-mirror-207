...
# Path params
PersonIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'person_id': typing.Union[PersonIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PrefillRequest


request_body_prefill_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PrefillRequest
...
class BaseApi(api_client.Api):
    ...
    def _prefill_person_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_prefill_request.serialize(body, content_type)
...
class PrefillPerson(BaseApi):
    ...
    def prefill_person(
        ...
        return self._prefill_person_oapg(
            body=body,
