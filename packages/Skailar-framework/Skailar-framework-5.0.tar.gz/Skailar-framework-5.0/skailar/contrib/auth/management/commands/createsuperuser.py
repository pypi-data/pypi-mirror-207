...
from skailar.contrib.auth.management import get_default_username
from skailar.contrib.auth.password_validation import validate_password
from skailar.core import exceptions
from skailar.core.management.base import BaseCommand, CommandError
from skailar.db import DEFAULT_DB_ALIAS
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            dest="interactive",
            help=(
                "Tells Skailar to NOT prompt the user for input of any kind. "
        ...
        try:
            if options["interactive"]:
                ...
                if (
                    ...
                    and "SKAILAR_SUPERUSER_PASSWORD" in os.environ
                ):
                    user_data[PASSWORD_FIELD] = os.environ["SKAILAR_SUPERUSER_PASSWORD"]
                # Use username from environment variable, if not provided in
                # options.
                if username is None:
                    username = os.environ.get(
                        "SKAILAR_SUPERUSER_" + self.UserModel.USERNAME_FIELD.upper()
                    )
                if username is None:
                    raise CommandError(
                ...
                user_data[self.UserModel.USERNAME_FIELD] = username
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    env_var = "SKAILAR_SUPERUSER_" + field_name.upper()
