...
RelatedResourceTypeSchema = RelatedResourceType
RelatedResourceIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'related_resource_id': typing.Union[RelatedResourceIdSchema, str, uuid.UUID, ],
        'encryption': typing.Union[EncryptionSchema, str, ],
...
request_query_encryption = api_client.QueryParameter(
    name="encryption",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = DocumentList
...
class ListDocuments(BaseApi):
    ...
    def list_documents(
        ...
        return self._list_documents_oapg(
