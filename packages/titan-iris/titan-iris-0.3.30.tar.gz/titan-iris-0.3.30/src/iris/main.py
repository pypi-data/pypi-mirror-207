...
def pull(
    image: str = typer.Argument(
        ..., help="The image to pull. Should be displayed in the TitanML Hub."
    )
):
...
def download(
    image: str = typer.Argument(
        ..., help="The model to pull. Should be displayed in the TitanML Hub."
    )
):
...
def infer(
    ...
    task: Task = typer.Option(
        ..., "--task", help="The task to optimize the model for."
    ),
...
def upload(
    ...
    name: str = typer.Argument(
        None, help="The name of the artefact. Displayed in the TitanML Hub."
    ),
