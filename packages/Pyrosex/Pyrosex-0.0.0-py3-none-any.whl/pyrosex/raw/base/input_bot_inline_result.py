...
class InputBotInlineResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputBotInlineResult <pyrosex.raw.types.InputBotInlineResult>`
            - :obj:`InputBotInlineResultDocument <pyrosex.raw.types.InputBotInlineResultDocument>`
            - :obj:`InputBotInlineResultGame <pyrosex.raw.types.InputBotInlineResultGame>`
            - :obj:`InputBotInlineResultPhoto <pyrosex.raw.types.InputBotInlineResultPhoto>`
    """

    QUALNAME = "pyrosex.raw.base.InputBotInlineResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-bot-inline-result")
