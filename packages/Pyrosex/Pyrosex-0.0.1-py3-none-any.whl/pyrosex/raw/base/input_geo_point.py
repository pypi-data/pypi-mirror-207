...
class InputGeoPoint:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputGeoPoint <pyrosex.raw.types.InputGeoPoint>`
            - :obj:`InputGeoPointEmpty <pyrosex.raw.types.InputGeoPointEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.InputGeoPoint"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-geo-point")
