...
from skailar.core.exceptions import EmptyResultSet, FieldError, FullResultSet
from skailar.db import DEFAULT_DB_ALIAS, connection
from skailar.db.models import CharField, Count, Exists, F, Max, OuterRef, Q
from skailar.db.models.expressions import RawSQL
from skailar.db.models.functions import ExtractYear, Length, LTrim
from skailar.db.models.sql.constants import LOUTER
from skailar.db.models.sql.where import AND, OR, NothingNode, WhereNode
from skailar.test import SimpleTestCase, TestCase, skipUnlessDBFeature
from skailar.test.utils import CaptureQueriesContext, register_lookup
...
class Queries1Tests(TestCase):
    ...
    def test_tickets_2076_7256(self):
        ...
        # isn't Skailar's problem. Garbage in, garbage out.
        self.assertSequenceEqual(
            Item.objects.filter(tags__isnull=False).order_by("tags", "id"),
            [self.i1, self.i2, self.i1, self.i2, self.i4],
        )

        # If we replace the default ordering, Skailar adjusts the required
    ...
    def test_ticket_20250(self):
        # A negated Q along with an annotated queryset failed in Skailar 1.4
...
class Queries5Tests(TestCase):
    ...
    def test_ordering(self):
        ...
        self.assertSequenceEqual(
            Ranking.objects.extra(
                tables=["skailar_site"], order_by=["-skailar_site.id", "rank"]
            ),
            [self.rank1, self.rank2, self.rank3],
        )
    ...
    def test_ticket7045(self):
        ...
        qs = Ranking.objects.extra(tables=["skailar_site"])
