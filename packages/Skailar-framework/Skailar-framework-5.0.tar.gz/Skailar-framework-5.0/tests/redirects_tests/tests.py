...
from skailar.contrib.redirects.models import Redirect
from skailar.contrib.sites.models import Site
from skailar.core.exceptions import ImproperlyConfigured
from skailar.http import HttpResponse, HttpResponseForbidden, HttpResponseRedirect
from skailar.test import TestCase, modify_settings, override_settings


@modify_settings(
    MIDDLEWARE={
        "append": "skailar.contrib.redirects.middleware.RedirectFallbackMiddleware"
    }
)
...
class RedirectTests(TestCase):
    ...
    def test_sites_not_installed(self):
        ...
        msg = (
            ...
            "skailar.contrib.sites is not installed."
        )
