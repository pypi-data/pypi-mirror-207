...
AccountAliasSchema = schemas.StrSchema
TypeSchema = schemas.StrSchema
SubtypeSchema = schemas.StrSchema
IncludeInfoOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'uuid': typing.Union[UuidSchema, list, tuple, ],
        ...
        'account_alias': typing.Union[AccountAliasSchema, str, ],
        'type': typing.Union[TypeSchema, str, ],
        'subtype': typing.Union[SubtypeSchema, str, ],
        'include_info_only': typing.Union[IncludeInfoOnlySchema, bool, ],
...
request_query_account_alias = api_client.QueryParameter(
    name="account_alias",
    style=api_client.ParameterStyle.FORM,
    schema=AccountAliasSchema,
    explode=True,
)
...
request_query_include_info_only = api_client.QueryParameter(
    name="include_info_only",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeInfoOnlySchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PostedTransactions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_posted_transactions_oapg(
        self,
    ...
    def _list_posted_transactions_oapg(
        ...
        for parameter in (
            ...
            request_query_account_alias,
            request_query_type,
            request_query_subtype,
            request_query_include_info_only,
            request_query_limit,
...
class ListPostedTransactions(BaseApi):
    ...
    def list_posted_transactions(
        ...
        return self._list_posted_transactions_oapg(
