...
class PhotoSize:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PhotoCachedSize <pyrosex.raw.types.PhotoCachedSize>`
            - :obj:`PhotoPathSize <pyrosex.raw.types.PhotoPathSize>`
            - :obj:`PhotoSize <pyrosex.raw.types.PhotoSize>`
            - :obj:`PhotoSizeEmpty <pyrosex.raw.types.PhotoSizeEmpty>`
            - :obj:`PhotoSizeProgressive <pyrosex.raw.types.PhotoSizeProgressive>`
            - :obj:`PhotoStrippedSize <pyrosex.raw.types.PhotoStrippedSize>`
    """

    QUALNAME = "pyrosex.raw.base.PhotoSize"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/photo-size")
