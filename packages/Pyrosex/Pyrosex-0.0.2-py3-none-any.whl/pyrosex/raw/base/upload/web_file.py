...
class WebFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`upload.WebFile <pyrosex.raw.types.upload.WebFile>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`upload.GetWebFile <pyrosex.raw.functions.upload.GetWebFile>`
    """

    QUALNAME = "pyrosex.raw.base.upload.WebFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/web-file")
