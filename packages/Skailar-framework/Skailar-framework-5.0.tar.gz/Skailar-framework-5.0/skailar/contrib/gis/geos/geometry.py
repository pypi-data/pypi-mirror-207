...
from skailar.contrib.gis.geos import prototypes as capi
from skailar.contrib.gis.geos.base import GEOSBase
from skailar.contrib.gis.geos.coordseq import GEOSCoordSeq
from skailar.contrib.gis.geos.error import GEOSException
from skailar.contrib.gis.geos.libgeos import GEOM_PTR, geos_version_tuple
from skailar.contrib.gis.geos.mutable_list import ListMixin
from skailar.contrib.gis.geos.prepared import PreparedGeometry
from skailar.contrib.gis.geos.prototypes.io import ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of skailar.utils.tree;
