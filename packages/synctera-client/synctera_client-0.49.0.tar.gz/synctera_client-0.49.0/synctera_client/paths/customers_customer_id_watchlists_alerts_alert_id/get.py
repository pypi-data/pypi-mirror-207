...
SchemaFor200ResponseBodyApplicationJson = WatchlistAlert
...
class GetWatchlistAlert(BaseApi):
    ...
    def get_watchlist_alert(
        ...
        return self._get_watchlist_alert_oapg(
