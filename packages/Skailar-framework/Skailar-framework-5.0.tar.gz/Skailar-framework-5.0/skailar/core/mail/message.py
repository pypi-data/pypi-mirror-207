...
from skailar.core.mail.utils import DNS_NAME
from skailar.utils.encoding import force_str, punycode
...
class EmailMessage:
    ...
    def message(self):
        ...
        if "date" not in header_names:
            ...
            # the stdlib/OS concept of a timezone, however, Skailar sets the
