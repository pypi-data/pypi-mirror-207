...
from skailar.test import Client, RequestFactory, SimpleTestCase, override_settings
from skailar.utils.translation import override
from skailar.views.csrf import CSRF_FAILURE_TEMPLATE_NAME, csrf_failure
...
class CsrfViewTests(SimpleTestCase):
    ...
    def test_no_skailar_template_engine(self):
        """
    ...
    def test_template_encoding(self):
        ...
        engines.
        """
        from skailar.views.csrf import Path
