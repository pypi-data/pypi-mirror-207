...
SchemaFor200ResponseBodyApplicationJson = ExternalAccountsTransactionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_external_account_transactions_oapg(
        self,
...
class GetExternalAccountTransactions(BaseApi):
    ...
    def get_external_account_transactions(
        ...
        return self._get_external_account_transactions_oapg(
