...
class ActiveActiveSubscriptionPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] aws_account_id: AWS account ID that the VPC to be peered lives in
        :param pulumi.Input[str] destination_region: Name of the region to create the VPC peering to
...
class ActiveActiveSubscriptionPeering(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcCidr")
    def vpc_cidr(self) -> pulumi.Output[Optional[str]]:
        """
        CIDR range of the VPC to be peered
        """
        return pulumi.get(self, "vpc_cidr")
