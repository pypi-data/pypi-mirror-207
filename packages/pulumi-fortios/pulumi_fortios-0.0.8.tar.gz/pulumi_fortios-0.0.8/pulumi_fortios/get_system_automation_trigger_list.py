...
__all__ = [
    ...
    'get_system_automation_trigger_list_output',
]
...
@_utilities.lift_output_func(get_system_automation_trigger_list)
def get_system_automation_trigger_list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
