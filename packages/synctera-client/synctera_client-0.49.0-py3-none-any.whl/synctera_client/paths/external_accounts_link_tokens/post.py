...
# body param
SchemaForRequestBodyApplicationJson = ExternalAccountLinkToken


request_body_external_account_link_token = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ExternalAccountLinkToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_verification_link_token_oapg(
        self,
    ...
    def _create_verification_link_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_external_account_link_token.serialize(body, content_type)
...
class CreateVerificationLinkToken(BaseApi):
    ...
    def create_verification_link_token(
        ...
        return self._create_verification_link_token_oapg(
            body=body,
