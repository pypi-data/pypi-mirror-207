...
# body param
SchemaForRequestBodyApplicationJson = AccountProduct


request_body_account_product = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AccountProduct
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_account_resource_product_oapg(
        self,
    ...
    def _create_account_resource_product_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_product.serialize(body, content_type)
...
class CreateAccountResourceProduct(BaseApi):
    ...
    def create_account_resource_product(
        ...
        return self._create_account_resource_product_oapg(
            body=body,
