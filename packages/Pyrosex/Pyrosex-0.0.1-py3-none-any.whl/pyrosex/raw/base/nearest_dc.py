...
class NearestDc:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`NearestDc <pyrosex.raw.types.NearestDc>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetNearestDc <pyrosex.raw.functions.help.GetNearestDc>`
    """

    QUALNAME = "pyrosex.raw.base.NearestDc"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/nearest-dc")
