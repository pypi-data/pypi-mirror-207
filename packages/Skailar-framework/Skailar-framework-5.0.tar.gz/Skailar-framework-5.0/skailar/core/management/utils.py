...
from skailar.apps import apps as installed_apps
from skailar.utils.crypto import get_random_string
from skailar.utils.encoding import DEFAULT_LOCALE_ENCODING
...
def handle_extensions(extensions):
    ...
    For example: running 'skailar-admin makemessages -e js,txt -e xhtml -a'
