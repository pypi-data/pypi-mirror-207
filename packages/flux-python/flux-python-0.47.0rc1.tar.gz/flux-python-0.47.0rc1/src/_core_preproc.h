...
# 294 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 389 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 463 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 516 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 560 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 589 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 613 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 661 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 687 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 702 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 788 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 894 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 979 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1018 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1095 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1146 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1167 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1203 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1269 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg, const char **topic,
                          const char **s);
# 1280 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1493 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1571 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1613 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1682 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_panic (flux_t *h, uint32_t nodeid, int flags, const char *reason);
# 1779 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1852 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1900 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 2022 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 2065 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2077 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2129 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2167 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2254 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2323 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2333 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2366 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2398 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2467 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2550 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2565 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2638 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2688 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2697 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2729 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2807 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2863 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2880 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2903 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2924 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2972 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3042 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3053 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3184 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3198 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3223 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3376 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3396 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3480 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3489 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3683 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3729 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3749 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3795 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3856 "/__w/flux-python/flux-python/src/_core_clean.h"
