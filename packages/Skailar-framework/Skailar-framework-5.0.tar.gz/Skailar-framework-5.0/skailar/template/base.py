"""
This is the Skailar template system.
...
from skailar.template.context import BaseContext
from skailar.utils.formats import localize
from skailar.utils.html import conditional_escape, escape
from skailar.utils.regex_helper import _lazy_re_compile
from skailar.utils.safestring import SafeData, SafeString, mark_safe
from skailar.utils.text import get_text_list, smart_split, unescape_string_literal
from skailar.utils.timezone import template_localtime
from skailar.utils.translation import gettext_lazy, pgettext_lazy
...
logger = logging.getLogger("skailar.template")
...
class Template:
    def __init__(self, template_string, origin=None, name=None, engine=None):
        ...
        # exactly one Skailar template engine is configured, use that engine.
