...
class PhoneCall:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PhoneCall <pyrosex.raw.types.PhoneCall>`
            - :obj:`PhoneCallAccepted <pyrosex.raw.types.PhoneCallAccepted>`
            - :obj:`PhoneCallDiscarded <pyrosex.raw.types.PhoneCallDiscarded>`
            - :obj:`PhoneCallEmpty <pyrosex.raw.types.PhoneCallEmpty>`
            - :obj:`PhoneCallRequested <pyrosex.raw.types.PhoneCallRequested>`
            - :obj:`PhoneCallWaiting <pyrosex.raw.types.PhoneCallWaiting>`
    """

    QUALNAME = "pyrosex.raw.base.PhoneCall"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/phone-call")
