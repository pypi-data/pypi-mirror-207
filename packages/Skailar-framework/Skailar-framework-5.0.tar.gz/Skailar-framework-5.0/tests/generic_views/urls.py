from skailar.contrib.auth import views as auth_views
from skailar.contrib.auth.decorators import login_required
from skailar.urls import path, re_path
from skailar.views.decorators.cache import cache_page
from skailar.views.generic import TemplateView, dates
