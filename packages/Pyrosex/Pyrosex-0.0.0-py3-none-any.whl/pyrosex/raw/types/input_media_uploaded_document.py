...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.InputMedia`.
    ...
    Parameters:
        file: :obj:`InputFile <pyrosex.raw.base.InputFile>`
        mime_type: ``str``
        attributes: List of :obj:`DocumentAttribute <pyrosex.raw.base.DocumentAttribute>`
        nosound_video (optional): ``bool``
        force_file (optional): ``bool``
        thumb (optional): :obj:`InputFile <pyrosex.raw.base.InputFile>`
        stickers (optional): List of :obj:`InputDocument <pyrosex.raw.base.InputDocument>`
