...
class WallPapers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.WallPapers <pyrosex.raw.types.account.WallPapers>`
            - :obj:`account.WallPapersNotModified <pyrosex.raw.types.account.WallPapersNotModified>`
    ...
    QUALNAME = "pyrosex.raw.base.account.WallPapers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/wall-papers")
