...
from skailar import get_version
from skailar.conf import SettingsReference, settings
from skailar.core.validators import EmailValidator, RegexValidator
from skailar.db import migrations, models
from skailar.db.migrations.serializer import BaseSerializer
from skailar.db.migrations.writer import MigrationWriter, OperationWriter
from skailar.test import SimpleTestCase
from skailar.utils.deconstruct import deconstructible
from skailar.utils.functional import SimpleLazyObject
from skailar.utils.timezone import get_default_timezone, get_fixed_timezone
...
class WriterTests(SimpleTestCase):
    ...
    def test_serialize_fields(self):
        ...
        self.assertSerializedResultEqual(
            ...
            ("models.CharField(max_length=255)", {"from skailar.db import models"}),
        )
    ...
    def test_serialize_settings(self):
        ...
        self.assertSerializedResultEqual(
            ...
            ("settings.AUTH_USER_MODEL", {"from skailar.conf import settings"}),
        )
    ...
    def test_serialize_class_based_validators(self):
        ...
        self.assertEqual(
            string, "skailar.core.validators.RegexValidator(message='hello')"
        )
        ...
        self.assertEqual(
            string,
            "skailar.core.validators.RegexValidator(regex=re.compile('^\\\\w+$'))",
        )
        self.serialize_round_trip(validator)
        ...
        self.assertEqual(
            string,
            "skailar.core.validators.RegexValidator('^[0-9]+$', "
        ...
        self.assertEqual(
            string,
            "skailar.core.validators.RegexValidator('^[-a-zA-Z0-9_]+$', 'Invalid', "
            "'invalid')",
        )
        self.serialize_round_trip(validator)
        ...
        string = MigrationWriter.serialize(validator)[0]
        self.assertEqual(
            string, "skailar.core.validators.EmailValidator(message='hello')"
        )
        self.serialize_round_trip(validator)
        ...
        validator = deconstructible(path="skailar.core.validators.EmailValidator2")(
            EmailValidator
        )(message="hello")
        with self.assertRaisesMessage(
            ValueError,
            "Could not find object EmailValidator2 in skailar.core.validators.",
        ):
            MigrationWriter.serialize(validator)
    ...
    def test_serialize_complex_func_index(self):
        ...
        self.assertEqual(imports, {"from skailar.db import models"})
    ...
    def test_serialize_type_model(self):
        ...
        self.assertSerializedResultEqual(
            ...
            ("('models.Model', {'from skailar.db import models'})", set()),
        )
    ...
    def test_migration_file_header_comments(self):
        ...
        with mock.patch("skailar.db.migrations.writer.now", lambda: dt):
            for include_header in (True, False):
                with self.subTest(include_header=include_header):
                    ...
                    self.assertEqual(
                        include_header,
                        output.startswith(
                            "# Generated by Skailar %s on 2015-07-31 04:40\n\n"
                            % get_version()
                        ),
                    )
    ...
    def test_models_import_omitted(self):
        """
        skailar.db.models shouldn't be imported if unused.
        """
        migration = type(
            "Migration",
            (migrations.Migration,),
        ...
        writer = MigrationWriter(migration)
        output = writer.as_string()
        self.assertIn("from skailar.db import migrations\n", output)
