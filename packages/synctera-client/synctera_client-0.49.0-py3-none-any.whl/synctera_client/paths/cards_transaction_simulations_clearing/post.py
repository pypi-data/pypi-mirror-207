...
# body param
SchemaForRequestBodyApplicationJson = ClearingModel


request_body_clearing_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _simulate_clearing_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_clearing_model.serialize(body, content_type)
...
class SimulateClearing(BaseApi):
    ...
    def simulate_clearing(
        ...
        return self._simulate_clearing_oapg(
            body=body,
