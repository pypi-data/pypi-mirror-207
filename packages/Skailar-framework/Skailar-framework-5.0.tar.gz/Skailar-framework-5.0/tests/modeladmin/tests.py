...
from skailar.contrib.admin.models import ADDITION, CHANGE, DELETION, LogEntry
...
from skailar.contrib.admin.widgets import (
    AdminDateWidget,
    AdminRadioSelect,
    AutocompleteSelect,
...
from skailar.forms.widgets import Select
from skailar.test import RequestFactory, SimpleTestCase, TestCase
