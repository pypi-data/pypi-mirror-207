...
from skailar.db import DatabaseError
from skailar.db.backends.base.introspection import BaseDatabaseIntrospection
from skailar.db.backends.base.introspection import FieldInfo as BaseFieldInfo
...
class FlexibleFieldLookupDict:
    # Maps SQL types to Skailar Field types. Some of the SQL types have multiple
