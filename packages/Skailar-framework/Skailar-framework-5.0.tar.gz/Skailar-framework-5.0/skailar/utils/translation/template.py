...
from skailar.template.base import Lexer, TokenType
...
def templatize(src, origin=None):
    """
    Turn a Skailar template into something that is understood by xgettext. It
    does so by translating the Skailar translation tags into standard gettext
