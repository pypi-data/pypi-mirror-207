...
def ArabicStrip(input_str, diacs=True, smallDiacs=False, shaddah=False, digit=False, alif=False, specialChars=False):
    ...
    Args:
        - input_str (:obj:`str'): A string to be processed.
        - diacs (:obj:`bool'): A Boolean value indicating whether to remove diacritics or not.
        - smallDiacs (:obj:`bool'): A Boolean value indicating whether to remove small Quranic annotation signs or not.
        - shaddah (:obj:`bool'): A Boolean value indicating whether to remove shaddah or not.
        - digit (:obj:`bool'): A Boolean value indicating whether to remove English and Arabic digits or not.
        - alif (:obj:`bool'): A Boolean value indicating whether to unify alif with hamzah or not.
        - specialChars (:obj:`bool'): A Boolean value indicating whether to remove some special characters or not.
    
    Returns:
        - A processed (:obj:`str') without diacritics, small Quranic annotation signs, shaddah, English and Arabic digits,
...
def removePunctuation( inputString ):
    ...
    Args:
      - inputString (:obj:`str`): The input string containing punctuation marks.
...
def removeEnglish( inputString ):
    ...
    Args:
         - inputString (:obj: `str`): The string to remove English characters from.

    Returns:
         - outputString (:obj: `str`): The input string with all English characters removed.
