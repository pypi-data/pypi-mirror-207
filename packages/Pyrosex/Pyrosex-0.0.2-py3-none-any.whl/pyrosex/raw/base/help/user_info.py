...
class UserInfo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.UserInfo <pyrosex.raw.types.help.UserInfo>`
            - :obj:`help.UserInfoEmpty <pyrosex.raw.types.help.UserInfoEmpty>`
    ...
    QUALNAME = "pyrosex.raw.base.help.UserInfo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/user-info")
