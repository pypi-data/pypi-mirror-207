...
# body param
SchemaForRequestBodyApplicationJson = ExternalAccountAccessToken


request_body_external_account_access_token = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ExternalAccountAccessToken
...
class BaseApi(api_client.Api):
    ...
    def _create_access_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_external_account_access_token.serialize(body, content_type)
