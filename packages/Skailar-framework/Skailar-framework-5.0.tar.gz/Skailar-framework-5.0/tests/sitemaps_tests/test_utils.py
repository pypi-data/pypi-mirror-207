...
from skailar.contrib.sitemaps import SitemapNotFound, _get_sitemap_full_url, ping_google
...
class PingGoogleTests(SitemapTestsBase):
    ...
    @mock.patch("skailar.contrib.sitemaps.urlopen")
    ...
    def test_get_sitemap_full_url_no_sites(self):
        msg = "ping_google requires skailar.contrib.sites, which isn't installed."
