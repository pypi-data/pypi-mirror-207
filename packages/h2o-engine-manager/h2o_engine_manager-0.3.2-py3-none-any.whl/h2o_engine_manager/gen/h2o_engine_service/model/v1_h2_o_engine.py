...
class V1H2OEngine(ModelNormal):
    ...
    def _from_openapi_data(cls, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cpu (int, none_type): The amount of CPU units requested by this H2OEngine.. [optional]  # noqa: E501
            gpu (int, none_type): The amount of GPU units requested by this H2OEngine.. [optional]  # noqa: E501
            memory_bytes (str, none_type): The amount of memory in bytes requested by this H2OEngine.. [optional]  # noqa: E501
