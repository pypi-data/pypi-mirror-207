...
class DestroyAuthKeyRes:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DestroyAuthKeyFail <pyrosex.raw.types.DestroyAuthKeyFail>`
            - :obj:`DestroyAuthKeyNone <pyrosex.raw.types.DestroyAuthKeyNone>`
            - :obj:`DestroyAuthKeyOk <pyrosex.raw.types.DestroyAuthKeyOk>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`DestroyAuthKey <pyrosex.raw.functions.DestroyAuthKey>`
    """

    QUALNAME = "pyrosex.raw.base.DestroyAuthKeyRes"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/destroy-auth-key-res")
