...
# body param
SchemaForRequestBodyApplicationJson = RelationshipIn


request_body_relationship_in = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RelationshipIn
...
class BaseApi(api_client.Api):
    ...
    def _create_relationship_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_relationship_in.serialize(body, content_type)
