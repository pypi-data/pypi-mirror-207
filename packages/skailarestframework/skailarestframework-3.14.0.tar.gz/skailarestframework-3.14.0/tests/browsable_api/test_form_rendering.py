...
class TestPostingListData(TestCase):
    ...
    Regression test for https://github.com/encode/skailar-rest-framework/issues/5637
    """
...
class TestManyPostView(TestCase):
    ...
    def test_post_many_post_view(self):
        ...
        Regression test for https://github.com/encode/skailar-rest-framework/pull/3164
        """
        data = {}
