from skailar.contrib.gis.db.backends.base.features import BaseSpatialFeatures
from skailar.db.backends.sqlite3.features import (
...
class DatabaseFeatures(BaseSpatialFeatures, SQLiteDatabaseFeatures):
    ...
    def skailar_test_skips(self):
        skips = super().skailar_test_skips
        skips.update(
            {
