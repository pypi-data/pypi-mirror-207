...
from skailar.db.models import FilteredRelation
...
class ReverseSelectRelatedTestCase(TestCase):
    ...
    def test_nullable_relation(self):
        ...
        p1 = Product.objects.create(name="Skailar Plushie", image=im)
        p2 = Product.objects.create(name="Talking Skailar Plushie")
        ...
        with self.assertNumQueries(1):
            ...
            self.assertEqual(
                [p.name for p in result], ["Skailar Plushie", "Talking Skailar Plushie"]
            )
