...
from skailar.http import HttpRequest, QueryDict
...
class Request:
    ...
    def user(self, value):
        ...
        compatibility with skailar.contrib.auth where the user property is
        set in the login and logout functions.

        Note that we also set the user on Skailar's underlying `HttpRequest`
    ...
    @property
    def FILES(self):
        # Leave this one alone for backwards compat with Skailar's request.FILES
