...
class WebDocument:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`WebDocument <pyrosex.raw.types.WebDocument>`
            - :obj:`WebDocumentNoProxy <pyrosex.raw.types.WebDocumentNoProxy>`
    """

    QUALNAME = "pyrosex.raw.base.WebDocument"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/web-document")
