...
# body param
SchemaForRequestBodyApplicationJson = AddVendorAccountsRequest


request_body_add_vendor_accounts_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddVendorAccountsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sync_vendor_external_accounts_oapg(
        self,
    ...
    def _sync_vendor_external_accounts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_add_vendor_accounts_request.serialize(body, content_type)
...
class SyncVendorExternalAccounts(BaseApi):
    ...
    def sync_vendor_external_accounts(
        ...
        return self._sync_vendor_external_accounts_oapg(
            body=body,
