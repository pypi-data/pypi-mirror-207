...
class InputMessage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputMessageCallbackQuery <pyrosex.raw.types.InputMessageCallbackQuery>`
            - :obj:`InputMessageID <pyrosex.raw.types.InputMessageID>`
            - :obj:`InputMessagePinned <pyrosex.raw.types.InputMessagePinned>`
            - :obj:`InputMessageReplyTo <pyrosex.raw.types.InputMessageReplyTo>`
    """

    QUALNAME = "pyrosex.raw.base.InputMessage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-message")
