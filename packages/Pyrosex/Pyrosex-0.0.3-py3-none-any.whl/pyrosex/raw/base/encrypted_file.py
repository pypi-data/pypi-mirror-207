...
class EncryptedFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EncryptedFile <pyrosex.raw.types.EncryptedFile>`
            - :obj:`EncryptedFileEmpty <pyrosex.raw.types.EncryptedFileEmpty>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.UploadEncryptedFile <pyrosex.raw.functions.messages.UploadEncryptedFile>`
    """

    QUALNAME = "pyrosex.raw.base.EncryptedFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/encrypted-file")
