...
class MessageInteractionCounters:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MessageInteractionCounters <pyrosex.raw.types.MessageInteractionCounters>`
    """

    QUALNAME = "pyrosex.raw.base.MessageInteractionCounters"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-interaction-counters")
