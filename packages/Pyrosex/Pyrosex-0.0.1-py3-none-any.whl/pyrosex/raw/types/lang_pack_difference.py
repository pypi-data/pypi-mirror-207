...
class LangPackDifference(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.LangPackDifference`.
    ...
    Parameters:
        ...
        version: ``int`` ``32-bit``
        strings: List of :obj:`LangPackString <pyrosex.raw.base.LangPackString>`
