...
class ChatParticipants:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatParticipants <pyrosex.raw.types.ChatParticipants>`
            - :obj:`ChatParticipantsForbidden <pyrosex.raw.types.ChatParticipantsForbidden>`
    """

    QUALNAME = "pyrosex.raw.base.ChatParticipants"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-participants")
