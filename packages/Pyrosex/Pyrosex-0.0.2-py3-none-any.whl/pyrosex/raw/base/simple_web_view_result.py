...
class SimpleWebViewResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SimpleWebViewResultUrl <pyrosex.raw.types.SimpleWebViewResultUrl>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.RequestSimpleWebView <pyrosex.raw.functions.messages.RequestSimpleWebView>`
    """

    QUALNAME = "pyrosex.raw.base.SimpleWebViewResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/simple-web-view-result")
