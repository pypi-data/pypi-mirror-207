...
from pyrosex.crypto import aes, rsa, prime
from pyrosex.errors import SecurityCheckMismatch
from pyrosex.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrosex.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
