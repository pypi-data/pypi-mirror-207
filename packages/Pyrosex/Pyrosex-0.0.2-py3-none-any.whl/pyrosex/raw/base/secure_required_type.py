...
class SecureRequiredType:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SecureRequiredType <pyrosex.raw.types.SecureRequiredType>`
            - :obj:`SecureRequiredTypeOneOf <pyrosex.raw.types.SecureRequiredTypeOneOf>`
    """

    QUALNAME = "pyrosex.raw.base.SecureRequiredType"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/secure-required-type")
