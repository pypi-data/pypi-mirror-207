...
class OSRunner(object):
    ...
    def updateProgress(self, value: "double") -> "void":
    ...
    def getOptionalBoolArgumentValue(self, argument_name: "std::string const &", user_arguments: "OSArgumentMap") -> "boost::optional< bool >":
