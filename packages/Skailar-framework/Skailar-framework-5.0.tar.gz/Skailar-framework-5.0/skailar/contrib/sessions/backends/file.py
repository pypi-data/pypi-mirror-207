...
from skailar.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from skailar.contrib.sessions.exceptions import InvalidSessionKey
from skailar.core.exceptions import ImproperlyConfigured, SuspiciousOperation
        ...
        try:
            ...
            if not os.path.isdir(storage_path):
                raise ImproperlyConfigured(
                    ...
                    " Skailar can store session data." % storage_path
                )
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "skailar.security.%s" % e.__class__.__name__
                        )
