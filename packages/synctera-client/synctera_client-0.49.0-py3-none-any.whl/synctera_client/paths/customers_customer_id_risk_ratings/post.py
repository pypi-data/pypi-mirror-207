...
# body param
SchemaForRequestBodyApplicationJson = RiskRating


request_body_risk_rating = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RiskRating
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_customer_risk_rating_oapg(
        self,
    ...
    def _create_customer_risk_rating_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_risk_rating.serialize(body, content_type)
...
class CreateCustomerRiskRating(BaseApi):
    ...
    def create_customer_risk_rating(
        ...
        return self._create_customer_risk_rating_oapg(
            body=body,
