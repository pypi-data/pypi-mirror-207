...
class GlobalPrivacySettings:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`GlobalPrivacySettings <pyrosex.raw.types.GlobalPrivacySettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetGlobalPrivacySettings <pyrosex.raw.functions.account.GetGlobalPrivacySettings>`
            - :obj:`account.SetGlobalPrivacySettings <pyrosex.raw.functions.account.SetGlobalPrivacySettings>`
    """

    QUALNAME = "pyrosex.raw.base.GlobalPrivacySettings"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/global-privacy-settings")
