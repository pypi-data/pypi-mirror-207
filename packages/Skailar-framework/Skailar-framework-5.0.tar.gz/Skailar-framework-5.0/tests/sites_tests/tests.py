...
from skailar.contrib.sites import models
from skailar.contrib.sites.checks import check_site_id
from skailar.contrib.sites.management import create_default_site
from skailar.contrib.sites.middleware import CurrentSiteMiddleware
from skailar.contrib.sites.models import Site, clear_site_cache
...
from skailar.core.exceptions import ObjectDoesNotExist, ValidationError
...
@modify_settings(INSTALLED_APPS={"append": "skailar.contrib.sites"})
class SitesFrameworkTests(TestCase):
    ...
    def test_get_current_site(self):
        ...
        with self.modify_settings(INSTALLED_APPS={"remove": "skailar.contrib.sites"}):
            site = get_current_site(request)
