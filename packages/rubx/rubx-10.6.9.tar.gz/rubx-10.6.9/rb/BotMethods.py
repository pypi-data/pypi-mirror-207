...
class BotMethods:
    ...
    def __ge__(self, kwargs):
        ...
        return self.edit_message_text(**kwargs)
    ...
    def __ne__(self, kwargs):
        ...
        return self.delete_message(**kwargs)
    
    def __lt__(self, kwargs):
        
        '''
        self < dict(limit=1, offset_id=...)
        '''
    ...
    def __le__(self, kwargs):
        ...
        return self.edit_message_keypad(**kwargs)
    
    def __add__(self, kwargs):
        
        '''
        self + dict(from_chat_id=..., message_id=..., to_chat_id=...)
        '''

        if not isinstance(kwargs, dict):
            kwargs: dict = kwargs.dict()

        return self.forward_message(**kwargs)
    ...
    def __mul__(self, kwargs):
        ...
        return self.edit_chat_keypad(**kwargs)
    ...
    def __mod__(self, *args, **kwargs):
        ...
        return self.set_commands(*args, **kwargs)
    ...
    def __pow__(self, kwargs):
        ...
        return self.send_sticker(**kwargs)
    ...
    def __rshift__(self, kwargs):
        '''
        self >> dict(chat_id=..., first_name=..., last_name=..., phone_number=...)
        '''
    ...
    def __and__(self, kwargs):
        ...
        return self.update_bot_endpoint(**kwargs)
    
    def __or__(self, __type = 'me', /):
    ...
    def __xor__(self, kwargs):
        ...
        return BotMethods.method(**kwargs)
