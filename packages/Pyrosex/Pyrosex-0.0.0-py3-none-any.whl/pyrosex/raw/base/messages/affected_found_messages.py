...
class AffectedFoundMessages:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.AffectedFoundMessages <pyrosex.raw.types.messages.AffectedFoundMessages>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.DeletePhoneCallHistory <pyrosex.raw.functions.messages.DeletePhoneCallHistory>`
    """

    QUALNAME = "pyrosex.raw.base.messages.AffectedFoundMessages"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/affected-found-messages")
