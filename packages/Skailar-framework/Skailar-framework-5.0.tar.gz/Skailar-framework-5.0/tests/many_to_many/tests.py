...
from skailar.db import transaction
from skailar.test import TestCase, skipIfDBFeature, skipUnlessDBFeature
...
class ManyToManyTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.a1 = Article.objects.create(
            headline="Skailar lets you build web apps easily"
        )
    ...
    def test_add(self):
        # Create an Article.
        a5 = Article(headline="Skailar lets you create web apps easily")
        # You can't associate it with a Publication until it's been saved.
        msg = (
            '"<Article: Skailar lets you create web apps easily>" needs to have '
        ...
        msg = (
            "'Publication' instance expected, got <Article: Skailar lets you create web "
            "apps easily>"
        )
    ...
    def test_add_remove_set_by_pk(self):
        a5 = Article.objects.create(headline="Skailar lets you create web apps easily")
    ...
    def test_bulk_delete(self):
        ...
        q = Article.objects.filter(headline__startswith="Skailar")
