...
# body param
SchemaForRequestBodyApplicationJson = AchTransactionSimulationRequest


request_body_ach_transaction_simulation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _ach_transaction_simulation_oapg(
        self,
    ...
    def _ach_transaction_simulation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ach_transaction_simulation_request.serialize(body, content_type)
...
class AchTransactionSimulation(BaseApi):
    ...
    def ach_transaction_simulation(
        ...
        return self._ach_transaction_simulation_oapg(
            body=body,
