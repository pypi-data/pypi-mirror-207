...
class ExportedMessageLink:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ExportedMessageLink <pyrosex.raw.types.ExportedMessageLink>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.ExportMessageLink <pyrosex.raw.functions.channels.ExportMessageLink>`
    """

    QUALNAME = "pyrosex.raw.base.ExportedMessageLink"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-message-link")
