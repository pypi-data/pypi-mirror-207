...
class FileHash:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`FileHash <pyrosex.raw.types.FileHash>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`upload.ReuploadCdnFile <pyrosex.raw.functions.upload.ReuploadCdnFile>`
            - :obj:`upload.GetCdnFileHashes <pyrosex.raw.functions.upload.GetCdnFileHashes>`
            - :obj:`upload.GetFileHashes <pyrosex.raw.functions.upload.GetFileHashes>`
    """

    QUALNAME = "pyrosex.raw.base.FileHash"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/file-hash")
