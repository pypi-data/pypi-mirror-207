...
# body param
SchemaForRequestBodyApplicationJson = OutgoingAchPatch


request_body_outgoing_ach_patch = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OutgoingAch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_transaction_out_oapg(
        self,
    ...
    def _patch_transaction_out_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_outgoing_ach_patch.serialize(body, content_type)
...
class PatchTransactionOut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_transaction_out(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_transaction_out(
        ...
        return self._patch_transaction_out_oapg(
            body=body,
