...
class DialogPeer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DialogPeer <pyrosex.raw.types.DialogPeer>`
            - :obj:`DialogPeerFolder <pyrosex.raw.types.DialogPeerFolder>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDialogUnreadMarks <pyrosex.raw.functions.messages.GetDialogUnreadMarks>`
    """

    QUALNAME = "pyrosex.raw.base.DialogPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/dialog-peer")
