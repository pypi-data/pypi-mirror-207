...
class PageListItem:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PageListItemBlocks <pyrosex.raw.types.PageListItemBlocks>`
            - :obj:`PageListItemText <pyrosex.raw.types.PageListItemText>`
    """

    QUALNAME = "pyrosex.raw.base.PageListItem"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/page-list-item")
