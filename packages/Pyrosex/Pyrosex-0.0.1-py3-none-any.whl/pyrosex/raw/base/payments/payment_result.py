...
class PaymentResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.PaymentResult <pyrosex.raw.types.payments.PaymentResult>`
            - :obj:`payments.PaymentVerificationNeeded <pyrosex.raw.types.payments.PaymentVerificationNeeded>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.SendPaymentForm <pyrosex.raw.functions.payments.SendPaymentForm>`
    """

    QUALNAME = "pyrosex.raw.base.payments.PaymentResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/payment-result")
