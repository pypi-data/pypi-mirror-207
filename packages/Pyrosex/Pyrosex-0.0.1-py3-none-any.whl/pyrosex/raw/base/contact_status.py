...
class ContactStatus:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ContactStatus <pyrosex.raw.types.ContactStatus>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetStatuses <pyrosex.raw.functions.contacts.GetStatuses>`
    """

    QUALNAME = "pyrosex.raw.base.ContactStatus"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/contact-status")
