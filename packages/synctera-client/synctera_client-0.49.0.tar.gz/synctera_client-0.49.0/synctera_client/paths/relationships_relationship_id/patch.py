...
# body param
SchemaForRequestBodyApplicationJson = PatchRelationshipIn


request_body_patch_relationship_in = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PatchRelationshipIn
...
class BaseApi(api_client.Api):
    ...
    def _update_relationship_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_relationship_in.serialize(body, content_type)
...
class UpdateRelationship(BaseApi):
    ...
    def update_relationship(
        ...
        return self._update_relationship_oapg(
            body=body,
