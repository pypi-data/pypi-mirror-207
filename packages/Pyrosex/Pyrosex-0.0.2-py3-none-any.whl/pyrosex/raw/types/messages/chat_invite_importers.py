...
class ChatInviteImporters(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.ChatInviteImporters`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        importers: List of :obj:`ChatInviteImporter <pyrosex.raw.base.ChatInviteImporter>`
