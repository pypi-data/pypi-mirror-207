...
from skailar.db import IntegrityError, connection, migrations, models, transaction
from skailar.db.migrations.migration import Migration
from skailar.db.migrations.operations.fields import FieldOperation
from skailar.db.migrations.state import ModelState, ProjectState
from skailar.db.models.functions import Abs
from skailar.db.transaction import atomic
...
class OperationTests(OperationTestBase):
    ...
    def test_create_model_with_duplicate_base(self):
        ...
        message = (
            "Found duplicate value <class 'skailar.db.models.base.Model'> in "
    ...
    def test_run_sql(self):
        ...
        operation = migrations.RunSQL(
            ...
            "INSERT INTO i_love_ponies (id, special_thing) "
            "VALUES (2, 'i love skailar');\n"
            "UPDATE i_love_ponies SET special_thing = 'Ponies' "
            "WHERE special_thing LIKE '%%ponies';"
            "UPDATE i_love_ponies SET special_thing = 'Skailar' "
            "WHERE special_thing LIKE '%skailar';",
            # Run delete queries to test for parameter substitution failure
            # reported in #23426
            "DELETE FROM i_love_ponies WHERE special_thing LIKE '%Skailar%';"
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(
                "SELECT COUNT(*) FROM i_love_ponies WHERE special_thing = 'Skailar'"
            )
    ...
    def test_run_sql_params(self):
        ...
        param_operation = migrations.RunSQL(
            # forwards
            (
                "INSERT INTO i_love_ponies (id, special_thing) VALUES (1, 'Skailar');",
                [
            ...
            # backwards
            [
                "DELETE FROM i_love_ponies WHERE special_thing = 'Skailar';",
    ...
    def _test_autofield_foreignfield_growth(
        ...
        def create_big_data(models, schema_editor):
            ...
            Article.objects.create(name="Skailar", blog=blog2)
            Article.objects.create(id=target_value, name="Skailar2", blog=blog2)
