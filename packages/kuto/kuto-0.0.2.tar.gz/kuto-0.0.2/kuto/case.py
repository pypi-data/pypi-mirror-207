...
from kuto.core.api.request import HttpRequest
...
from kuto.utils.exceptions import NoSuchDriverType, ElementNameEmptyException
...
class TestCase(HttpRequest):
    ...
    @staticmethod
    def upload_pic_to_allure(file_path: str):
        """图片上传至allure报告"""
        upload_pic(file_path)
