...
from portmodlib.atom import Atom, FQAtom, QualifiedAtom, VAtom, Version, atom_sat
...
def _import_common(
    ...
    if installed and path:
        ...
        files = list(_iterate_pybuilds(base_atom, repo_name=repo))
