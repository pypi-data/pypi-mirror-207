...
class PeerSettings:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.PeerSettings <pyrosex.raw.types.messages.PeerSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetPeerSettings <pyrosex.raw.functions.messages.GetPeerSettings>`
    """

    QUALNAME = "pyrosex.raw.base.messages.PeerSettings"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/peer-settings")
