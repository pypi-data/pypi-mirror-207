...
from skailar.test.selenium import SeleniumTestCase
from skailar.urls import reverse
from skailar.utils.translation import get_language, override
from skailar.views.i18n import JavaScriptCatalog, get_formats
...
class SetLanguageTests(TestCase):
    """Test the skailar.views.i18n.set_language view."""
    ...
    def test_setlang_cookie(self):
        ...
        test_settings = {
            "MIDDLEWARE": ["skailar.middleware.common.CommonMiddleware"],
    ...
    @modify_settings(
        MIDDLEWARE={
            "append": "skailar.middleware.locale.LocaleMiddleware",
        }
    )
...
class I18NViewTests(SimpleTestCase):
    """Test skailar.views.i18n views other than set_language."""
    ...
    def test_jsi18n(self):
        ...
        for lang_code in ["es", "fr", "ru"]:
            with override(lang_code):
                catalog = gettext.translation("skailarjs", locale_dir, [lang_code])
    ...
    def test_i18n_language_english_default(self):
        ...
        translation available and a catalog composed by skailarjs domain
    ...
    def test_template_encoding(self):
        ...
        engines.
        """
        from skailar.views.i18n import Path
