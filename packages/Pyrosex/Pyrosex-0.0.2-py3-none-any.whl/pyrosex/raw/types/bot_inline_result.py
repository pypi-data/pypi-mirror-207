...
class BotInlineResult(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.BotInlineResult`.
    ...
    Parameters:
        id: ``str``
        type: ``str``
        send_message: :obj:`BotInlineMessage <pyrosex.raw.base.BotInlineMessage>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): :obj:`WebDocument <pyrosex.raw.base.WebDocument>`
        content (optional): :obj:`WebDocument <pyrosex.raw.base.WebDocument>`
    """
