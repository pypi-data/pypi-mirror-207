...
class TermsOfService:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.TermsOfService <pyrosex.raw.types.help.TermsOfService>`
    """

    QUALNAME = "pyrosex.raw.base.help.TermsOfService"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/terms-of-service")
