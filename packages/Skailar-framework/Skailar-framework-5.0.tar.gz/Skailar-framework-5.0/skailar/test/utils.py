...
from skailar.conf import UserSettingsHolder, settings
from skailar.core import mail
from skailar.core.exceptions import ImproperlyConfigured
from skailar.core.signals import request_started, setting_changed
from skailar.db import DEFAULT_DB_ALIAS, connections, reset_queries
from skailar.db.models.options import Options
from skailar.template import Template
from skailar.test.signals import template_rendered
from skailar.urls import get_script_prefix, set_script_prefix
from skailar.utils.translation import deactivate
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = "skailar.core.mail.backends.locmem.EmailBackend"
...
class override_settings(TestContextDecorator):
    ...
    def decorate_class(self, cls):
        ...
        if not issubclass(cls, SimpleTestCase):
            raise ValueError(
                "Only subclasses of Skailar SimpleTestCase can be decorated "
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from skailar.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    Skailar template engine for a test or skip it if Jinja2 isn't available.
    """
    ...
    return override_settings(
        TEMPLATES=[
            ...
            {
                "BACKEND": "skailar.template.backends.jinja2.Jinja2",
                "APP_DIRS": True,
...
class LoggingCaptureMixin:
    """
    Capture the output from the 'skailar' logger and store it on the class's
    logger_output attribute.
    """

    def setUp(self):
        self.logger = logging.getLogger("skailar")
