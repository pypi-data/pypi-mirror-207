...
class ExportedChatInvites(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.ExportedChatInvites`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        invites: List of :obj:`ExportedChatInvite <pyrosex.raw.base.ExportedChatInvite>`
