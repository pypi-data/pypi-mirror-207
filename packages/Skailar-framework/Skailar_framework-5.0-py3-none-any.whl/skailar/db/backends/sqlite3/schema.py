...
from skailar.db import NotSupportedError
from skailar.db.backends.base.schema import BaseDatabaseSchemaEditor
from skailar.db.backends.ddl_references import Statement
from skailar.db.backends.utils import strip_quotes
from skailar.db.models import UniqueConstraint
...
class DatabaseSchemaEditor(BaseDatabaseSchemaEditor):
    ...
    def _remake_table(
        ...
        meta_contents = {
            ...
            "index_together": index_together,  # RemovedInSkailar51Warning.
            "indexes": indexes,
