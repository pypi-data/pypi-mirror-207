...
SchemaFor200ResponseBodyApplicationJson = PaymentScheduleList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_payment_schedules_oapg(
        self,
...
class ListPaymentSchedules(BaseApi):
    ...
    def list_payment_schedules(
        ...
        return self._list_payment_schedules_oapg(
