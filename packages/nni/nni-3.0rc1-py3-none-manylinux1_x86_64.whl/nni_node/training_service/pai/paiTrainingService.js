...
let PAITrainingService = class PAITrainingService {
    ...
    config;
    constructor(config) {
        this.log = (0, log_1.getLogger)('PAITrainingService');
        this.metricsEmitter = new events_1.EventEmitter();
        this.trialJobsMap = new Map();
        this.jobQueue = [];
        this.expRootDir = path_1.default.join('/nni-experiments', (0, experimentStartupInfo_1.getExperimentId)());
    ...
    cancelTrialJob(trialJobId, isEarlyStopped = false) {
        ...
        (0, request_1.default)(stopJobRequest, (error, response, _body) => {
    ...
    async submitTrialJob(form) {
        ...
        const trialJobId = form.id === undefined ? (0, utils_2.uniqueString)(5) : form.id;
                ...
                taskRoles: {
                    taskrole: {
                        ...
                        resourcePerInstance: {
                            ...
                            memoryMB: (0, experimentConfig_1.toMegaBytes)(this.config.trialMemorySize)
                        },
                        commands: [
    ...
    async submitTrialJobToPAI(trialJobId) {
        ...
        await (0, util_1.execMkdir)(trialJobDetail.logPath);
        ...
        (0, request_1.default)(submitJobRequest, (error, response, body) => {
            if ((error !== undefined && error !== null) || response.statusCode >= 400) {
    ...
    async writeParameterFile(directory, hyperParameters) {
        const filepath = path_1.default.join(directory, (0, utils_2.generateParamFileName)(hyperParameters));
