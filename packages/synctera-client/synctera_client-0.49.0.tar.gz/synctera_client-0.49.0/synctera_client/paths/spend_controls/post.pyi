...
# body param
SchemaForRequestBodyApplicationJson = SpendControl


request_body_spend_control = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = SpendControlResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_spend_control_oapg(
        self,
    ...
    def _create_spend_control_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_spend_control.serialize(body, content_type)
...
class CreateSpendControl(BaseApi):
    ...
    def create_spend_control(
        ...
        return self._create_spend_control_oapg(
            body=body,
