...
class SearchCounter:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.SearchCounter <pyrosex.raw.types.messages.SearchCounter>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchCounters <pyrosex.raw.functions.messages.GetSearchCounters>`
    """

    QUALNAME = "pyrosex.raw.base.messages.SearchCounter"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/search-counter")
