...
# body param
SchemaForRequestBodyApplicationJson = PatchAccount


request_body_patch_account = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AccountGenericResponse
...
class BaseApi(api_client.Api):
    ...
    def _patch_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_account.serialize(body, content_type)
...
class PatchAccount(BaseApi):
    ...
    def patch_account(
        ...
        return self._patch_account_oapg(
            body=body,
