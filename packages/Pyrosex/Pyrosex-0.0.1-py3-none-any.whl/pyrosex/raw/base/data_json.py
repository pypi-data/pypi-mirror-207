...
class DataJSON:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DataJSON <pyrosex.raw.types.DataJSON>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`bots.SendCustomRequest <pyrosex.raw.functions.bots.SendCustomRequest>`
            - :obj:`phone.GetCallConfig <pyrosex.raw.functions.phone.GetCallConfig>`
    """

    QUALNAME = "pyrosex.raw.base.DataJSON"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/data-json")
