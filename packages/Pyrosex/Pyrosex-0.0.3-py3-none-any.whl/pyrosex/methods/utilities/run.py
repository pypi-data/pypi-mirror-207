...
import pyrosex
from pyrosex.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyrosex.Client.start`, :meth:`~pyrosex.idle` and :meth:`~pyrosex.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyrosex.compose`.
