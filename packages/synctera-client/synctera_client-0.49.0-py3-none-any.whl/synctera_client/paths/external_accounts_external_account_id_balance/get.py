...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'max_age': typing.Union[MaxAgeSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ExternalAccountBalance
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_external_account_balance_oapg(
        self,
...
class GetExternalAccountBalance(BaseApi):
    ...
    def get_external_account_balance(
        ...
        return self._get_external_account_balance_oapg(
