...
class StickerSetCovered:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`StickerSetCovered <pyrosex.raw.types.StickerSetCovered>`
            - :obj:`StickerSetMultiCovered <pyrosex.raw.types.StickerSetMultiCovered>`
    ...
    QUALNAME = "pyrosex.raw.base.StickerSetCovered"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/sticker-set-covered")
