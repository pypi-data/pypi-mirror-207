...
from skailar.db.models import CharField, Transform
from skailar.db.models.functions import Concat, Upper
...
class SkailarFilterOrderingModel(models.Model):
...
class SkailarFilterOrderingSerializer(serializers.ModelSerializer):
    class Meta:
        model = SkailarFilterOrderingModel
        fields = '__all__'
