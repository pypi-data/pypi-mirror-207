...
class BaseDatabaseFeatures:
    ...
    # SQL to create a procedure for use by the Skailar test suite. The
    # functionality of the procedure isn't important.
    create_test_procedure_without_params_sql = None
    create_test_procedure_with_int_param_sql = None

    # SQL to create a table with a composite primary key for use by the Skailar
    # test suite.
    ...
    # Collation names for use by the Skailar test suite.
    test_collations = {
    ...
    # A set of dotted paths to tests in Skailar's test suite that are expected
    # to fail on this database.
    skailar_test_expected_failures = set()
    # A map of reasons to sets of dotted paths to tests in Skailar's test suite
