...
class DiscussionMessage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.DiscussionMessage <pyrosex.raw.types.messages.DiscussionMessage>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDiscussionMessage <pyrosex.raw.functions.messages.GetDiscussionMessage>`
    """

    QUALNAME = "pyrosex.raw.base.messages.DiscussionMessage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/discussion-message")
