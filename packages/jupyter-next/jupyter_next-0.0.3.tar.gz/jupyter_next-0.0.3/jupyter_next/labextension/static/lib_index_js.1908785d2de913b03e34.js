"use strict";
(self["webpackChunk_datalayer_jupyter_next"] = self["webpackChunk_datalayer_jupyter_next"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_next', // API Namespace
    endPoint);
    let response;
    try {
...
const IJupyterDocker = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_4__.Token('@datalayer/jupyter-next:plugin');
const jupyterDocker = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-next-widget';
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_next server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_9__.connect)('ws://localhost:8888/jupyter_next/echo', true);
...
//# sourceMappingURL=lib_index_js.1908785d2de913b03e34.js.map