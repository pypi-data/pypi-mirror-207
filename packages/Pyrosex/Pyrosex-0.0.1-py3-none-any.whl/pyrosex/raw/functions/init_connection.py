...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        lang_pack: ``str``
        lang_code: ``str``
        query: Any method from :obj:`~pyrosex.raw.functions`
        proxy (optional): :obj:`InputClientProxy <pyrosex.raw.base.InputClientProxy>`
        params (optional): :obj:`JSONValue <pyrosex.raw.base.JSONValue>`

    Returns:
        Any object from :obj:`~pyrosex.raw.types`
    """
