...
from skailar.template import Context, Engine, TemplateDoesNotExist, TemplateSyntaxError
from skailar.template.base import UNKNOWN_SOURCE
...
class TemplateTestMixin:
    ...
    def test_extends_generic_template(self):
        """
        #24338 -- Allow extending skailar.template.backends.skailar.Template
        objects.
        """
        engine = self._engine()
