...
class Theme(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.Theme`.
    ...
    Parameters:
        ...
        document (optional): :obj:`Document <pyrosex.raw.base.Document>`
        settings (optional): List of :obj:`ThemeSettings <pyrosex.raw.base.ThemeSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.CreateTheme <pyrosex.raw.functions.account.CreateTheme>`
            - :obj:`account.UpdateTheme <pyrosex.raw.functions.account.UpdateTheme>`
            - :obj:`account.GetTheme <pyrosex.raw.functions.account.GetTheme>`
    """
