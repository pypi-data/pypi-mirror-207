...
if __name__ == '__main__':
    ...
    print("LINUX PATH INPUT: ")
    print("LINUX:" , convert_path_to_linux(path))
    print("WINDOWS: ",convert_path_to_windows(path))
    
    path = "C:\\Users\\bobgr\\Desktop\\NASA Spring 2023\\Gridtools Package (Code, README, inputs, outputs, examples, verification)\\SampleOutputs 0000-0059 01-01-2020\\"
    print("WINDOWS PATH INPUT: ")
    print("LINUX:" , convert_path_to_linux(path))
    print("WINDOWS: ",convert_path_to_windows(path))
