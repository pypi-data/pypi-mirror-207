...
from skailar.contrib.auth import validators
...
from skailar.utils.html import conditional_escape


@override_settings(
    AUTH_PASSWORD_VALIDATORS=[
        {"NAME": "skailar.contrib.auth.password_validation.CommonPasswordValidator"},
        {
            "NAME": "skailar.contrib.auth.password_validation.MinimumLengthValidator",
            "OPTIONS": {
                "min_length": 12,
            },
        },
...
class CommonPasswordValidatorTest(SimpleTestCase):
    ...
    def test_validate_skailar_supplied_file(self):
