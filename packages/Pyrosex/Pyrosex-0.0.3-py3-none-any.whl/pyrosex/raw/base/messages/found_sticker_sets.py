...
class FoundStickerSets:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.FoundStickerSets <pyrosex.raw.types.messages.FoundStickerSets>`
            - :obj:`messages.FoundStickerSetsNotModified <pyrosex.raw.types.messages.FoundStickerSetsNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.SearchStickerSets <pyrosex.raw.functions.messages.SearchStickerSets>`
    """

    QUALNAME = "pyrosex.raw.base.messages.FoundStickerSets"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/found-sticker-sets")
