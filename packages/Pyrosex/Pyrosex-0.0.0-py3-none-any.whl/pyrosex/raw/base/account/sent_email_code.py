...
class SentEmailCode:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.SentEmailCode <pyrosex.raw.types.account.SentEmailCode>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.SendVerifyEmailCode <pyrosex.raw.functions.account.SendVerifyEmailCode>`
    """

    QUALNAME = "pyrosex.raw.base.account.SentEmailCode"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/sent-email-code")
