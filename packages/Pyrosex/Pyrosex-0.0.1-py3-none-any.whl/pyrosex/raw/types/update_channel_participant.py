...
class UpdateChannelParticipant(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.Update`.
    ...
    Parameters:
        ...
        user_id: ``int`` ``64-bit``
        qts: ``int`` ``32-bit``
        prev_participant (optional): :obj:`ChannelParticipant <pyrosex.raw.base.ChannelParticipant>`
        new_participant (optional): :obj:`ChannelParticipant <pyrosex.raw.base.ChannelParticipant>`
        invite (optional): :obj:`ExportedChatInvite <pyrosex.raw.base.ExportedChatInvite>`
    """
