...
# body param
SchemaForRequestBodyApplicationJson = AccountCreation


request_body_account_creation = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AccountGenericResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_creation.serialize(body, content_type)
...
class CreateAccount(BaseApi):
    ...
    def create_account(
        ...
        return self._create_account_oapg(
            body=body,
