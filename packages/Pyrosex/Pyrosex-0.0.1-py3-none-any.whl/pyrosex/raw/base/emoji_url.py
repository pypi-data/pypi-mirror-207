...
class EmojiURL:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EmojiURL <pyrosex.raw.types.EmojiURL>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetEmojiURL <pyrosex.raw.functions.messages.GetEmojiURL>`
    """

    QUALNAME = "pyrosex.raw.base.EmojiURL"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/emoji-url")
