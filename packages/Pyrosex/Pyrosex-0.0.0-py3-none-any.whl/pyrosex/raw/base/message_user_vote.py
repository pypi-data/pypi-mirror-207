...
class MessageUserVote:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MessageUserVote <pyrosex.raw.types.MessageUserVote>`
            - :obj:`MessageUserVoteInputOption <pyrosex.raw.types.MessageUserVoteInputOption>`
            - :obj:`MessageUserVoteMultiple <pyrosex.raw.types.MessageUserVoteMultiple>`
    """

    QUALNAME = "pyrosex.raw.base.MessageUserVote"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-user-vote")
