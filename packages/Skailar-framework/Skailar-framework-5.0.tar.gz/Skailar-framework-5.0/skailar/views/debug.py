...
from skailar.http import Http404, HttpResponse, HttpResponseNotFound
from skailar.template import Context, Engine, TemplateDoesNotExist
from skailar.template.defaultfilters import pprint
...
from skailar.utils.version import PY311, get_docs_version

# Minimal Skailar templates engine to render the error templates
...
class ExceptionReporter:
    ...
    def get_traceback_data(self):
        ...
        c = {
            ...
            "skailar_version_info": get_version(),
            "sys_path": sys.path,
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "skailar" if module_name.startswith("skailar.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
