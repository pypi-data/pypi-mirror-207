...
class EmojiLanguage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EmojiLanguage <pyrosex.raw.types.EmojiLanguage>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetEmojiKeywordsLanguages <pyrosex.raw.functions.messages.GetEmojiKeywordsLanguages>`
    """

    QUALNAME = "pyrosex.raw.base.EmojiLanguage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/emoji-language")
