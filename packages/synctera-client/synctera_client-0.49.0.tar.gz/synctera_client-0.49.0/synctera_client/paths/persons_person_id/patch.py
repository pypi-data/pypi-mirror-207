...
# body param
SchemaForRequestBodyApplicationJson = PatchPerson


request_body_patch_person = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ResponsePerson
...
class BaseApi(api_client.Api):
    ...
    def _update_person_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_person.serialize(body, content_type)
