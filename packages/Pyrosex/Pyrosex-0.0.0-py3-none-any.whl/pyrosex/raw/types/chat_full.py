...
class ChatFull(TLObject):  # type: ignore
    ...
    Parameters:
        id: ``int`` ``64-bit``
        about: ``str``
        participants: :obj:`ChatParticipants <pyrosex.raw.base.ChatParticipants>`
        ...
        chat_photo (optional): :obj:`Photo <pyrosex.raw.base.Photo>`
        exported_invite (optional): :obj:`ExportedChatInvite <pyrosex.raw.base.ExportedChatInvite>`
        bot_info (optional): List of :obj:`BotInfo <pyrosex.raw.base.BotInfo>`
