...
from skailar.test import SimpleTestCase, TestCase, TransactionTestCase
...
class SkailarJSONEncoderTests(SimpleTestCase):
    def test_lazy_string_encoding(self):
        self.assertEqual(
            json.dumps({"lang": gettext_lazy("French")}, cls=SkailarJSONEncoder),
            '{"lang": "French"}',
        )
        with override("fr"):
            self.assertEqual(
    ...
    def test_timedelta(self):
        ...
        self.assertEqual(
            json.dumps({"duration": duration}, cls=SkailarJSONEncoder),
