...
T = TypeVar("T", bound="RemoveRecentCustomStatusJsonBody")


@attr.s(auto_attribs=True)
class RemoveRecentCustomStatusJsonBody:
    """
    Attributes:
        emoji (str): Any emoji
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        remove_recent_custom_status_json_body = cls(
            emoji=emoji,
            text=text,
            duration=duration,
            expires_at=expires_at,
        ...
        remove_recent_custom_status_json_body.additional_properties = d
        return remove_recent_custom_status_json_body
