...
class LoginToken:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`auth.LoginToken <pyrosex.raw.types.auth.LoginToken>`
            - :obj:`auth.LoginTokenMigrateTo <pyrosex.raw.types.auth.LoginTokenMigrateTo>`
            - :obj:`auth.LoginTokenSuccess <pyrosex.raw.types.auth.LoginTokenSuccess>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.ExportLoginToken <pyrosex.raw.functions.auth.ExportLoginToken>`
            - :obj:`auth.ImportLoginToken <pyrosex.raw.functions.auth.ImportLoginToken>`
    """

    QUALNAME = "pyrosex.raw.base.auth.LoginToken"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/login-token")
