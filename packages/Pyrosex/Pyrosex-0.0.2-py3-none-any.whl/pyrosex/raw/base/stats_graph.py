...
class StatsGraph:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`StatsGraph <pyrosex.raw.types.StatsGraph>`
            - :obj:`StatsGraphAsync <pyrosex.raw.types.StatsGraphAsync>`
            - :obj:`StatsGraphError <pyrosex.raw.types.StatsGraphError>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stats.LoadAsyncGraph <pyrosex.raw.functions.stats.LoadAsyncGraph>`
    """

    QUALNAME = "pyrosex.raw.base.StatsGraph"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/stats-graph")
