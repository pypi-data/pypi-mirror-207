...
request_path_external_card_id = api_client.PathParameter(
...
# body param
SchemaForRequestBodyApplicationJson = ExternalCardUpdateRequest


request_body_external_card_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExternalCardResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_external_card_oapg(
        self,
    ...
    def _update_external_card_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_external_card_update_request.serialize(body, content_type)
...
class UpdateExternalCard(BaseApi):
    ...
    def update_external_card(
        ...
        return self._update_external_card_oapg(
            body=body,
