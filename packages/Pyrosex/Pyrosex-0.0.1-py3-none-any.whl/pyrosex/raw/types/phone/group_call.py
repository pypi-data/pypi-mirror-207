...
class GroupCall(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call: :obj:`GroupCall <pyrosex.raw.base.GroupCall>`
        participants: List of :obj:`GroupCallParticipant <pyrosex.raw.base.GroupCallParticipant>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCall <pyrosex.raw.functions.phone.GetGroupCall>`
    """
