...
import aikoai
from aikoai import version
from aikoai.cli import api_register, display_error, tools_register, wandb_register
...
def main():
    ...
    if args.api_key is not None:
        aikoai.api_key = args.api_key
    if args.api_base is not None:
        aikoai.api_base = args.api_base
    if args.organization is not None:
        aikoai.organization = args.organization
