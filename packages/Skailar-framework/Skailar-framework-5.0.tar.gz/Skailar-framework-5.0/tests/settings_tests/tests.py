...
from skailar.conf import ENVIRONMENT_VARIABLE, LazySettings, Settings, settings
...
from skailar.urls import clear_script_prefix, set_script_prefix
...
class SettingsTests(SimpleTestCase):
    ...
    def test_class_decorator(self):
        ...
        with self.assertRaisesMessage(
            Exception, "Only subclasses of Skailar SimpleTestCase"
        ):
    ...
    def test_no_settings_module(self):
        msg = (
            ...
            "must either define the environment variable SKAILAR_SETTINGS_MODULE "
    ...
    @requires_tz_support
    @mock.patch("skailar.conf.global_settings.TIME_ZONE", "test")
