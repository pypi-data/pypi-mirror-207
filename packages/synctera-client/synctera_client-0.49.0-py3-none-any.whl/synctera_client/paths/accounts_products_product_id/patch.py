...
# Path params
ProductIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product_id': typing.Union[ProductIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PatchAccountProduct


request_body_patch_account_product = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AccountProduct
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_account_product_oapg(
        self,
    ...
    def _patch_account_product_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_account_product.serialize(body, content_type)
...
class PatchAccountProduct(BaseApi):
    ...
    def patch_account_product(
        ...
        return self._patch_account_product_oapg(
            body=body,
