...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer: :obj:`InputEncryptedChat <pyrosex.raw.base.InputEncryptedChat>`
        random_id: ``int`` ``64-bit``
        data: ``bytes``
        file: :obj:`InputEncryptedFile <pyrosex.raw.base.InputEncryptedFile>`
        silent (optional): ``bool``

    Returns:
        :obj:`messages.SentEncryptedMessage <pyrosex.raw.base.messages.SentEncryptedMessage>`
    """
