...
from skailar.core.handlers.asgi import ASGIRequest
from skailar.core.handlers.base import BaseHandler
from skailar.core.handlers.wsgi import LimitedStream, WSGIRequest
from skailar.core.serializers.json import SkailarJSONEncoder
from skailar.core.signals import got_request_exception, request_finished, request_started
from skailar.db import close_old_connections
from skailar.http import HttpHeaders, HttpRequest, QueryDict, SimpleCookie
from skailar.test import signals
from skailar.test.utils import ContextList
from skailar.urls import resolve
from skailar.utils.encoding import force_bytes
...
class RequestFactory:
    ...
    def __init__(self, *, json_encoder=SkailarJSONEncoder, headers=None, **defaults):
...
class ClientMixin:
    ...
    def login(self, **credentials):
        ...
        are incorrect.
        """
        from skailar.contrib.auth import authenticate
    ...
    def force_login(self, user, backend=None):
        def get_backend():
            from skailar.contrib.auth import load_backend
    ...
    def _login(self, user, backend=None):
        from skailar.contrib.auth import login
    ...
    def logout(self):
        ...
        from skailar.contrib.auth import get_user, logout
