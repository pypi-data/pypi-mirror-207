...
class CaptureAVDeviceDesktop(InputStream):
    ...
    Attributes:
        stream_audio (:obj:`~pycover.types.InputAudioStream()`):
            Input Audio Stream Descriptor
        stream_video (:obj:`~pycover.types.InputVideoStream()`):
            Input Video Stream Descriptor
    Parameters:
        audio_info (:obj: `~pycover.media_devices.DeviceInfo()`):
            The audio device capturing params
        screen_info (:obj: `~pycover.media_devices.ScreenManager()`):
            The screen video capturing params
        audio_parameters (:obj:`~pycover.types.AudioParameters()`):
            The audio parameters of the stream, can be used also
            :obj:`~pycover.types.HighQualityAudio()`,
            :obj:`~pycover.types.MediumQualityAudio()` or
            :obj:`~pycover.types.LowQualityAudio()`
        video_parameters (:obj:`~pycover.types.VideoParameters()`):
