...
class SamplesGeneratorParallelized:
    def __init__(self, code_path: str, code_entry_name: str, n_workers=2, max_samples_in_queue=128):
    ...
    def start(self) -> None:
        ...
        self._ready_samples = multiprocessing.Queue(self.max_samples_in_queue)
    ...
    def _generate_samples(self, sample_identities: List[Tuple[DataStateEnum, int]]) -> multiprocessing.Queue:
    ...
    def release(self) -> None:
        ...
        self._samples_to_process.close()
        self._ready_samples.close()
