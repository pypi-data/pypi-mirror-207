...
class SavedContact:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SavedPhoneContact <pyrosex.raw.types.SavedPhoneContact>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetSaved <pyrosex.raw.functions.contacts.GetSaved>`
    """

    QUALNAME = "pyrosex.raw.base.SavedContact"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/saved-contact")
