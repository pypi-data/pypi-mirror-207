...
# body param
SchemaForRequestBodyApplicationJson = OutgoingAchRequest


request_body_outgoing_ach_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = OutgoingAch
...
class BaseApi(api_client.Api):
    ...
    def _add_transaction_out_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_outgoing_ach_request.serialize(body, content_type)
...
class AddTransactionOut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_transaction_out(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def add_transaction_out(
        ...
        return self._add_transaction_out_oapg(
            body=body,
