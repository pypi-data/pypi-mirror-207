...
class HistoryImport:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.HistoryImport <pyrosex.raw.types.messages.HistoryImport>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.InitHistoryImport <pyrosex.raw.functions.messages.InitHistoryImport>`
    """

    QUALNAME = "pyrosex.raw.base.messages.HistoryImport"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/history-import")
