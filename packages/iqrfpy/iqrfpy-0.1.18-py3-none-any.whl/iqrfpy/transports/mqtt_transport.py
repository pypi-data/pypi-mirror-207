...
class MqttTransport(ITransport):
    ...
    __slots__ = '_client', '_params', '_callback', '_timeout', '_cv', '_msg_ids', '_m_type', '_response', \
        '_dpa_timeout', '_received_timeout'
    ...
    def __init__(self, params: MqttTransportParams, callback: Optional[Callable] = None,
        ...
        self._connect_cv: threading.Condition = threading.Condition()
    ...
    def initialize(self) -> None:
        ...
        self._client.connect_async(self._params.host, self._params.port)
        self._client.loop_start()
        with self._connect_cv:
            self._connect_cv.wait()
