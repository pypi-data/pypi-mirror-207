...
class InlineResponse20038Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20038ResponseUser'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20038Response.  # noqa: E501


        :return: The user of this InlineResponse20038Response.  # noqa: E501
        :rtype: InlineResponse20038ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20038Response.


        :param user: The user of this InlineResponse20038Response.  # noqa: E501
        :type: InlineResponse20038ResponseUser
        """
