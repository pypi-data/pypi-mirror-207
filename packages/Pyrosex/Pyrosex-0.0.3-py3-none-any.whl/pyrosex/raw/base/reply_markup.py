...
class ReplyMarkup:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ReplyInlineMarkup <pyrosex.raw.types.ReplyInlineMarkup>`
            - :obj:`ReplyKeyboardForceReply <pyrosex.raw.types.ReplyKeyboardForceReply>`
            - :obj:`ReplyKeyboardHide <pyrosex.raw.types.ReplyKeyboardHide>`
            - :obj:`ReplyKeyboardMarkup <pyrosex.raw.types.ReplyKeyboardMarkup>`
    """

    QUALNAME = "pyrosex.raw.base.ReplyMarkup"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/reply-markup")
