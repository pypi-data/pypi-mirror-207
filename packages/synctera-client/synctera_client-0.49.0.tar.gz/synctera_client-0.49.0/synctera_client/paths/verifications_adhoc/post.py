...
# body param
SchemaForRequestBodyApplicationJson = AdhocVerificationRequest


request_body_adhoc_verification_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AdhocVerificationResponse
...
class BaseApi(api_client.Api):
    ...
    def _verify_ad_hoc_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_adhoc_verification_request.serialize(body, content_type)
...
class VerifyAdHoc(BaseApi):
    ...
    def verify_ad_hoc(
        ...
        return self._verify_ad_hoc_oapg(
            body=body,
