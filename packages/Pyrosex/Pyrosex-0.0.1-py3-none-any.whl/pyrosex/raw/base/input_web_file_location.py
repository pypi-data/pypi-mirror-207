...
class InputWebFileLocation:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputWebFileGeoPointLocation <pyrosex.raw.types.InputWebFileGeoPointLocation>`
            - :obj:`InputWebFileLocation <pyrosex.raw.types.InputWebFileLocation>`
    """

    QUALNAME = "pyrosex.raw.base.InputWebFileLocation"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-web-file-location")
