...
from skailar.contrib.gis.measure import Area as AreaMeasure
from skailar.contrib.gis.measure import Distance as DistanceMeasure
...
class BaseSpatialOperations:
    ...
    # Mapping between Skailar function names and backend names, when names do not
