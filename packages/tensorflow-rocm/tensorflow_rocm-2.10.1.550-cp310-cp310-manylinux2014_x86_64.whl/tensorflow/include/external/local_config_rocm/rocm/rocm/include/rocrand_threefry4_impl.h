...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/rocrand/rocrand_threefry4_impl.h by using #include <rocrand/rocrand_threefry4_impl.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/rocrand/rocrand_threefry4_impl.h by using #include <rocrand/rocrand_threefry4_impl.h>"
#endif
/* include file */
