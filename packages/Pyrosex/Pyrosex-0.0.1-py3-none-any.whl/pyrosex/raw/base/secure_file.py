...
class SecureFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SecureFile <pyrosex.raw.types.SecureFile>`
            - :obj:`SecureFileEmpty <pyrosex.raw.types.SecureFileEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.SecureFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/secure-file")
