...
SchemaFor200ResponseBodyApplicationJson = DisclosureResponse
...
class ListDisclosures1(BaseApi):
    ...
    def list_disclosures1(
        ...
        return self._list_disclosures1_oapg(
