...
from skailar.db.models import F, Max, Min
from skailar.http import HttpRequest
from skailar.template import (
    Context,
    RequestContext,
    Template,
    TemplateSyntaxError,
...
from skailar.utils.timezone import timedelta
...
class TemplateTests(SimpleTestCase):
    ...
    def test_tz_template_context_processor(self):
        """
        Test the skailar.template.context_processors.tz template context processor.
        """
