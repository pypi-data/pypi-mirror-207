...
from skailar.db import DEFAULT_DB_ALIAS, models, router, transaction
from skailar.db.models import DO_NOTHING, ForeignObject, ForeignObjectRel
from skailar.db.models.base import ModelBase, make_foreign_order_accessors
from skailar.db.models.fields.mixins import FieldCacheMixin
from skailar.db.models.fields.related import (
    ReverseManyToOneDescriptor,
    lazy_related_operation,
)
from skailar.db.models.query_utils import PathInfo
from skailar.db.models.sql import AND
...
class GenericRelation(ForeignObject):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Reverse relations are always nullable (Skailar can't enforce that a
