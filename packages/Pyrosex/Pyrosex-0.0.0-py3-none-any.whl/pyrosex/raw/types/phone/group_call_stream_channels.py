...
class GroupCallStreamChannels(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels: List of :obj:`GroupCallStreamChannel <pyrosex.raw.base.GroupCallStreamChannel>`
