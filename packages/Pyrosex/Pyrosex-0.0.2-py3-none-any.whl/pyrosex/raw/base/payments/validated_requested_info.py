...
class ValidatedRequestedInfo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.ValidatedRequestedInfo <pyrosex.raw.types.payments.ValidatedRequestedInfo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.ValidateRequestedInfo <pyrosex.raw.functions.payments.ValidateRequestedInfo>`
    """

    QUALNAME = "pyrosex.raw.base.payments.ValidatedRequestedInfo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/validated-requested-info")
