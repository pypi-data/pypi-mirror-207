...
class ResolvedPeer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`contacts.ResolvedPeer <pyrosex.raw.types.contacts.ResolvedPeer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.ResolveUsername <pyrosex.raw.functions.contacts.ResolveUsername>`
            - :obj:`contacts.ResolvePhone <pyrosex.raw.functions.contacts.ResolvePhone>`
    """

    QUALNAME = "pyrosex.raw.base.contacts.ResolvedPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/resolved-peer")
