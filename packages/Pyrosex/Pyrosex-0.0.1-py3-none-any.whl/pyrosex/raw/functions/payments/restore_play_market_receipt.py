...
class RestorePlayMarketReceipt(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["receipt"]

    ID = 0xd164e36a
    QUALNAME = "functions.payments.RestorePlayMarketReceipt"

    def __init__(self, *, receipt: bytes) -> None:
        self.receipt = receipt  # bytes

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "RestorePlayMarketReceipt":
        # No flags
