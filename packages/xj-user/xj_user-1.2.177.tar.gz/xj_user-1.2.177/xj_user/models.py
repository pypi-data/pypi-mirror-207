...
class PlatformsToUsers(models.Model):
    ...
    user = models.ForeignKey(BaseInfo, verbose_name='用户', on_delete=models.CASCADE, db_column='user_id',
                             help_text='', primary_key=True)
    platform = models.ForeignKey(Platform, verbose_name='平台', on_delete=models.CASCADE, help_text='')
