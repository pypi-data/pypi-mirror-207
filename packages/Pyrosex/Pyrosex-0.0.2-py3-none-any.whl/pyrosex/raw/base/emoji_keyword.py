...
class EmojiKeyword:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EmojiKeyword <pyrosex.raw.types.EmojiKeyword>`
            - :obj:`EmojiKeywordDeleted <pyrosex.raw.types.EmojiKeywordDeleted>`
    """

    QUALNAME = "pyrosex.raw.base.EmojiKeyword"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/emoji-keyword")
