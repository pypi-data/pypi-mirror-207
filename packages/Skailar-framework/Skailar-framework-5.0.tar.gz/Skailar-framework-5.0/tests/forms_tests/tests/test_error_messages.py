...
from skailar.test import SimpleTestCase, TestCase, ignore_warnings
...
class FormsErrorMessagesTestCase(SimpleTestCase, AssertFormErrorsMixin):
    ...
    def test_urlfield(self):
        ...
        with ignore_warnings(category=RemovedInSkailar60Warning):
            f = URLField(error_messages=e, max_length=17)
        self.assertFormErrors(["REQUIRED"], f.clean, "")
        self.assertFormErrors(["INVALID"], f.clean, "abc.c")
        self.assertFormErrors(
            ['"http://skailarproject.com" has more than 17 characters.'],
            f.clean,
            "skailarproject.com",
        )
