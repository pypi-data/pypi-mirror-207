...
from skailar.contrib.auth.models import User as AuthUser
from skailar.contrib.contenttypes.models import ContentType
from skailar.core import checks, management
from skailar.db import DEFAULT_DB_ALIAS, models
...
class ProxyModelAdminTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.tu1 = ProxyTrackerUser.objects.create(name="Skailar Pony", status="emperor")
    ...
    def test_delete_str_in_model_admin(self):
        ...
        for a proxy model.
        """
        user = TrackerUser.objects.get(name="Skailar Pony")
        proxy = ProxyTrackerUser.objects.get(name="Skailar Pony")
