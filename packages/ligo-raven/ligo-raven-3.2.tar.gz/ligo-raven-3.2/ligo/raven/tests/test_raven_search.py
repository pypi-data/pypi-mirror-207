...
@pytest.mark.parametrize(
    'gracedb_id,event_type,gpstime,tl,th,group,pipelines,searches,mock_gracedb',
    [['E100','Superevent', 100, -5, 1, None, [], [], mock_gracedb_rest],
     ...
     ['E102','Superevent', 100, -5, 1, 'CBC', None, None, mock_gracedb_rest],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], [], mock_gracedb_rest],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], ['SubGRB'], mock_gracedb_rest],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], ['SubGRB','SubGRBTargeted'], mock_gracedb_rest],
     ['S101','External', 100, -10, 10, None, ['SNEWS'], [], mock_gracedb_rest],
     ['S102','External', 100, -1, 5, None, ['Fermi'], ['MDC'], mock_gracedb_rest],
     ...
     ['E102','Superevent', 100, -5, 1, 'CBC', None, None, mock_gracedb_sdk],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], [], mock_gracedb_sdk],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], ['SubGRB'], mock_gracedb_sdk],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], ['SubGRB','SubGRBTargeted'], mock_gracedb_sdk],
     ['S101','External', 100, -10, 10, None, ['SNEWS'], [], mock_gracedb_sdk],
     ['S102','External', 100, -1, 5, None, ['Fermi'], ['MDC'], mock_gracedb_sdk]])
...
@pytest.mark.parametrize(
    'gracedb_id,event_type,gpstime,tl,th,group,pipelines,searches,se_searches,mock_gracedb',
    [['E100','Superevent', 100, -5, 1, None, [], [], [], mock_gracedb_rest],
     ['E101','Superevent', 100, -600, 60, 'Burst', [], [], [], mock_gracedb_rest],
     ['E102','Superevent', 100, -5, 1, 'CBC', [], [], [], mock_gracedb_rest],
     ['S100','External', 100, -1, 5, None, ['Fermi','Swift'], [], [], mock_gracedb_rest],
