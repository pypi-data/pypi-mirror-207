...
class AttachMenuBot(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.AttachMenuBot`.
    ...
    Parameters:
        bot_id: ``int`` ``64-bit``
        short_name: ``str``
        peer_types: List of :obj:`AttachMenuPeerType <pyrosex.raw.base.AttachMenuPeerType>`
        icons: List of :obj:`AttachMenuBotIcon <pyrosex.raw.base.AttachMenuBotIcon>`
