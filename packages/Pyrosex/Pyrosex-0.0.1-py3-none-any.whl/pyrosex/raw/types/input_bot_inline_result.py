...
class InputBotInlineResult(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.InputBotInlineResult`.
    ...
    Parameters:
        id: ``str``
        type: ``str``
        send_message: :obj:`InputBotInlineMessage <pyrosex.raw.base.InputBotInlineMessage>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): :obj:`InputWebDocument <pyrosex.raw.base.InputWebDocument>`
        content (optional): :obj:`InputWebDocument <pyrosex.raw.base.InputWebDocument>`
    """
