...
class NotifyPeer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`NotifyBroadcasts <pyrosex.raw.types.NotifyBroadcasts>`
            - :obj:`NotifyChats <pyrosex.raw.types.NotifyChats>`
            - :obj:`NotifyPeer <pyrosex.raw.types.NotifyPeer>`
            - :obj:`NotifyUsers <pyrosex.raw.types.NotifyUsers>`
    """

    QUALNAME = "pyrosex.raw.base.NotifyPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/notify-peer")
