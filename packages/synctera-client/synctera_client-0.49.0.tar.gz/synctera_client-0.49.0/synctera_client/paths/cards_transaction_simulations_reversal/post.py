...
# body param
SchemaForRequestBodyApplicationJson = ReversalModel


request_body_reversal_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _simulate_reversal_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_reversal_model.serialize(body, content_type)
...
class SimulateReversal(BaseApi):
    ...
    def simulate_reversal(
        ...
        return self._simulate_reversal_oapg(
            body=body,
