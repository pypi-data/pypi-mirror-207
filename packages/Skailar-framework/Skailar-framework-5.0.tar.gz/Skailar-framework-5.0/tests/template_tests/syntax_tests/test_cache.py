...
from skailar.template import Context, Engine, TemplateSyntaxError
...
class CacheTagTests(SimpleTestCase):
    libraries = {
        "cache": "skailar.templatetags.cache",
...
class CacheTests(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        cls.engine = Engine(libraries={"cache": "skailar.templatetags.cache"})
        super().setUpClass()
