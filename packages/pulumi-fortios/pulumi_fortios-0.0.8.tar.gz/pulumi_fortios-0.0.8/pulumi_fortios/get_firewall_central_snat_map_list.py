...
__all__ = [
    ...
    'get_firewall_central_snat_map_list_output',
]
...
@_utilities.lift_output_func(get_firewall_central_snat_map_list)
def get_firewall_central_snat_map_list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
