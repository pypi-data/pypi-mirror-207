...
from gaiaframework.base.server.server import ZIDS_Server
...
class Server(ZIDS_Server):

    def __init__(self):
        # self.mysql_connect(host="", user="", password="", database="")
        ...
        super().__init__(x_token="your-x-token", verify_x_token=False, verify_company_token=False, debug=False)
    ...
    def predict(self, body: generatedProjectNameInputs, request: Request) -> List[generatedProjectNameOutputs]:
    ...
    def parse(self, body: generatedProjectNameInputs, request: Request) -> List[generatedProjectNameOutputs]:
        '''
        parse api
        '''
        data = body.dict()
