...
class LoggedOut:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`auth.LoggedOut <pyrosex.raw.types.auth.LoggedOut>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.LogOut <pyrosex.raw.functions.auth.LogOut>`
    """

    QUALNAME = "pyrosex.raw.base.auth.LoggedOut"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/logged-out")
