...
class Config(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.Config`.
    ...
    Parameters:
        ...
        test_mode: ``bool``
        this_dc: ``int`` ``32-bit``
        dc_options: List of :obj:`DcOption <pyrosex.raw.base.DcOption>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetConfig <pyrosex.raw.functions.help.GetConfig>`
    """
