...
# Path params
NoteIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'note_id': typing.Union[NoteIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PatchNote


request_body_patch_note = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = NoteResponse
...
class BaseApi(api_client.Api):
    ...
    def _patch_note_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_note.serialize(body, content_type)
