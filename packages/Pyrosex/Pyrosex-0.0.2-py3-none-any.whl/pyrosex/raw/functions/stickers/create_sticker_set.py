...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        title: ``str``
        short_name: ``str``
        stickers: List of :obj:`InputStickerSetItem <pyrosex.raw.base.InputStickerSetItem>`
        masks (optional): ``bool``
        animated (optional): ``bool``
        videos (optional): ``bool``
        thumb (optional): :obj:`InputDocument <pyrosex.raw.base.InputDocument>`
        software (optional): ``str``

    Returns:
        :obj:`messages.StickerSet <pyrosex.raw.base.messages.StickerSet>`
    """
