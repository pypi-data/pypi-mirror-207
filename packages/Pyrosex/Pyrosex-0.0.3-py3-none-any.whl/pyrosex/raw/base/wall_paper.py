...
class WallPaper:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`WallPaper <pyrosex.raw.types.WallPaper>`
            - :obj:`WallPaperNoFile <pyrosex.raw.types.WallPaperNoFile>`
    ...
    QUALNAME = "pyrosex.raw.base.WallPaper"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/wall-paper")
