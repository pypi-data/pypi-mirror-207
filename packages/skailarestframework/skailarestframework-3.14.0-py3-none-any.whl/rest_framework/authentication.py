...
from skailar.contrib.auth import authenticate, get_user_model
...
def get_authorization_header(request):
    ...
    if isinstance(auth, str):
        # Work around skailar test client oddness
...
class SessionAuthentication(BaseAuthentication):
    """
    Use Skailar's session framework for authentication.
    """
...
class RemoteUserAuthentication(BaseAuthentication):
    ...
    'skailar.contrib.auth.backends.RemoteUserBackend in your
