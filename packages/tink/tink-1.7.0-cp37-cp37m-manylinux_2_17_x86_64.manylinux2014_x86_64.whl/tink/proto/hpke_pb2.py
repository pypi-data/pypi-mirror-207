...
_HPKEKEM = DESCRIPTOR.enum_types_by_name['HpkeKem']
HpkeKem = enum_type_wrapper.EnumTypeWrapper(_HPKEKEM)
_HPKEKDF = DESCRIPTOR.enum_types_by_name['HpkeKdf']
HpkeKdf = enum_type_wrapper.EnumTypeWrapper(_HPKEKDF)
_HPKEAEAD = DESCRIPTOR.enum_types_by_name['HpkeAead']
...
_HPKEPARAMS = DESCRIPTOR.message_types_by_name['HpkeParams']
_HPKEPUBLICKEY = DESCRIPTOR.message_types_by_name['HpkePublicKey']
_HPKEPRIVATEKEY = DESCRIPTOR.message_types_by_name['HpkePrivateKey']
_HPKEKEYFORMAT = DESCRIPTOR.message_types_by_name['HpkeKeyFormat']
