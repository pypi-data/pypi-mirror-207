...
new gridjs.Grid({
    columns: [
        ...
        },
        {
            name: 'Status',
            formatter: (cell) => {
                let icon = (cell.is_delete) ? '<i class="bi bi-x-circle text-danger ml" title="Rota Desativada Pelo Sistema"></i>' : '<i class="bi bi-check-circle text-success ml" title="Rota Disponivel"></i>';
                ...
                $button.html(`
                        <i class="bi bi-toggle-on ml" title="Rota aberta para uso"></i>
                        <i class="bi bi-toggle-off ml" title="Rota desativada para uso"></i>
                    `)
