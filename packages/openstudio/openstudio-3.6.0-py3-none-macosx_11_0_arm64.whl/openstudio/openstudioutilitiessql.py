...
class SqlFile(object):
    ...
    def getExteriorFenestrationValue(self, subSurfaceName: "std::string const &", columnName: "std::string const &") -> "boost::optional< double >":
        return _openstudioutilitiessql.SqlFile_getExteriorFenestrationValue(self, subSurfaceName, columnName)

    def assemblyUFactor(self, subSurfaceName: "std::string const &") -> "boost::optional< double >":
        return _openstudioutilitiessql.SqlFile_assemblyUFactor(self, subSurfaceName)

    def assemblySHGC(self, subSurfaceName: "std::string const &") -> "boost::optional< double >":
        return _openstudioutilitiessql.SqlFile_assemblySHGC(self, subSurfaceName)

    def assemblyVisibleTransmittance(self, subSurfaceName: "std::string const &") -> "boost::optional< double >":
    ...
    def illuminanceMapHourlyReportIndex(self, mapIndex: "int", dateTime: "DateTime") -> "boost::optional< int >":
        return _openstudioutilitiessql.SqlFile_illuminanceMapHourlyReportIndex(self, mapIndex, dateTime)

    def illuminanceMapDate(self, hourlyReportIndex: "int") -> "boost::optional< openstudio::DateTime >":
