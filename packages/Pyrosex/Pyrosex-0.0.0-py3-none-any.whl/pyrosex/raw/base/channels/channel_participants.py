...
class ChannelParticipants:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`channels.ChannelParticipants <pyrosex.raw.types.channels.ChannelParticipants>`
            - :obj:`channels.ChannelParticipantsNotModified <pyrosex.raw.types.channels.ChannelParticipantsNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetParticipants <pyrosex.raw.functions.channels.GetParticipants>`
    """

    QUALNAME = "pyrosex.raw.base.channels.ChannelParticipants"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/channel-participants")
