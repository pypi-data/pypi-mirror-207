...
from skailar.apps.registry import apps as global_apps
from skailar.db import DatabaseError, connection, migrations, models
from skailar.db.migrations.exceptions import InvalidMigrationPlan
...
class ExecutorTests(MigrationTestBase):
    ...
    @override_settings(
        MIGRATION_MODULES={
            ...
            "skailar.contrib.auth": "skailar.contrib.auth.migrations",
        },
    ...
    def test_migrations_applied_and_recorded_atomically(self):
        ...
        executor = MigrationExecutor(connection)
        with mock.patch(
            "skailar.db.migrations.executor.MigrationExecutor.record_migration"
        ) as record_migration:
    ...
    def test_migrate_skips_schema_creation(self, mocked_has_table):
        """
        The skailar_migrations table is not created if there are no migrations
        to record.
        """
        executor = MigrationExecutor(connection)
