...
class InputEncryptedFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputEncryptedFile <pyrosex.raw.types.InputEncryptedFile>`
            - :obj:`InputEncryptedFileBigUploaded <pyrosex.raw.types.InputEncryptedFileBigUploaded>`
            - :obj:`InputEncryptedFileEmpty <pyrosex.raw.types.InputEncryptedFileEmpty>`
            - :obj:`InputEncryptedFileUploaded <pyrosex.raw.types.InputEncryptedFileUploaded>`
    """

    QUALNAME = "pyrosex.raw.base.InputEncryptedFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-encrypted-file")
