...
class ChannelDifference:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`updates.ChannelDifference <pyrosex.raw.types.updates.ChannelDifference>`
            - :obj:`updates.ChannelDifferenceEmpty <pyrosex.raw.types.updates.ChannelDifferenceEmpty>`
            - :obj:`updates.ChannelDifferenceTooLong <pyrosex.raw.types.updates.ChannelDifferenceTooLong>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`updates.GetChannelDifference <pyrosex.raw.functions.updates.GetChannelDifference>`
    """

    QUALNAME = "pyrosex.raw.base.updates.ChannelDifference"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/channel-difference")
