...
class ControllerTest(unittest.TestCase):
    ...
    def test_controller_use_case(self):
        ...
        # os.environ['HADRON_DEFAULT_PATH'] = 'https://raw.githubusercontent.com/project-hadron/hadron-asset-bank/master/contracts/commons/synthetic_data_types'
        os.environ['HADRON_SYNTHETIC_DATA_SIZE'] = '1000'
        os.environ['HADRON_SYNTHETIC_DATA_TYPES_URI'] = 'work/data'
