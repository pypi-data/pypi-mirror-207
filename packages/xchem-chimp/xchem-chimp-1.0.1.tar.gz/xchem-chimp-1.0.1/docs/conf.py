...
release = xchem_chimp.__version__
...
html_theme_options = dict(
    ...
    gitlab_url="https://gitlab.diamond.ac.uk/data-analysis/imaging/xchem-chimp",
    icon_links=[],
...
ultimate_replacements = {
    "$" + "{repository_name}": "xchem-chimp",
    "$" + "{package_name}": "xchem_chimp",
    "$" + "{git_url}": "https://gitlab.diamond.ac.uk/data-analysis/imaging",
...
# dae_devops_fingerprint 4f7869a916e64cc6deee18600ed692ec
