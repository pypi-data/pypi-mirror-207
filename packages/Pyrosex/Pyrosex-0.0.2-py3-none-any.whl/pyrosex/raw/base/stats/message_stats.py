...
class MessageStats:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`stats.MessageStats <pyrosex.raw.types.stats.MessageStats>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stats.GetMessageStats <pyrosex.raw.functions.stats.GetMessageStats>`
    """

    QUALNAME = "pyrosex.raw.base.stats.MessageStats"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-stats")
