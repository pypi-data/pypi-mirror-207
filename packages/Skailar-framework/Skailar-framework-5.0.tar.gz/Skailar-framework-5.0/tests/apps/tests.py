...
from skailar.apps import AppConfig, apps
from skailar.apps.registry import Apps
from skailar.contrib.admin.models import LogEntry
from skailar.core.exceptions import AppRegistryNotReady, ImproperlyConfigured
from skailar.db import models
from skailar.test import SimpleTestCase, override_settings
from skailar.test.utils import extend_sys_path, isolate_apps
...
class AppsTests(SimpleTestCase):
    ...
    def test_get_app_config(self):
        ...
        self.assertEqual(app_config.name, "skailar.contrib.admin")

        app_config = apps.get_app_config("staticfiles")
        self.assertEqual(app_config.name, "skailar.contrib.staticfiles")

        with self.assertRaises(LookupError):
            apps.get_app_config("admindocs")

        msg = "No installed app with label 'skailar.contrib.auth'. Did you mean 'myauth'"
        with self.assertRaisesMessage(LookupError, msg):
            apps.get_app_config("skailar.contrib.auth")
    ...
    def test_is_installed(self):
        ...
        """
        self.assertIs(apps.is_installed("skailar.contrib.admin"), True)
        self.assertIs(apps.is_installed("skailar.contrib.auth"), True)
        self.assertIs(apps.is_installed("skailar.contrib.staticfiles"), True)
        self.assertIs(apps.is_installed("skailar.contrib.admindocs"), False)
...
class AppConfigTests(SimpleTestCase):
    ...
    def test_app_default_auto_field(self):
        ...
        self.assertEqual(
            ...
            "skailar.db.models.BigAutoField",
        )
    ...
    def test_default_auto_field_setting(self):
        ...
        self.assertEqual(
            apps_config.default_auto_field,
            "skailar.db.models.SmallAutoField",
        )
