...
class LangPackString:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`LangPackString <pyrosex.raw.types.LangPackString>`
            - :obj:`LangPackStringDeleted <pyrosex.raw.types.LangPackStringDeleted>`
            - :obj:`LangPackStringPluralized <pyrosex.raw.types.LangPackStringPluralized>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`langpack.GetStrings <pyrosex.raw.functions.langpack.GetStrings>`
    """

    QUALNAME = "pyrosex.raw.base.LangPackString"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/lang-pack-string")
