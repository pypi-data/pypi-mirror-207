...
class EnrollRuleValuate(models.Model):
    ...
    expression_string = models.TextField(verbose_name='逻辑表达式', blank=True, null=True, help_text='')
...
class Enroll(models.Model):
    ...
    price = models.DecimalField(verbose_name='单价', max_digits=32, decimal_places=8, default=0, help_text='')
    ...
    fee = models.DecimalField(verbose_name='小费', max_digits=32, decimal_places=2, default=0, blank=True, null=True, help_text='')
    reduction = models.DecimalField(verbose_name='商家减免', max_digits=32, decimal_places=2, default=0, help_text='商家减免额')
    subitems_amount = models.DecimalField(verbose_name='分项合计', max_digits=32, decimal_places=2, default=0, help_text='')
    amount = models.DecimalField(verbose_name='总收/付金额', max_digits=32, decimal_places=2, default=0, blank=True, null=True, help_text='')
    paid_amount = models.DecimalField(verbose_name='已收/付金额', max_digits=32, decimal_places=2, default=0, blank=True, null=True, help_text='')
    unpaid_amount = models.DecimalField(verbose_name='未收/付金额', max_digits=32, decimal_places=2, default=0, blank=True, null=True, help_text='补差价')
    commision = models.DecimalField(verbose_name='佣金', max_digits=32, decimal_places=2, default=0, help_text='每份提成')
    deposit = models.DecimalField(verbose_name='每份预付押金', max_digits=32, decimal_places=8, default=0, help_text='')
...
class EnrollSubitem(models.Model):
    ...
    price = models.DecimalField(verbose_name='分项单价', max_digits=32, decimal_places=8, default=0, blank=True, null=True, help_text='清单单价')
    ...
    amount = models.DecimalField(verbose_name='分项小计', max_digits=32, decimal_places=8, default=0, blank=True, null=True, help_text='')
...
class EnrollRecord(models.Model):
    ...
    price = models.DecimalField(verbose_name='应付单价', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    deposit = models.DecimalField(verbose_name='应付押金', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    count = models.DecimalField(verbose_name='购买数量', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    main_amount = models.DecimalField(verbose_name='主项合计', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    coupon_amount = models.DecimalField(verbose_name='优惠券合计', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    again_reduction = models.DecimalField(verbose_name='商家再减免', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='商家再减免(发起人填)')
    subitems_amount = models.DecimalField(verbose_name='分项合计', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    deposit_amount = models.DecimalField(verbose_name='押金合计', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    amount = models.DecimalField(verbose_name='总计应收/付金额', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    paid_amount = models.DecimalField(verbose_name='已收/付金额', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    unpaid_amount = models.DecimalField(verbose_name='未收/付金额', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    fee = models.DecimalField(verbose_name='小费', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    ...
    again_price = models.DecimalField(verbose_name='追加价格', max_digits=10, decimal_places=2, blank=True, null=True, default=0, help_text='')
    again_fee = models.DecimalField(verbose_name='追加消费', max_digits=10, decimal_places=2, blank=True, null=True, default=0, help_text='')
    initiator_again_price = models.DecimalField(verbose_name='发起人追补单价', max_digits=10, decimal_places=2, blank=True, null=True, default=0, help_text='')
...
class EnrollRecordExtendField(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '报名分项表扩展字段表'
        # 联合约束   其中goods和user不能重复
...
class EnrollSubitemRecord(models.Model):
    ...
    price = models.DecimalField(verbose_name='分项单价', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    count = models.DecimalField(verbose_name='分项数量', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
    subitem_amount = models.DecimalField(verbose_name='分项小计', max_digits=32, decimal_places=8, blank=True, null=True, default=0, help_text='')
