...
from devapp.tools import define_flags, to_list, write_file, exists, os
...
class kafka:
    ...
    @classmethod
    def snk(cls, key='{d[id]}', topic=None, cfg=None, is_rx=True):
        """
...
def send(data, msg, key, enc, topic, cb, con):
    try:
        ...
        app.warn('kafka snk received bogus data', json=data)
        return
