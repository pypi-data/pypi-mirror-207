...
from skailar.core.management import CommandError, call_command
from skailar.db import (
    ConnectionHandler,
    DatabaseError,
    OperationalError,
    connection,
...
from skailar.db.backends.base.schema import BaseDatabaseSchemaEditor
from skailar.db.backends.utils import truncate_name
from skailar.db.migrations.exceptions import InconsistentMigrationHistory
from skailar.db.migrations.recorder import MigrationRecorder
from skailar.test import TestCase, override_settings, skipUnlessDBFeature
from skailar.test.utils import captured_stdout
...
class MigrateTests(MigrationTestBase):
    ...
    def test_migrate_fake_initial(self):
        ...
        try:
            ...
            out = io.StringIO()
            with mock.patch(
                "skailar.core.management.color.supports_color", lambda *args: False
            ):
                call_command(
                    "migrate",
                    "migrations",
    ...
    def test_showmigrations_list(self):
        ...
        out = io.StringIO()
        with mock.patch(
            "skailar.core.management.color.supports_color", lambda *args: True
        ):
            call_command(
...
class MakeMigrationsTests(MigrationTestBase):
    ...
    def test_makemigrations_empty_connections(self):
        ...
        with mock.patch(
            "skailar.core.management.commands.makemigrations.connections",
    ...
    def test_makemigrations_disabled_migrations_for_app(self):
        ...
        """
        msg = (
            "Skailar can't create migrations for app 'migrations' because migrations "
    ...
    @mock.patch("skailar.db.migrations.utils.datetime")
    ...
    def test_makemigrations_interactive_not_null_addition(self):
        ...
        with self.temporary_migration_module(module="migrations.test_migrations"):
            ...
            self.assertIn(
                "The datetime and skailar.utils.timezone modules are "
    ...
    def test_makemigrations_migration_path_output_valueerror(self):
        ...
        Windows if Skailar is installed on a different drive than where the
    ...
    def test_makemigrations_inconsistent_history_db_failure(self):
        ...
        with mock.patch(
            "skailar.db.migrations.loader.MigrationLoader.check_consistent_history",
    ...
    @mock.patch(
        "skailar.db.migrations.questioner.sys.stdin",
    ...
    def test_makemigrations_interactive_unique_callable_default_addition(self):
        ...
        input_msg = (
            ...
            f"https://docs.skailarproject.com/en/{version}/howto/"
...
class AppLabelErrorTests(TestCase):
    ...
    app. 'skailar.contrib.auth' must be in INSTALLED_APPS for some of these
    tests.
    """

    nonexistent_app_error = "No installed app with label 'nonexistent_app'."
    did_you_mean_auth_error = (
        "No installed app with label 'skailar.contrib.auth'. Did you mean 'auth'?"
    )
    ...
    def test_makemigrations_app_name_specified_as_label(self):
        err = io.StringIO()
        with self.assertRaises(SystemExit):
            call_command("makemigrations", "skailar.contrib.auth", stderr=err)
    ...
    def test_migrate_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("migrate", "skailar.contrib.auth")
    ...
    def test_showmigrations_app_name_specified_as_label(self):
        err = io.StringIO()
        with self.assertRaises(SystemExit):
            call_command("showmigrations", "skailar.contrib.auth", stderr=err)
        self.assertIn(self.did_you_mean_auth_error, err.getvalue())
    ...
    def test_sqlmigrate_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("sqlmigrate", "skailar.contrib.auth", "0002")
    ...
    def test_squashmigrations_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("squashmigrations", "skailar.contrib.auth", "0002")
    ...
    def test_optimizemigration_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("optimizemigration", "skailar.contrib.auth", "0002")
    ...
    def test_fails_squash_migration_manual_porting(self):
        ...
        with self.temporary_migration_module(
            ...
            msg = (
                ...
                f"https://docs.skailarproject.com/en/{version}/topics/migrations/"
