...
# body param
SchemaForRequestBodyApplicationJson = WithdrawalRequestModel


request_body_withdrawal_request_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _simulate_withdrawal_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_withdrawal_request_model.serialize(body, content_type)
...
class SimulateWithdrawal(BaseApi):
    ...
    def simulate_withdrawal(
        ...
        return self._simulate_withdrawal_oapg(
            body=body,
