...
class SecureValueError:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SecureValueError <pyrosex.raw.types.SecureValueError>`
            - :obj:`SecureValueErrorData <pyrosex.raw.types.SecureValueErrorData>`
            - :obj:`SecureValueErrorFile <pyrosex.raw.types.SecureValueErrorFile>`
            - :obj:`SecureValueErrorFiles <pyrosex.raw.types.SecureValueErrorFiles>`
            - :obj:`SecureValueErrorFrontSide <pyrosex.raw.types.SecureValueErrorFrontSide>`
            - :obj:`SecureValueErrorReverseSide <pyrosex.raw.types.SecureValueErrorReverseSide>`
            - :obj:`SecureValueErrorSelfie <pyrosex.raw.types.SecureValueErrorSelfie>`
            - :obj:`SecureValueErrorTranslationFile <pyrosex.raw.types.SecureValueErrorTranslationFile>`
            - :obj:`SecureValueErrorTranslationFiles <pyrosex.raw.types.SecureValueErrorTranslationFiles>`
    """

    QUALNAME = "pyrosex.raw.base.SecureValueError"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/secure-value-error")
