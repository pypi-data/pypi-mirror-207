...
class KeyboardButtonRow(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.KeyboardButtonRow`.
    ...
    Parameters:
        buttons: List of :obj:`KeyboardButton <pyrosex.raw.base.KeyboardButton>`
    """
