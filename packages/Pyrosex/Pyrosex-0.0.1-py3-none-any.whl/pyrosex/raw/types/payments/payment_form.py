...
class PaymentForm(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.payments.PaymentForm`.
    ...
    Parameters:
        ...
        title: ``str``
        description: ``str``
        invoice: :obj:`Invoice <pyrosex.raw.base.Invoice>`
        ...
        photo (optional): :obj:`WebDocument <pyrosex.raw.base.WebDocument>`
        native_provider (optional): ``str``
        native_params (optional): :obj:`DataJSON <pyrosex.raw.base.DataJSON>`
        saved_info (optional): :obj:`PaymentRequestedInfo <pyrosex.raw.base.PaymentRequestedInfo>`
        saved_credentials (optional): :obj:`PaymentSavedCredentials <pyrosex.raw.base.PaymentSavedCredentials>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetPaymentForm <pyrosex.raw.functions.payments.GetPaymentForm>`
    """

    __slots__: List[str] = ["form_id", "bot_id", "title", "description", "invoice", "provider_id", "url", "users", "can_save_credentials", "password_missing", "photo", "native_provider", "native_params", "saved_info", "saved_credentials"]
    ...
    def read(b: BytesIO, *args: Any) -> "PaymentForm":
        ...
        return PaymentForm(form_id=form_id, bot_id=bot_id, title=title, description=description, invoice=invoice, provider_id=provider_id, url=url, users=users, can_save_credentials=can_save_credentials, password_missing=password_missing, photo=photo, native_provider=native_provider, native_params=native_params, saved_info=saved_info, saved_credentials=saved_credentials)
