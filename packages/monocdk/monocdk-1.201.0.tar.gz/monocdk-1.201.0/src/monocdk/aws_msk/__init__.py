...
class CfnClusterPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param cluster_arn: ``AWS::MSK::ClusterPolicy.ClusterArn``.
        :param policy: ``AWS::MSK::ClusterPolicy.Policy``.
        '''
        if __debug__:
...
class CfnVpcConnection(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param authentication: ``AWS::MSK::VpcConnection.Authentication``.
        :param client_subnets: ``AWS::MSK::VpcConnection.ClientSubnets``.
        :param security_groups: ``AWS::MSK::VpcConnection.SecurityGroups``.
        :param target_cluster_arn: ``AWS::MSK::VpcConnection.TargetClusterArn``.
        :param vpc_id: ``AWS::MSK::VpcConnection.VpcId``.
        :param tags: ``AWS::MSK::VpcConnection.Tags``.
        '''
        if __debug__:
