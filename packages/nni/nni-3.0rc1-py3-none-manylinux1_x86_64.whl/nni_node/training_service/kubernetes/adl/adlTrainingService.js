...
let AdlTrainingService = class AdlTrainingService extends kubernetesTrainingService_1.KubernetesTrainingService {
    ...
    tensorboardName = "adaptdl-tensorboard-" + (0, experimentStartupInfo_1.getExperimentId)().toLowerCase();
    constructor() {
        super();
...
`;
    ...
    async prepareRunScript(jobId, form, codeDir, outputDir) {
        ...
        const hyperParametersFile = (0, utils_1.generateParamFileName)(form.hyperParameters);
        ...
        if (this.versionCheck) {
            nniManagerVersion = await (0, utils_1.getVersion)();
        }
        let nvidiaScript = '';
