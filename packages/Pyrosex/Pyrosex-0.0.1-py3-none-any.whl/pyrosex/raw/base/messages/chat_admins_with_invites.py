...
class ChatAdminsWithInvites:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ChatAdminsWithInvites <pyrosex.raw.types.messages.ChatAdminsWithInvites>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetAdminsWithInvites <pyrosex.raw.functions.messages.GetAdminsWithInvites>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ChatAdminsWithInvites"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-admins-with-invites")
