...
from skailar.core import checks, exceptions, serializers
from skailar.db import connection
from skailar.db.models import F, OuterRef, Subquery
from skailar.db.models.expressions import RawSQL
from skailar.forms import Form
from skailar.test.utils import CaptureQueriesContext, isolate_apps

from . import PostgreSQLSimpleTestCase, PostgreSQLTestCase
from .models import HStoreModel, PostgreSQLModel

try:
    from skailar.contrib.postgres import forms
    from skailar.contrib.postgres.fields import HStoreField
    from skailar.contrib.postgres.fields.hstore import KeyTransform
    from skailar.contrib.postgres.validators import KeysValidator
except ImportError:
    pass
...
class TestValidator(PostgreSQLSimpleTestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, "skailar.contrib.postgres.validators.KeysValidator")
