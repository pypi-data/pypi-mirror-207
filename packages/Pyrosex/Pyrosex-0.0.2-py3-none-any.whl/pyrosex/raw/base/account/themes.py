...
class Themes:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.Themes <pyrosex.raw.types.account.Themes>`
            - :obj:`account.ThemesNotModified <pyrosex.raw.types.account.ThemesNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetThemes <pyrosex.raw.functions.account.GetThemes>`
            - :obj:`account.GetChatThemes <pyrosex.raw.functions.account.GetChatThemes>`
    """

    QUALNAME = "pyrosex.raw.base.account.Themes"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/themes")
