...
format:  ## run autoformatting with black
	python -m black tonereader/ setup.py
...
annotate:  ## run type checking
	python -m mypy ./tonereader

#########
# TESTS #
#########
test: ## clean and run unit tests
	python3 -m pytest -v tonereader/tests

coverage:  ## clean and run unit tests with coverage
	python3 -m pytest -v tonereader/tests --cov=tonereader --cov-branch --cov-fail-under=75 --cov-report term-missing
