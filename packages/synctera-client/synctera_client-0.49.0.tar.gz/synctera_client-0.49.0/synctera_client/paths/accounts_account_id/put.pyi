...
# body param
SchemaForRequestBodyApplicationJson = AccountDepository


request_body_account_depository = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_depository.serialize(body, content_type)
