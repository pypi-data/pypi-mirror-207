...
# body param
SchemaForRequestBodyApplicationJson = NoteCreate


request_body_note_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = NoteResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_note_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_note_create.serialize(body, content_type)
