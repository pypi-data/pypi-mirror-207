...
SchemaFor200ResponseBodyApplicationJson = WatchlistAlertList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_watchlist_alerts_oapg(
        self,
...
class ListWatchlistAlerts(BaseApi):
    ...
    def list_watchlist_alerts(
        ...
        return self._list_watchlist_alerts_oapg(
