...
class ResetPasswordResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.ResetPasswordFailedWait <pyrosex.raw.types.account.ResetPasswordFailedWait>`
            - :obj:`account.ResetPasswordOk <pyrosex.raw.types.account.ResetPasswordOk>`
            - :obj:`account.ResetPasswordRequestedWait <pyrosex.raw.types.account.ResetPasswordRequestedWait>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.ResetPassword <pyrosex.raw.functions.account.ResetPassword>`
    """

    QUALNAME = "pyrosex.raw.base.account.ResetPasswordResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/reset-password-result")
