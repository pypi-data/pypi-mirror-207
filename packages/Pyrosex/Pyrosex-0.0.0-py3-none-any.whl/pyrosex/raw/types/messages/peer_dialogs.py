...
class PeerDialogs(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs: List of :obj:`Dialog <pyrosex.raw.base.Dialog>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetPeerDialogs <pyrosex.raw.functions.messages.GetPeerDialogs>`
            - :obj:`messages.GetPinnedDialogs <pyrosex.raw.functions.messages.GetPinnedDialogs>`
    """
