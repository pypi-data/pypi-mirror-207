...
class Cd(CmdBase):
    ...
    def init_parser(self, subparsers):
        ...
        cd_parser = subparsers.add_parser(
            "cdout",
            help="leave the context to the specified dataset.",
            example="cdout.example",
        )
    ...
    def cmd_entry(self, cmdargs, config, *args, **kwargs):
        ...
        if "DATASET_NAME" in os.environ and is_exists:
            ...
            if sysstr in ["Windows"]:
                ...
                stdio.print_stdout(
                    "to deactivate current environment, please run:\n call %USERPROFILE%\.dsdl\.env.bat"
                )
                ...
                PS1_VAR_NEW = CONDA_PROMPT_MODIFIER + PS1_VAR_OS
