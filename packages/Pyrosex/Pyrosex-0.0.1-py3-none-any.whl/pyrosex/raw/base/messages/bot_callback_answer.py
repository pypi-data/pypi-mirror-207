...
class BotCallbackAnswer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.BotCallbackAnswer <pyrosex.raw.types.messages.BotCallbackAnswer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetBotCallbackAnswer <pyrosex.raw.functions.messages.GetBotCallbackAnswer>`
    """

    QUALNAME = "pyrosex.raw.base.messages.BotCallbackAnswer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/bot-callback-answer")
