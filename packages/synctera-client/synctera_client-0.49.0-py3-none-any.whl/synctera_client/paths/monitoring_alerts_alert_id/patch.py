...
# body param
SchemaForRequestBodyApplicationJson = MonitoringAlert


request_body_monitoring_alert = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_alert_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_monitoring_alert.serialize(body, content_type)
...
class UpdateAlert(BaseApi):
    ...
    def update_alert(
        ...
        return self._update_alert_oapg(
            body=body,
