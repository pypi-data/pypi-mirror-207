...
class WebAuthorizations:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.WebAuthorizations <pyrosex.raw.types.account.WebAuthorizations>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetWebAuthorizations <pyrosex.raw.functions.account.GetWebAuthorizations>`
    """

    QUALNAME = "pyrosex.raw.base.account.WebAuthorizations"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/web-authorizations")
