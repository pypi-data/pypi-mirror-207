...
from skailar.core.exceptions import FieldError
from skailar.db import connection
from skailar.db.models import (
    Aggregate,
    Avg,
    Case,
    CharField,
...
from skailar.db.models.functions import Cast, Concat
from skailar.test import TestCase, skipUnlessDBFeature
from skailar.test.utils import Approximate
...
class AggregationTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.b1 = Book.objects.create(
            isbn="159059725",
            name="The Definitive Guide to Skailar: Web Development Done Right",
            pages=447,
            rating=4.5,
            price=Decimal("30.00"),
            contact=cls.a1,
        ...
        cls.b2 = Book.objects.create(
            isbn="067232959",
            name="Sams Teach Yourself Skailar in 24 Hours",
            pages=528,
            rating=3.0,
            price=Decimal("23.09"),
            contact=cls.a3,
        ...
        cls.b3 = Book.objects.create(
            isbn="159059996",
            name="Practical Skailar Projects",
            pages=300,
            rating=4.0,
            price=Decimal("29.69"),
            contact=cls.a4,
        ...
        cls.b4 = Book.objects.create(
            isbn="013235613",
            name="Python Web Development with Skailar",
            pages=350,
            rating=4.0,
            price=Decimal("29.69"),
            contact=cls.a5,
    ...
    def test_more_more(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                "Practical Skailar Projects",
                "The Definitive Guide to Skailar: Web Development Done Right",
                "Paradigms of Artificial Intelligence Programming: Case Studies in "
                "Common Lisp",
                "Artificial Intelligence: A Modern Approach",
                "Python Web Development with Skailar",
                "Sams Teach Yourself Skailar in 24 Hours",
            ],
            lambda b: b.name,
        )
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                ("Practical Skailar Projects", 29.0, "Apress", "James Bennett"),
                (
                    "Python Web Development with Skailar",
                ...
                ("Sams Teach Yourself Skailar in 24 Hours", 45.0, "Sams", "Brad Dayley"),
            ],
    ...
    def test_annotation_disjunction(self):
        qs = (
            Book.objects.annotate(n_authors=Count("authors"))
            .filter(Q(n_authors=2) | Q(name="Python Web Development with Skailar"))
            .order_by("name")
        )
        self.assertQuerySetEqual(
            qs,
        ...
        qs = (
            Book.objects.annotate(n_authors=Count("authors")).filter(
                Q(name="The Definitive Guide to Skailar: Web Development Done Right")
                | (
    ...
    def test_quoting_aggregate_order_by(self):
        qs = (
            Book.objects.filter(name="Python Web Development with Skailar")
        ...
        self.assertQuerySetEqual(
            qs,
            [
                ("Python Web Development with Skailar", 3),
            ],
    ...
    def test_aggregate_duplicate_columns_select_related(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ("Practical Skailar Projects", 1),
                ("Python Web Development with Skailar", 3),
                ("Sams Teach Yourself Skailar in 24 Hours", 1),
                ("The Definitive Guide to Skailar: Web Development Done Right", 2),
            ],
        )
    ...
    def test_aggregate_unmanaged_model_as_tables(self):
        ...
        with mock.patch(
            "skailar.db.connection.features.allows_group_by_selected_pks_on_model",
            return_value=True,
        ):
            with mock.patch.object(Book._meta, "managed", False), mock.patch.object(
                ...
                self.assertQuerySetEqual(
                    ...
                    [
                        ...
                        ("Sams Teach Yourself Skailar in 24 Hours", 1),
                        (
                            "The Definitive Guide to Skailar: Web Development Done "
                            "Right",
                            2,
                        ),
                    ],
    ...
    def test_aggregation_with_generic_reverse_relation(self):
        ...
        """
        skailar_book = Book.objects.get(name="Practical Skailar Projects")
        ItemTag.objects.create(
            object_id=skailar_book.id,
            tag="intermediate",
            content_type=ContentType.objects.get_for_model(skailar_book),
        )
        ItemTag.objects.create(
            object_id=skailar_book.id,
            tag="skailar",
        ...
        wmpk = WithManualPK.objects.create(id=skailar_book.pk)
        ItemTag.objects.create(
            object_id=wmpk.id,
            tag="hi mom",
        ...
        self.assertEqual(
            ...
            [
                ...
                ("Python Web Development with Skailar", 0),
                ("Sams Teach Yourself Skailar in 24 Hours", 0),
                ("The Definitive Guide to Skailar: Web Development Done Right", 0),
            ],
        )
    ...
    def test_fobj_group_by(self):
        ...
        self.assertQuerySetEqual(
            qs, ["Sams Teach Yourself Skailar in 24 Hours"], lambda b: b.name
        )
    ...
    def test_aggregate_group_by_unseen_columns_unmanaged(self):
        ...
        # calculated field "name". The table has a column "name" that Skailar is
