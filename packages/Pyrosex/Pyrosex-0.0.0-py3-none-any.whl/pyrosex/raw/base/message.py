...
class Message:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`Message <pyrosex.raw.types.Message>`
            - :obj:`MessageEmpty <pyrosex.raw.types.MessageEmpty>`
            - :obj:`MessageService <pyrosex.raw.types.MessageService>`
    """

    QUALNAME = "pyrosex.raw.base.Message"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message")
