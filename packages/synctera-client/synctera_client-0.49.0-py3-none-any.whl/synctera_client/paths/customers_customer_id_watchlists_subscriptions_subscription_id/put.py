...
SubscriptionIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customer_id': typing.Union[CustomerIdSchema, str, uuid.UUID, ],
        'subscription_id': typing.Union[SubscriptionIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = WatchlistSubscription


request_body_watchlist_subscription = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WatchlistSubscription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_watchlist_subscription_oapg(
        self,
    ...
    def _update_watchlist_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_watchlist_subscription.serialize(body, content_type)
...
class UpdateWatchlistSubscription(BaseApi):
    ...
    def update_watchlist_subscription(
        ...
        return self._update_watchlist_subscription_oapg(
            body=body,
