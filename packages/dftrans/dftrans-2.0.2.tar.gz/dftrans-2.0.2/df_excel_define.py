...
def dfloaddatafromdbbysql(specialdflist: list, tableindex: list, positionlist: list,
                          ip: str, port: int, database: str, user: str, password: str, sqlstr: str):
    """
    读取db数据到df
    ...
    :return:
    """
    result = dfreaddatabysql(ip=ip, port=port, database=database, user=user, password=password, sqlstr=sqlstr)
