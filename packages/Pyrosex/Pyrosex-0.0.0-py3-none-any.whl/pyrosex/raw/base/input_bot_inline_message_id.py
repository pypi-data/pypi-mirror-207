...
class InputBotInlineMessageID:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputBotInlineMessageID <pyrosex.raw.types.InputBotInlineMessageID>`
            - :obj:`InputBotInlineMessageID64 <pyrosex.raw.types.InputBotInlineMessageID64>`
    """

    QUALNAME = "pyrosex.raw.base.InputBotInlineMessageID"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-bot-inline-message-id")
