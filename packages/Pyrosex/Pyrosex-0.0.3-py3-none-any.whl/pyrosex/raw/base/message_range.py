...
class MessageRange:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MessageRange <pyrosex.raw.types.MessageRange>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSplitRanges <pyrosex.raw.functions.messages.GetSplitRanges>`
    """

    QUALNAME = "pyrosex.raw.base.MessageRange"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-range")
