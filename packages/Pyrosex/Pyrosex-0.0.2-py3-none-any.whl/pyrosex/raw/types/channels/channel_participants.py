...
class ChannelParticipants(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.channels.ChannelParticipants`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        participants: List of :obj:`ChannelParticipant <pyrosex.raw.base.ChannelParticipant>`
