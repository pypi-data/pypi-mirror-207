...
from skailar.core.management import ManagementUtility
...
class BashCompletionTests(unittest.TestCase):
    ...
    def setUp(self):
        self.old_SKAILAR_AUTO_COMPLETE = os.environ.get("SKAILAR_AUTO_COMPLETE")
        os.environ["SKAILAR_AUTO_COMPLETE"] = "1"

    def tearDown(self):
        if self.old_SKAILAR_AUTO_COMPLETE:
            os.environ["SKAILAR_AUTO_COMPLETE"] = self.old_SKAILAR_AUTO_COMPLETE
        else:
            del os.environ["SKAILAR_AUTO_COMPLETE"]
    ...
    def _user_input(self, input_str):
        ...
        $COMP_CWORD must be incremented by 1:
          ...
          * 'skailar-admin start' -> COMP_CWORD=1
          * 'skailar-admin startproject' -> COMP_CWORD=1
          * 'skailar-admin startproject ' -> COMP_CWORD=2
        """
    ...
    def test_skailar_admin_py(self):
        "skailar_admin.py will autocomplete option flags"
        self._user_input("skailar-admin sqlmigrate --verb")
    ...
    def test_custom_command(self):
        ...
        self._user_input("skailar-admin test_command --l")
        output = self._run_autocomplete()
        self.assertEqual(output, ["--list"])

    def test_subcommands(self):
        "Subcommands can be autocompleted"
        self._user_input("skailar-admin sql")
        output = self._run_autocomplete()
    ...
    def test_completed_subcommand(self):
        ...
        self._user_input("skailar-admin startproject ")  # Trailing whitespace
        output = self._run_autocomplete()
        for item in output:
    ...
    def test_help(self):
        ...
        self._user_input("skailar-admin help --")
        output = self._run_autocomplete()
        self.assertEqual(output, [""])

    def test_app_completion(self):
        "Application names will be autocompleted for an AppCommand"
        self._user_input("skailar-admin sqlmigrate a")
        output = self._run_autocomplete()
        a_labels = sorted(
            app_config.label
