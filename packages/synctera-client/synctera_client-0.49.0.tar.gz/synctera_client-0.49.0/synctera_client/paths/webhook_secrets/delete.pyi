...
# Query params
OldSecretOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'old_secret_only': typing.Union[OldSecretOnlySchema, bool, ],
    },
    total=False
)
...
request_query_old_secret_only = api_client.QueryParameter(
    name="old_secret_only",
    style=api_client.ParameterStyle.FORM,
    schema=OldSecretOnlySchema,
    explode=True,
)
...
class RevokeSecret(BaseApi):
    ...
    def revoke_secret(
        ...
        return self._revoke_secret_oapg(
