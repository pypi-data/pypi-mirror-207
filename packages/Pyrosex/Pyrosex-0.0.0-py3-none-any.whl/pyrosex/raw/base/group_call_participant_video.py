...
class GroupCallParticipantVideo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`GroupCallParticipantVideo <pyrosex.raw.types.GroupCallParticipantVideo>`
    """

    QUALNAME = "pyrosex.raw.base.GroupCallParticipantVideo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/group-call-participant-video")
