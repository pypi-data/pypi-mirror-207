...
class CountriesList:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.CountriesList <pyrosex.raw.types.help.CountriesList>`
            - :obj:`help.CountriesListNotModified <pyrosex.raw.types.help.CountriesListNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetCountriesList <pyrosex.raw.functions.help.GetCountriesList>`
    """

    QUALNAME = "pyrosex.raw.base.help.CountriesList"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/countries-list")
