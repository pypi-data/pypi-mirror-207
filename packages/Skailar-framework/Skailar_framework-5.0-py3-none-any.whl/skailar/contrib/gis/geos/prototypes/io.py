...
from skailar.contrib.gis.geos.libgeos import (
    GEOM_PTR,
    GEOSFuncFactory,
    geos_version_tuple,
)
from skailar.contrib.gis.geos.prototypes.errcheck import (
    check_geom,
    check_sized_string,
    check_string,
)
from skailar.contrib.gis.geos.prototypes.geom import c_uchar_p, geos_char_p
...
class WKBWriter(IOBase):
    ...
    def _handle_empty_point(self, geom):
        from skailar.contrib.gis.geos import Point
    ...
    def write(self, geom):
        ...
        from skailar.contrib.gis.geos import Polygon
    ...
    def write_hex(self, geom):
        ...
        from skailar.contrib.gis.geos.polygon import Polygon
