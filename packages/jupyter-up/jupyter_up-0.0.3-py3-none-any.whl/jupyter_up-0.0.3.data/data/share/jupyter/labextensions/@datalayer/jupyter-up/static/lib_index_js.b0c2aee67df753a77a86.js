"use strict";
(self["webpackChunk_datalayer_jupyter_up"] = self["webpackChunk_datalayer_jupyter_up"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_up', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterUp": () => (/* binding */ IJupyterUp),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "jupyterUp": () => (/* binding */ jupyterUp)
/* harmony export */ });
...
const IJupyterUp = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_4__.Token('@datalayer/jupyter-up:plugin');
const jupyterUp = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-up-widget';
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_up server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_9__.connect)('ws://localhost:8888/jupyter_up/echo', true);
        return jupyterUp;
    }
};
...
//# sourceMappingURL=lib_index_js.b0c2aee67df753a77a86.js.map