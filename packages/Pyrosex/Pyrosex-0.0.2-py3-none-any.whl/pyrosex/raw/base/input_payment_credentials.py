...
class InputPaymentCredentials:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputPaymentCredentials <pyrosex.raw.types.InputPaymentCredentials>`
            - :obj:`InputPaymentCredentialsApplePay <pyrosex.raw.types.InputPaymentCredentialsApplePay>`
            - :obj:`InputPaymentCredentialsGooglePay <pyrosex.raw.types.InputPaymentCredentialsGooglePay>`
            - :obj:`InputPaymentCredentialsSaved <pyrosex.raw.types.InputPaymentCredentialsSaved>`
    """

    QUALNAME = "pyrosex.raw.base.InputPaymentCredentials"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-payment-credentials")
