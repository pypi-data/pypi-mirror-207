...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        id (optional): ``str``
        shipping_options (optional): List of :obj:`ShippingOption <pyrosex.raw.base.ShippingOption>`
