...
R8Z1_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R8Z1Cluster(GenericK8sCluster):
    """ R8Z1 Cluster Overrides """

    allowed_instances: Instances = R8Z1_INSTANCES
