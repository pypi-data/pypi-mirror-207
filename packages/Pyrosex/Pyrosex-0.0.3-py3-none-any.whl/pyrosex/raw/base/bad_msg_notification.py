...
class BadMsgNotification:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`BadMsgNotification <pyrosex.raw.types.BadMsgNotification>`
            - :obj:`BadServerSalt <pyrosex.raw.types.BadServerSalt>`
    """

    QUALNAME = "pyrosex.raw.base.BadMsgNotification"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/bad-msg-notification")
