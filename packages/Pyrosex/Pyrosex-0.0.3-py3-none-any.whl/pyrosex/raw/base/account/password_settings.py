...
class PasswordSettings:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.PasswordSettings <pyrosex.raw.types.account.PasswordSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPasswordSettings <pyrosex.raw.functions.account.GetPasswordSettings>`
    """

    QUALNAME = "pyrosex.raw.base.account.PasswordSettings"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/password-settings")
