...
class PromoData:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.PromoData <pyrosex.raw.types.help.PromoData>`
            - :obj:`help.PromoDataEmpty <pyrosex.raw.types.help.PromoDataEmpty>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPromoData <pyrosex.raw.functions.help.GetPromoData>`
    """

    QUALNAME = "pyrosex.raw.base.help.PromoData"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/promo-data")
