...
from skailar.contrib.contenttypes.fields import GenericForeignKey
from skailar.db import models
from skailar.db.migrations.exceptions import InvalidBasesError
from skailar.db.migrations.operations import (
    AddField,
    AlterField,
    DeleteModel,
    RemoveField,
)
from skailar.db.migrations.state import (
    ModelState,
    ProjectState,
    get_related_models_recursive,
)
from skailar.test import SimpleTestCase, ignore_warnings, override_settings
...
class StateTests(SimpleTestCase):
    ...
    # RemovedInSkailar51Warning, when deprecation ends, only remove
    ...
    def test_create(self):
        ...
        class Author(models.Model):
            ...
            class Meta:
                ...
                index_together = ["bio", "age"]  # RemovedInSkailar51Warning.
    ...
    def test_render_unique_app_labels(self):
        ...
        class A(models.Model):
            class Meta:
                app_label = "skailar.contrib.auth"
...
class ModelStateTests(SimpleTestCase):
    ...
    @isolate_apps("migrations", "skailar.contrib.contenttypes")
