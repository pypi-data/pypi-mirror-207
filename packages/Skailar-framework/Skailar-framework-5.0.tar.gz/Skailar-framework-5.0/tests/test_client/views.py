...
from skailar.forms import fields
from skailar.forms.forms import Form
...
from skailar.test import Client
...
def view_with_header(request):
    ...
    response.headers["X-SKAILAR-TEST"] = "Slartibartfast"
    return response
...
def skailar_project_redirect(request):
    return HttpResponseRedirect("https://www.skailarproject.com/")
