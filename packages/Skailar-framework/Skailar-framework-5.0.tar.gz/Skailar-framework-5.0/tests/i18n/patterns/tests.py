...
from skailar.http import HttpResponse, HttpResponsePermanentRedirect
...
from skailar.urls import clear_url_caches, resolve, reverse, translate_url
    ...
    TEMPLATES=[
        {
            ...
            "OPTIONS": {
                "context_processors": [
                    "skailar.template.context_processors.i18n",
                ],
            },
        }
    ],
