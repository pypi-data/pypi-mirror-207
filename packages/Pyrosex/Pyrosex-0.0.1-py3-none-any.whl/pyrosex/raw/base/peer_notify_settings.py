...
class PeerNotifySettings:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PeerNotifySettings <pyrosex.raw.types.PeerNotifySettings>`
    ...
    QUALNAME = "pyrosex.raw.base.PeerNotifySettings"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/peer-notify-settings")
