...
class BaseDatabaseIntrospection:
    ...
    def get_field_type(self, data_type, description):
        ...
        match a Skailar field type to a database column.
    ...
    def skailar_table_names(self, only_existing=False, include_views=True):
        """
        Return a list of all table names that have associated Skailar models and
