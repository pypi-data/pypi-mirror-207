...
from skailar.core.files.uploadedfile import SimpleUploadedFile, UploadedFile
from skailar.http.multipartparser import (
    FILE,
    MultiPartParser,
    MultiPartParserError,
    Parser,
)
from skailar.test import SimpleTestCase, TestCase, client, override_settings
...
class FileUploadTests(TestCase):
    ...
    def test_upload_interrupted_temporary_file_handler(self):
        ...
        with tempfile.NamedTemporaryFile() as temp_file:
            ...
            temp_file.seek(0)
            with mock.patch(
                "skailar.http.multipartparser.Parser",
                MockedParser,
            ):
                response = self.client.post(
    ...
    def test_file_error_blocking(self):
        ...
        # the skailar.test.client.FakePayload.read() implementation changes then
    ...
    def test_filename_case_preservation(self):
        ...
        # so we don't have to carry such a file in the Skailar tests source code
        # tree.
