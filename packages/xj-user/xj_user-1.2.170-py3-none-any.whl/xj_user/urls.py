...
from xj_user.apis import user_login_wechat_app, user_login_wechat_h5
from xj_user.apis.user_add import UserAdd
from xj_user.apis.user_login_wechat_h5 import WechetH5Login
...
urlpatterns = [
    ...
    re_path(r'^login_main/?$', WechetH5Login.login_main, ),  #登录总接口
