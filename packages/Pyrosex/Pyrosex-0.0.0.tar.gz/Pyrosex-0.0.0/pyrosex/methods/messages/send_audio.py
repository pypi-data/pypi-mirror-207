...
import pyrosex
from pyrosex import StopTransmission, enums
from pyrosex import raw
from pyrosex import types
from pyrosex import utils
from pyrosex.errors import FilePartMissing
from pyrosex.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrosex.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrosex.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrosex.Client.stop_transmission`, None is returned.
