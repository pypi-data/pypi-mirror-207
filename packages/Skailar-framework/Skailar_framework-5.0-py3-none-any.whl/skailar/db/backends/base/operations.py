...
from skailar.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "skailar.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in skailar.core.management.color.
    ...
    def adapt_timefield_value(self, value):
        ...
        if timezone.is_aware(value):
            raise ValueError("Skailar does not support timezone-aware times.")
        return str(value)
