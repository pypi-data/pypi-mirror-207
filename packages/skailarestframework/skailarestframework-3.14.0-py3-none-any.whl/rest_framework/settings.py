...
# Import from `skailar.core.signals` instead of the official location
# `skailar.test.signals` to avoid importing the test module unnecessarily.
...
DEFAULTS = {
    ...
    # Authentication
    'UNAUTHENTICATED_USER': 'skailar.contrib.auth.models.AnonymousUser',
...
class APISettings:
    ...
    def __check_user_settings(self, user_settings):
        SETTINGS_DOC = "https://www.skailar-rest-framework.org/api-guide/settings/"
