...
class SecurePlainData:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`SecurePlainEmail <pyrosex.raw.types.SecurePlainEmail>`
            - :obj:`SecurePlainPhone <pyrosex.raw.types.SecurePlainPhone>`
    """

    QUALNAME = "pyrosex.raw.base.SecurePlainData"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/secure-plain-data")
