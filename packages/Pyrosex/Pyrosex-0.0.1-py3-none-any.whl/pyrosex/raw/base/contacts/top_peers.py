...
class TopPeers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`contacts.TopPeers <pyrosex.raw.types.contacts.TopPeers>`
            - :obj:`contacts.TopPeersDisabled <pyrosex.raw.types.contacts.TopPeersDisabled>`
            - :obj:`contacts.TopPeersNotModified <pyrosex.raw.types.contacts.TopPeersNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetTopPeers <pyrosex.raw.functions.contacts.GetTopPeers>`
    """

    QUALNAME = "pyrosex.raw.base.contacts.TopPeers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/top-peers")
