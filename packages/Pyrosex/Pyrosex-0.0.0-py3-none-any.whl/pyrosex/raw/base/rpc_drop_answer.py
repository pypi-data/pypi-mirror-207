...
class RpcDropAnswer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`RpcAnswerDropped <pyrosex.raw.types.RpcAnswerDropped>`
            - :obj:`RpcAnswerDroppedRunning <pyrosex.raw.types.RpcAnswerDroppedRunning>`
            - :obj:`RpcAnswerUnknown <pyrosex.raw.types.RpcAnswerUnknown>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`RpcDropAnswer <pyrosex.raw.functions.RpcDropAnswer>`
    """

    QUALNAME = "pyrosex.raw.base.RpcDropAnswer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/rpc-drop-answer")
