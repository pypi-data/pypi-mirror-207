...
class WebViewResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`WebViewResultUrl <pyrosex.raw.types.WebViewResultUrl>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.RequestWebView <pyrosex.raw.functions.messages.RequestWebView>`
    """

    QUALNAME = "pyrosex.raw.base.WebViewResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/web-view-result")
