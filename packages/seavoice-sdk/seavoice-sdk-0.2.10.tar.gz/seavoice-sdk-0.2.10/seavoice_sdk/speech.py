...
class Recognizer():
    ...
    def __init__(self, speech_config: SpeechConfig, audio_config: Optional[audio.AudioConfig] = None, monitor_session: bool = False, itn: bool = True, punctuation: bool = True):
        ...
        self.ws = self.RecognizerWebSocket(self.__ws_uri, [("sample_rate",self.sample_rate), ("itn",self.itn), ("punctuation",self.punctuation), ("connection-id",self.connection_id)], self)
