...
import pyrosex
from pyrosex import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~pyrosex.types.Message`: On success, the sent text message is returned.
        ...
        Example:
            .. code-block:: python
                ...
                await app.send_message("me", "https://docs.pyrosex.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.pyrosex.org")]
                        ]))
        """
