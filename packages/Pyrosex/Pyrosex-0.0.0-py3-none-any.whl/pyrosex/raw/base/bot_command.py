...
class BotCommand:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`BotCommand <pyrosex.raw.types.BotCommand>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`bots.GetBotCommands <pyrosex.raw.functions.bots.GetBotCommands>`
    """

    QUALNAME = "pyrosex.raw.base.BotCommand"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/bot-command")
