...
class InputFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputFile <pyrosex.raw.types.InputFile>`
            - :obj:`InputFileBig <pyrosex.raw.types.InputFileBig>`
    """

    QUALNAME = "pyrosex.raw.base.InputFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-file")
