...
from guimpl.row_pygubu.row_pygubu_main import RowPygubuUiApp
from guimpl.row_pygubu.axeschoosewidgetsframe import AxesChooseWidgetsFrameWidget

from guimpl.surcouches_pygubu.autowidgetsframe import AutoWidgetsFrame
from guimpl.surcouches_pygubu.mainaxewidgetsframewidget import (
...
class View(RowPygubuUiApp):
    ...
    def second_layer_init(self, fig):
        ...
        self.menu_Fichier.add_command(
            label="Enregistrer sous", command=self.controller.save_as
        )
