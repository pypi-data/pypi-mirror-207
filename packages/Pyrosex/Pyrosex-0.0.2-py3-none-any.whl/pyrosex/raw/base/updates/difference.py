...
class Difference:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`updates.Difference <pyrosex.raw.types.updates.Difference>`
            - :obj:`updates.DifferenceEmpty <pyrosex.raw.types.updates.DifferenceEmpty>`
            - :obj:`updates.DifferenceSlice <pyrosex.raw.types.updates.DifferenceSlice>`
            - :obj:`updates.DifferenceTooLong <pyrosex.raw.types.updates.DifferenceTooLong>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`updates.GetDifference <pyrosex.raw.functions.updates.GetDifference>`
    """

    QUALNAME = "pyrosex.raw.base.updates.Difference"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/difference")
