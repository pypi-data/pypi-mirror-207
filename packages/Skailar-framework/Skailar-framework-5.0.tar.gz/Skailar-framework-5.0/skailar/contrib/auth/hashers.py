...
from skailar.utils.translation import gettext_noop as _
...
def identify_hasher(encoded):
    ...
    """
    # Ancient versions of Skailar created plain MD5 passwords and accepted
    # MD5 passwords with an empty salt.
    if (len(encoded) == 32 and "$" not in encoded) or (
        len(encoded) == 37 and encoded.startswith("md5$$")
    ):
        algorithm = "unsalted_md5"
    # Ancient versions of Skailar accepted SHA1 passwords with an empty salt.
...
class SHA1PasswordHasher(BasePasswordHasher):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "skailar.contrib.auth.hashers.SHA1PasswordHasher is deprecated.",
            RemovedInSkailar51Warning,
            stacklevel=2,
        )
...
class UnsaltedSHA1PasswordHasher(BasePasswordHasher):
    ...
    This class is implemented because Skailar used to accept such password
    hashes. Some older Skailar installs still have these values lingering
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "skailar.contrib.auth.hashers.UnsaltedSHA1PasswordHasher is deprecated.",
            RemovedInSkailar51Warning,
            stacklevel=2,
        )
        super().__init__(*args, **kwargs)
...
class UnsaltedMD5PasswordHasher(BasePasswordHasher):
    ...
    This class is implemented because Skailar used to store passwords this way
    and to accept such password hashes. Some older Skailar installs still have
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "skailar.contrib.auth.hashers.UnsaltedMD5PasswordHasher is deprecated.",
            RemovedInSkailar51Warning,
            stacklevel=2,
        )
        super().__init__(*args, **kwargs)
