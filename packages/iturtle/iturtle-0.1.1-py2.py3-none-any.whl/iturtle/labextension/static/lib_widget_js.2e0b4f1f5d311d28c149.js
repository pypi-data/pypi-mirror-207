...
const TurtleQuest = () => {
    ...
    return (react_1.default.createElement("div", { className: "Widget" },
        ...
        react_1.default.createElement("div", { style: { backgroundColor: background } },
                    ...
                    switch (action.type) {
                        ...
                        case interface_1.ActionType.LINE_ABSOLUTE:
                            if (action.pen) {
                                ...
                                const visual = react_1.default.createElement("line", { x1: position[0], y1: position[1], x2: action.position[0], y2: action.position[1], strokeLinecap: "round", strokeWidth: 1, stroke: action.color, style: {
