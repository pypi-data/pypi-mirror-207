...
from skailar.db.models.functions import Lower, Upper
from skailar.test import SimpleTestCase, TestCase, override_settings, skipUnlessDBFeature
...
class SimpleIndexesTests(SimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        self.assertEqual(path, "skailar.db.models.Index")
