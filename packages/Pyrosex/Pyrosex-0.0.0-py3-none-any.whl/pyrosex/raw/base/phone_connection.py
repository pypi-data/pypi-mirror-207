...
class PhoneConnection:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PhoneConnection <pyrosex.raw.types.PhoneConnection>`
            - :obj:`PhoneConnectionWebrtc <pyrosex.raw.types.PhoneConnectionWebrtc>`
    """

    QUALNAME = "pyrosex.raw.base.PhoneConnection"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/phone-connection")
