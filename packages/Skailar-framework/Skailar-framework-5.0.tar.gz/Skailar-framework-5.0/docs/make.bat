...
if "%1" == "html" (
	%SPHINXBUILD% -b skailarhtml %ALLSPHINXOPTS% %BUILDDIR%/html
...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\skailar.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\skailar.qhc
	goto end
)
