...
SchemaFor201ResponseBodyApplicationJson = AccountTemplateResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_account_template_oapg(
        self,
...
class CreateAccountTemplate(BaseApi):
    ...
    def create_account_template(
        ...
        return self._create_account_template_oapg(
            body=body,
