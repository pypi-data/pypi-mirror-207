...
class PageListOrderedItem:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PageListOrderedItemBlocks <pyrosex.raw.types.PageListOrderedItemBlocks>`
            - :obj:`PageListOrderedItemText <pyrosex.raw.types.PageListOrderedItemText>`
    """

    QUALNAME = "pyrosex.raw.base.PageListOrderedItem"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/page-list-ordered-item")
