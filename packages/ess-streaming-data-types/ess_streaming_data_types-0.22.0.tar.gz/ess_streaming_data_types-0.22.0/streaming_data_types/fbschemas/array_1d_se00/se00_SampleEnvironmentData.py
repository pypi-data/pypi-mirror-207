...
class se00_SampleEnvironmentData(object):
    ...
    @classmethod
    def se00_SampleEnvironmentDataBufferHasIdentifier(
...
def se00_SampleEnvironmentDataStart(builder):
...
def se00_SampleEnvironmentDataAddName(builder, name):
...
def se00_SampleEnvironmentDataAddChannel(builder, channel):
...
def se00_SampleEnvironmentDataAddPacketTimestamp(builder, packetTimestamp):
...
def se00_SampleEnvironmentDataAddTimeDelta(builder, timeDelta):
...
def se00_SampleEnvironmentDataAddTimestampLocation(builder, timestampLocation):
...
def se00_SampleEnvironmentDataAddValuesType(builder, valuesType):
...
def se00_SampleEnvironmentDataAddValues(builder, values):
    builder.PrependUOffsetTRelativeSlot(
...
def se00_SampleEnvironmentDataAddTimestamps(builder, timestamps):
    builder.PrependUOffsetTRelativeSlot(
...
def se00_SampleEnvironmentDataStartTimestampsVector(builder, numElems):
...
def se00_SampleEnvironmentDataAddMessageCounter(builder, messageCounter):
...
def se00_SampleEnvironmentDataEnd(builder):
