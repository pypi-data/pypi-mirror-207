...
class InputPeerNotifySettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.InputPeerNotifySettings`.
    ...
    Parameters:
        ...
        sound (optional): :obj:`NotificationSound <pyrosex.raw.base.NotificationSound>`
    """
