...
TokenStateSchema = DigitalWalletTokenState
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'token_state': typing.Union[TokenStateSchema, ],
...
request_query_token_state = api_client.QueryParameter(
    name="token_state",
    style=api_client.ParameterStyle.FORM,
    schema=TokenStateSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_digital_wallet_tokens_oapg(
        self,
...
class ListDigitalWalletTokens(BaseApi):
    ...
    def list_digital_wallet_tokens(
        ...
        return self._list_digital_wallet_tokens_oapg(
