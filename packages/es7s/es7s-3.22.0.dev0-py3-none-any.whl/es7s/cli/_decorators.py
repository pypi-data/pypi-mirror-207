...
def _with_progress_bar(func: F) -> F:
    def wrapper(*args, **kwargs):
        ...
        try:
            func(pbar, *args, **kwargs)   # pbar MUST be present in decorated constructor args
        finally:
            pbar.close()
        return func
...
def _preserve_terminal_state(func: F) -> F:
    def wrapper(*args, **kwargs):
        ...
        try:
            func(tstatectl=tstatectl, *args, **kwargs)  # tstatectl CAN be present in decorated constructor args
        finally:
