...
class MigrationLoader:
    ...
    inherit from skailar.db.migrations.Migration. See
    skailar.db.migrations.migration for what that looks like.
            ...
            if exc.node in reverse_replacements:
                ...
                if not is_replaced:
                    ...
                    raise NodeNotFoundError(
                        ...
                        "Skailar tried to replace migration {1}.{2} with any of [{3}] "
