...
from pyrosex.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyrosex.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyrosex.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("pyrosexbot")
                print(results)
        """
