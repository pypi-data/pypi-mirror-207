...
__all__ = [
    ...
    'get_firewall_consolidated_policy_output',
]
...
@_utilities.lift_output_func(get_firewall_consolidated_policy)
def get_firewall_consolidated_policy_output(policyid: Optional[pulumi.Input[int]] = None,
