...
class SeleniumTests(AdminSeleniumTestCase):
    ...
    def setUp(self):
        ...
        self.selenium.execute_script(
            "localStorage.removeItem('skailar.admin.navSidebarIsOpen')"
        )
    ...
    def test_sidebar_state_persists(self):
        ...
        self.assertIsNone(
            self.selenium.execute_script(
                "return localStorage.getItem('skailar.admin.navSidebarIsOpen')"
            )
        )
        toggle_button = self.selenium.find_element(
            By.CSS_SELECTOR, "#toggle-nav-sidebar"
    ...
    def test_sidebar_filter_persists(self):
        ...
        filter_value_script = (
            "return sessionStorage.getItem('skailar.admin.navSidebarFilterValue')"
        )
