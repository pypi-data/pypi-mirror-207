__all__ = ['Undefined', 'ModelMap', 'ContextVarMap', 'ModelDataMap', 'GenericType', 'EMPTY_TAGS', 'FORM_FIELDS', 'TAGS',
           'INPUT_TYPES', 'Number', 'YEAR_PATTERN', 'DAY_PATTERN', 'MONTH_PATTERN', 'ISO_DATE_PATTERN',
           'ISO_DATETIME_PATTERN', 'LiteralFormField', 'LiteralInputType', 'BRAZIL_STATES_PATTERN', 'BRAZIL_STATES'
           ]
...
ContextVarMap = ChainMap()

ModelDataMap = ChainMap()
...
LiteralFormField = Literal['input', 'select', 'textarea']

TAGS: list[str] = ['a', 'address', 'area', 'abbr', 'article', 'aside', 'audio', 'body',
...
INPUT_TYPES: list[str] = ['button', 'checkbox', 'color', 'date', 'datetime-local', 'email', 'file', 'hidden', 'image',
                          'month', 'number', 'password', 'radio', 'range', 'reset', 'search', 'submit', 'tel', 'text',
                          'time', 'url', 'week']

LiteralInputType = Literal['button', 'checkbox', 'color', 'date', 'datetime-local', 'email', 'file', 'hidden', 'image',
                          'month', 'number', 'password', 'radio', 'range', 'reset', 'search', 'submit', 'tel', 'text',
                          'time', 'url', 'week']
...
BRAZIL_STATES = {"AC", "AL", "AP", "AM", "BA", "CE", "DF", "GO", "ES", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE",
                 "PI", "RJ", "RN", "RS", "RO", "RR", "SP", "SC", "SE", "TO"}

BRAZIL_STATES_PATTERN = re.compile(r'{}'.format('|'.join(BRAZIL_STATES)))

if __name__ == '__main__':
    print(BRAZIL_STATES_PATTERN.pattern)