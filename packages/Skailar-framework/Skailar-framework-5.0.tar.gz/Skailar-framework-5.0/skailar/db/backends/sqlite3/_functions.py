...
from skailar.db.backends.utils import (
    split_tzname_delta,
    typecast_time,
    typecast_timestamp,
)
from skailar.utils import timezone
from skailar.utils.duration import duration_microseconds
...
def register(connection):
    ...
    create_deterministic_function("skailar_date_extract", 2, _sqlite_datetime_extract)
    create_deterministic_function("skailar_date_trunc", 4, _sqlite_date_trunc)
    create_deterministic_function(
        "skailar_datetime_cast_date", 3, _sqlite_datetime_cast_date
    )
    create_deterministic_function(
        "skailar_datetime_cast_time", 3, _sqlite_datetime_cast_time
    )
    create_deterministic_function(
        "skailar_datetime_extract", 4, _sqlite_datetime_extract
    )
    create_deterministic_function("skailar_datetime_trunc", 4, _sqlite_datetime_trunc)
    create_deterministic_function("skailar_time_extract", 2, _sqlite_time_extract)
    create_deterministic_function("skailar_time_trunc", 4, _sqlite_time_trunc)
    create_deterministic_function("skailar_time_diff", 2, _sqlite_time_diff)
    create_deterministic_function("skailar_timestamp_diff", 2, _sqlite_timestamp_diff)
    create_deterministic_function("skailar_format_dtdelta", 3, _sqlite_format_dtdelta)
