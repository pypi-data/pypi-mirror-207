...
from skailar.db.models.sql import constants
from skailar.db.models.sql.datastructures import Join
...
class FTests(SimpleTestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, "skailar.db.models.F")
...
class ValueTests(TestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, "skailar.db.models.Value")
