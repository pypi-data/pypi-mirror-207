...
class SavedRingtones:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.SavedRingtones <pyrosex.raw.types.account.SavedRingtones>`
            - :obj:`account.SavedRingtonesNotModified <pyrosex.raw.types.account.SavedRingtonesNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetSavedRingtones <pyrosex.raw.functions.account.GetSavedRingtones>`
    """

    QUALNAME = "pyrosex.raw.base.account.SavedRingtones"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/saved-ringtones")
