...
class MPU6050(object):
    ...
    def i2c_write_byte(self, addr, value):
        value = bytearray([addr, value])
        self._i2cDev.writeto(MPU_DEV_ID, value)

    def i2c_read_byte(self, addr):
        Reg = bytearray([addr])
        self._i2cDev.writeto(MPU_DEV_ID, Reg)
        tmp = bytearray(self._i2cDev.readfrom(MPU_DEV_ID, 1))
        return tmp[0]
    ...
    def i2c_read_len(self, addr, len):
        ...
        self._i2cDev.writeto(MPU_DEV_ID, reg)
        sleep_ms(20)
        return bytearray(self._i2cDev.readfrom(MPU_DEV_ID, len))
    ...
    # 设置MPU6050的误差
    def setOffset(self, gx_offset=None, gy_offset=None, gz_offset=None, ax_offset=None, ay_offset=None, az_offset=None):
        self._gx_offset = gx_offset or self._gx_offset
        self._gy_offset = gy_offset or self._gy_offset
        self._gz_offset = gz_offset or self._gz_offset
        self._ax_offset = ax_offset or self._ax_offset
        self._ay_offset = ay_offset or self._ay_offset
        self._az_offset = az_offset or self._az_offset
    ...
    def getGyroscope(self):
        ...
        return gx + self._gx_offset, gy + self._gy_offset, gz + self._gz_offset
    ...
    def getAcceleration(self):
        ...
        return ax + self._ax_offset, ay + self._ay_offset, az + self._az_offset
