...
__all__ = [
    ...
    'get_system_ipv6_tunnel_list_output',
]
...
@_utilities.lift_output_func(get_system_ipv6_tunnel_list)
def get_system_ipv6_tunnel_list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
