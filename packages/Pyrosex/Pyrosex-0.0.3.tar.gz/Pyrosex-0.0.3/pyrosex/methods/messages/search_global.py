...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyrosex.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyrosex.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrosex.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyrosex". Get the first 50 results
                async for message in app.search_global("pyrosex", limit=50):
                    print(message.text)
