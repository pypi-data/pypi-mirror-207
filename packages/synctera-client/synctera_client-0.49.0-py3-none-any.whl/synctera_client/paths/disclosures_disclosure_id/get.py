...
# Path params
DisclosureIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'disclosure_id': typing.Union[DisclosureIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_disclosure_id = api_client.PathParameter(
    name="disclosure_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DisclosureIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = Disclosure
...
class GetDisclosure(BaseApi):
    ...
    def get_disclosure(
        ...
        return self._get_disclosure_oapg(
