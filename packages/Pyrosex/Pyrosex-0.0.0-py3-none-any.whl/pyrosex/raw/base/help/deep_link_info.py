...
class DeepLinkInfo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.DeepLinkInfo <pyrosex.raw.types.help.DeepLinkInfo>`
            - :obj:`help.DeepLinkInfoEmpty <pyrosex.raw.types.help.DeepLinkInfoEmpty>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetDeepLinkInfo <pyrosex.raw.functions.help.GetDeepLinkInfo>`
    """

    QUALNAME = "pyrosex.raw.base.help.DeepLinkInfo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/deep-link-info")
