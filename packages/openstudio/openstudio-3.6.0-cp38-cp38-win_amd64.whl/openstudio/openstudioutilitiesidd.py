...
class IddKey(object):
    ...
    @staticmethod
    def load(name: "std::string const &", text: "std::string const &") -> "boost::optional< openstudio::IddKey >":
...
class IddField(object):
    ...
    @staticmethod
    def load(name: "std::string const &", text: "std::string const &", objectName: "std::string const &") -> "boost::optional< openstudio::IddField >":
...
class IddObject(object):
    ...
    @staticmethod
    def load(*args) -> "boost::optional< openstudio::IddObject >":
...
class IddFile(object):
    ...
    @staticmethod
    def catchallIddFile() -> "openstudio::IddFile":
    ...
    @staticmethod
    def load(*args) -> "boost::optional< openstudio::IddFile >":
    ...
    @staticmethod
    def parseVersionBuild(p: "path") -> "std::pair< openstudio::VersionString,std::string >":
