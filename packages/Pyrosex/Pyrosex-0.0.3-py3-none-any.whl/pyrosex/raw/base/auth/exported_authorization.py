...
class ExportedAuthorization:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`auth.ExportedAuthorization <pyrosex.raw.types.auth.ExportedAuthorization>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.ExportAuthorization <pyrosex.raw.functions.auth.ExportAuthorization>`
    """

    QUALNAME = "pyrosex.raw.base.auth.ExportedAuthorization"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-authorization")
