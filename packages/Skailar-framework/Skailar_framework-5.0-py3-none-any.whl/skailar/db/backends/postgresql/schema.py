...
from skailar.db.backends.ddl_references import IndexColumns
...
class DatabaseSchemaEditor(BaseDatabaseSchemaEditor):
    ...
    def _alter_column_type_sql(
        ...
        if new_is_auto and not old_is_auto:
            ...
            # Drop IDENTITY if exists (pre-Skailar 4.1 serial columns don't have
            # it).
            self.execute(
            ...
            # Drop the sequence if exists (Skailar 4.1+ identity columns don't
            # have it).
            other_actions = []
            ...
            # Alter the sequence type if exists (Skailar 4.1+ identity columns
            # don't have it).
            other_actions = []
            if sequence_name := self._get_sequence_name(table, column):
                other_actions = [
