...
class ComparisonObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'variable': (SpaceObject,),  # noqa: E501
            'comparison': (SpaceObject,),  # noqa: E501
            'data': ([FluxData],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, variable, comparison, data, *args, **kwargs):  # noqa: E501
        """ComparisonObject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, variable, comparison, data, *args, **kwargs):  # noqa: E501
        """ComparisonObject - a model defined in OpenAPI
