...
class ChannelParticipantBanned(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.ChannelParticipant`.
    ...
    Parameters:
        ...
        date: ``int`` ``32-bit``
        banned_rights: :obj:`ChatBannedRights <pyrosex.raw.base.ChatBannedRights>`
        left (optional): ``bool``
    """
