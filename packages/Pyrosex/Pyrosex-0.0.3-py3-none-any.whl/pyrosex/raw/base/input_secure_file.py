...
class InputSecureFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputSecureFile <pyrosex.raw.types.InputSecureFile>`
            - :obj:`InputSecureFileUploaded <pyrosex.raw.types.InputSecureFileUploaded>`
    """

    QUALNAME = "pyrosex.raw.base.InputSecureFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-secure-file")
