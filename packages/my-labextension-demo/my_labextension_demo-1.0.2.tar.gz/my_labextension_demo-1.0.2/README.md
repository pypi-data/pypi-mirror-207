...
```bash
pip install my_labextension_demo
```
...
```bash
pip uninstall my_labextension_demo
```
...
# Change directory to the my_labextension_demo directory
...
folder is located. Then you can remove the symlink named `my-labextension-demo` within that folder.
