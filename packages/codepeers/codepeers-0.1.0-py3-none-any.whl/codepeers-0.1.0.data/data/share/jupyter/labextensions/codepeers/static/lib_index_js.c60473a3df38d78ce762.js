...
const StreamChatCodeChannelView = ({ chatClient, chatChannel, myCode }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "column", h: "100%", align: "stretch" },
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flexGrow: 1, overflowY: 'scroll' } },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Chat, { client: chatClient, theme: "str-chat__theme-light", customClasses: {
                    chat: _emotion_css__WEBPACK_IMPORTED_MODULE_0__.css `
              height: 100%;
              .str-chat__send-button {
                display: block !important;
            ...
            `
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Channel, { channel: chatChannel, Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__.CodeMessage, ThreadStart: VoidComponent, ThreadHeader: _components_customized_chat__WEBPACK_IMPORTED_MODULE_11__.SimpleReturnThreadHeader },
                    react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Window, null,
                        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "row", align: "center", justify: "space-between", p: "md" },
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Text, null,
                                "Total Code Submissions: ",
                                sortedMessages.length),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Select, { label: "Sort By", value: sortKind, data: [
                        ...
                        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.MessageList, { messages: sortedMessages, disableDateSeparator: true })),
                    react__WEBPACK_IMPORTED_MODULE_3___default().createElement(WrappedThread, { Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__.ThreadMessage })))),
        !isCodeSynced && (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flexGrow: 0 } },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(SyncCodeView, { myCode: myCode, handleSubmit: handleSubmit, isUpdate: !!submittedCode })))));
};
const SyncCodeView = ({ myCode, handleSubmit, isUpdate }) => {
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Divider, null),
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "row", align: "center", justify: "space-between" },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flex: 1 } },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_components_code_block__WEBPACK_IMPORTED_MODULE_12__.PyCodeBlock, { code: myCode.code })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: handleSubmit, title: (isUpdate && 'Update') || 'Submit' },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.SendButton, { sendMessage: e => {
                        return;
                    } })))));
};
...
const PeerCodeView = ({ codeBlock }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_components_app_container__WEBPACK_IMPORTED_MODULE_17__.FramedAppContainer, null,
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(InnerView, { chatChannel: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatChannel, chatClient: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatClient, myCode: codeBlock })));
};
const VoidComponent = () => react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null);
const WrappedThread = props => (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: {
        position: 'relative',
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'stretch'
    } },
    react__WEBPACK_IMPORTED_MODULE_3___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Thread, Object.assign({}, props))));


/***/ })

}]);
//# sourceMappingURL=lib_index_js.c60473a3df38d78ce762.js.map