...
class PhoneCallDiscardReason:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PhoneCallDiscardReasonBusy <pyrosex.raw.types.PhoneCallDiscardReasonBusy>`
            - :obj:`PhoneCallDiscardReasonDisconnect <pyrosex.raw.types.PhoneCallDiscardReasonDisconnect>`
            - :obj:`PhoneCallDiscardReasonHangup <pyrosex.raw.types.PhoneCallDiscardReasonHangup>`
            - :obj:`PhoneCallDiscardReasonMissed <pyrosex.raw.types.PhoneCallDiscardReasonMissed>`
    """

    QUALNAME = "pyrosex.raw.base.PhoneCallDiscardReason"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/phone-call-discard-reason")
