from skailar.contrib.gis.db.models.functions import (
    Area,
    Distance,
    Length,
    Perimeter,
...
from skailar.contrib.gis.geos import GEOSGeometry, LineString, Point
from skailar.contrib.gis.measure import D  # alias for Distance
...
class DistanceTest(TestCase):
    ...
    def test_geodetic_distance_lookups(self):
        ...
        # Geodetic distance lookup but telling GeoSkailar to use `distance_spheroid`
