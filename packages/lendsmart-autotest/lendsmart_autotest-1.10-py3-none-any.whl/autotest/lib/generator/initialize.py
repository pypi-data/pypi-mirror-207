...
class FlowGeneratorInitializer:
    ...
    def get_generated_actions(
        self, test_case_data, rand_combinations: list[list], all_questions, all_combos : list
    ):
        """
            ...
            res.append(
                {
                    "test_data": {
                        ...
                        "product_name" : path_or("", ["product_name"], self.__event_data),
