...
def check_args_post_argparse(context: CertoraContext) -> None:
    ...
    print(f"default_jar_path - {default_jar_path}")
    print(f"context.server - {getattr(context, 'server', '<not exists>')}")
    print(f"is_new_api - {Util.is_new_api()}")
    print(f"context.staging - {Util.is_new_api()}")
    print(f"context.staging - {getattr(context, 'staging', '<not exists>')}")
    print(f"context.cloud - {getattr(context, 'cloud', '<not exists>')}")
