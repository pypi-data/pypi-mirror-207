...
class SecureRequiredTypeOneOf(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.SecureRequiredType`.
    ...
    Parameters:
        types: List of :obj:`SecureRequiredType <pyrosex.raw.base.SecureRequiredType>`
    """
