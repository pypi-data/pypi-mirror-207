...
# Our modules
import vespa.analysis.functors.funct_fidsum_wbnaa as funct_fidsum_megalaser
from vespa.analysis.chain_base import Chain



class ChainPrepMegalaser(Chain):
    """ 
    ...
    def run(self, voxels, entry='all', do_calculate=False):
        ...
        if entry == 'all':
            funct_fidsum_megalaser.do_processing_all(self)
        else:
            print('oooops!')
