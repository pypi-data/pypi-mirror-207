...
class PasswordRecovery:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`auth.PasswordRecovery <pyrosex.raw.types.auth.PasswordRecovery>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.RequestPasswordRecovery <pyrosex.raw.functions.auth.RequestPasswordRecovery>`
    """

    QUALNAME = "pyrosex.raw.base.auth.PasswordRecovery"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/password-recovery")
