...
class Command(BaseCommand):
    help = (
        ...
        "outputs\na GeoSkailar model with the given model name. For example:\n"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_false",
            dest="imports",
            help="Do not include `from skailar.contrib.gis.db import models` statement.",
        )
        parser.add_argument(
            "--null",
            action=ListOptionAction,
    ...
    def handle(self, *args, **options):
        ...
        # and options.
        from skailar.contrib.gis.utils.ogrinspect import _ogrinspect, mapping
