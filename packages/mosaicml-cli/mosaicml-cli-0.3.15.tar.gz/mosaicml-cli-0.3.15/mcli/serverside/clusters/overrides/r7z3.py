...
R7Z3_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R7Z3Cluster(GenericK8sCluster):
    """ R7Z3 Cluster Overrides """

    allowed_instances: Instances = R7Z3_INSTANCES
