...
class MsgResendReq:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MsgResendAnsReq <pyrosex.raw.types.MsgResendAnsReq>`
            - :obj:`MsgResendReq <pyrosex.raw.types.MsgResendReq>`
    """

    QUALNAME = "pyrosex.raw.base.MsgResendReq"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/msg-resend-req")
