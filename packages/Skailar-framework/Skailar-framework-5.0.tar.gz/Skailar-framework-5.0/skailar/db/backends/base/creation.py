...
class BaseDatabaseCreation:
    ...
    def create_test_db(
        ...
        """
        # Don't import skailar.core.management if it isn't needed.
        ...
        if os.environ.get("RUNNING_SKAILARS_TEST_SUITE") == "true":
    ...
    def mark_expected_failures_and_skips(self):
        """
        Mark tests in Skailar's test suite which are expected failures on this
        database and test which should be skipped on this database.
        """
        # Only load unittest if we're actually testing.
        from unittest import expectedFailure, skip

        for test_name in self.connection.features.skailar_test_expected_failures:
        ...
        for reason, tests in self.connection.features.skailar_test_skips.items():
    ...
    def setup_worker_connection(self, _worker_id):
        ...
        # reflected in skailar.db.connections. If the following line assigned
