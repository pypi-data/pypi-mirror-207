...
class PaymentRequestedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.PaymentRequestedInfo`.
    ...
    Parameters:
        ...
        phone (optional): ``str``
        email (optional): ``str``
        shipping_address (optional): :obj:`PostAddress <pyrosex.raw.base.PostAddress>`
    """
