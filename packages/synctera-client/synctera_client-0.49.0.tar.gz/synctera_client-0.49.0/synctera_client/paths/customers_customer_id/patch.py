...
# body param
SchemaForRequestBodyApplicationJson = PatchCustomer


request_body_patch_customer = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_customer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_customer.serialize(body, content_type)
