...
class Action(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["action", b"action", "build_deploy", b"build_deploy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "build_deploy", b"build_deploy"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["action", b"action"]) -> typing_extensions.Literal["build_deploy"] | None: ...
...
class Resources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "resource", b"resource"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "resource", b"resource"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["resource", b"resource"]) -> typing_extensions.Literal["cpu_resources", "gpu_resources"] | None: ...
