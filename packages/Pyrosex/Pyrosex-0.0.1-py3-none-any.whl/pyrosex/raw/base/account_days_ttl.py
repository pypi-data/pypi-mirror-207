...
class AccountDaysTTL:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`AccountDaysTTL <pyrosex.raw.types.AccountDaysTTL>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAccountTTL <pyrosex.raw.functions.account.GetAccountTTL>`
    """

    QUALNAME = "pyrosex.raw.base.AccountDaysTTL"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/account-days-ttl")
