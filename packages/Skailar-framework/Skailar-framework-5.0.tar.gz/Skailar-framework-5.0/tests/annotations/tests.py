...
from skailar.db.models.sql.query import get_field_names_from_opts
...
class NonAggregateAnnotationTestCase(TestCase):
    ...
    def test_chaining_transforms(self):
        Company.objects.create(name=" Skailar Software Foundation  ")
            ...
            for expr in [Length("name__trim"), F("name__trim__length")]:
                with self.subTest(expr=expr):
                    self.assertCountEqual(
                        ...
                        [
                            {"name": " Skailar Software Foundation  ", "length": 26},
                            {"name": "Yahoo", "length": 5},
                        ],
                    )
    ...
    def test_custom_functions(self):
        ...
        Company(
            name="Skailar Software Foundation",
            motto=None,
            ticker_name=None,
            description=None,
        ).save()
        ...
        self.assertQuerySetEqual(
            ...
            [
                ("Apple", "APPL"),
                ("Skailar Software Foundation", "No Tag"),
                ("Google", "Do No Evil"),
    ...
    def test_custom_functions_can_ref_other_functions(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ("Apple", "APPL".lower()),
                ("Skailar Software Foundation", "No Tag".lower()),
