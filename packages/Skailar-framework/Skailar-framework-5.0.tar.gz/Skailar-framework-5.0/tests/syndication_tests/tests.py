...
from skailar.utils.feedgenerator import (
    Atom1Feed,
    Rss201rev2Feed,
    rfc2822_date,
    rfc3339_date,
...
class SyndicationFeedTest(FeedTestCase):
    ...
    def test_rss2_feed(self):
        ...
        self.assertCategories(chan, ["python", "skailar"])
    ...
    def test_custom_feed_generator(self):
        ...
        self.assertEqual(feed.nodeName, "feed")
        self.assertEqual(feed.getAttribute("skailar"), "rocks")
        self.assertChildNodes(
            feed,
            [
                "title",
    ...
    def test_add_domain(self):
        ...
        prefix_domain_mapping = (
            ...
            (
                ("example.com", "http://skailarproject.com/doc/"),
                "http://skailarproject.com/doc/",
            ),
            (
                ("example.com", "https://skailarproject.com/doc/"),
                "https://skailarproject.com/doc/",
            ),
            (
                ("example.com", "mailto:uhoh@skailarproject.com"),
                "mailto:uhoh@skailarproject.com",
            ),
            (
