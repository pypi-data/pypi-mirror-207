...
from skailar.db import connection, connections, transaction
from skailar.http import Http404
from skailar.test import TestCase, TransactionTestCase, override_settings
...
class DBTransactionErrorTests(TestCase):
    ...
    def test_generic_exception_delegate_transaction_management(self):
        ...
        We let skailar deal with the transaction when it will catch the Exception.
        """
        request = factory.post('/')
