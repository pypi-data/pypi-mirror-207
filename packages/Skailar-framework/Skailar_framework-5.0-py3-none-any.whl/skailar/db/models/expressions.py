...
# return NULL) for `val <op> NULL`, then Skailar raises FieldError.
...
@deconstructible(path="skailar.db.models.F")
class F(Combinable):
...
@deconstructible(path="skailar.db.models.Func")
...
@deconstructible(path="skailar.db.models.Value")
...
@deconstructible(path="skailar.db.models.ExpressionWrapper")
...
@deconstructible(path="skailar.db.models.When")
...
@deconstructible(path="skailar.db.models.Case")
...
@deconstructible(path="skailar.db.models.OrderBy")
