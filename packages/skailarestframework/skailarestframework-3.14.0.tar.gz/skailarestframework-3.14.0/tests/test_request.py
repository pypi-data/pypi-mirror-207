...
import pytest
from skailar.contrib.auth import authenticate, login, logout
...
from skailar.http.request import RawPostDataException
...
class TestInitializer(TestCase):
    def test_request_type(self):
        ...
        message = (
            ...
            '`skailar.http.HttpRequest`, not `rest_framework.request.Request`.'
        )
...
@override_settings(
    ...
    FILE_UPLOAD_HANDLERS=['skailar.core.files.uploadhandler.TemporaryFileUploadHandler'])
...
class TestUserSetter(TestCase):
    ...
    def test_calling_user_fails_when_attribute_error_is_raised(self):
        ...
        # The middleware processes the underlying Skailar request, sets anonymous user
...
class TestHttpRequest(TestCase):
    ...
    def test_duplicate_request_form_data_access(self):
        """
        Form data is copied to the underlying skailar request for middleware
