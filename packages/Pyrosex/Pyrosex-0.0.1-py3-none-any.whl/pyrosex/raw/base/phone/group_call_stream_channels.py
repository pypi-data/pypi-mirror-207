...
class GroupCallStreamChannels:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`phone.GroupCallStreamChannels <pyrosex.raw.types.phone.GroupCallStreamChannels>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCallStreamChannels <pyrosex.raw.functions.phone.GetGroupCallStreamChannels>`
    """

    QUALNAME = "pyrosex.raw.base.phone.GroupCallStreamChannels"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/group-call-stream-channels")
