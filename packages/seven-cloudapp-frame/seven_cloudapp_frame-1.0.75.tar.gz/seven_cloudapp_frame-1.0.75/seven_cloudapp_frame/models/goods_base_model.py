...
@LastEditTime: 2023-05-05 13:58:31
...
class GoodsBaseModel():
    ...
    def get_special_goods_list_for_top(self, app_id, goods_id, access_token, app_key, app_secret, is_log=False, page_index=0, page_size=20):
        """
