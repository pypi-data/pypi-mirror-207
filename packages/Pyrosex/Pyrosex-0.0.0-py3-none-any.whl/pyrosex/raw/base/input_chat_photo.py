...
class InputChatPhoto:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputChatPhoto <pyrosex.raw.types.InputChatPhoto>`
            - :obj:`InputChatPhotoEmpty <pyrosex.raw.types.InputChatPhotoEmpty>`
            - :obj:`InputChatUploadedPhoto <pyrosex.raw.types.InputChatUploadedPhoto>`
    """

    QUALNAME = "pyrosex.raw.base.InputChatPhoto"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-chat-photo")
