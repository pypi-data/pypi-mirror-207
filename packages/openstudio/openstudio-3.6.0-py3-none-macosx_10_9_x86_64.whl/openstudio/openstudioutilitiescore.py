...
def getSharedModuleSuffix() -> "std::string_view":
    return _openstudioutilitiescore.getSharedModuleSuffix()

def getSharedModulePrefix() -> "std::string_view":
    return _openstudioutilitiescore.getSharedModulePrefix()

def getSharedModuleName(basename: "std::string_view") -> "std::string":
...
class UnzipFile(object):
    ...
    def chunksize(self) -> "unsigned long":
        return _openstudioutilitiescore.UnzipFile_chunksize(self)

    def setChunksize(self, chunksize: "unsigned long") -> "void":
