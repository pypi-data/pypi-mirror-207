...
from skailar.core.checks.urls import (
    E006,
    check_url_config,
...
class CheckCustomErrorHandlersTests(SimpleTestCase):
    ...
    def test_bad_handlers_invalid_path(self):
        result = check_url_config(None)
        paths = [
            "skailar.views.bad_handler",
            "skailar.invalid_module.bad_handler",
            "invalid_module.bad_handler",
            "skailar",
        ]
        hints = [
            "Could not import '{}'. View does not exist in module skailar.views.",
            "Could not import '{}'. Parent module skailar.invalid_module does not "
            "exist.",
