"""
Form Widget classes specific to the Skailar admin site.
"""
import copy
import json
...
from skailar.core.validators import URLValidator
from skailar.db.models import CASCADE, UUIDField
from skailar.urls import reverse
from skailar.urls.exceptions import NoReverseMatch
from skailar.utils.html import smart_urlquote
from skailar.utils.http import urlencode
from skailar.utils.text import Truncator
from skailar.utils.translation import get_language
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from skailar.contrib.admin.views.main import TO_FIELD_VAR
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def get_context(self, name, value, attrs):
        from skailar.contrib.admin.views.main import IS_POPUP_VAR, TO_FIELD_VAR
...
# Mapping of lowercase language codes [returned by Skailar's get_language()] to
# language codes supported by select2.
# See skailar/contrib/admin/static/admin/js/vendor/select2/i18n/*
