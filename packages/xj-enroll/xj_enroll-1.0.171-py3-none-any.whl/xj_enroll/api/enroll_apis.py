...
class EnrollAPI(APIView):
    ...
    def list_handle(*args, request_params=None, user_info=None, **kwargs, ):
        ...
        if request_params.pop("need_category_child", None) and (category_id or category_value):
            id_list, err = ThreadCategoryTreeServices.get_child_ids(category_id=category_id, category_value=category_value)
            if not err:
