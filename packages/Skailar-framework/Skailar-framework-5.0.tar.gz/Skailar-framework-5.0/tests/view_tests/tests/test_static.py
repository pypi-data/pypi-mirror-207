...
from skailar.conf.urls.static import static
from skailar.core.exceptions import ImproperlyConfigured
from skailar.http import FileResponse, HttpResponseNotModified
from skailar.test import SimpleTestCase, override_settings
from skailar.utils.http import http_date
from skailar.views.static import directory_index, was_modified_since
...
class StaticTests(SimpleTestCase):
    """Tests skailar views in skailar/views/static.py"""
    ...
    def test_not_modified_since(self):
        ...
        response = self.client.get(
            "/%s/%s" % (self.prefix, file_name),
            headers={
                # This is 24h before max Unix time. Remember to fix Skailar and
    ...
    def test_template_encoding(self):
        ...
        engines.
        """
        from skailar.views.static import Path
