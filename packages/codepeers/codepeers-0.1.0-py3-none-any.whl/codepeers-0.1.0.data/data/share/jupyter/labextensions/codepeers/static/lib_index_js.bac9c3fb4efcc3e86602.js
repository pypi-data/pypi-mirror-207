...
/* harmony import */ var _views_ask_help__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/ask-help */ "./lib/views/ask-help.js");
...
const makeAskHelpElement = (panel) => {
    ...
    const frameElement = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_ask_help__WEBPACK_IMPORTED_MODULE_2__.AskHelpView, {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../utils */ "./lib/utils/props.js");
/* harmony import */ var _code_block__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../code-block */ "./lib/components/code-block.js");
/* harmony import */ var _reactive_popover__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../reactive-popover */ "./lib/components/reactive-popover.js");
...
const CodeMessageWithCongtext = (props) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_6___default().createElement("div", { className: (0,clsx__WEBPACK_IMPORTED_MODULE_5__["default"])('str-chat__message', 'str-chat__message-team', 'str-chat__message-team--single', {
            ...
            'str-chat__message--has-attachment': !!((_d = message.attachments) === null || _d === void 0 ? void 0 : _d.length),
        ...
        react__WEBPACK_IMPORTED_MODULE_6___default().createElement("div", { className: "str-chat__message-team-group" },
            react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_4__.Flex, { direction: "row", align: "center", justify: "right", mb: "xs" },
                react__WEBPACK_IMPORTED_MODULE_6___default().createElement("div", { className: "str-chat__message-team-meta" },
                    react__WEBPACK_IMPORTED_MODULE_6___default().createElement("div", { className: "str-chat__message-team-author", onClick: onUserClick },
                        react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_4__.Text, { weight: "bold" }, ((_e = message.user) === null || _e === void 0 ? void 0 : _e.name) || ((_f = message.user) === null || _f === void 0 ? void 0 : _f.id)),
                ...
                message.text && (react__WEBPACK_IMPORTED_MODULE_6___default().createElement("div", { className: (0,clsx__WEBPACK_IMPORTED_MODULE_5__["default"])('str-chat__message-team-text', {
                    ...
                    !initialMessage && isMessageReactionEnabled(message) && (react__WEBPACK_IMPORTED_MODULE_6___default().createElement(ReactionGroup, { gap: "md" },
                        react__WEBPACK_IMPORTED_MODULE_6___default().createElement("span", { onClick: e => {
                            ...
                            react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_reactive_popover__WEBPACK_IMPORTED_MODULE_8__.ReactivePopover, { popoverText: "Copied!", popoverTimeout: 1000 },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_6___default().createElement("span", { onClick: handleOpenThread, title: replyCount > 0 ? 'Show Replies' : 'Start a Thread' },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_4__.Box, { style: { borderRadius: '20px', overflow: 'hidden' } },
                        react__WEBPACK_IMPORTED_MODULE_6___default().createElement(_code_block__WEBPACK_IMPORTED_MODULE_9__.PyCodeBlock, { code: message.text })))),
...
const isMessageReactionEnabled = (message) => message.status !== 'sending' &&
    ...
    message.type !== 'error';
const ReactionGroup = (0,_utils__WEBPACK_IMPORTED_MODULE_10__.withDefaultProps)(_emotion_styled__WEBPACK_IMPORTED_MODULE_0___default()(_mantine_core__WEBPACK_IMPORTED_MODULE_4__.Flex, { shouldForwardProp: () => true }) `
    position: absolute;
    top: 8px;
    right: 8px;
    height: 36px;
...
const ReactionAuxText = (0,_utils__WEBPACK_IMPORTED_MODULE_10__.withDefaultProps)(_mantine_core__WEBPACK_IMPORTED_MODULE_4__.Text, {
    size: 'sm',
    weight: 'bold',
    ml: '2px'
});
const ReactionIcon = (0,_utils__WEBPACK_IMPORTED_MODULE_10__.withDefaultProps)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_3__.FontAwesomeIcon, {
    size: 'lg'
});
...
const SimpleReturnThreadHeader = (props) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(ClickableBox, { onClick: closeThread, title: "Close Thread", style: { position: 'absolute', top: '0px', left: '0px', zIndex: 10000 } },
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, { icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_1__.faArrowLeft })));
};
...
const GETSTREAM_API_KEY = 'kvd6dftk577c';
...
/* harmony import */ var _chat_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chat-notifications */ "./lib/hooks/chat-notifications.js");
...
const useChatCompletion = (prompt) => {
    ...
    (0,_chat_notifications__WEBPACK_IMPORTED_MODULE_3__.useDynamicCompletionNotification)(prompt, result);
...
/***/ "./lib/hooks/chat-notifications.js":
/*!*****************************************!*\
  !*** ./lib/hooks/chat-notifications.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useDynamicCompletionNotification": () => (/* binding */ useDynamicCompletionNotification)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _mantine_notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mantine/notifications */ "webpack/sharing/consume/default/@mantine/notifications/@mantine/notifications");
...
const NotificationBody = ({ prompt, response }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Stack, { spacing: "sm" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Text, null,
            "\uD83D\uDE03: ",
            `${prompt.slice(0, 30)}...${prompt.slice(-10)}`),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Text, null,
            "\uD83E\uDD16: ",
            response)));
};
const useDynamicCompletionNotification = (prompt, currentResult) => {
    const userPrompt = typeof prompt === 'string' ? prompt : prompt.userPrompt;
    const notificationShowed = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
    const updateNotification = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((props) => {
        if (notificationShowed.current) {
            return _mantine_notifications__WEBPACK_IMPORTED_MODULE_1__.notifications.update(props);
        }
        notificationShowed.current = true;
        return _mantine_notifications__WEBPACK_IMPORTED_MODULE_1__.notifications.show(props);
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        const notificationId = stringHash(userPrompt).toString();
        if (currentResult) {
            updateNotification({
                title: 'Chatbot response',
                message: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NotificationBody, { prompt: userPrompt, response: currentResult })),
                id: notificationId,
                autoClose: false
            });
        }
        return () => {
            setTimeout(() => {
                _mantine_notifications__WEBPACK_IMPORTED_MODULE_1__.notifications.hide(notificationId);
            }, 20 * 1000);
        };
    }, [JSON.stringify(userPrompt), currentResult]);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AskHelpView": () => (/* binding */ AskHelpView)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @emotion/css */ "webpack/sharing/consume/default/@emotion/css/@emotion/css");
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_emotion_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _mantine_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mantine/core */ "webpack/sharing/consume/default/@mantine/core/@mantine/core?2426");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react_async__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-async */ "webpack/sharing/consume/default/react-async/react-async");
...
/* harmony import */ var stream_chat_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! stream-chat-react */ "webpack/sharing/consume/default/stream-chat-react/stream-chat-react");
/* harmony import */ var stream_chat_react__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var stream_chat_react_dist_css_index_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! stream-chat-react/dist/css/index.css */ "./node_modules/stream-chat-react/dist/css/index.css");
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tiny-invariant */ "webpack/sharing/consume/default/tiny-invariant/tiny-invariant");
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(tiny_invariant__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_app_container__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../components/app-container */ "./lib/components/app-container.js");
/* harmony import */ var _components_base__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/base */ "./lib/components/base.js");
/* harmony import */ var _components_code_block__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/code-block */ "./lib/components/code-block.js");
/* harmony import */ var _components_customized_chat__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/customized-chat/code-message */ "./lib/components/customized-chat/code-message.js");
/* harmony import */ var _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/customized-chat */ "./lib/components/customized-chat/thread-header.js");
/* harmony import */ var _hocs_check_props__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../hocs/check-props */ "./lib/hocs/check-props.js");
/* harmony import */ var _hocs_refresh_chat__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../hocs/refresh-chat */ "./lib/hocs/refresh-chat.js");
/* harmony import */ var _hooks_ai_sort__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../hooks/ai-sort */ "./lib/hooks/ai-sort.js");
/* harmony import */ var _hooks_stream_chat__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../hooks/stream-chat */ "./lib/hooks/stream-chat.js");
/* harmony import */ var _hooks_user_data__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../hooks/user-data */ "./lib/hooks/user-data.js");
...
const StreamChatCodeChannelView = ({ chatClient, chatChannel, myCode }) => {
    const [sortKind, setSortKind] = react__WEBPACK_IMPORTED_MODULE_2___default().useState('likes');
    const messages = chatChannel.state.messages.filter(m => !m.deleted_at);
    const submittedCodeList = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => (0,_utils__WEBPACK_IMPORTED_MODULE_7__.filterMap)(messages, ({ text, codeMetadata, id }) => {
        var _a;
    ...
    const { sortedIndex: complexitySortedIndex, isLoading: isComplexitySortLoading } = (0,_hooks_ai_sort__WEBPACK_IMPORTED_MODULE_8__.useComlexitySort)(submittedCodeList);
    const { sortedIndex: similaritySortedIndex, isLoading: isSimilaritySortLoading } = (0,_hooks_ai_sort__WEBPACK_IMPORTED_MODULE_8__.useSimilaritySort)(myCode.code, submittedCodeList);
    const sortedMessages = (() => {
        switch (sortKind) {
            case 'likes':
                return messages.sort((ma, mb) => { var _a, _b, _c, _d; return (_b = (_a = mb.reaction_counts) === null || _a === void 0 ? void 0 : _a.like) !== null && _b !== void 0 ? _b : 0 - ((_d = (_c = ma.reaction_counts) === null || _c === void 0 ? void 0 : _c.like) !== null && _d !== void 0 ? _d : 0); });
            case 'comments':
                return messages.sort((ma, mb) => { var _a, _b; return (_a = mb.reply_count) !== null && _a !== void 0 ? _a : 0 - ((_b = ma.reply_count) !== null && _b !== void 0 ? _b : 0); });
            case 'similarity':
                tiny_invariant__WEBPACK_IMPORTED_MODULE_6___default()(!!similaritySortedIndex);
                return similaritySortedIndex.map(i => messages[i]);
            case 'complexity':
                tiny_invariant__WEBPACK_IMPORTED_MODULE_6___default()(!!complexitySortedIndex);
    ...
    const { run: handleSubmit } = (0,react_async__WEBPACK_IMPORTED_MODULE_3__.useAsync)({
        deferFn: (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(() => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Flex, { direction: "column", h: "100%", align: "stretch" },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Box, { style: { flexGrow: 1, overflowY: 'scroll' } },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.Chat, { client: chatClient, theme: "str-chat__theme-light", customClasses: {
                    chat: _emotion_css__WEBPACK_IMPORTED_MODULE_0__.css `
              height: 100%;
              .str-chat__send-button {
                display: block !important;
            ...
            `
                ...
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.Channel, { channel: chatChannel, Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_9__.CodeMessage, ThreadStart: VoidComponent, ThreadHeader: _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__.SimpleReturnThreadHeader },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.Window, null,
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Flex, { direction: "row", align: "center", justify: "space-between", p: "md" },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Text, null,
                                "Total Code Submissions: ",
                                sortedMessages.length),
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Select, { label: "Sort By", value: sortKind, data: [
                        ...
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.MessageList, { messages: sortedMessages, disableDateSeparator: true })),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(WrappedThread, { Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_9__.ThreadMessage })))),
        !isCodeSynced && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Box, { style: { flexGrow: 0 } },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(SyncCodeView, { myCode: myCode, handleSubmit: handleSubmit, isUpdate: !!submittedCode })))));
};
const SyncCodeView = ({ myCode, handleSubmit, isUpdate }) => {
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Divider, null),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Flex, { direction: "row", align: "center", justify: "space-between" },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mantine_core__WEBPACK_IMPORTED_MODULE_1__.Box, { style: { flex: 1 } },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_components_code_block__WEBPACK_IMPORTED_MODULE_11__.PyCodeBlock, { code: myCode.code })),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_components_base__WEBPACK_IMPORTED_MODULE_12__.ClearButton, { onClick: handleSubmit, title: (isUpdate && 'Update') || 'Submit', style: { color: '#006cff' } },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.SendIconV2, null)))));
};
const InnerView = (0,_hocs_check_props__WEBPACK_IMPORTED_MODULE_13__.withPropsCheckDefined)((0,_hocs_refresh_chat__WEBPACK_IMPORTED_MODULE_14__.withChannelAutoRefresh)(StreamChatCodeChannelView));
const PeerCodeView = ({ codeBlock }) => {
    const { topic_id: topicId, user_id: userId, user_name: userName } = codeBlock;
    const credentials = (0,_hooks_user_data__WEBPACK_IMPORTED_MODULE_15__.useChatUserCredentials)({ userId, userName });
    const chatResources = (0,_hooks_stream_chat__WEBPACK_IMPORTED_MODULE_16__.useStreamChat)({
        channelId: `review-${topicId}`,
        credentials
    }).inner();
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_components_app_container__WEBPACK_IMPORTED_MODULE_17__.FramedAppContainer, null,
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(InnerView, { chatChannel: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatChannel, chatClient: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatClient, myCode: codeBlock })));
};
const VoidComponent = () => react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null);
const WrappedThread = props => (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: {
        position: 'relative',
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'stretch'
    } },
    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(stream_chat_react__WEBPACK_IMPORTED_MODULE_4__.Thread, Object.assign({}, props))));


/***/ })

}]);
//# sourceMappingURL=lib_index_js.bac9c3fb4efcc3e86602.js.map