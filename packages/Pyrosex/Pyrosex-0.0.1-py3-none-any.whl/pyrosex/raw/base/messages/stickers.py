...
class Stickers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.Stickers <pyrosex.raw.types.messages.Stickers>`
            - :obj:`messages.StickersNotModified <pyrosex.raw.types.messages.StickersNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetStickers <pyrosex.raw.functions.messages.GetStickers>`
    """

    QUALNAME = "pyrosex.raw.base.messages.Stickers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/stickers")
