...
# body param
SchemaForRequestBodyApplicationJson = PatchDocument


request_body_patch_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_document_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_document.serialize(body, content_type)
...
class UpdateDocument(BaseApi):
    ...
    def update_document(
        ...
        return self._update_document_oapg(
            body=body,
