...
def pack_islands(override_context: typing.
                 ...
                 *,
                 ...
                 pin_method: typing.Optional[typing.Any] = 'NORMAL',
    ...
    :param pin_method: Pinned Islands * ``NORMAL`` Normal -- Pin information is not used. * ``IGNORED`` Ignored -- Pinned islands are not packed. * ``SCALE`` Locked scale -- Pinned islands won't rescale. * ``ROTATION`` Locked rotation -- Pinned islands won't rotate. * ``ROTATION_SCALE`` Locked rotation and scale -- Pinned islands will translate only. * ``LOCKED`` Locked position -- Pinned islands are locked in place.
