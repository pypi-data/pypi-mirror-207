...
SchemaFor200ResponseBodyApplicationJson = CardImageDetailsList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_card_image_details_oapg(
        self,
...
class ListCardImageDetails(BaseApi):
    ...
    def list_card_image_details(
        ...
        return self._list_card_image_details_oapg(
