...
from skailar.contrib.gis.geos import GEOSException, GEOSGeometry
from skailar.forms.widgets import Widget
from skailar.utils import translation
from skailar.utils.deprecation import RemovedInSkailar51Warning

logger = logging.getLogger("skailar.contrib.gis")
...
class BaseGeometryWidget(Widget):
    ...
    geom_type = "GEOMETRY"
    map_srid = 4326
    map_width = 600  # RemovedInSkailar51Warning
    map_height = 400  # RemovedInSkailar51Warning
    display_raw = False
    ...
    def get_context(self, name, value, attrs):
        ...
        context.update(
            self.build_attrs(
                ...
                {
                    "name": name,
                    "module": "geoskailar_%s" % name.replace("-", "_"),  # JS-safe
