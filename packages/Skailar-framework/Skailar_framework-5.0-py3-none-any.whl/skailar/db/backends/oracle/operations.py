...
from skailar.db import DatabaseError, NotSupportedError
from skailar.db.backends.base.operations import BaseDatabaseOperations
from skailar.db.backends.utils import split_tzname_delta, strip_quotes, truncate_name
from skailar.db.models import AutoField, Exists, ExpressionWrapper, Lookup
from skailar.db.models.expressions import RawSQL
from skailar.db.models.sql.where import WhereNode
from skailar.utils import timezone
from skailar.utils.encoding import force_bytes, force_str
...
/"""
    ...
    # https://groups.google.com/forum/#!msg/skailar-developers/zwQju7hbG78/9l934yelwfsJ
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the Skailar convention of using
    ...
    # DATE and TIMESTAMP columns, but Skailar wants to see a
        ...
        for param in returning_params:
            ...
            if value == []:
                raise DatabaseError(
                    ...
                    "https://code.skailarproject.com/ticket/28859)."
                )
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        # keys which Skailar doesn't define. Emulate the PostgreSQL behavior
    ...
    def adapt_datetimefield_value(self, value):
        ...
        If naive datetime is passed assumes that is in UTC. Normally Skailar
