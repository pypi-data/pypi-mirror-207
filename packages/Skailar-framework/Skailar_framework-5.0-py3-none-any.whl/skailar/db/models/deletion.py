...
from skailar.db import IntegrityError, connections, models, transaction
from skailar.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("skailar.db.models.SET", (value,), {})
