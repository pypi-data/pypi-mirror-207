...
class UrlAuthResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`UrlAuthResultAccepted <pyrosex.raw.types.UrlAuthResultAccepted>`
            - :obj:`UrlAuthResultDefault <pyrosex.raw.types.UrlAuthResultDefault>`
            - :obj:`UrlAuthResultRequest <pyrosex.raw.types.UrlAuthResultRequest>`
    ...
    QUALNAME = "pyrosex.raw.base.UrlAuthResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/url-auth-result")
