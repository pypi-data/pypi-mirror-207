...
# body param
SchemaForRequestBodyApplicationJson = WatchlistSuppress


request_body_watchlist_suppress = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _suppress_watchlist_entity_alert_oapg(
        self,
    ...
    def _suppress_watchlist_entity_alert_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_watchlist_suppress.serialize(body, content_type)
...
class SuppressWatchlistEntityAlert(BaseApi):
    ...
    def suppress_watchlist_entity_alert(
        ...
        return self._suppress_watchlist_entity_alert_oapg(
            body=body,
