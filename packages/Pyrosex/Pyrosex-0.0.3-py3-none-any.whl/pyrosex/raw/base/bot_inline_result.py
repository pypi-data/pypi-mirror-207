...
class BotInlineResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`BotInlineMediaResult <pyrosex.raw.types.BotInlineMediaResult>`
            - :obj:`BotInlineResult <pyrosex.raw.types.BotInlineResult>`
    """

    QUALNAME = "pyrosex.raw.base.BotInlineResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/bot-inline-result")
