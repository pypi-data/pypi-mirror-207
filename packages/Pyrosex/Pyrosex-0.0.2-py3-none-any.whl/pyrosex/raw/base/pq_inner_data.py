...
class PQInnerData:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PQInnerData <pyrosex.raw.types.PQInnerData>`
            - :obj:`PQInnerDataDc <pyrosex.raw.types.PQInnerDataDc>`
            - :obj:`PQInnerDataTemp <pyrosex.raw.types.PQInnerDataTemp>`
            - :obj:`PQInnerDataTempDc <pyrosex.raw.types.PQInnerDataTempDc>`
    """

    QUALNAME = "pyrosex.raw.base.PQInnerData"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/pq-inner-data")
