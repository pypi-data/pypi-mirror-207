...
def intro():
    ...
    while Game_Running:
        ...
        if order == 4:
            ImageSample = pygame.image.load("Manikin front Down Right.png")
        if order == 1:
            ImageSample = pygame.image.load("Manikin Back Down Left.png")
        if order == 3:
            ImageSample = pygame.image.load("Manikin front Up Right.png")
        if order == 2:
            ImageSample = pygame.image.load("Manikin Back Up Right.png")
