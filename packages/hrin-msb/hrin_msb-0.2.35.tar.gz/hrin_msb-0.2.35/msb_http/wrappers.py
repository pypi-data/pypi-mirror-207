...
from msb_dataclasses import SearchParameterRequest, Singleton
from msb_env import (Config, MsbConfigNames, NameConst)
...
class IntraServiceRequest(ApiRequest):
	...
	def __init__(self, version: int = 1, **kwargs):
		super(IntraServiceRequest, self).__init__(api_host=self.msb_intra_service_host, version=version, **kwargs)
