...
class BankCardData:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.BankCardData <pyrosex.raw.types.payments.BankCardData>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetBankCardData <pyrosex.raw.functions.payments.GetBankCardData>`
    """

    QUALNAME = "pyrosex.raw.base.payments.BankCardData"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/bank-card-data")
