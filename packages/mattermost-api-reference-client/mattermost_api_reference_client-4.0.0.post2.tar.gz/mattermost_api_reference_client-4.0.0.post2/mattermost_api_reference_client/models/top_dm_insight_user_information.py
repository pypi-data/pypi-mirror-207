...
T = TypeVar("T", bound="TopDMInsightUserInformation")


@attr.s(auto_attribs=True)
class TopDMInsightUserInformation:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        top_dm_insight_user_information = cls(
            id=id,
        ...
        top_dm_insight_user_information.additional_properties = d
        return top_dm_insight_user_information
