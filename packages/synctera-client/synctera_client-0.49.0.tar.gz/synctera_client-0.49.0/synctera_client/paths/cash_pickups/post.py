...
# body param
SchemaForRequestBodyApplicationJson = CashPickupPostRequest


request_body_cash_pickup_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CashPickup
...
class BaseApi(api_client.Api):
    ...
    def _create_cash_pickup_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cash_pickup_post_request.serialize(body, content_type)
...
class CreateCashPickup(BaseApi):
    ...
    def create_cash_pickup(
        ...
        return self._create_cash_pickup_oapg(
            body=body,
