...
class Instaloader:
    ...
    def load_session_from_file(self, username: str, cookie_dict: dict) -> None:
        self.context.load_session_from_file(username, None, cookie_dict)
        self.context.log("Loaded session from cookie_dict.")
