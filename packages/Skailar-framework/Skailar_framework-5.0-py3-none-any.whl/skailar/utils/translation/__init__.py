...
from skailar.utils.autoreload import autoreload_started, file_changed
...
# without having to first configure Skailar, and (2) if some other code creates
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from skailar.utils.translation import trans_real as trans
            ...
            from skailar.utils.translation import trans_null as trans
