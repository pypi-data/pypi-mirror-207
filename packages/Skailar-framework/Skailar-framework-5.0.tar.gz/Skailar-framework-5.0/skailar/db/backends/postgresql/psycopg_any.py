...
try:
    ...
    class SkailarRangeDumper(RangeDumper):
        """A Range dumper customized for Skailar."""

        def upgrade(self, obj, format):
            # Dump ranges containing naive datetimes as tstzrange, because
            # Skailar doesn't use tz-aware ones.
    ...
    def get_adapters_template(use_tz, timezone):
        ...
        ctx.register_dumper(Range, SkailarRangeDumper)
