...
class UserProfilePhoto:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`UserProfilePhoto <pyrosex.raw.types.UserProfilePhoto>`
            - :obj:`UserProfilePhotoEmpty <pyrosex.raw.types.UserProfilePhotoEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.UserProfilePhoto"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/user-profile-photo")
