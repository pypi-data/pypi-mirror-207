...
class SuggestedShortName:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`stickers.SuggestedShortName <pyrosex.raw.types.stickers.SuggestedShortName>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stickers.SuggestShortName <pyrosex.raw.functions.stickers.SuggestShortName>`
    """

    QUALNAME = "pyrosex.raw.base.stickers.SuggestedShortName"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/suggested-short-name")
