...
class Peer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PeerChannel <pyrosex.raw.types.PeerChannel>`
            - :obj:`PeerChat <pyrosex.raw.types.PeerChat>`
            - :obj:`PeerUser <pyrosex.raw.types.PeerUser>`
    """

    QUALNAME = "pyrosex.raw.base.Peer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/peer")
