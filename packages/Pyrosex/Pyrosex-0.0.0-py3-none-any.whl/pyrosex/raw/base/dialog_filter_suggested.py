...
class DialogFilterSuggested:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DialogFilterSuggested <pyrosex.raw.types.DialogFilterSuggested>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSuggestedDialogFilters <pyrosex.raw.functions.messages.GetSuggestedDialogFilters>`
    """

    QUALNAME = "pyrosex.raw.base.DialogFilterSuggested"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/dialog-filter-suggested")
