...
class Password(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.account.Password`.
    ...
    Parameters:
        new_algo: :obj:`PasswordKdfAlgo <pyrosex.raw.base.PasswordKdfAlgo>`
        new_secure_algo: :obj:`SecurePasswordKdfAlgo <pyrosex.raw.base.SecurePasswordKdfAlgo>`
        secure_random: ``bytes``
        has_recovery (optional): ``bool``
        has_secure_values (optional): ``bool``
        has_password (optional): ``bool``
        current_algo (optional): :obj:`PasswordKdfAlgo <pyrosex.raw.base.PasswordKdfAlgo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPassword <pyrosex.raw.functions.account.GetPassword>`
    """
