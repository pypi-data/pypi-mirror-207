...
# body param
SchemaForRequestBodyApplicationJson = Business


request_body_business = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Business
...
class BaseApi(api_client.Api):
    ...
    def _create_business_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_business.serialize(body, content_type)
...
class CreateBusiness(BaseApi):
    ...
    def create_business(
        ...
        return self._create_business_oapg(
            body=body,
