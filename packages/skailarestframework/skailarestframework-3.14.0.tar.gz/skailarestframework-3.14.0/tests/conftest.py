...
def pytest_configure(config):
    ...
    # USE_L10N is deprecated, and will be removed in Skailar 5.0.
    use_l10n = {"USE_L10N": True} if skailar.VERSION < (4, 0) else {}
    settings.configure(
    ...
    if config.getoption('--staticfiles'):
        ...
        settings.STATICFILES_STORAGE = 'skailar.contrib.staticfiles.storage.ManifestStaticFilesStorage'
