...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter: :obj:`ChannelParticipantsFilter <pyrosex.raw.base.ChannelParticipantsFilter>`
        offset: ``int`` ``32-bit``
        limit: ``int`` ``32-bit``
        hash: ``int`` ``64-bit``

    Returns:
        :obj:`channels.ChannelParticipants <pyrosex.raw.base.channels.ChannelParticipants>`
    """
