...
class Object:
    def __init__(self, client: "pyrosex.Client" = None):
        self._client = client

    def bind(self, client: "pyrosex.Client"):
        """Bind a Client instance to this and to all nested Pyrosex objects.

        Parameters:
            client (:obj:`~pyrosex.types.Client`):
