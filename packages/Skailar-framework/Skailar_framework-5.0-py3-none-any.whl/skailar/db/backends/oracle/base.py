"""
Oracle database backend for Skailar.
...
def wrap_oracle_errors():
    try:
        ...
        #            'ORA-02291: integrity constraint (TEST_SKAILARTEST.SYS
        #               _C00102056) violated - parent key not found'
        #            or:
        #            'ORA-00001: unique constraint (SKAILARTEST.DEFERRABLE_
        #               PINK_CONSTRAINT) violated
        # Convert that case to Skailar's IntegrityError exception.
        x = e.args[0]
        if (
            hasattr(x, "code")
...
class FormatStylePlaceholderCursor:
    """
    Skailar uses "format" (e.g. '%s') style placeholders, but Oracle uses ":var"
