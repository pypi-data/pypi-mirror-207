...
from skailar.contrib.staticfiles.handlers import ASGIStaticFilesHandler
from skailar.core.asgi import get_asgi_application
from skailar.core.handlers.asgi import ASGIHandler, ASGIRequest
from skailar.core.signals import request_finished, request_started
...
from skailar.utils.http import http_date
...
class ASGITest(SimpleTestCase):
    ...
    # test.
    @ignore_warnings(module="skailar.http.response")
    ...
    @modify_settings(INSTALLED_APPS={"append": "skailar.contrib.staticfiles"})
    @override_settings(
        STATIC_URL="static/",
    ...
    async def test_wrong_connection_type(self):
        ...
        communicator = ApplicationCommunicator(application, scope)
        await communicator.send_input({"type": "http.request"})
        msg = "Skailar can only handle ASGI/HTTP connections, not other."
