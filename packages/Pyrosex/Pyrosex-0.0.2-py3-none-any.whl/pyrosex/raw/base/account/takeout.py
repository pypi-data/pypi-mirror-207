...
class Takeout:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.Takeout <pyrosex.raw.types.account.Takeout>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.InitTakeoutSession <pyrosex.raw.functions.account.InitTakeoutSession>`
    """

    QUALNAME = "pyrosex.raw.base.account.Takeout"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/takeout")
