...
from skailar.forms import URLField
...
class URLFieldTest(FormFieldAssertionsMixin, SimpleTestCase):
    ...
    def test_urlfield_clean(self):
        # RemovedInSkailar60Warning: When the deprecation ends, remove the
        ...
        tests = [
            ...
            (
                "www.example.com/s/http://code.skailarproject.com/ticket/13804",
                "https://www.example.com/s/http://code.skailarproject.com/ticket/13804",
            ),
            # Normalization.
            ("http://example.com/     ", "http://example.com/"),
            # Valid IDN.
...
class URLFieldAssumeSchemeDeprecationTest(FormFieldAssertionsMixin, SimpleTestCase):
    def test_urlfield_raises_warning(self):
        msg = (
            "The default scheme will be changed from 'http' to 'https' in Skailar 6.0. "
