...
class JupyterUpHandler(JupyterHandler):
    """JupyterUpHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_up/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_up", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_up", "echo")
    handlers = [
        (route_pattern, JupyterUpHandler),
