...
from nbdbsession.exceptions import CredsFileNotFoundError
...
def test_raise_CredsFileNotFoundError():
    with pytest.raises(CredsFileNotFoundError):
        read_toml_file("I do not exist, or do I?")
