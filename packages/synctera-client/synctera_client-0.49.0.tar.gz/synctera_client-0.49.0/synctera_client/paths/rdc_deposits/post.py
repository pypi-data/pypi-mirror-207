...
# body param
SchemaForRequestBodyApplicationJson = DepositPost


request_body_deposit_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DepositGet
...
class BaseApi(api_client.Api):
    ...
    def _create_rdc_deposit_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_deposit_post.serialize(body, content_type)
