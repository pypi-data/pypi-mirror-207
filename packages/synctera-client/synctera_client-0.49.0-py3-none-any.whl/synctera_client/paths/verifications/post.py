...
# body param
SchemaForRequestBodyApplicationJson = Verification


request_body_verification = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Verification
...
class BaseApi(api_client.Api):
    ...
    def _create_verification_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_verification.serialize(body, content_type)
...
class CreateVerification(BaseApi):
    ...
    def create_verification(
        ...
        return self._create_verification_oapg(
            body=body,
