...
async def dynamic_spider(datasource: DataSource):
    ...
    # url = "https://api.vc.bilibili.com/dynamic_svr/v1/dynamic_svr/get_dynamic_detail?dynamic_id=773981999188672531"
    # detail = (await request("GET", url))["card"]
    # up = datasource.get_up(5834)
