...
class SearchResultsPositions:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.SearchResultsPositions <pyrosex.raw.types.messages.SearchResultsPositions>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchResultsPositions <pyrosex.raw.functions.messages.GetSearchResultsPositions>`
    """

    QUALNAME = "pyrosex.raw.base.messages.SearchResultsPositions"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/search-results-positions")
