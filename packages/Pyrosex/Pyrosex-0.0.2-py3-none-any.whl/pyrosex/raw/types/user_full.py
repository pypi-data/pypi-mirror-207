...
class UserFull(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.UserFull`.
    ...
    Parameters:
        id: ``int`` ``64-bit``
        settings: :obj:`PeerSettings <pyrosex.raw.base.PeerSettings>`
        ...
        about (optional): ``str``
        profile_photo (optional): :obj:`Photo <pyrosex.raw.base.Photo>`
        bot_info (optional): :obj:`BotInfo <pyrosex.raw.base.BotInfo>`
        ...
        bot_group_admin_rights (optional): :obj:`ChatAdminRights <pyrosex.raw.base.ChatAdminRights>`
        bot_broadcast_admin_rights (optional): :obj:`ChatAdminRights <pyrosex.raw.base.ChatAdminRights>`
    """
