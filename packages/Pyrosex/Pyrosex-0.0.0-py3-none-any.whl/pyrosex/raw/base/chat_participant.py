...
class ChatParticipant:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatParticipant <pyrosex.raw.types.ChatParticipant>`
            - :obj:`ChatParticipantAdmin <pyrosex.raw.types.ChatParticipantAdmin>`
            - :obj:`ChatParticipantCreator <pyrosex.raw.types.ChatParticipantCreator>`
    """

    QUALNAME = "pyrosex.raw.base.ChatParticipant"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-participant")
