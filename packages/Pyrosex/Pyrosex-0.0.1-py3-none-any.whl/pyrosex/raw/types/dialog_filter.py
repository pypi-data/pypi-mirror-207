...
class DialogFilter(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.DialogFilter`.
    ...
    Parameters:
        id: ``int`` ``32-bit``
        title: ``str``
        pinned_peers: List of :obj:`InputPeer <pyrosex.raw.base.InputPeer>`
        include_peers: List of :obj:`InputPeer <pyrosex.raw.base.InputPeer>`
        exclude_peers: List of :obj:`InputPeer <pyrosex.raw.base.InputPeer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDialogFilters <pyrosex.raw.functions.messages.GetDialogFilters>`
    """
