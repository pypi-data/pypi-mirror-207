...
from skailar.contrib.auth.models import AbstractBaseUser
from skailar.core.validators import RegexValidator, validate_slug
from skailar.db import connection, migrations, models
from skailar.db.migrations.autodetector import MigrationAutodetector
from skailar.db.migrations.graph import MigrationGraph
from skailar.db.migrations.loader import MigrationLoader
from skailar.db.migrations.questioner import MigrationQuestioner
from skailar.db.migrations.state import ModelState, ProjectState
from skailar.test import SimpleTestCase, TestCase, ignore_warnings, override_settings
...
class AutodetectorTests(BaseAutodetectorTests):
    ...
    @mock.patch(
        "skailar.db.migrations.questioner.MigrationQuestioner.ask_not_null_addition",
    ...
    @mock.patch(
        "skailar.db.migrations.questioner.MigrationQuestioner.ask_auto_now_add_addition"
    )
    ...
    @mock.patch(
        "skailar.db.migrations.questioner.MigrationQuestioner.ask_not_null_alteration",
        side_effect=AssertionError("Should not have prompted for not null addition"),
    )
    ...
    def test_rename_field_preserved_db_column(self):
        ...
        self.assertEqual(
            ...
            (
                "field",
                "skailar.db.models.IntegerField",
                [],
                {"db_column": "field"},
            ),
        )
