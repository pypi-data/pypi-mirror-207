...
# body param
SchemaForRequestBodyApplicationJson = CustomerInBody


request_body_customer_in_body = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CustomerInBody
...
class BaseApi(api_client.Api):
    ...
    def _create_customer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customer_in_body.serialize(body, content_type)
