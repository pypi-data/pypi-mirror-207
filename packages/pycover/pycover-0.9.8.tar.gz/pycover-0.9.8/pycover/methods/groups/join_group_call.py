...
class JoinGroupCall(Scaffold):
    async def join_group_call(
        ...
        Parameters:
            ...
            stream (:obj:`~pycover.types.InputStream()`):
                Input Streams descriptor, can be used also
                :obj:`~pycover.types.AudioPiped()`,
                :obj:`~pycover.types.AudioImagePiped()`,
                :obj:`~pycover.types.AudioVideoPiped()` or
                :obj:`~pycover.types.VideoPiped()`
            ...
            stream_type (:obj:`~pycover.StreamType`, **optional**)
                The type of Stream
        ...
        Raises:
            ...
            NodeJSNotRunning: In case you try
                ...
                :meth:`~pycover.pycover.start` before
