...
from gaiaframework.base.pipeline.preprocessor import ZIDS_Preprocessor
...
##
# @file
# @brief Preprocess class, implements ZIDS_Preprocessor base class.
class generatedClass(ZIDS_Preprocessor):
    """! Preprocessor class implements ZIDS_Preprocessor base class.

    This is the first stage of the pipeline and its main goal is to prepare our dataset format to the model.

    Its base class ZIDS_Preprocessor declares phases based on UVM (Universal Verification Methodology) and by this
