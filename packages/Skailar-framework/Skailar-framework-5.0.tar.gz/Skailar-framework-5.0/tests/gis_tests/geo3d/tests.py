...
from skailar.contrib.gis.db.models import Extent3D, Union
...
from skailar.contrib.gis.geos import GEOSGeometry, LineString, Point, Polygon
...
class Geo3DTest(Geo3DLoadingHelper, TestCase):
    ...
    available within GeoSkailar.  For more information, see the PostGIS docs
    ...
    def test_3d_layermapping(self):
        ...
        from skailar.contrib.gis.utils import LayerMapError, LayerMapping
