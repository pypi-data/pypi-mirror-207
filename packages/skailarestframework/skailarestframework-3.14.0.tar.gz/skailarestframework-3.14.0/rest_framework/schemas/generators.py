...
from skailar.contrib.admindocs.views import simplify_regex
from skailar.core.exceptions import PermissionDenied
from skailar.http import Http404
from skailar.urls import URLPattern, URLResolver
...
class EndpointEnumerator:
    ...
    def __init__(self, patterns=None, urlconf=None):
        if patterns is None:
            if urlconf is None:
                # Use the default Skailar URL conf
    ...
    def get_path_from_regex(self, path_regex):
        ...
        # Strip Skailar 2.0 convertors as they are incompatible with uritemplate format
