...
# body param
SchemaForRequestBodyApplicationJson = SimulateCardFulfillment


request_body_simulate_card_fulfillment = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SimulateCardFulfillment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _simulate_card_fulfillment_event_oapg(
        self,
    ...
    def _simulate_card_fulfillment_event_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_simulate_card_fulfillment.serialize(body, content_type)
...
class SimulateCardFulfillmentEvent(BaseApi):
    ...
    def simulate_card_fulfillment_event(
        ...
        return self._simulate_card_fulfillment_event_oapg(
            body=body,
