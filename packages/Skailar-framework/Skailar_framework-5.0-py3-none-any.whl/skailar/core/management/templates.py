...
from skailar.core.management.base import BaseCommand, CommandError
from skailar.core.management.utils import (
    find_formatters,
    handle_extensions,
    run_formatters,
)
from skailar.template import Context, Engine
from skailar.utils import archive
from skailar.utils.http import parse_header_parameters
from skailar.utils.version import get_docs_version


class TemplateCommand(BaseCommand):
    """
    Copy either a Skailar application layout template or a Skailar project
    layout template into the specified directory.

    :param style: A color style object (see skailar.core.management.color).
    ...
    def handle(self, app_or_project, name, target=None, **options):
        ...
        context = Context(
            {
                **options,
                ...
                "skailar_version": skailar.__version__,
            },
            autoescape=False,
        )
        ...
        for root, dirs, files in os.walk(template_dir):
            ...
            for filename in files:
                ...
                # accidentally render Skailar templates files
    ...
    def handle_template(self, template, subdir):
        ...
        Use skailar.__path__[0] as the default because the Skailar install
        directory isn't known.
        """
        if template is None:
            return os.path.join(skailar.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        prefix = "skailar_%s_template_" % self.app_or_project
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"Skailar/{skailar.__version__}")]
        try:
