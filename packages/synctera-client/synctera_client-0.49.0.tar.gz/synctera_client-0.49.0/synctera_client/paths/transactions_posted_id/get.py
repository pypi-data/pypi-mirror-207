...
SchemaFor200ResponseBodyApplicationJson = PostedTransaction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_posted_transaction_by_id_oapg(
        self,
...
class GetPostedTransactionById(BaseApi):
    ...
    def get_posted_transaction_by_id(
        ...
        return self._get_posted_transaction_by_id_oapg(
