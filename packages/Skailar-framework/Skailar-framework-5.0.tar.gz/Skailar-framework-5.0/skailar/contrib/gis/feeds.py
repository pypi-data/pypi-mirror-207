from skailar.contrib.syndication.views import Feed as BaseFeed
from skailar.utils.feedgenerator import Atom1Feed, Rss201rev2Feed
...
class Feed(BaseFeed):
    """
    This is a subclass of the `Feed` from `skailar.contrib.syndication`.
