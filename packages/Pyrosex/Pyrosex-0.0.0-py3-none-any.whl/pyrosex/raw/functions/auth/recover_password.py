...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        code: ``str``
        new_settings (optional): :obj:`account.PasswordInputSettings <pyrosex.raw.base.account.PasswordInputSettings>`

    Returns:
        :obj:`auth.Authorization <pyrosex.raw.base.auth.Authorization>`
    """
