...
from skailar.utils.html import conditional_escape, escape, format_html
from skailar.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from skailar.utils.html import strip_spaces_between_tags
...
def load(parser, token):
    ...
    ``skailar/templatetags/news/photos.py``::
