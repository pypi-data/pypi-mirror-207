...
class InputChannel:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputChannel <pyrosex.raw.types.InputChannel>`
            - :obj:`InputChannelEmpty <pyrosex.raw.types.InputChannelEmpty>`
            - :obj:`InputChannelFromMessage <pyrosex.raw.types.InputChannelFromMessage>`
    """

    QUALNAME = "pyrosex.raw.base.InputChannel"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-channel")
