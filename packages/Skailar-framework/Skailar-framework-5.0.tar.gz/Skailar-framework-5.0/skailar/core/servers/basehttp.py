...
This is a simple server for use in testing or debugging Skailar apps. It hasn't
...
from skailar.core.handlers.wsgi import LimitedStream
...
def get_internal_wsgi_application():
    ...
    for Skailar's internal server (runserver); external WSGI servers should just
    be configured to point to the correct application object directly.

    If settings.WSGI_APPLICATION is not set (is ``None``), return
    whatever ``skailar.core.wsgi.get_wsgi_application`` returns.
    """
