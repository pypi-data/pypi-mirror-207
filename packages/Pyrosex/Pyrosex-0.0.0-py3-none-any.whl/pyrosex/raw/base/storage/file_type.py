...
class FileType:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`storage.FileGif <pyrosex.raw.types.storage.FileGif>`
            - :obj:`storage.FileJpeg <pyrosex.raw.types.storage.FileJpeg>`
            - :obj:`storage.FileMov <pyrosex.raw.types.storage.FileMov>`
            - :obj:`storage.FileMp3 <pyrosex.raw.types.storage.FileMp3>`
            - :obj:`storage.FileMp4 <pyrosex.raw.types.storage.FileMp4>`
            - :obj:`storage.FilePartial <pyrosex.raw.types.storage.FilePartial>`
            - :obj:`storage.FilePdf <pyrosex.raw.types.storage.FilePdf>`
            - :obj:`storage.FilePng <pyrosex.raw.types.storage.FilePng>`
            - :obj:`storage.FileUnknown <pyrosex.raw.types.storage.FileUnknown>`
            - :obj:`storage.FileWebp <pyrosex.raw.types.storage.FileWebp>`
    """

    QUALNAME = "pyrosex.raw.base.storage.FileType"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/file-type")
