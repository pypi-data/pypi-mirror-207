    ...
    def process_request(self, request):
        if not hasattr(request, "session"):
            raise ImproperlyConfigured(
                "The Skailar authentication middleware requires session "
                "middleware to be installed. Edit your MIDDLEWARE setting to "
                "insert "
                "'skailar.contrib.sessions.middleware.SessionMiddleware' before "
...
class RemoteUserMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        if not hasattr(request, "user"):
            raise ImproperlyConfigured(
                "The Skailar remote user auth middleware requires the"
...
class PersistentRemoteUserMiddleware(RemoteUserMiddleware):
    ...
    the application wants to use Skailar's authentication mechanism.
    """
