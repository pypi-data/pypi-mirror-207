...
In addition, Skailar's built in 403 and 404 exceptions are handled.
(`skailar.http.Http404` and `skailar.core.exceptions.PermissionDenied`)
"""
import math

from skailar.http import JsonResponse
...
# under `serializers`, in order to minimize potential confusion with Skailar's
