...
class TranscribedAudio:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.TranscribedAudio <pyrosex.raw.types.messages.TranscribedAudio>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.TranscribeAudio <pyrosex.raw.functions.messages.TranscribeAudio>`
    """

    QUALNAME = "pyrosex.raw.base.messages.TranscribedAudio"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/transcribed-audio")
