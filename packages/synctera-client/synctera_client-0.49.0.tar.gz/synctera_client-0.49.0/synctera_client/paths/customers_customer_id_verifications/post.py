...
# body param
SchemaForRequestBodyApplicationJson = CustomerVerificationResult


request_body_customer_verification_result = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CustomerVerificationResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_customer_verification_result_oapg(
        self,
    ...
    def _create_customer_verification_result_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customer_verification_result.serialize(body, content_type)
...
class CreateCustomerVerificationResult(BaseApi):
    ...
    def create_customer_verification_result(
        ...
        return self._create_customer_verification_result_oapg(
            body=body,
