...
from skailar.db.models import BooleanField
...
class Tests(TestCase):
    ...
    def test_dbms_session(self):
        ...
        with connection.cursor() as cursor:
            cursor.callproc("DBMS_SESSION.SET_IDENTIFIER", ["_skailar_testing!"])
        ...
        try:
            with self.assertRaisesMessage(
                ...
                (
                    ...
                    "OCI library (see https://code.skailarproject.com/ticket/28859)."
                ),
            ):
