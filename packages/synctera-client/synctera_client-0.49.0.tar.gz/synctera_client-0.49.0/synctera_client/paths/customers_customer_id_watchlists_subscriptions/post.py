...
SchemaFor201ResponseBodyApplicationJson = WatchlistSubscription
...
class WatchlistSubscribe(BaseApi):
    ...
    def watchlist_subscribe(
        ...
        return self._watchlist_subscribe_oapg(
            body=body,
