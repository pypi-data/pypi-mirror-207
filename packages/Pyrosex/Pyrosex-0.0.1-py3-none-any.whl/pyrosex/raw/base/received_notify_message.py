...
class ReceivedNotifyMessage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ReceivedNotifyMessage <pyrosex.raw.types.ReceivedNotifyMessage>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.ReceivedMessages <pyrosex.raw.functions.messages.ReceivedMessages>`
    """

    QUALNAME = "pyrosex.raw.base.ReceivedNotifyMessage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/received-notify-message")
