...
class DraftMessage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DraftMessage <pyrosex.raw.types.DraftMessage>`
            - :obj:`DraftMessageEmpty <pyrosex.raw.types.DraftMessageEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.DraftMessage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/draft-message")
