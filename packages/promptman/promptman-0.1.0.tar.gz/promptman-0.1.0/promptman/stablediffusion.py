def template(input:str = ""):
    prompt:str = f"{input}, "
    negative_prompt:str = " "
    return str(prompt), str(negative_prompt)

def disney(input:str = ""):
...
def anime_model_racecar(input:str = ""):
