...
from skailar.contrib.staticfiles import finders, storage
from skailar.contrib.staticfiles.management.commands.collectstatic import (
...
class TestHashedFiles:
    ...
    @override_settings(
        ...
        STATICFILES_FINDERS=["skailar.contrib.staticfiles.finders.FileSystemFinder"],
    )
