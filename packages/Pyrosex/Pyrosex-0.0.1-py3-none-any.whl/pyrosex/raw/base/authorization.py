...
class Authorization:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`Authorization <pyrosex.raw.types.Authorization>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.AcceptLoginToken <pyrosex.raw.functions.auth.AcceptLoginToken>`
    """

    QUALNAME = "pyrosex.raw.base.Authorization"
