...
from skailar.forms.formsets import formset_factory
...
class ModelFormsetTest(TestCase):
    ...
    def test_callable_defaults(self):
        ...
        # Skailar will render a hidden field for model fields that have a callable
    ...
    def test_inlineformset_with_arrayfield(self):
        class SimpleArrayField(forms.CharField):
            """A proxy for skailar.contrib.postgres.forms.SimpleArrayField."""
