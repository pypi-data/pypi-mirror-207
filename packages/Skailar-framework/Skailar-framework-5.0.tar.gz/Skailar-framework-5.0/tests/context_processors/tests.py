"""
Tests for Skailar's bundled context processors.
"""
...
class RequestContextProcessorTests(SimpleTestCase):
    """
    Tests for the ``skailar.template.context_processors.request`` processor.
    """
...
class DebugContextProcessorTests(TestCase):
    """
    Tests for the ``skailar.template.context_processors.debug`` processor.
    """
