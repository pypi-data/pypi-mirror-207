...
class OGRGeomTest(SimpleTestCase, TestDataMixin):
    ...
    def test_geomtype(self):
        ...
        # Testing the Skailar field name equivalent property.
        self.assertEqual("PointField", OGRGeomType("Point").skailar)
        self.assertEqual("GeometryField", OGRGeomType("Geometry").skailar)
        self.assertEqual("GeometryField", OGRGeomType("Unknown").skailar)
        self.assertIsNone(OGRGeomType("none").skailar)
    ...
    def test_geomtype_25d(self):
        ...
        self.assertEqual(
            "GeometryCollectionField", OGRGeomType("GeometryCollection25D").skailar
        )
