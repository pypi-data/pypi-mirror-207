...
class KerasDenseRegressor(BaseEstimator, RegressorMixin):
    def __init__(self, units=(64, 64), dropout=0, activation="relu",
                 ...
                 out_act="linear", metrics="mean_absolute_error", model=None,
                 verbose=0):
        self.units = units
    ...
    def fit(self, X, y, sample_weight=None):
        if self.model is None:
            self._build_model(X, y, out_act=self.out_act,
        ...
        return self.model.fit(X, y, epochs=self.epochs, verbose=self.verbose,
                              sample_weight=sample_weight, callbacks=calls,
    ...
    def _build_model(self, X, y, out_act, loss, metrics):
        ...
        self.model.compile(loss=loss, weighted_metrics=metrics,
...
class KerasDenseClassifier(KerasDenseRegressor, ClassifierMixin):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        return super().fit(X, y_enc, sample_weight=sample_weight)
