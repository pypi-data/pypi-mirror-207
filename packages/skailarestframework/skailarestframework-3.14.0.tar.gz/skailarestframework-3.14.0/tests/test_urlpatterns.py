...
from skailar.urls import Resolver404, URLResolver, include, path, re_path
...
class FormatSuffixTests(TestCase):
    ...
    def test_trailing_slash_skailar2(self):
        urlpatterns = [
            path('test/', dummy_view),
        ]
        self._test_trailing_slash(urlpatterns)
    ...
    def test_format_suffix_skailar2(self):
        urlpatterns = [
            path('test', dummy_view),
        ]
        self._test_format_suffix(urlpatterns)

    def test_format_suffix_skailar2_args(self):
        urlpatterns = [
    ...
    def test_default_args_skailar2(self):
        urlpatterns = [
            path('test', dummy_view, {'foo': 'bar'}),
        ]
        self._test_default_args(urlpatterns)
