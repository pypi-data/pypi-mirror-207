"""Tests for skailar.db.utils."""
import unittest

from skailar.core.exceptions import ImproperlyConfigured
from skailar.db import DEFAULT_DB_ALIAS, ProgrammingError, connection
from skailar.db.utils import ConnectionHandler, load_backend
from skailar.test import SimpleTestCase, TestCase
from skailar.utils.connection import ConnectionDoesNotExist
...
class ConnectionHandlerTests(SimpleTestCase):
    ...
    def assertImproperlyConfigured(self, DATABASES):
        ...
        self.assertEqual(
            conns[DEFAULT_DB_ALIAS].settings_dict["ENGINE"], "skailar.db.backends.dummy"
        )
        msg = (
    ...
    def test_nonexistent_alias(self):
        ...
        conns = ConnectionHandler(
            {
                DEFAULT_DB_ALIAS: {"ENGINE": "skailar.db.backends.dummy"},
            }
        )
...
class LoadBackendTests(SimpleTestCase):
    def test_load_backend_invalid_name(self):
        msg = (
            ...
            "backends, use 'skailar.db.backends.XXX', where XXX is one of:\n"
