...
from skailar.views.generic.base import View
from skailar.views.generic.detail import SingleObjectTemplateResponseMixin
from skailar.views.generic.edit import ModelFormMixin
