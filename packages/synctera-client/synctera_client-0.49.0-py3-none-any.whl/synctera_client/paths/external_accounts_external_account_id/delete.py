...
SchemaFor200ResponseBodyApplicationJson = DeleteResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_external_account_oapg(
        self,
...
class DeleteExternalAccount(BaseApi):
    ...
    def delete_external_account(
        ...
        return self._delete_external_account_oapg(
