...
class RecentMeUrls:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.RecentMeUrls <pyrosex.raw.types.help.RecentMeUrls>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetRecentMeUrls <pyrosex.raw.functions.help.GetRecentMeUrls>`
    """

    QUALNAME = "pyrosex.raw.base.help.RecentMeUrls"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/recent-me-urls")
