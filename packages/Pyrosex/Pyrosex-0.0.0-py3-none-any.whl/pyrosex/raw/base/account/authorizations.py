...
class Authorizations:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.Authorizations <pyrosex.raw.types.account.Authorizations>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAuthorizations <pyrosex.raw.functions.account.GetAuthorizations>`
    """

    QUALNAME = "pyrosex.raw.base.account.Authorizations"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/authorizations")
