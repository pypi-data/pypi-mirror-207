...
from skailar.test import SimpleTestCase, modify_settings
from skailar.test.utils import extend_sys_path
from skailar.utils.module_loading import (
...
class DefaultLoader(unittest.TestCase):
    def test_loader(self):
        ...
        self.assertFalse(module_has_submodule(test_module, "skailar"))
        with self.assertRaises(ImportError):
            import_module("utils_tests.test_module.skailar")
...
class ModuleImportTests(SimpleTestCase):
    def test_import_string(self):
        cls = import_string("skailar.utils.module_loading.import_string")
