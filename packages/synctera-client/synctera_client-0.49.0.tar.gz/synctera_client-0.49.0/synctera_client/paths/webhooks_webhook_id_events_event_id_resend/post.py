...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'delay': typing.Union[DelaySchema, decimal.Decimal, int, ],
    },
    total=False
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'webhook_id': typing.Union[WebhookIdSchema, str, uuid.UUID, ],
...
SchemaFor200ResponseBodyApplicationJson = Event
...
class ResendEvent(BaseApi):
    ...
    def resend_event(
        ...
        return self._resend_event_oapg(
