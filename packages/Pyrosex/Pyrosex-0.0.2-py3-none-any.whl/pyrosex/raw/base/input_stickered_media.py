...
class InputStickeredMedia:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputStickeredMediaDocument <pyrosex.raw.types.InputStickeredMediaDocument>`
            - :obj:`InputStickeredMediaPhoto <pyrosex.raw.types.InputStickeredMediaPhoto>`
    """

    QUALNAME = "pyrosex.raw.base.InputStickeredMedia"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-stickered-media")
