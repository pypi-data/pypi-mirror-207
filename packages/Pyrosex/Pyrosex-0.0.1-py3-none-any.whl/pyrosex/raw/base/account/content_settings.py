...
class ContentSettings:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.ContentSettings <pyrosex.raw.types.account.ContentSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetContentSettings <pyrosex.raw.functions.account.GetContentSettings>`
    """

    QUALNAME = "pyrosex.raw.base.account.ContentSettings"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/content-settings")
