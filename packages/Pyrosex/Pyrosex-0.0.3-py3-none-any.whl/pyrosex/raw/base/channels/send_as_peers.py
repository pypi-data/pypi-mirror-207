...
class SendAsPeers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`channels.SendAsPeers <pyrosex.raw.types.channels.SendAsPeers>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetSendAs <pyrosex.raw.functions.channels.GetSendAs>`
    """

    QUALNAME = "pyrosex.raw.base.channels.SendAsPeers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/send-as-peers")
