...
class OptionalMeasureLanguage(object):
    ...
    def __ref__(self) -> "openstudio::MeasureLanguage":
    ...
    def get(self) -> "openstudio::MeasureLanguage":
        return _openstudioutilitiesbcl.OptionalMeasureLanguage_get(self)

    def set(self, t: "MeasureLanguage") -> "void":
...
class BCLFileReference(object):
    ...
    def __init__(self, measureRootDir: "path", relativePath: "path", setMembers: "bool const"=False):
    ...
    def relativePath(self) -> "openstudio::path":
...
class BCLComponent(object):
    ...
    def __lt__(self, other: "BCLComponent") -> "bool":
...
def MeasureLanguage_enumName() -> "std::string":
    return _openstudioutilitiesbcl.MeasureLanguage_enumName()

def MeasureLanguage_getValues() -> "std::set< int,std::less< int >,std::allocator< int > >":
    return _openstudioutilitiesbcl.MeasureLanguage_getValues()
...
class BCLMeasure(object):
    ...
    @staticmethod
    def isIgnoredFileName(fileName: "std::string const &") -> "bool":
        return _openstudioutilitiesbcl.BCLMeasure_isIgnoredFileName(fileName)

    @staticmethod
    def isApprovedFile(absoluteFilePath: "path", measureDir: "path") -> "bool":
    ...
    def measureLanguage(self) -> "openstudio::MeasureLanguage":
    ...
    def setMeasureLanguage(self, measureLanguage: "MeasureLanguage") -> "void":
    ...
    def primaryPythonScriptPath(self) -> "boost::optional< openstudio::path >":
        return _openstudioutilitiesbcl.BCLMeasure_primaryPythonScriptPath(self)

    def primaryScriptPath(self) -> "boost::optional< openstudio::path >":
    ...
    def __lt__(self, other: "BCLMeasure") -> "bool":
    ...
    def updateMeasureScript(self, oldMeasureType: "MeasureType", newMeasureType: "MeasureType", oldMeasureLanguage: "MeasureLanguage", newMeasureLanguage: "MeasureLanguage", oldClassName: "std::string const &", newClassName: "std::string const &", name: "std::string const &", description: "std::string const &", modelerDescription: "std::string const &") -> "bool":
...
def BCLMeasure_isIgnoredFileName(fileName: "std::string const &") -> "bool":
    return _openstudioutilitiesbcl.BCLMeasure_isIgnoredFileName(fileName)

def BCLMeasure_isApprovedFile(absoluteFilePath: "path", measureDir: "path") -> "bool":
    return _openstudioutilitiesbcl.BCLMeasure_isApprovedFile(absoluteFilePath, measureDir)
