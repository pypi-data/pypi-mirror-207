...
from skailar.db import DEFAULT_DB_ALIAS, DatabaseError, NotSupportedError
from skailar.db.backends import utils
from skailar.db.backends.base.validation import BaseDatabaseValidation
from skailar.db.backends.signals import connection_created
from skailar.db.backends.utils import debug_transaction
from skailar.db.transaction import TransactionManagementError
from skailar.db.utils import DatabaseErrorWrapper
...
logger = logging.getLogger("skailar.db.backends.base")
...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS):
        ...
        # to disambiguate it from Skailar settings modules.
    ...
    def timezone(self):
        ...
        time zone Skailar uses, as long as aware datetimes are used everywhere.
        Other users connecting to the database can choose their own time zone.

        When the database backend doesn't support time zones, the time zone
        Skailar uses may be constrained by the requirements of other users of
        the database.
        """
    ...
    def is_usable(self):
        ...
        as that may prevent Skailar from recycling unusable connections.
        """
        raise NotImplementedError(
