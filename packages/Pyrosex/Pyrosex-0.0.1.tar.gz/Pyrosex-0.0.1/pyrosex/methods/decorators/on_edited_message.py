...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pyrosex.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrosex.Client):
                self.add_handler(pyrosex.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrosex.handlers.EditedMessageHandler(func, self),
