...
class ChannelMessagesFilter:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChannelMessagesFilter <pyrosex.raw.types.ChannelMessagesFilter>`
            - :obj:`ChannelMessagesFilterEmpty <pyrosex.raw.types.ChannelMessagesFilterEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.ChannelMessagesFilter"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/channel-messages-filter")
