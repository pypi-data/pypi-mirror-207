...
from skailar.core.cache import DEFAULT_CACHE_ALIAS, caches
from skailar.core.exceptions import ImproperlyConfigured, SynchronousOnlyOperation
from skailar.http import HttpResponse, HttpResponseNotAllowed
from skailar.test import RequestFactory, SimpleTestCase
