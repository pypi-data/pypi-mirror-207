...
class AttachMenuBotIcon(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        name: ``str``
        icon: :obj:`Document <pyrosex.raw.base.Document>`
        colors (optional): List of :obj:`AttachMenuBotIconColor <pyrosex.raw.base.AttachMenuBotIconColor>`
    """
