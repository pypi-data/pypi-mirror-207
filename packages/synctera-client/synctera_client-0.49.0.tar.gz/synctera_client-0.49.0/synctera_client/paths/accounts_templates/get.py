...
SchemaFor200ResponseBodyApplicationJson = TemplateList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_account_templates_oapg(
        self,
...
class ListAccountTemplates(BaseApi):
    ...
    def list_account_templates(
        ...
        return self._list_account_templates_oapg(
