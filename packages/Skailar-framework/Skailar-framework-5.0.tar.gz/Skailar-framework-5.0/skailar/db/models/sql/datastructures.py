...
from skailar.core.exceptions import FullResultSet
from skailar.db.models.sql.constants import INNER, LOUTER
...
class Join:
    ...
    def as_sql(self, compiler, connection):
        ...
        # RemovedInSkailar60Warning: when the depraction ends, replace with:
        # for lhs, rhs in self.join_field:
        join_fields = self.join_fields or self.join_cols
        for lhs, rhs in join_fields:
            if isinstance(lhs, str):
                # RemovedInSkailar60Warning: when the depraction ends, remove
