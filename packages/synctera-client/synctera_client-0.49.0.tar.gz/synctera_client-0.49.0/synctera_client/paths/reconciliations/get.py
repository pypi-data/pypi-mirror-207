...
SchemaFor200ResponseBodyApplicationJson = ReconciliationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_reconciliations_oapg(
        self,
...
class ListReconciliations(BaseApi):
    ...
    def list_reconciliations(
        ...
        return self._list_reconciliations_oapg(
