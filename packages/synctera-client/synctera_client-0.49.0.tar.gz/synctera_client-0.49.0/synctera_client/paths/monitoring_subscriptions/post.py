...
# body param
SchemaForRequestBodyApplicationJson = MonitoringSubscription


request_body_monitoring_subscription = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MonitoringSubscription
...
class BaseApi(api_client.Api):
    ...
    def _create_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_monitoring_subscription.serialize(body, content_type)
