...
class ChatInviteImporters:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ChatInviteImporters <pyrosex.raw.types.messages.ChatInviteImporters>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetChatInviteImporters <pyrosex.raw.functions.messages.GetChatInviteImporters>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ChatInviteImporters"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-invite-importers")
