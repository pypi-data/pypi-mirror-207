...
class Contacts:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`contacts.Contacts <pyrosex.raw.types.contacts.Contacts>`
            - :obj:`contacts.ContactsNotModified <pyrosex.raw.types.contacts.ContactsNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetContacts <pyrosex.raw.functions.contacts.GetContacts>`
    """

    QUALNAME = "pyrosex.raw.base.contacts.Contacts"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/contacts")
