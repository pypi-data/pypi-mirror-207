...
class LoginTokenSuccess(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.auth.LoginToken`.
    ...
    Parameters:
        authorization: :obj:`auth.Authorization <pyrosex.raw.base.auth.Authorization>`
