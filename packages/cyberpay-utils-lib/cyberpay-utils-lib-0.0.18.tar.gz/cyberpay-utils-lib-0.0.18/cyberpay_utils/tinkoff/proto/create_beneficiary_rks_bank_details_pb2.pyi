...
class CreateBeneficiaryRksBankDetailsRequest(_message.Message):
    __slots__ = ["account_number", "bank_name", "beneficiary_id", "bik", "corr_account_number", "inn", "is_default", "kpp", "name", "type"]
    ...
    name: str
    type: str
    def __init__(self, beneficiary_id: _Optional[str] = ..., type: _Optional[str] = ..., is_default: bool = ..., bik: _Optional[str] = ..., kpp: _Optional[str] = ..., inn: _Optional[str] = ..., name: _Optional[str] = ..., bank_name: _Optional[str] = ..., account_number: _Optional[str] = ..., corr_account_number: _Optional[str] = ...) -> None: ...

class CreateBeneficiaryRksBankDetailsResponse(_message.Message):
