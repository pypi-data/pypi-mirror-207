...
R7Z4_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R7Z4Cluster(GenericK8sCluster):
    """ R7Z4 Cluster Overrides """

    allowed_instances: Instances = R7Z4_INSTANCES
