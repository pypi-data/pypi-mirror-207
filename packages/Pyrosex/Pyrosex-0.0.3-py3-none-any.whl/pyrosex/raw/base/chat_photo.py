...
class ChatPhoto:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatPhoto <pyrosex.raw.types.ChatPhoto>`
            - :obj:`ChatPhotoEmpty <pyrosex.raw.types.ChatPhotoEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.ChatPhoto"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-photo")
