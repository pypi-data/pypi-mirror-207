...
class RegexPrinter:
    ...
    CUSTOM_STYLES = {
        "title": pt.Style(
            fg="true-white", frozen=True,
            bold=True,
            underlined=True,
            overlined=True,
        ),
        "header": pt.Style(fg="yellow", bold=True, frozen=True),
        "t": pt.Style(fg="green", frozen=True),
        "n": pt.Style(fg="red", frozen=True),
        "fn": pt.Style(fg="blue", frozen=True),
        "url": pt.Style(underlined=True, frozen=True),
        "hl": pt.Style(italic=True, frozen=True),
        "comment": pt.Style(fg=pt.cv.GRAY_35, frozen=True),
    }
    PADDING = 4
