...
class TinkoffServiceGrpcClient:
    ...
    def create_beneficiary_rks_bank_details(
        self,
        request: create_beneficiary_rks_bank_details_pb2.CreateBeneficiaryRksBankDetailsRequest,
    ) -> (
        create_beneficiary_rks_bank_details_pb2.CreateBeneficiaryRksBankDetailsResponse
    ):
        with grpc.insecure_channel(self.service_host) as channel:
            stub = tinkoff_pb2_grpc.TinkoffStub(channel)
            response = stub.CreateBeneficiaryRksBankDetails(request)
            return response
    ...
    def edit_beneficiary_rks_bank_details(
        self,
        request: edit_beneficiary_rks_bank_details_pb2.EditBeneficiaryRksBankDetailsRequest,
    ) -> edit_beneficiary_rks_bank_details_pb2.EditBeneficiaryRksBankDetailsResponse:
        with grpc.insecure_channel(self.service_host) as channel:
            stub = tinkoff_pb2_grpc.TinkoffStub(channel)
            response = stub.EditBeneficiaryRksBankDetails(request)
            return response
