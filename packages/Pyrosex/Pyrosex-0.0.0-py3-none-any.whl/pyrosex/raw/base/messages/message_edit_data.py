...
class MessageEditData:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.MessageEditData <pyrosex.raw.types.messages.MessageEditData>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetMessageEditData <pyrosex.raw.functions.messages.GetMessageEditData>`
    """

    QUALNAME = "pyrosex.raw.base.messages.MessageEditData"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-edit-data")
