        ...
        react_1.default.createElement(core_1.Stack, { spacing: 0, align: "center" },
            ...
            data !== "" ?
                react_1.default.createElement(core_1.Group, { sx: { marginBottom: "1rem", width: "95%" }, position: "center" },
                    react_1.default.createElement(core_1.Tabs, { value: tabValue, sx: { width: "100%" }, onTabChange: (value) => {
...
const VisualMenu = ({ chartType, setChartType, XAxis, setXAxis }) => {
    const model = hooks_1.useModel();
    const [cache, setCache] = hooks_1.useModelState("cache");
    const [colArray, setColArray] = react_1.useState(JSON.parse(cache.includes("selectedCol") ? cache : `{"selectedCol":[{"seriesName":"", "colName":"", "aggregate":""}]}`).selectedCol);
    const cacheObject = JSON.parse(cache === "" ? "{ }" : cache);
    const ChartIconMap = {
            ...
            react_1.default.createElement(core_1.Tabs.Panel, { value: "data" },
                react_1.default.createElement(core_1.ScrollArea, { h: const_1.MenuHeight, w: "100%", sx: {
                    ...
                    react_1.default.createElement(core_1.Grid, { sx: {
                        ...
                        react_1.default.createElement(XAxisSelection, { XAxis: XAxis, setXAxis: setXAxis, cacheObject: cacheObject, setCache: setCache, colName: colArray, sendVisSql: sendVisSql }),
                        colArray.map((item, index) => {
                            return (react_1.default.createElement(SelectDropDown, { index: index, name: item.colName, colArray: colArray, setColArray: setColArray, XAxis: XAxis, sendVisSql: sendVisSql }));
                        }),
...
//# sourceMappingURL=lib_WidgetModel_js.5546899a5e6b316d1dc2.js.map