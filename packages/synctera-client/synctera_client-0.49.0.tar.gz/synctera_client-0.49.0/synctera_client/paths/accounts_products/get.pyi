...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'product_type': typing.Union[ProductTypeSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = AccountProductList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_account_resource_products_oapg(
        self,
...
class ListAccountResourceProducts(BaseApi):
    ...
    def list_account_resource_products(
        ...
        return self._list_account_resource_products_oapg(
