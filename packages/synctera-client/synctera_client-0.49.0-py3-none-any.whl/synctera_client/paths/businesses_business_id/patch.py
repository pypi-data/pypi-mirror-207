...
request_path_business_id = api_client.PathParameter(
    name="business_id",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = PatchBusiness


request_body_patch_business = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Business
...
class BaseApi(api_client.Api):
    ...
    def _update_business_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_business.serialize(body, content_type)
