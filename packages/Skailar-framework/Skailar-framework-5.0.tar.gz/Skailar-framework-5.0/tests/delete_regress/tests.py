...
from skailar.db import connection, models, transaction
from skailar.db.models import Exists, OuterRef
...
class DeleteCascadeTests(TestCase):
    def test_generic_relation_cascade(self):
        """
        Skailar cascades deletes through generic-related objects to their
        reverse relations.
        """
