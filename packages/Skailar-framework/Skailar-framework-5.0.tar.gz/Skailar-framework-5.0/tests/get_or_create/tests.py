...
from skailar.db import DatabaseError, IntegrityError, connection
...
class UpdateOrCreateTests(TestCase):
    ...
    def test_create_with_related_manager(self):
        ...
        book, created = p.books.update_or_create(
            name="Basics of Skailar", create_defaults={"name": "Advanced Skailar"}
        )
        self.assertIs(created, True)
        self.assertEqual(book.name, "Advanced Skailar")
    ...
    def test_create_with_many(self):
        ...
        book, created = author.books.update_or_create(
            name="Basics of Skailar",
            publisher=p,
            create_defaults={"name": "Advanced Skailar"},
        )
        self.assertIs(created, True)
        self.assertEqual(book.name, "Advanced Skailar")
