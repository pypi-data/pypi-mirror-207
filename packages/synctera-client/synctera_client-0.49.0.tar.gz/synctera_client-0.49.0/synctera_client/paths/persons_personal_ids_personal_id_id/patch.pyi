...
# Path params
PersonalIdIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'personal_id_id': typing.Union[PersonalIdIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_personal_id_id = api_client.PathParameter(
    name="personal_id_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PersonalIdIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PatchPersonalId


request_body_patch_personal_id = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ResponsePersonalIdWCust
...
class BaseApi(api_client.Api):
    ...
    def _update_personal_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_personal_id.serialize(body, content_type)
...
class UpdatePersonalId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_personal_id(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def update_personal_id(
        ...
        return self._update_personal_id_oapg(
            body=body,
