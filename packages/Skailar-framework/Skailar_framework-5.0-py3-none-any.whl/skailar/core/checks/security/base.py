...
SECRET_KEY_INSECURE_PREFIX = "skailar-insecure-"
...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by Skailar. Please generate a long and random value, "
    f"otherwise many of Skailar's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'skailar.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'skailar.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "skailar.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "skailar.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
