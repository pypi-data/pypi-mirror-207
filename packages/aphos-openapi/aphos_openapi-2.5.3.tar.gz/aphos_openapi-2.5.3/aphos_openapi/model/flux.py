...
class Flux(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, right_asc, declination, added_by, ap_auto, apertures, photo, ap_auto_dev, aperture_devs, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, right_asc, declination, added_by, ap_auto, apertures, photo, ap_auto_dev, aperture_devs, *args, **kwargs):  # noqa: E501
        """Flux - a model defined in OpenAPI
