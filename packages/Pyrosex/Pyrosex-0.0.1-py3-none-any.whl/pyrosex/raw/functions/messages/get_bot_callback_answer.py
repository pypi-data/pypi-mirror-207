...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        game (optional): ``bool``
        data (optional): ``bytes``
        password (optional): :obj:`InputCheckPasswordSRP <pyrosex.raw.base.InputCheckPasswordSRP>`

    Returns:
        :obj:`messages.BotCallbackAnswer <pyrosex.raw.base.messages.BotCallbackAnswer>`
    """
