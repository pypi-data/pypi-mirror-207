...
class BotResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.BotResults`.
    ...
    Parameters:
        query_id: ``int`` ``64-bit``
        results: List of :obj:`BotInlineResult <pyrosex.raw.base.BotInlineResult>`
        cache_time: ``int`` ``32-bit``
        users: List of :obj:`User <pyrosex.raw.base.User>`
        gallery (optional): ``bool``
        next_offset (optional): ``str``
        switch_pm (optional): :obj:`InlineBotSwitchPM <pyrosex.raw.base.InlineBotSwitchPM>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetInlineBotResults <pyrosex.raw.functions.messages.GetInlineBotResults>`
    """
