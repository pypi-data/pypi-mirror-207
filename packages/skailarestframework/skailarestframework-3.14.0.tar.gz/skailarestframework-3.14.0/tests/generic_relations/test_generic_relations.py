...
class TestGenericRelations(TestCase):
    def setUp(self):
        self.bookmark = Bookmark.objects.create(url='https://www.skailarproject.com/')
        Tag.objects.create(tagged_item=self.bookmark, tag='skailar')
    ...
    def test_generic_relation(self):
        ...
        expected = {
            'tags': ['skailar', 'python'],
            'url': 'https://www.skailarproject.com/'
        }
    ...
    def test_generic_fk(self):
        ...
        expected = [
            {
                'tag': 'skailar',
                'tagged_item': 'Bookmark: https://www.skailarproject.com/'
            },
            {
                'tag': 'python',
                'tagged_item': 'Bookmark: https://www.skailarproject.com/'
