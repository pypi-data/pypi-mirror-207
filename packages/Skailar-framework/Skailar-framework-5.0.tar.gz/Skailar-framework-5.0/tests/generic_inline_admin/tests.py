...
from skailar.contrib.admin.sites import AdminSite
from skailar.contrib.auth.models import User
from skailar.contrib.contenttypes.admin import GenericTabularInline
from skailar.contrib.contenttypes.models import ContentType
from skailar.forms.formsets import DEFAULT_MAX_NUM
from skailar.forms.models import ModelForm
...
class GenericAdminViewTest(TestDataMixin, TestCase):
    def setUp(self):
        ...
        e = Episode.objects.create(name="This Week in Skailar")
...
class GenericInlineAdminParametersTest(TestDataMixin, TestCase):
    ...
    def _create_object(self, model):
        ...
        """
        e = model.objects.create(name="This Week in Skailar")
