...
class State:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`updates.State <pyrosex.raw.types.updates.State>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`updates.GetState <pyrosex.raw.functions.updates.GetState>`
    """

    QUALNAME = "pyrosex.raw.base.updates.State"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/state")
