...
# body param
SchemaForRequestBodyApplicationJson = PaymentSchedule


request_body_payment_schedule = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PaymentSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_payment_schedule_oapg(
        self,
    ...
    def _create_payment_schedule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_payment_schedule.serialize(body, content_type)
...
class CreatePaymentSchedule(BaseApi):
    ...
    def create_payment_schedule(
        ...
        return self._create_payment_schedule_oapg(
            body=body,
