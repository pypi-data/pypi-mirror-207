...
class FavedStickers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.FavedStickers <pyrosex.raw.types.messages.FavedStickers>`
            - :obj:`messages.FavedStickersNotModified <pyrosex.raw.types.messages.FavedStickersNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetFavedStickers <pyrosex.raw.functions.messages.GetFavedStickers>`
    """

    QUALNAME = "pyrosex.raw.base.messages.FavedStickers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/faved-stickers")
