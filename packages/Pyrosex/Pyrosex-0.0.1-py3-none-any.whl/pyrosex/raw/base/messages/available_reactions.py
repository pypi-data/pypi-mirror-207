...
class AvailableReactions:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.AvailableReactions <pyrosex.raw.types.messages.AvailableReactions>`
            - :obj:`messages.AvailableReactionsNotModified <pyrosex.raw.types.messages.AvailableReactionsNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetAvailableReactions <pyrosex.raw.functions.messages.GetAvailableReactions>`
    """

    QUALNAME = "pyrosex.raw.base.messages.AvailableReactions"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/available-reactions")
