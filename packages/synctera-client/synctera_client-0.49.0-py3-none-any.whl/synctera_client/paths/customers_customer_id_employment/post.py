...
SchemaFor201ResponseBodyApplicationJson = Employment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_customer_employment_oapg(
        self,
...
class CreateCustomerEmployment(BaseApi):
    ...
    def create_customer_employment(
        ...
        return self._create_customer_employment_oapg(
            body=body,
