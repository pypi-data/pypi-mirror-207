...
setup(
    ...
    description='A toolkit to get or remove similar items from the csv file',  # Optional
    ...
    # https://packaging.python.org/specifications/core-metadata/#home-page-optional
     url='https://github.com/dhchenx/csv-similarity',  # Optional
    ...
    # larger catalog.
    keywords="csv file similarity",  # Optional
    ...
    install_requires=[
        "jieba","numpy","strsimpy","quick-csv"
    ],  # Optional
