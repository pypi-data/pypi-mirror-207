...
class MultiScreener(BaseModel):
    ...
    def __init__(
        ...
        self.market: Dict[str, Dict[str, Optional[Union[AutoScreener, AutoDataset]]]] = {}
        self.invalid: Dict[str, List[str]] = {}
        self.screeners: List[Union[AutoScreener, AutoDataset]] = []
        self.stopped: List[Union[AutoScreener, AutoDataset]] = []
        self.loaded: Set[Union[AutoScreener, AutoDataset]] = set()
    ...
    def save_dataset(self, screener: Union[AutoScreener, AutoDataset]) -> None:
        """
    ...
    def load_dataset(self, screener: Union[AutoScreener, AutoDataset]) -> None:
        """
        Saves the data of the screener.
    ...
    def handle(self, screener: Union[AutoScreener, AutoDataset]) -> None:
        """
        ...
        if (
            ...
            (dt.datetime.now() - screener.market.index[-1]).seconds >=
            self.cancel + (
...
Screeners = Union[
    AutoScreener, AutoScreener, MultiScreener
]

def live_screeners(screeners: Iterable[Screeners]) -> List[Screeners]:
    """
