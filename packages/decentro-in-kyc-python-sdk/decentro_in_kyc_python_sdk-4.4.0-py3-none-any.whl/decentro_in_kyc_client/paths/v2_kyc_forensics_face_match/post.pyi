...
from decentro_in_kyc_client.model.match_face400_response import MatchFace400Response as MatchFace400ResponseSchema
from decentro_in_kyc_client.model.match_face_request import MatchFaceRequest as MatchFaceRequestSchema
from decentro_in_kyc_client.model.match_face_response import MatchFaceResponse as MatchFaceResponseSchema

from decentro_in_kyc_client.type.match_face_response import MatchFaceResponse
from decentro_in_kyc_client.type.match_face_request import MatchFaceRequest
from decentro_in_kyc_client.type.match_face400_response import MatchFace400Response

# body param
SchemaForRequestBodyMultipartFormData = MatchFaceRequestSchema


request_body_match_face_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MatchFaceResponseSchema
...
SchemaFor400ResponseBodyApplicationJson = MatchFace400ResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: MatchFace400Response
...
class BaseApi(api_client.Api):
    ...
    def _match_face_mapped_args(
        self,
        body: typing.Optional[MatchFaceRequest] = None,
        reference_id: typing.Optional[str] = None,
        consent: typing.Optional[str] = None,
        consent_purpose: typing.Optional[str] = None,
        image1: typing.Optional[typing.IO] = None,
        image2: typing.Optional[typing.IO] = None,
        threshold: typing.Optional[int] = None,
        image1_url: typing.Optional[str] = None,
        image2_url: typing.Optional[str] = None,
        ...
        if threshold is not None:
            _body["threshold"] = threshold
        if image1_url is not None:
            _body["image1_url"] = image1_url
        if image2_url is not None:
            _body["image2_url"] = image2_url
    ...
    async def _amatch_face_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_match_face_request.serialize(body, content_type)
...
class MatchFace(BaseApi):
    ...
    async def amatch_face(
        ...
        args = self._match_face_mapped_args(
            body=body,
        ...
        return await self._amatch_face_oapg(
            body=args.body,
        )
