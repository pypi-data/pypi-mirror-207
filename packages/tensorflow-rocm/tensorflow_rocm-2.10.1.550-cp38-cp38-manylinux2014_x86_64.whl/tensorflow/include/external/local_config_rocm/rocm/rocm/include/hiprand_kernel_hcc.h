...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/hiprand/hiprand_kernel_hcc.h by using #include <hiprand/hiprand_kernel_hcc.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/hiprand/hiprand_kernel_hcc.h by using #include <hiprand/hiprand_kernel_hcc.h>"
#endif
/* include file */
