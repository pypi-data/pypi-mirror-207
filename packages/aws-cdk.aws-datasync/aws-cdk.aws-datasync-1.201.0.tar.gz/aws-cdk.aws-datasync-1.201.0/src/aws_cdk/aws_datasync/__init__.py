...
class CfnStorageSystem(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param agent_arns: ``AWS::DataSync::StorageSystem.AgentArns``.
        :param server_configuration: ``AWS::DataSync::StorageSystem.ServerConfiguration``.
        :param system_type: ``AWS::DataSync::StorageSystem.SystemType``.
        :param cloud_watch_log_group_arn: ``AWS::DataSync::StorageSystem.CloudWatchLogGroupArn``.
        :param name: ``AWS::DataSync::StorageSystem.Name``.
        :param server_credentials: ``AWS::DataSync::StorageSystem.ServerCredentials``.
        :param tags: ``AWS::DataSync::StorageSystem.Tags``.
        '''
        if __debug__:
    ...
    class ServerConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param server_hostname: ``CfnStorageSystem.ServerConfigurationProperty.ServerHostname``.
            :param server_port: ``CfnStorageSystem.ServerConfigurationProperty.ServerPort``.
    ...
    class ServerCredentialsProperty:
        def __init__(self, *, password: builtins.str, username: builtins.str) -> None:
            '''
            :param password: ``CfnStorageSystem.ServerCredentialsProperty.Password``.
            :param username: ``CfnStorageSystem.ServerCredentialsProperty.Username``.
