...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice: :obj:`InputInvoice <pyrosex.raw.base.InputInvoice>`
        info: :obj:`PaymentRequestedInfo <pyrosex.raw.base.PaymentRequestedInfo>`
        save (optional): ``bool``

    Returns:
        :obj:`payments.ValidatedRequestedInfo <pyrosex.raw.base.payments.ValidatedRequestedInfo>`
    """
