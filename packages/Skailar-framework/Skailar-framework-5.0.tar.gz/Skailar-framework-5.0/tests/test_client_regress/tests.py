...
from skailar.contrib.auth.signals import user_logged_in, user_logged_out
from skailar.http import HttpResponse
from skailar.template import Context, RequestContext, TemplateSyntaxError, engines
from skailar.template.response import SimpleTemplateResponse
...
from skailar.test.client import RedirectCycleError, RequestFactory, encode_file
...
class AssertContainsTests(SimpleTestCase):
    ...
    def test_assert_contains_renders_template_response(self):
        ...
        """
        template = engines["skailar"].from_string("Hello")
...
class AssertRedirectsTests(SimpleTestCase):
    ...
    def test_redirect_fetch_redirect_response(self):
        """Preserve extra headers of requests made with skailar.test.Client."""
        methods = (
            "get",
            "post",
            "head",
