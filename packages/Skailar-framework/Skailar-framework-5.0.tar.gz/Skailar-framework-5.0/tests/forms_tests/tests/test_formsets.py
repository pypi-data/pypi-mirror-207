...
from skailar.forms.formsets import (
    INITIAL_FORM_COUNT,
    MAX_NUM_FORM_COUNT,
    MIN_NUM_FORM_COUNT,
    TOTAL_FORM_COUNT,
...
from skailar.forms.renderers import TemplatesSetting
from skailar.forms.utils import ErrorList
from skailar.forms.widgets import HiddenInput
...
<div>Votes:<input type="number" name="choices-0-votes"></div>""",
    ...
    def test_formset_validation_count(self):
        ...
        with mock.patch(
            "skailar.forms.formsets.ManagementForm.is_valid", mocked_is_valid
        ), mock.patch("skailar.forms.forms.BaseForm.full_clean", mocked_full_clean):
            self.assertTrue(formset.is_valid())
...
<input type="text" name="form-0-name" id="id_form-0-name"></div>""",
    ...
    def test_custom_renderer(self):
        ...
        and ErrorList.
        """
        from skailar.forms.renderers import Jinja2
