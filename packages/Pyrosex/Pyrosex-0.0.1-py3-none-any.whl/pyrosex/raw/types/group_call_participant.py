...
class GroupCallParticipant(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.GroupCallParticipant`.
    ...
    Parameters:
        peer: :obj:`Peer <pyrosex.raw.base.Peer>`
        date: ``int`` ``32-bit``
        source: ``int`` ``32-bit``
        muted (optional): ``bool``
        left (optional): ``bool``
        ...
        video (optional): :obj:`GroupCallParticipantVideo <pyrosex.raw.base.GroupCallParticipantVideo>`
        presentation (optional): :obj:`GroupCallParticipantVideo <pyrosex.raw.base.GroupCallParticipantVideo>`
    """
