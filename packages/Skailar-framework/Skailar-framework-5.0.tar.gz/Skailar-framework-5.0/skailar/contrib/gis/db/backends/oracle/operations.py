...
from skailar.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
from skailar.contrib.gis.db.backends.utils import SpatialOperator
from skailar.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from skailar.contrib.gis.geos.prototypes.io import wkb_r
from skailar.contrib.gis.measure import Distance
from skailar.db.backends.oracle.operations import DatabaseOperations
...
class OracleOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from skailar.contrib.gis.db.backends.oracle.models import OracleGeometryColumns

        return OracleGeometryColumns

    def spatial_ref_sys(self):
        from skailar.contrib.gis.db.backends.oracle.models import OracleSpatialRefSys
