...
from skailar.core.cache.backends.base import DEFAULT_TIMEOUT, BaseCache
from skailar.db import DatabaseError, connections, models, router, transaction
from skailar.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a Skailar model _meta class.
