class SESChecks:
    ...
    SES_IAM_AUTH="SES MUST have IAM enabled and used to manage authentication and authorization"
...
class SESMethodAssociations:
    ...
    SES_IAM_AUTH = "check_iam_policies"
...
security_checks = {
    ...
    # },
    "SES_IAM_AUTH": {
        "method_name": SESMethodAssociations.SES_IAM_AUTH,
        "check_description": SESChecks.SES_IAM_AUTH
    },
    " SES_CHECK_TAGS": {
