...
class Pong:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`Pong <pyrosex.raw.types.Pong>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`Ping <pyrosex.raw.functions.Ping>`
            - :obj:`PingDelayDisconnect <pyrosex.raw.functions.PingDelayDisconnect>`
    """

    QUALNAME = "pyrosex.raw.base.Pong"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/pong")
