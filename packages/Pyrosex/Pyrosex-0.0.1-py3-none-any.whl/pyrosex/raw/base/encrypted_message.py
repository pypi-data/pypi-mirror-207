...
class EncryptedMessage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`EncryptedMessage <pyrosex.raw.types.EncryptedMessage>`
            - :obj:`EncryptedMessageService <pyrosex.raw.types.EncryptedMessageService>`
    """

    QUALNAME = "pyrosex.raw.base.EncryptedMessage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/encrypted-message")
