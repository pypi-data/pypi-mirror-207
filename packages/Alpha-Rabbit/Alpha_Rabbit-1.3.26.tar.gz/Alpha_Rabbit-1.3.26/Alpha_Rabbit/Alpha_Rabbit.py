...
class multi_factor_test(object):
    ...
    def multif_select_noisies(self,allfactors,Price,quantiles,days,savedir):
        '''
        输入:
        因子矩阵
        ...
        for fc in list(allfactors):
            ...
            qreturn,clean_factor = sst.factor_ret_test_sheet(fc,res_df,Price,quantiles,days,savedir)
        ...
        for nzfc in list(noise_factors_df):
            ...
            nz_qreturn,clean_factor = sst.factor_ret_test_sheet(nzfc,nz_res_df,Price,quantiles,days,savedir)
            # 因子判别
    ...
    def multif_select_short(self,allfactors,Price,quantiles,days,savedir):
        '''
        输入:
        去噪后的因子
        ...
        for srtfc in list(short_factors_df):
            ...
            srt_qreturn,clean_factor = sst.factor_ret_test_sheet(srtfc,srt_res_df,Price,quantiles,days,savedir)
            # 因子判别
