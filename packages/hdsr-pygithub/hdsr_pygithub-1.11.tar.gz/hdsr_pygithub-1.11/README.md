...
[example repo]: https://github.com/hdsr-mid/path_finder
...
5. You can use this token in two ways:
   1. recommended: Create a file on your personal HDSR drive (do not share this file with others!): 
      - 'G:/secrets.env' and add one line: GITHUB_PERSONAL_ACCESS_TOKEN=<your_token>
...
```
pip install hdsr-pygithub (or 'conda install hdsr-pygithub --channel hdsr-mid') 
...
```
# Ensure you followed steps 1, 2, 3, , 4 and 5.1 topic 'Token' above
pip install hdsr-pygithub (or 'conda install hdsr-pygithub --channel hdsr-mid')
...
hdsr_pygithub\downloader\base.py     244     38    84%
