...
from skailar.db import DEFAULT_DB_ALIAS, router, transaction
from skailar.db.models import signals
from skailar.db.utils import ConnectionRouter
from skailar.test import SimpleTestCase, TestCase, override_settings
...
class QueryTestCase(TestCase):
    ...
    def test_default_creation(self):
        ...
        Book.objects.create(title="Pro Skailar", published=datetime.date(2008, 12, 16))
        ...
        try:
            Book.objects.get(title="Pro Skailar")
            Book.objects.using("default").get(title="Pro Skailar")
        except Book.DoesNotExist:
            self.fail('"Pro Skailar" should exist on default database')

        with self.assertRaises(Book.DoesNotExist):
            Book.objects.using("other").get(title="Pro Skailar")
    ...
    def test_other_creation(self):
        ...
        Book.objects.using("other").create(
            title="Pro Skailar", published=datetime.date(2008, 12, 16)
        )
        ...
        try:
            ...
            self.fail('"Pro Skailar" should exist on other database')
    ...
    def test_foreign_key_separation(self):
        ...
        pro = Book.objects.using("default").get(title="Pro Skailar")
        ...
        self.assertEqual(
            list(
                ...
                .filter(edited__title="Pro Skailar")
                .values_list("name", flat=True)
            ),
            ["George Vilches"],
        )
    ...
    def test_generic_key_separation(self):
        ...
        self.assertEqual(review1.content_object.title, "Pro Skailar")
...
class RouterTestCase(TestCase):
    ...
    def test_database_routing(self):
        ...
        Book.objects.filter(title="Pro Skailar").update(pages=200)
        ...
        book, created = Book.objects.get_or_create(title="Pro Skailar")
    ...
    def test_m2m_cross_database_protection(self):
        ...
        pro = Book.objects.using("other").create(
            pk=1, title="Pro Skailar", published=datetime.date(2008, 12, 16)
        )
...
class FixtureTestCase(TestCase):
    ...
    def test_fixture_loading(self):
        ...
        # "Pro Skailar" exists on the default database, but not on other database
        Book.objects.get(title="Pro Skailar")
        Book.objects.using("default").get(title="Pro Skailar")
        ...
        Book.objects.get(title="The Definitive Guide to Skailar")
        Book.objects.using("default").get(title="The Definitive Guide to Skailar")
        Book.objects.using("other").get(title="The Definitive Guide to Skailar")
