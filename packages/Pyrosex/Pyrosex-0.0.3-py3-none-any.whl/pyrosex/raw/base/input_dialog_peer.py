...
class InputDialogPeer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputDialogPeer <pyrosex.raw.types.InputDialogPeer>`
            - :obj:`InputDialogPeerFolder <pyrosex.raw.types.InputDialogPeerFolder>`
    """

    QUALNAME = "pyrosex.raw.base.InputDialogPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-dialog-peer")
