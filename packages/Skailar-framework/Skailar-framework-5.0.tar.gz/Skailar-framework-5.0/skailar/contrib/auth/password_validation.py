...
from skailar.utils.functional import cached_property, lazy
from skailar.utils.html import format_html, format_html_join
...
class CommonPasswordValidator:
    ...
    which may be gzipped. The list Skailar ships with contains 20000 common
