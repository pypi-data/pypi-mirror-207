...
class ExportedChatInvites:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ExportedChatInvites <pyrosex.raw.types.messages.ExportedChatInvites>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetExportedChatInvites <pyrosex.raw.functions.messages.GetExportedChatInvites>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ExportedChatInvites"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-chat-invites")
