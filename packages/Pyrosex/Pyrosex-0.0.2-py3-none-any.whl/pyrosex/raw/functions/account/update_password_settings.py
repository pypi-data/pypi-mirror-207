...
class UpdatePasswordSettings(TLObject):  # type: ignore
    ...
    Parameters:
        password: :obj:`InputCheckPasswordSRP <pyrosex.raw.base.InputCheckPasswordSRP>`
        new_settings: :obj:`account.PasswordInputSettings <pyrosex.raw.base.account.PasswordInputSettings>`
