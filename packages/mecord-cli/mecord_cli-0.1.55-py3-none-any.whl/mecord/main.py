...
from mecord.windows.I_application import IApplication
from mecord import xy_user
from mecord.windows import resources_rc
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        app = IApplication(sys.argv)

        SignalCenter().show_main_window.emit()
