...
# The given code calculates the quality of remote sensing images using various evaluation metrics:
# RMSE, CC, DD, ERGAS, PSNR, RSNR, SAM, SSIM, and UIQI. Each function corresponds to a specific metric
# and computes the similarity between a reference image (ref_img) and a reconstructed image (rec_img).
