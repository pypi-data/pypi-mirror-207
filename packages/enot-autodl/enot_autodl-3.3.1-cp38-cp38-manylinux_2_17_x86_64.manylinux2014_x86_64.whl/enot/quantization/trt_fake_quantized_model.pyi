...
class TrtFakeQuantizedModel(FakeQuantizedModel):
    def __init__(self, model: nn.Module, leaf_modules: Optional[List[Union[Type[nn.Module], nn.Module]]] = ..., quantization_scheme: str = ..., use_weight_scale_factors: bool = ..., use_bias_scale_factors: bool = ...) -> None: ...
