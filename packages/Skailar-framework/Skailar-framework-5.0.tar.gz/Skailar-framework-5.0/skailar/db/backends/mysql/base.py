"""
MySQL database backend for Skailar.

Requires mysqlclient: https://pypi.org/project/mysqlclient/
"""
from skailar.core.exceptions import ImproperlyConfigured
from skailar.db import IntegrityError
from skailar.db.backends import utils as backend_utils
...
# terms of actual behavior as they are signed and include days -- and Skailar
# expects time.
skailar_conversions = {
    **conversions,
...
class CursorWrapper:
    ...
    def execute(self, query, args=None):
        try:
            ...
            # misclassified and Skailar would prefer the more logical place.
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        # prevent KeyErrors in Skailar < 2.0. We can remove this workaround when
        # mysqlclient 2.1 becomes the minimal mysqlclient supported by Skailar.
