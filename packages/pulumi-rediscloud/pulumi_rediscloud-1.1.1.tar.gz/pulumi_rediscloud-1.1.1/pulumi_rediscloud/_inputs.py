...
class SubscriptionCloudProviderRegionArgs:
    def __init__(__self__, *,
                 networking_deployment_cidr: pulumi.Input[str],
                 preferred_availability_zones: pulumi.Input[Sequence[pulumi.Input[str]]],
                 region: pulumi.Input[str],
        ...
        """
        :param pulumi.Input[str] networking_deployment_cidr: Deployment CIDR mask. The total number of bits must be 24 (x.x.x.x/24)
        :param pulumi.Input[Sequence[pulumi.Input[str]]] preferred_availability_zones: Availability zones deployment preferences (for the selected provider & region). If multiple_availability_zones is set to 'true', select three availability zones from the list. If you don't want to specify preferred avaialbility zones, set this attribute to an empty list ('[]').
        :param pulumi.Input[str] region: Deployment region as defined by cloud provider
        :param pulumi.Input[bool] multiple_availability_zones: Support deployment on multiple availability zones within the selected region. Default: ‘false’
    ...
    def preferred_availability_zones(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    def preferred_availability_zones(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
...
class SubscriptionCreationPlanArgs:
    def __init__(__self__, *,
                 memory_limit_in_gb: pulumi.Input[float],
                 modules: pulumi.Input[Sequence[pulumi.Input[str]]],
                 quantity: pulumi.Input[int],
        ...
        :param pulumi.Input[int] quantity: The planned number of databases in the subscription
        :param pulumi.Input[bool] replication: Databases replication. Set to `true` if any of your databases will use replication
    ...
    @property
    @pulumi.getter
    def modules(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    @modules.setter
    def modules(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
