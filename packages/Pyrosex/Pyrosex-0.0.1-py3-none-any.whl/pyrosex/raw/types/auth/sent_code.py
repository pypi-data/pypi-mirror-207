...
class SentCode(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.auth.SentCode`.
    ...
    Parameters:
        type: :obj:`auth.SentCodeType <pyrosex.raw.base.auth.SentCodeType>`
        phone_code_hash: ``str``
        next_type (optional): :obj:`auth.CodeType <pyrosex.raw.base.auth.CodeType>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.SendCode <pyrosex.raw.functions.auth.SendCode>`
            - :obj:`auth.ResendCode <pyrosex.raw.functions.auth.ResendCode>`
            - :obj:`account.SendChangePhoneCode <pyrosex.raw.functions.account.SendChangePhoneCode>`
            - :obj:`account.SendConfirmPhoneCode <pyrosex.raw.functions.account.SendConfirmPhoneCode>`
            - :obj:`account.SendVerifyPhoneCode <pyrosex.raw.functions.account.SendVerifyPhoneCode>`
    """
