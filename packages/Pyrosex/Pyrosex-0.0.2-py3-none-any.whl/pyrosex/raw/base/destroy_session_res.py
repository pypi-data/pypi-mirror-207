...
class DestroySessionRes:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DestroySessionNone <pyrosex.raw.types.DestroySessionNone>`
            - :obj:`DestroySessionOk <pyrosex.raw.types.DestroySessionOk>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`DestroySession <pyrosex.raw.functions.DestroySession>`
    """

    QUALNAME = "pyrosex.raw.base.DestroySessionRes"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/destroy-session-res")
