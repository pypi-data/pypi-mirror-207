...
class NotificationSound:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`NotificationSoundDefault <pyrosex.raw.types.NotificationSoundDefault>`
            - :obj:`NotificationSoundLocal <pyrosex.raw.types.NotificationSoundLocal>`
            - :obj:`NotificationSoundNone <pyrosex.raw.types.NotificationSoundNone>`
            - :obj:`NotificationSoundRingtone <pyrosex.raw.types.NotificationSoundRingtone>`
    """

    QUALNAME = "pyrosex.raw.base.NotificationSound"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/notification-sound")
