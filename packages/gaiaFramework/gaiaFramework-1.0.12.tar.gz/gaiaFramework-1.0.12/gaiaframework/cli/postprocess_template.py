...
from gaiaframework.base.pipeline.postprocessor import ZIDS_Postprocessor
...
class generatedClass(ZIDS_Postprocessor):
    ...
    def config(self):
        """Implement here configurations required on Preprocess stage. Overrides ZIDS_Component.config()"""
        pass
