...
class PassportConfig:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.PassportConfig <pyrosex.raw.types.help.PassportConfig>`
            - :obj:`help.PassportConfigNotModified <pyrosex.raw.types.help.PassportConfigNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPassportConfig <pyrosex.raw.functions.help.GetPassportConfig>`
    """

    QUALNAME = "pyrosex.raw.base.help.PassportConfig"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/passport-config")
