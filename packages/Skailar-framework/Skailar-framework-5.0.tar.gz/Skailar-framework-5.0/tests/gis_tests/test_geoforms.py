...
from skailar.contrib.gis import forms
from skailar.contrib.gis.forms import BaseGeometryWidget, OpenLayersWidget
...
class GeometryFieldTest(SimpleTestCase):
    ...
    def test_field_string_value(self):
        ...
        with self.assertLogs("skailar.contrib.gis", "ERROR") as logger_calls:
            output = str(form)
