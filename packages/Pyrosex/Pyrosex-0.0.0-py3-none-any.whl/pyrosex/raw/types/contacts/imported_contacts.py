...
class ImportedContacts(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported: List of :obj:`ImportedContact <pyrosex.raw.base.ImportedContact>`
        popular_invites: List of :obj:`PopularContact <pyrosex.raw.base.PopularContact>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.ImportContacts <pyrosex.raw.functions.contacts.ImportContacts>`
    """
