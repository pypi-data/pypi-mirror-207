...
class ArchivedStickers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ArchivedStickers <pyrosex.raw.types.messages.ArchivedStickers>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetArchivedStickers <pyrosex.raw.functions.messages.GetArchivedStickers>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ArchivedStickers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/archived-stickers")
