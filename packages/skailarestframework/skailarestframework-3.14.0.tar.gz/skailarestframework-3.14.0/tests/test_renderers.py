...
from skailar.utils.safestring import SafeText
...
class RendererEndToEndTests(TestCase):
    ...
    def test_204_no_content_responses_have_no_content_type_set(self):
        ...
        https://github.com/encode/skailar-rest-framework/issues/1196
        """
...
class TestSchemaJSRenderer(TestCase):
    ...
    def test_schemajs_output(self):
        """
        Test output of the SchemaJS renderer as per #5608. Skailar 2.0 on Py3 prints binary data as b'xyz' in templates,
