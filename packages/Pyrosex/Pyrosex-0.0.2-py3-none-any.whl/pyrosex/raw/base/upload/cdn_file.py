...
class CdnFile:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`upload.CdnFile <pyrosex.raw.types.upload.CdnFile>`
            - :obj:`upload.CdnFileReuploadNeeded <pyrosex.raw.types.upload.CdnFileReuploadNeeded>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`upload.GetCdnFile <pyrosex.raw.functions.upload.GetCdnFile>`
    """

    QUALNAME = "pyrosex.raw.base.upload.CdnFile"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/cdn-file")
