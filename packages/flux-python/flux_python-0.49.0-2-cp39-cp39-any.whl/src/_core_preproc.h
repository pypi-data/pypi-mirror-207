...
# 1089 "/workspaces/flux-python/src/_core_clean.h"
...
# 1140 "/workspaces/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1263 "/workspaces/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg, const char **topic,
                          const char **s);
# 1274 "/workspaces/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1487 "/workspaces/flux-python/src/_core_clean.h"
...
# 1565 "/workspaces/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1607 "/workspaces/flux-python/src/_core_clean.h"
enum {
...
# 1676 "/workspaces/flux-python/src/_core_clean.h"
int flux_panic (flux_t *h, uint32_t nodeid, int flags, const char *reason);
# 1777 "/workspaces/flux-python/src/_core_clean.h"
enum {
...
# 1866 "/workspaces/flux-python/src/_core_clean.h"
...
# 1914 "/workspaces/flux-python/src/_core_clean.h"
...
# 1952 "/workspaces/flux-python/src/_core_clean.h"
...
# 2181 "/workspaces/flux-python/src/_core_clean.h"
enum {
...
# 2268 "/workspaces/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2337 "/workspaces/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2347 "/workspaces/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2380 "/workspaces/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2412 "/workspaces/flux-python/src/_core_clean.h"
...
# 2481 "/workspaces/flux-python/src/_core_clean.h"
...
# 2564 "/workspaces/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2579 "/workspaces/flux-python/src/_core_clean.h"
...
# 2652 "/workspaces/flux-python/src/_core_clean.h"
...
# 2702 "/workspaces/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2711 "/workspaces/flux-python/src/_core_clean.h"
...
# 2743 "/workspaces/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2821 "/workspaces/flux-python/src/_core_clean.h"
...
# 2877 "/workspaces/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2894 "/workspaces/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2917 "/workspaces/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2938 "/workspaces/flux-python/src/_core_clean.h"
...
# 2986 "/workspaces/flux-python/src/_core_clean.h"
...
# 3056 "/workspaces/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3067 "/workspaces/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3218 "/workspaces/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3232 "/workspaces/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3257 "/workspaces/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3368 "/workspaces/flux-python/src/_core_clean.h"
...
# 3410 "/workspaces/flux-python/src/_core_clean.h"
...
# 3430 "/workspaces/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3514 "/workspaces/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3717 "/workspaces/flux-python/src/_core_clean.h"
...
# 3748 "/workspaces/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3763 "/workspaces/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3783 "/workspaces/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3802 "/workspaces/flux-python/src/_core_clean.h"
...
# 3829 "/workspaces/flux-python/src/_core_clean.h"
...
# 3890 "/workspaces/flux-python/src/_core_clean.h"
