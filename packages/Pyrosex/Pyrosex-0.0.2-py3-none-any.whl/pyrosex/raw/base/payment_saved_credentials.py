...
class PaymentSavedCredentials:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PaymentSavedCredentialsCard <pyrosex.raw.types.PaymentSavedCredentialsCard>`
    """

    QUALNAME = "pyrosex.raw.base.PaymentSavedCredentials"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/payment-saved-credentials")
