...
class Dialogs:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.Dialogs <pyrosex.raw.types.messages.Dialogs>`
            - :obj:`messages.DialogsNotModified <pyrosex.raw.types.messages.DialogsNotModified>`
            - :obj:`messages.DialogsSlice <pyrosex.raw.types.messages.DialogsSlice>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDialogs <pyrosex.raw.functions.messages.GetDialogs>`
    """

    QUALNAME = "pyrosex.raw.base.messages.Dialogs"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/dialogs")
