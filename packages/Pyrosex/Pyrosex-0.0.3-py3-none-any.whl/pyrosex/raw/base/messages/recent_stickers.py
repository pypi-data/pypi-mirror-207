...
class RecentStickers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.RecentStickers <pyrosex.raw.types.messages.RecentStickers>`
            - :obj:`messages.RecentStickersNotModified <pyrosex.raw.types.messages.RecentStickersNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetRecentStickers <pyrosex.raw.functions.messages.GetRecentStickers>`
    """

    QUALNAME = "pyrosex.raw.base.messages.RecentStickers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/recent-stickers")
