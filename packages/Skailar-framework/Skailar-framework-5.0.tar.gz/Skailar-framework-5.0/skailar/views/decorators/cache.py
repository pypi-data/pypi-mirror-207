...
from skailar.middleware.cache import CacheMiddleware
from skailar.utils.cache import add_never_cache_headers, patch_cache_control
from skailar.utils.decorators import decorator_from_middleware_with_args
...
def cache_page(timeout, *, cache=None, key_prefix=None):
    ...
    get_current_site().domain, for example, as that is unique across a Skailar
    project.
