...
class InlineBotSwitchPM:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InlineBotSwitchPM <pyrosex.raw.types.InlineBotSwitchPM>`
    """

    QUALNAME = "pyrosex.raw.base.InlineBotSwitchPM"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/inline-bot-switch-pm")
