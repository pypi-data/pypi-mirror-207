...
__all__ = [
    ...
    'get_firewall_dos_policy6_output',
]
...
@_utilities.lift_output_func(get_firewall_dos_policy6)
def get_firewall_dos_policy6_output(policyid: Optional[pulumi.Input[int]] = None,
