...
# body param
SchemaForRequestBodyApplicationJson = ReconciliationInput


request_body_reconciliation_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Reconciliation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_reconciliation_oapg(
        self,
    ...
    def _create_reconciliation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_reconciliation_input.serialize(body, content_type)
...
class CreateReconciliation(BaseApi):
    ...
    def create_reconciliation(
        ...
        return self._create_reconciliation_oapg(
            body=body,
