...
# body param
SchemaForRequestBodyApplicationJson = InternalAccountPost


request_body_internal_account_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = InternalAccountResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_internal_accounts_oapg(
        self,
    ...
    def _add_internal_accounts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_internal_account_post.serialize(body, content_type)
...
class AddInternalAccounts(BaseApi):
    ...
    def add_internal_accounts(
        ...
        return self._add_internal_accounts_oapg(
            body=body,
