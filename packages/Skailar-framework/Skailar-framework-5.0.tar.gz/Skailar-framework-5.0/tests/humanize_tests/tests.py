...
from skailar.contrib.humanize.templatetags import humanize
from skailar.template import Context, Template, defaultfilters
...
from skailar.utils.timezone import get_fixed_timezone
...
@modify_settings(INSTALLED_APPS={"append": "skailar.contrib.humanize"})
