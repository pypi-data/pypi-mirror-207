...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~pyrosex.enums.ChatMemberStatus`):
            The member's status in the chat.

        user (:obj:`~pyrosex.types.User`, *optional*):
        ...
        invited_by (:obj:`~pyrosex.types.User`, *optional*):
        ...
        promoted_by (:obj:`~pyrosex.types.User`, *optional*):
            Administrators only. Information about the user who promoted this member as administrator.

        restricted_by (:obj:`~pyrosex.types.User`, *optional*):
