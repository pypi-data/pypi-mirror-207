...
class StickerSetInstallResult:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.StickerSetInstallResultArchive <pyrosex.raw.types.messages.StickerSetInstallResultArchive>`
            - :obj:`messages.StickerSetInstallResultSuccess <pyrosex.raw.types.messages.StickerSetInstallResultSuccess>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.InstallStickerSet <pyrosex.raw.functions.messages.InstallStickerSet>`
    """

    QUALNAME = "pyrosex.raw.base.messages.StickerSetInstallResult"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/sticker-set-install-result")
