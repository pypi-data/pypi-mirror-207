...
T = TypeVar("T", bound="AddGroupMembersJsonBody")


@attr.s(auto_attribs=True)
class AddGroupMembersJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_group_members_json_body = cls(
            user_ids=user_ids,
        )

        add_group_members_json_body.additional_properties = d
        return add_group_members_json_body
