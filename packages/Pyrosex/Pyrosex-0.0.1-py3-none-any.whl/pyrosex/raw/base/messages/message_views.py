...
class MessageViews:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.MessageViews <pyrosex.raw.types.messages.MessageViews>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetMessagesViews <pyrosex.raw.functions.messages.GetMessagesViews>`
    """

    QUALNAME = "pyrosex.raw.base.messages.MessageViews"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-views")
