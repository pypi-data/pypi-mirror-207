...
from skailar.test import TransactionTestCase
from skailar.test.utils import captured_stdout

from .models import Proxy, UserProxy

update_proxy_permissions = import_module(
    "skailar.contrib.auth.migrations.0011_update_proxy_permissions"
)
...
class ProxyModelWithDifferentAppLabelTests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        rather than the proxy model (as they were before Skailar 2.2 and
        migration 11).
        """
