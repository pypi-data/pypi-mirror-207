...
# Path params
ReconciliationIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'reconciliation_id': typing.Union[ReconciliationIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_reconciliation_id = api_client.PathParameter(
    name="reconciliation_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReconciliationIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = Reconciliation
...
class BaseApi(api_client.Api):
    ...
    def _get_reconciliation_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_reconciliation_id,
        ):
...
class GetReconciliation(BaseApi):
    ...
    def get_reconciliation(
        ...
        return self._get_reconciliation_oapg(
