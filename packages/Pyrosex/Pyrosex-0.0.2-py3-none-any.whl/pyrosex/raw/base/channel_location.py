...
class ChannelLocation:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChannelLocation <pyrosex.raw.types.ChannelLocation>`
            - :obj:`ChannelLocationEmpty <pyrosex.raw.types.ChannelLocationEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.ChannelLocation"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/channel-location")
