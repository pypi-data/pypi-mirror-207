...
R8Z3_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R8Z3Cluster(GenericK8sCluster):
    """ R8Z3 Cluster Overrides """

    allowed_instances: Instances = R8Z3_INSTANCES
