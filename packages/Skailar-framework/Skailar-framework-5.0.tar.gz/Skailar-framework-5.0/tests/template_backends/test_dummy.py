...
from skailar.forms import CharField, Form, Media
...
from skailar.template import TemplateDoesNotExist, TemplateSyntaxError
from skailar.template.backends.dummy import TemplateStrings
...
class TemplateStringsTests(SimpleTestCase):
    ...
    def test_skailar_html_escaping(self):
        if self.backend_name == "dummy":
            self.skipTest("test doesn't apply to dummy backend")
        ...
        form = TestForm()
        template = self.engine.get_template("template_backends/skailar_escaping.html")
