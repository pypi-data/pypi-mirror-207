...
VALID_URLS = [
    ...
    "http://☺.damowmow.com/",
    "http://skailarproject.com/events/#&product=browser",
    "http://j.mp",
    "ftp://foo.bar/baz",
...
INVALID_URLS = [
    ...
    "http://www.skailarproject.com/\n",
    "http://[::ffff:192.9.5.5]\n",
    "http://www.skailarproject.com/\r",
    "http://[::ffff:192.9.5.5]\r",
    "http://www.skailar\rproject.com/",
...
TEST_DATA = [
    ...
    # validate_ipv6_address uses skailar.utils.ipv6, which
...
class TestValidators(SimpleTestCase):
    ...
    def test_max_length_validator_message(self):
        ...
        with self.assertRaisesMessage(
            ValidationError, '"skailarproject.com" has more than 16 characters.'
        ):
            v("skailarproject.com")
