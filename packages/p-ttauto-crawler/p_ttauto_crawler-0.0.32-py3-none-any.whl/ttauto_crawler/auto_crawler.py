...
def processAllImage(data, curDownloadDir, addRandomText, img2videoCnt):
    src = curDownloadDir
    dst = curOutputDir()
    s = []
...
# data = {
#     "0":"https://www.bilibili.com/video/BV1rh411L7ZT/?spm_id_from=333.999.0.0&vd_source=538d26f8c0706aab9d1830e51e4ef45b",
# }
