...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setMinimumSize(QSize(440, 0))
        ...
        self.groupBox_5.setMinimumSize(QSize(230, 0))
        ...
        self.checkBox_UsingDriftUnloading_tabTAF.setEnabled(False)

        self.gridLayout_98.addWidget(self.checkBox_UsingDriftUnloading_tabTAF, 0, 0, 1, 1)


        self.gridLayout_2.addWidget(self.groupBox_48, 4, 0, 1, 1)

        self.groupBox = QGroupBox(self.tab_calibration)
        self.groupBox.setObjectName(u"groupBox")
        sizePolicy.setHeightForWidth(self.groupBox.sizePolicy().hasHeightForWidth())
        self.groupBox.setSizePolicy(sizePolicy)
        self.groupBox.setMinimumSize(QSize(440, 0))
        ...
        sizePolicy9.setHeightForWidth(self.graphicsView_tab_TipAreaFunction.sizePolicy().hasHeightForWidth())
        self.graphicsView_tab_TipAreaFunction.setSizePolicy(sizePolicy9)
        ...
        self.gridLayout_6.addWidget(self.pushButton_plot_chosen_test_tab_inclusive_frame_stiffness, 3, 0, 1, 2)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameStiffness_Calibration.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameStiffness_Calibration.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameCompliance_Calibration.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameCompliance_Calibration.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.graphicsView_tabTipAreaFunction.sizePolicy().hasHeightForWidth())
        self.graphicsView_tabTipAreaFunction.setSizePolicy(sizePolicy11)

        self.gridLayout_13.addWidget(self.graphicsView_tabTipAreaFunction, 2, 0, 1, 12)

        self.groupBox_22 = QGroupBox(self.tab_2)
        self.groupBox_22.setObjectName(u"groupBox_22")
        sizePolicy9.setHeightForWidth(self.groupBox_22.sizePolicy().hasHeightForWidth())
        self.groupBox_22.setSizePolicy(sizePolicy9)
        ...
        sizePolicy12.setHeightForWidth(self.label_27.sizePolicy().hasHeightForWidth())
        self.label_27.setSizePolicy(sizePolicy12)
        ...
        sizePolicy12.setHeightForWidth(self.label_31.sizePolicy().hasHeightForWidth())
        self.label_31.setSizePolicy(sizePolicy12)
        ...
        self.gridLayout_2.addWidget(self.graphicsView_tab_TipAreaFunction, 0, 2, 11, 3)

        self.groupBox_7 = QGroupBox(self.tab_calibration)
        self.groupBox_7.setObjectName(u"groupBox_7")
        sizePolicy.setHeightForWidth(self.groupBox_7.sizePolicy().hasHeightForWidth())
        self.groupBox_7.setSizePolicy(sizePolicy)
        self.groupBox_7.setMinimumSize(QSize(440, 0))
        ...
        self.gridLayout_15.addWidget(self.doubleSpinBox_E_Tip_tabTAF, 1, 1, 1, 1)

        self.label_64 = QLabel(self.groupBox_7)
        self.label_64.setObjectName(u"label_64")
        self.label_64.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_15.addWidget(self.label_64, 1, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.doubleSpinBox_Poisson_Tip_tabTAF, 1, 3, 1, 1)
        ...
        sizePolicy13.setHeightForWidth(self.lineEdit_TipName_tabTAF.sizePolicy().hasHeightForWidth())
        self.lineEdit_TipName_tabTAF.setSizePolicy(sizePolicy13)

        self.gridLayout_15.addWidget(self.lineEdit_TipName_tabTAF, 0, 1, 1, 3)
        ...
        sizePolicy5.setHeightForWidth(self.spinBox_number_of_TAFterms.sizePolicy().hasHeightForWidth())
        self.spinBox_number_of_TAFterms.setSizePolicy(sizePolicy5)
        self.spinBox_number_of_TAFterms.setValue(3)

        self.gridLayout_15.addWidget(self.spinBox_number_of_TAFterms, 2, 3, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.label_14, 2, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.groupBox_6, 7, 0, 1, 1)
        ...
        sizePolicy15.setHeightForWidth(self.tableWidget_tabTAF.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabTAF.setSizePolicy(sizePolicy15)
        self.tableWidget_tabTAF.setMinimumSize(QSize(205, 0))
        ...
        self.gridLayout_2.addWidget(self.tableWidget_tabTAF, 3, 1, 8, 1)
        ...
        sizePolicy16 = QSizePolicy(QSizePolicy.Ignored, QSizePolicy.Expanding)
        ...
        self.groupBox_10.setMinimumSize(QSize(440, 0))
        ...
        self.gridLayout_19.addWidget(self.groupBox_10, 1, 0, 1, 2)

        self.groupBox_9 = QGroupBox(self.tab_7)
        self.groupBox_9.setObjectName(u"groupBox_9")
        sizePolicy.setHeightForWidth(self.groupBox_9.sizePolicy().hasHeightForWidth())
        self.groupBox_9.setSizePolicy(sizePolicy)
        self.groupBox_9.setMinimumSize(QSize(440, 0))
        ...
        sizePolicy12.setHeightForWidth(self.label_77.sizePolicy().hasHeightForWidth())
        self.label_77.setSizePolicy(sizePolicy12)
        ...
        self.groupBox_8.setMinimumSize(QSize(230, 0))
        self.groupBox_8.setMaximumSize(QSize(230, 16777215))
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_UsingRate2findSurface_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_UsingRate2findSurface_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_19.addWidget(self.groupBox_8, 4, 0, 1, 1)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_iLHU_inclusive_frame_stiffness_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_iLHU_inclusive_frame_stiffness_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameStiffness_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameStiffness_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameCompliance_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameCompliance_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_19.addWidget(self.graphicsView_tab_TipAreaFunction_2, 0, 5, 10, 1)
        ...
        self.gridLayout_19.addWidget(self.groupBox_45, 3, 0, 1, 1)
        ...
        sizePolicy15.setHeightForWidth(self.tableWidget_tabTipRadius_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabTipRadius_FrameStiffness.setSizePolicy(sizePolicy15)
        self.tableWidget_tabTipRadius_FrameStiffness.setMinimumSize(QSize(205, 0))
        ...
        self.gridLayout_19.addWidget(self.tableWidget_tabTipRadius_FrameStiffness, 2, 1, 8, 1)
        ...
        self.gridLayout_19.addWidget(self.groupBox_11, 2, 0, 1, 1)
        ...
        self.gridLayout_62.addWidget(self.graphicsView_load_depth_tab_inclusive_frame_stiffness_tabTipRadius, 1, 0, 1, 3)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabTipRadius.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_62.addWidget(self.pushButton_plot_chosen_test_tab_inclusive_frame_stiffness_tabTipRadius, 3, 0, 1, 3)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_iLHU_inclusive_frame_stiffness_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.checkBox_iLHU_inclusive_frame_stiffness_tabTipRadius.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_TipRadius_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.lineEdit_TipRadius_tabTipRadius.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_reducedModulus_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.lineEdit_reducedModulus_tabTipRadius.setSizePolicy(sizePolicy10)
        ...
        sizePolicy14.setHeightForWidth(self.tableWidget_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabTipRadius.setSizePolicy(sizePolicy14)
        ...
        self.lineEdit = QLineEdit(self.groupBox_29)
        ...
        self.gridLayout_60.addWidget(self.lineEdit, 1, 1, 1, 3)
        ...
        sizePolicy19 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Maximum)
        sizePolicy19.setHorizontalStretch(0)
        sizePolicy19.setVerticalStretch(0)
        sizePolicy19.setHeightForWidth(self.lineEdit_path_tabTipRadius.sizePolicy().hasHeightForWidth())
        self.lineEdit_path_tabTipRadius.setSizePolicy(sizePolicy19)
        ...
        self.gridLayout_60.addWidget(self.lineEdit_path_tabTipRadius, 0, 1, 1, 3)
        ...
        self.gridLayout_60.addWidget(self.doubleSpinBox_Poisson_tabTipRadius, 2, 3, 1, 1)
        ...
        self.gridLayout_60.addWidget(self.doubleSpinBox_E_tabTipRadius, 2, 1, 1, 1)

        self.label_74 = QLabel(self.groupBox_29)
        self.label_74.setObjectName(u"label_74")
        sizePolicy12.setHeightForWidth(self.label_74.sizePolicy().hasHeightForWidth())
        self.label_74.setSizePolicy(sizePolicy12)

        self.gridLayout_60.addWidget(self.label_74, 2, 2, 1, 1)
        ...
        self.gridLayout_60.addWidget(self.label_83, 2, 0, 1, 1)
        ...
        self.groupBox_13.setMinimumSize(QSize(440, 0))
        ...
        sizePolicy11.setHeightForWidth(self.graphicsView_load_depth_tab_inclusive_frame_stiffness_tabHE_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.graphicsView_load_depth_tab_inclusive_frame_stiffness_tabHE_FrameStiffness.setSizePolicy(sizePolicy11)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameStiffness_tabHE_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameStiffness_tabHE_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameCompliance_tabHE_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameCompliance_tabHE_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_37.addWidget(self.graphicsView_tab_TipAreaFunction_3, 0, 2, 16, 1)
        ...
        self.groupBox_16.setMinimumSize(QSize(440, 0))
        ...
        self.gridLayout_37.addWidget(self.groupBox_16, 1, 0, 1, 2)
        ...
        self.tableWidget_tabHE_FrameStiffness.setMinimumSize(QSize(205, 0))
        ...
        self.gridLayout_37.addWidget(self.tableWidget_tabHE_FrameStiffness, 2, 1, 14, 1)
        ...
        self.gridLayout_37.addWidget(self.groupBox_41, 3, 0, 1, 1)
        ...
        self.groupBox_25.setMinimumSize(QSize(230, 0))
        self.groupBox_25.setMaximumSize(QSize(230, 16777215))
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_UsingRate2findSurface_tabHE_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_UsingRate2findSurface_tabHE_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_37.addWidget(self.groupBox_25, 4, 0, 1, 1)
        ...
        self.gridLayout_37.addWidget(self.groupBox_26, 6, 0, 1, 1)
        ...
        self.gridLayout_37.addWidget(self.progressBar_tabHE_FrameStiffness, 7, 0, 1, 1)
        ...
        self.gridLayout_37.addWidget(self.pushButton_Calculate_tabHE_FrameStiffness, 8, 0, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.doubleSpinBox_Poisson_Tip_tabHE, 1, 13, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.lineEdit_TipName_tabHE, 0, 3, 1, 11)
        ...
        self.gridLayout_43.addWidget(self.label_62, 1, 10, 1, 3)

        self.label_56 = QLabel(self.groupBox_23)
        self.label_56.setObjectName(u"label_56")
        sizePolicy12.setHeightForWidth(self.label_56.sizePolicy().hasHeightForWidth())
        self.label_56.setSizePolicy(sizePolicy12)
        self.label_56.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_43.addWidget(self.label_56, 3, 1, 1, 1)

        self.lineEdit_TAF2_tabHE = QLineEdit(self.groupBox_23)
        self.lineEdit_TAF2_tabHE.setObjectName(u"lineEdit_TAF2_tabHE")
        sizePolicy10.setHeightForWidth(self.lineEdit_TAF2_tabHE.sizePolicy().hasHeightForWidth())
        self.lineEdit_TAF2_tabHE.setSizePolicy(sizePolicy10)
        self.lineEdit_TAF2_tabHE.setMinimumSize(QSize(80, 0))
        self.lineEdit_TAF2_tabHE.setMaximumSize(QSize(80, 16777215))
        self.lineEdit_TAF2_tabHE.setReadOnly(True)

        self.gridLayout_43.addWidget(self.lineEdit_TAF2_tabHE, 3, 5, 1, 1)

        self.lineEdit_TAF1_tabHE = QLineEdit(self.groupBox_23)
        self.lineEdit_TAF1_tabHE.setObjectName(u"lineEdit_TAF1_tabHE")
        sizePolicy10.setHeightForWidth(self.lineEdit_TAF1_tabHE.sizePolicy().hasHeightForWidth())
        self.lineEdit_TAF1_tabHE.setSizePolicy(sizePolicy10)
        self.lineEdit_TAF1_tabHE.setMinimumSize(QSize(80, 0))
        self.lineEdit_TAF1_tabHE.setMaximumSize(QSize(80, 16777215))
        ...
        self.gridLayout_43.addWidget(self.lineEdit_TAF1_tabHE, 3, 2, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.lineEdit_TAF5_tabHE, 6, 5, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.label_53, 6, 4, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.lineEdit_TAF4_tabHE, 6, 2, 1, 1)

        self.label_57 = QLabel(self.groupBox_23)
        self.label_57.setObjectName(u"label_57")
        sizePolicy12.setHeightForWidth(self.label_57.sizePolicy().hasHeightForWidth())
        self.label_57.setSizePolicy(sizePolicy12)

        self.gridLayout_43.addWidget(self.label_57, 3, 4, 1, 1)

        self.label_58 = QLabel(self.groupBox_23)
        self.label_58.setObjectName(u"label_58")
        sizePolicy12.setHeightForWidth(self.label_58.sizePolicy().hasHeightForWidth())
        self.label_58.setSizePolicy(sizePolicy12)

        self.gridLayout_43.addWidget(self.label_58, 6, 8, 1, 1)

        self.label_55 = QLabel(self.groupBox_23)
        self.label_55.setObjectName(u"label_55")
        sizePolicy12.setHeightForWidth(self.label_55.sizePolicy().hasHeightForWidth())
        self.label_55.setSizePolicy(sizePolicy12)
        self.label_55.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_43.addWidget(self.label_55, 3, 8, 1, 1)

        self.label_54 = QLabel(self.groupBox_23)
        self.label_54.setObjectName(u"label_54")
        sizePolicy12.setHeightForWidth(self.label_54.sizePolicy().hasHeightForWidth())
        self.label_54.setSizePolicy(sizePolicy12)

        self.gridLayout_43.addWidget(self.label_54, 3, 13, 1, 1)

        self.lineEdit_TAF3_tabHE = QLineEdit(self.groupBox_23)
        self.lineEdit_TAF3_tabHE.setObjectName(u"lineEdit_TAF3_tabHE")
        sizePolicy23 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy23.setHorizontalStretch(0)
        sizePolicy23.setVerticalStretch(0)
        sizePolicy23.setHeightForWidth(self.lineEdit_TAF3_tabHE.sizePolicy().hasHeightForWidth())
        self.lineEdit_TAF3_tabHE.setSizePolicy(sizePolicy23)
        ...
        self.gridLayout_43.addWidget(self.lineEdit_TAF3_tabHE, 3, 10, 1, 1)
        ...
        self.gridLayout_43.addWidget(self.label_61, 1, 1, 1, 4)
        ...
        self.gridLayout_43.addWidget(self.Copy_TAF_tabHE, 7, 0, 1, 14)
        ...
        sizePolicy5.setHeightForWidth(self.groupBox_47.sizePolicy().hasHeightForWidth())
        self.groupBox_47.setSizePolicy(sizePolicy5)
        ...
        sizePolicy12.setHeightForWidth(self.label_108.sizePolicy().hasHeightForWidth())
        self.label_108.setSizePolicy(sizePolicy12)

        self.gridLayout_97.addWidget(self.label_108, 1, 0, 1, 1)

        self.label_120 = QLabel(self.groupBox_47)
        self.label_120.setObjectName(u"label_120")
        sizePolicy12.setHeightForWidth(self.label_120.sizePolicy().hasHeightForWidth())
        self.label_120.setSizePolicy(sizePolicy12)
        ...
        sizePolicy12.setHeightForWidth(self.label_66.sizePolicy().hasHeightForWidth())
        self.label_66.setSizePolicy(sizePolicy12)
        ...
        sizePolicy12.setHeightForWidth(self.groupBox_21.sizePolicy().hasHeightForWidth())
        self.groupBox_21.setSizePolicy(sizePolicy12)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_UsingRate2findSurface_tabHE.sizePolicy().hasHeightForWidth())
        self.checkBox_UsingRate2findSurface_tabHE.setSizePolicy(sizePolicy10)
        ...
        sizePolicy5.setHeightForWidth(self.groupBox_20.sizePolicy().hasHeightForWidth())
        self.groupBox_20.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.groupBox_42.sizePolicy().hasHeightForWidth())
        self.groupBox_42.setSizePolicy(sizePolicy5)
        ...
        sizePolicy15.setHeightForWidth(self.tableWidget_tabHE.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabHE.setSizePolicy(sizePolicy15)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabHE.sizePolicy().hasHeightForWidth())
        self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabHE.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_iLHU_inclusive_frame_stiffness_tabHE.sizePolicy().hasHeightForWidth())
        self.checkBox_iLHU_inclusive_frame_stiffness_tabHE.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_45.addWidget(self.pushButton_plot_chosen_test_tab_inclusive_frame_stiffness_tabHE, 3, 0, 1, 3)
        ...
        sizePolicy16.setHeightForWidth(self.tabWidget_10.sizePolicy().hasHeightForWidth())
        self.tabWidget_10.setSizePolicy(sizePolicy16)
        self.tab_35 = QWidget()
        ...
        self.groupBox_30.setMinimumSize(QSize(440, 0))
        ...
        self.gridLayout_67.addWidget(self.groupBox_30, 3, 0, 1, 2)
        ...
        sizePolicy12.setHeightForWidth(self.label_99.sizePolicy().hasHeightForWidth())
        self.label_99.setSizePolicy(sizePolicy12)
        ...
        self.gridLayout_67.addWidget(self.groupBox_31, 4, 0, 1, 1)

        self.groupBox_34 = QGroupBox(self.tab_35)
        self.groupBox_34.setObjectName(u"groupBox_34")
        sizePolicy5.setHeightForWidth(self.groupBox_34.sizePolicy().hasHeightForWidth())
        self.groupBox_34.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout_67.addWidget(self.groupBox_43, 5, 0, 1, 1)
        ...
        sizePolicy6.setHeightForWidth(self.graphicsView_tab_TipAreaFunction_6.sizePolicy().hasHeightForWidth())
        self.graphicsView_tab_TipAreaFunction_6.setSizePolicy(sizePolicy6)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_showFindSurface_tab_inclusive_frame_stiffness_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_iLHU_inclusive_frame_stiffness_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_iLHU_inclusive_frame_stiffness_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameStiffness_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameStiffness_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_FrameCompliance_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.lineEdit_FrameCompliance_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_67.addWidget(self.graphicsView_tab_TipAreaFunction_6, 2, 2, 10, 1)
        ...
        self.groupBox_33.setMinimumSize(QSize(230, 0))
        self.groupBox_33.setMaximumSize(QSize(230, 16777215))
        ...
        sizePolicy10.setHeightForWidth(self.checkBox_UsingRate2findSurface_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.checkBox_UsingRate2findSurface_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_67.addWidget(self.groupBox_33, 6, 0, 1, 1)
        ...
        sizePolicy15.setHeightForWidth(self.tableWidget_tabPopIn_FrameStiffness.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabPopIn_FrameStiffness.setSizePolicy(sizePolicy15)
        self.tableWidget_tabPopIn_FrameStiffness.setMinimumSize(QSize(205, 0))
        ...
        self.gridLayout_67.addWidget(self.tableWidget_tabPopIn_FrameStiffness, 4, 1, 8, 1)
        ...
        sizePolicy12.setHeightForWidth(self.label_103.sizePolicy().hasHeightForWidth())
        self.label_103.setSizePolicy(sizePolicy12)
        ...
        sizePolicy12.setHeightForWidth(self.label_105.sizePolicy().hasHeightForWidth())
        self.label_105.setSizePolicy(sizePolicy12)
        ...
        sizePolicy15.setHeightForWidth(self.tableWidget_tabPopIn.sizePolicy().hasHeightForWidth())
        self.tableWidget_tabPopIn.setSizePolicy(sizePolicy15)
        ...
        sizePolicy12.setHeightForWidth(self.label_107.sizePolicy().hasHeightForWidth())
        self.label_107.setSizePolicy(sizePolicy12)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_E_errorBar_tabPopIn.sizePolicy().hasHeightForWidth())
        self.lineEdit_E_errorBar_tabPopIn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.lineEdit_E_tabPopIn.sizePolicy().hasHeightForWidth())
        self.lineEdit_E_tabPopIn.setSizePolicy(sizePolicy10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionopen.setText(QCoreApplication.translate("MainWindow", u"Open/Load", None))
