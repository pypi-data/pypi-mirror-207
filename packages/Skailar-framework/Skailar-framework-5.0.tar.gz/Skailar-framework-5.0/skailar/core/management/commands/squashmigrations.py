...
from skailar.db import DEFAULT_DB_ALIAS, connections, migrations
from skailar.db.migrations.loader import AmbiguityError, MigrationLoader
        ...
        for smigration in migrations_to_squash:
            if smigration.replaces:
                raise CommandError(
                    ...
                    "normal migration first: https://docs.skailarproject.com/en/%s/"
