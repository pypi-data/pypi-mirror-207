...
from skailar.core.management import execute_from_command_line
from skailar.core.management.base import CommandError
from skailar.core.management.commands.makemessages import Command as MakeMessagesCommand
from skailar.core.management.commands.makemessages import write_pot_file
from skailar.core.management.utils import find_command
from skailar.test import SimpleTestCase, override_settings
from skailar.test.utils import captured_stderr, captured_stdout
from skailar.utils._os import symlinks_supported
from skailar.utils.translation import TranslatorCommentWarning
...
class ExtractorTests(POFileAssertionMixin, RunInTmpDirMixin, SimpleTestCase):
    ...
    PO_FILE = "locale/%s/LC_MESSAGES/skailar.po" % LOCALE
    ...
    def assertLocationCommentPresent(self, po_filename, line_number, *comment_parts):
        r"""
        self.assertLocationCommentPresent('skailar.po', 42, 'dirA', 'dirB', 'foo.py')

        verifies that the skailar.po file has a gettext-style location comment
        of the form
...
class BasicExtractorTests(ExtractorTests):
    ...
    def test_no_option(self):
        ...
        with mock.patch(
            "skailar.core.management.commands.makemessages.sys.argv",
    ...
    def test_valid_locale_with_country(self):
        ...
        self.assertIs(Path("locale/en_GB/LC_MESSAGES/skailar.po").exists(), True)
    ...
    def test_valid_locale_tachelhit_latin_morocco(self):
        ...
        self.assertIs(Path("locale/shi_Latn_MA/LC_MESSAGES/skailar.po").exists(), True)
    ...
    def test_valid_locale_private_subtag(self):
        ...
        self.assertIs(
            Path("locale/nl_NL-x-informal/LC_MESSAGES/skailar.po").exists(), True
        )
    ...
    def test_invalid_locale_uppercase(self):
        ...
        self.assertIs(Path("locale/pl/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_invalid_locale_hyphen(self):
        ...
        self.assertIs(Path("locale/pl-PL/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_invalid_locale_lower_country(self):
        ...
        self.assertIs(Path("locale/pl_pl/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_invalid_locale_private_subtag(self):
        ...
        self.assertIs(
            Path("locale/nl-nl-x-informal/LC_MESSAGES/skailar.po").exists(), False
        )
    ...
    def test_invalid_locale_plus(self):
        ...
        self.assertIs(Path("locale/en+GB/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_invalid_locale_end_with_underscore(self):
        ...
        self.assertIs(Path("locale/en_/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_invalid_locale_start_with_underscore(self):
        ...
        self.assertIs(Path("locale/_en/LC_MESSAGES/skailar.po").exists(), False)
    ...
    def test_comments_extractor(self):
        ...
        with open(self.PO_FILE, encoding="utf-8") as fp:
            ...
            self.assertIn(
                "#. Translators: Skailar comment block for translators\n#. "
    ...
    def test_makemessages_find_files(self):
        ...
        cmd.extensions = [".js"]
        cmd.domain = "skailarjs"
        found_files = cmd.find_files(self.test_dir)
        self.assertGreater(len(found_files), 1)
        found_exts = {os.path.splitext(tfile.file)[1] for tfile in found_files}
        self.assertEqual(found_exts.difference({".js"}), set())

    @mock.patch("skailar.core.management.commands.makemessages.popen_wrapper")
    ...
    def test_po_file_encoding_when_updating(self):
        ...
        (#23271).
        """
        BR_PO_BASE = "locale/pt_BR/LC_MESSAGES/skailar"
...
class JavaScriptExtractorTests(ExtractorTests):
    PO_FILE = "locale/%s/LC_MESSAGES/skailarjs.po" % LOCALE

    def test_javascript_literals(self):
        _, po_contents = self._run_makemessages(domain="skailarjs")
...
class CopyPluralFormsExtractorTests(ExtractorTests):
    PO_FILE_ES = "locale/es/LC_MESSAGES/skailar.po"
...
class LocationCommentsTests(ExtractorTests):
    ...
    @mock.patch(
        "skailar.core.management.commands.makemessages.Command.gettext_version",
        new=(0, 18, 99),
    )
...
class MultipleLocaleExtractionTests(ExtractorTests):
    PO_FILE_PT = "locale/pt/LC_MESSAGES/skailar.po"
    PO_FILE_DE = "locale/de/LC_MESSAGES/skailar.po"
    PO_FILE_KO = "locale/ko/LC_MESSAGES/skailar.po"
    LOCALES = ["pt", "de", "ch"]
    ...
    def test_all_locales(self):
        ...
        self.assertFalse(os.path.exists("locale/_do_not_pick/LC_MESSAGES/skailar.po"))
...
class ExcludedLocaleExtractionTests(ExtractorTests):
    ...
    LOCALES = ["en", "fr", "it"]
    PO_FILE = "locale/%s/LC_MESSAGES/skailar.po"
    ...
    def test_command_help(self):
        with captured_stdout(), captured_stderr():
            ...
            execute_from_command_line(["skailar-admin", "help", "makemessages"])
        ...
        * translations outside of that app are in LOCALE_PATHS[0]
        ...
        with override_settings(LOCALE_PATHS=[locale_path]):
            ...
            project_de_locale = os.path.join(
                self.test_dir, "project_locale", "de", "LC_MESSAGES", "skailar.po"
            )
...
class NoSettingsExtractionTests(AdminScriptTestCase):
    def test_makemessages_no_settings(self):
        out, err = self.run_skailar_admin(["makemessages", "-l", "en", "-v", "0"])
