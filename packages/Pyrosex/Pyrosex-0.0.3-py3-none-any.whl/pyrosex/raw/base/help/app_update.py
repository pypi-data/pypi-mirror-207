...
class AppUpdate:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.AppUpdate <pyrosex.raw.types.help.AppUpdate>`
            - :obj:`help.NoAppUpdate <pyrosex.raw.types.help.NoAppUpdate>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetAppUpdate <pyrosex.raw.functions.help.GetAppUpdate>`
    """

    QUALNAME = "pyrosex.raw.base.help.AppUpdate"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/app-update")
