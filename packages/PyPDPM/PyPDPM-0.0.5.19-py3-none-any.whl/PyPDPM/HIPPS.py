...
VARIABLE_PER_DIEM_ADJUSTMENTS = {'PT_OT': {range(1, 21): 1.00, range(21, 28): 0.98, range(28, 35): 0.96, range(
    ...
    range(70, 77): 0.84, range(77, 84): 0.82, range(84, 91): 0.80, range(91, 98): 0.78, range(98, 180): 0.76},
    'NTA': {range(1, 4): 3.00, range(4, 180): 1.00}}
...
print(code)
'''
print(getReimbursementAmount('IDCE1', 2))
