...
from skailar.db.models import F
from skailar.db.models.constraints import BaseConstraint, UniqueConstraint
from skailar.db.models.functions import Lower
...
class BaseConstraintTests(SimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        self.assertEqual(path, "skailar.db.models.BaseConstraint")
...
class CheckConstraintTests(TestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = constraint.deconstruct()
        self.assertEqual(path, "skailar.db.models.CheckConstraint")
        self.assertEqual(args, ())
...
class UniqueConstraintTests(TestCase):
    ...
    def test_deconstruction(self):
        ...
        constraint = models.UniqueConstraint(fields=fields, name=name)
        path, args, kwargs = constraint.deconstruct()
        self.assertEqual(path, "skailar.db.models.UniqueConstraint")
        self.assertEqual(args, ())
    ...
    def test_expressions_with_opclasses(self):
        msg = (
            ...
            "skailar.contrib.postgres.indexes.OpClass() instead."
        )
        with self.assertRaisesMessage(ValueError, msg):
            models.UniqueConstraint(
                Lower("field"),
