 ...
 * Run this script.
 * Test extraction - verify the new msgid in sampleproject's skailar.po.
 * Add a translation to sampleproject's skailar.po.
 * Run this script.
...
def update_translation_catalogs():
    ...
    pofile = os.path.join(proj_dir, "locale", "fr", "LC_MESSAGES", "skailar.po")
