...
R99Z1_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R99Z1Cluster(GenericK8sCluster):
    """ R99Z1 Cluster Overrides """

    allowed_instances: Instances = R99Z1_INSTANCES
