...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrosex.types.InputMediaPhoto`, :obj:`~pyrosex.types.InputMediaVideo`, :obj:`~pyrosex.types.InputMediaAudio` and :obj:`~pyrosex.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrosex.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrosex.types import InputMediaPhoto, InputMediaVideo
