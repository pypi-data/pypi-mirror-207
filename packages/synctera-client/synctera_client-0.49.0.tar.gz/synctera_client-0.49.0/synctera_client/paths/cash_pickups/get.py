...
StatusSchema = CashPickupStatus
EmployeeCustomerIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'employee_customer_id': typing.Union[EmployeeCustomerIdSchema, str, uuid.UUID, ],
...
request_query_employee_customer_id = api_client.QueryParameter(
    name="employee_customer_id",
    style=api_client.ParameterStyle.FORM,
    schema=EmployeeCustomerIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = CashPickupList
...
class BaseApi(api_client.Api):
    ...
    def _list_cash_pickups_oapg(
        ...
        for parameter in (
            ...
            request_query_employee_customer_id,
...
class ListCashPickups(BaseApi):
    ...
    def list_cash_pickups(
        ...
        return self._list_cash_pickups_oapg(
