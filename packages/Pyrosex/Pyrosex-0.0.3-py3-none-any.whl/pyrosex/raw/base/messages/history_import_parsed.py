...
class HistoryImportParsed:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.HistoryImportParsed <pyrosex.raw.types.messages.HistoryImportParsed>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.CheckHistoryImport <pyrosex.raw.functions.messages.CheckHistoryImport>`
    """

    QUALNAME = "pyrosex.raw.base.messages.HistoryImportParsed"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/history-import-parsed")
