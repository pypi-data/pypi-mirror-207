...
class JoinAsPeers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`phone.JoinAsPeers <pyrosex.raw.types.phone.JoinAsPeers>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCallJoinAs <pyrosex.raw.functions.phone.GetGroupCallJoinAs>`
    """

    QUALNAME = "pyrosex.raw.base.phone.JoinAsPeers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/join-as-peers")
