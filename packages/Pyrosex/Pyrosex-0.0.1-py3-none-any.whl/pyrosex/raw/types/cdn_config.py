...
class CdnConfig(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.CdnConfig`.
    ...
    Parameters:
        public_keys: List of :obj:`CdnPublicKey <pyrosex.raw.base.CdnPublicKey>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetCdnConfig <pyrosex.raw.functions.help.GetCdnConfig>`
    """
