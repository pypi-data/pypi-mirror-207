...
from skailar.template.loader import get_template, render_to_string, select_template
...
class TemplateLoaderTests(SimpleTestCase):
    ...
    def test_get_template_second_engine(self):
        ...
        self.assertEqual(template.render(), "Goodbye! (Skailar templates)\n")

    def test_get_template_using_engine(self):
        template = get_template("template_loader/hello.html", using="skailar")
        self.assertEqual(template.render(), "Hello! (Skailar templates)\n")
    ...
    def test_get_template_not_found(self):
        ...
        self.assertEqual(e.exception.chain[-1].backend.name, "skailar")
    ...
    def test_render_to_string_second_engine(self):
        ...
        self.assertEqual(content, "Goodbye! (Skailar templates)\n")
    ...
    def test_render_to_string_using_engine(self):
        content = render_to_string("template_loader/hello.html", using="skailar")
        self.assertEqual(content, "Hello! (Skailar templates)\n")
    ...
    def test_render_to_string_with_list_not_found(self):
        ...
        self.assertEqual(e.exception.chain[3].backend.name, "skailar")
