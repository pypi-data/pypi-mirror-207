...
from module.pyclipboard import PyClipboard
from module.pyAutoKeyboard import PyAutoKeyboard
from module.pyAutoMouse import PyAutoMouse
import pyautogui
...
class AutoOperation(PyAutoKeyboard,PyAutoMouse):
    ...
    # 记录当前数据
    def recordData(self):
        self.record_data = self.pclip.paste()
