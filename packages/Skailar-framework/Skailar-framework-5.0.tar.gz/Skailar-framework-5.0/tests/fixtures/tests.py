...
from skailar.core.files.temp import NamedTemporaryFile
from skailar.core.management import CommandError
from skailar.core.management.commands.dumpdata import ProxyModelWarning
from skailar.core.serializers.base import ProgressBar
from skailar.db import IntegrityError, connection
from skailar.test import TestCase, TransactionTestCase, skipUnlessDBFeature
...
class FixtureLoadingTests(DumpDataAssertMixin, TestCase):
    def test_loading_and_dumping(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                '<Tag: <Article: Skailar conquers world!> tagged "skailar">',
                '<Tag: <Article: Skailar conquers world!> tagged "world domination">',
            ],
            transform=repr,
            ordered=False,
        )
        ...
        self.assertQuerySetEqual(
            Visa.objects.all(),
            [
                "<Visa: Skailar Reinhardt Can add user, Can change user, Can delete "
                "user>",
        ...
        self._dumpdata_assert(
            ...
            '[["Artist formerly known as \\"Prince\\""], ["Skailar Reinhardt"]]}}]',
        ...
        self._dumpdata_assert(
            ["fixtures.person"],
            '[{"fields": {"name": "Skailar Reinhardt"}, "model": "fixtures.person"}, '
        ...
        self._dumpdata_assert(
            ...
            '{"headline": "Skailar conquers world!", '
        ...
        self._dumpdata_assert(
            ["fixtures"],
            '<?xml version="1.0" encoding="utf-8"?><skailar-objects version="1.0">'
            ...
            '<field type="CharField" name="headline">Skailar conquers world!</field>'
            ...
            '<field type="CharField" name="name">skailar</field>'
            '<field to="contenttypes.contenttype" name="tagged_type" '
            'rel="ManyToOneRel"><natural>fixtures</natural><natural>article</natural>'
            "</field>"
            ...
            '<field type="CharField" name="name">Skailar Reinhardt</field>'
            "</object>"
            ...
            "<natural>Skailar Reinhardt</natural></field>"
            ...
            "<object><natural>Skailar Reinhardt</natural></object></field>"
            "</object></skailar-objects>",
            format="xml",
            natural_foreign_keys=True,
        )
    ...
    def test_dumpdata_with_filtering_manager(self):
        ...
        # Dump using Skailar's base manager. Should return all objects,
    ...
    def test_compress_format_loading(self):
        ...
        self.assertEqual(Article.objects.get().headline, "Skailar pets kitten")
    ...
    def test_loading_stdin(self):
        ...
        with mock.patch(
            "skailar.core.management.commands.loaddata.sys.stdin", open(fixture_json)
        ):
        ...
        with mock.patch(
            "skailar.core.management.commands.loaddata.sys.stdin", open(fixture_xml)
        ):
...
class NonexistentFixtureTests(TestCase):
    ...
    @mock.patch("skailar.db.connection.enable_constraint_checking")
    @mock.patch("skailar.db.connection.disable_constraint_checking")
