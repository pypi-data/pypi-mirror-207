...
from skailar.core import signals
from skailar.core.exceptions import RequestAborted, RequestDataTooBig
from skailar.core.handlers import base
...
from skailar.urls import set_script_prefix
from skailar.utils.functional import cached_property

logger = logging.getLogger("skailar.request")
...
class ASGIRequest(HttpRequest):
    ...
    def __init__(self, scope, body_file):
        ...
        # The Skailar path is different from ASGI scope path args, it should
...
class ASGIHandler(base.BaseHandler):
    ...
    async def __call__(self, scope, receive, send):
        ...
        if scope["type"] != "http":
            raise ValueError(
                "Skailar can only handle ASGI/HTTP connections, not %s." % scope["type"]
            )
