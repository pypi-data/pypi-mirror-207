...
class TmpPassword:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.TmpPassword <pyrosex.raw.types.account.TmpPassword>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetTmpPassword <pyrosex.raw.functions.account.GetTmpPassword>`
    """

    QUALNAME = "pyrosex.raw.base.account.TmpPassword"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/tmp-password")
