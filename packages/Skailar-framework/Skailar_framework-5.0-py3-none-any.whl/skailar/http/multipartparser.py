...
from skailar.core.files.uploadhandler import SkipFile, StopFutureHandlers, StopUpload
...
class MultiPartParser:
    ...
    def __init__(self, META, input_data, upload_handlers, encoding=None):
        ...
        :META:
            The standard ``META`` dictionary in Skailar request objects.
        :input_data:
    ...
    def _update_unget_history(self, num_bytes):
        ...
        if number_equal > 40:
            raise SuspiciousMultipartForm(
                ...
                " if there is none, report this to the Skailar developers."
            )
