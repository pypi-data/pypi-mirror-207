...
StartEffectiveDateSchema = schemas.DateSchema
EndEffectiveDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'effective_date': typing.Union[EffectiveDateSchema, str, date, ],
        'start_effective_date': typing.Union[StartEffectiveDateSchema, str, date, ],
        'end_effective_date': typing.Union[EndEffectiveDateSchema, str, date, ],
...
request_query_start_effective_date = api_client.QueryParameter(
    name="start_effective_date",
    style=api_client.ParameterStyle.FORM,
    schema=StartEffectiveDateSchema,
    explode=True,
)
request_query_end_effective_date = api_client.QueryParameter(
    name="end_effective_date",
    style=api_client.ParameterStyle.FORM,
    schema=EndEffectiveDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = OutgoingAchList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_transactions_out_oapg(
        self,
    ...
    def _list_transactions_out_oapg(
        ...
        for parameter in (
            ...
            request_query_start_effective_date,
            request_query_end_effective_date,
            request_query_limit,
...
class ListTransactionsOut(BaseApi):
    ...
    def list_transactions_out(
        ...
        return self._list_transactions_out_oapg(
