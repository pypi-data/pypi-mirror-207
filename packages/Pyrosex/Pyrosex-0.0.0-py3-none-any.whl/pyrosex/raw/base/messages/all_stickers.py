...
class AllStickers:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.AllStickers <pyrosex.raw.types.messages.AllStickers>`
            - :obj:`messages.AllStickersNotModified <pyrosex.raw.types.messages.AllStickersNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetAllStickers <pyrosex.raw.functions.messages.GetAllStickers>`
            - :obj:`messages.GetMaskStickers <pyrosex.raw.functions.messages.GetMaskStickers>`
    """

    QUALNAME = "pyrosex.raw.base.messages.AllStickers"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/all-stickers")
