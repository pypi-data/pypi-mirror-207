...
from skailar.contrib.sessions.backends.base import UpdateError
from skailar.contrib.sessions.backends.cache import SessionStore as CacheSession
from skailar.contrib.sessions.backends.cached_db import SessionStore as CacheDBSession
from skailar.contrib.sessions.backends.db import SessionStore as DatabaseSession
from skailar.contrib.sessions.backends.file import SessionStore as FileSession
from skailar.contrib.sessions.backends.signed_cookies import (
    SessionStore as CookieSession,
)
from skailar.contrib.sessions.exceptions import InvalidSessionKey, SessionInterrupted
from skailar.contrib.sessions.middleware import SessionMiddleware
from skailar.contrib.sessions.models import Session
from skailar.contrib.sessions.serializers import JSONSerializer
from skailar.core import management
from skailar.core.cache import caches
...
from skailar.core.signing import TimestampSigner
        ...
        for encoded in tests:
            with self.subTest(encoded=encoded):
                with self.assertLogs(
                    "skailar.security.SuspiciousSession", "WARNING"
                ) as cm:
...
class CacheDBSessionTests(SessionTestsMixin, TestCase):
    ...
    @ignore_warnings(module="skailar.core.cache.backends.base")
...
class FileSessionTests(SessionTestsMixin, SimpleTestCase):
    ...
    @override_settings(
        SESSION_ENGINE="skailar.contrib.sessions.backends.file",
...
class CookieSessionTests(SessionTestsMixin, SimpleTestCase):
    ...
    def test_unpickling_exception(self):
        ...
        self.session.save()
        with mock.patch("skailar.core.signing.loads", side_effect=ValueError):
            self.session.load()
