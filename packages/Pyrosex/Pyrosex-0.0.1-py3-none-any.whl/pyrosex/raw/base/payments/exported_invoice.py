...
class ExportedInvoice:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.ExportedInvoice <pyrosex.raw.types.payments.ExportedInvoice>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.ExportInvoice <pyrosex.raw.functions.payments.ExportInvoice>`
    """

    QUALNAME = "pyrosex.raw.base.payments.ExportedInvoice"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-invoice")
