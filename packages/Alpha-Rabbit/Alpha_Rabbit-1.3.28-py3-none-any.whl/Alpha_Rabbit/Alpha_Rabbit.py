...
class multi_factor_test(object):
    ...
    def multif_barra_norm(self,allfactors,quantiles,Bft):
        ...
        for fcname in list(df):
            ...
            res_df = self.one_factor_grouper(test_fc,fcname,quantiles)# 序数标准化
            # 风格中性化-回归取残差
    ...
    def multif_select_noisies(self,allfactors,Price,quantiles,days,savedir,index_price = None):
        ...
        noise_factors_df = self.mat_orthog(allfactors[noise_factors],noise_factors) # 正交化
...
class Barra_factor_ana(object):
    ...
    def rise_barra_factors(self,rank_normalize:bool):
        ...
        # momentum
        print('rise momentum')
        retroll504 = list(self.returndata.shift(21).dropna(how = 'all').rolling(504))[504:]
        self.momtm = pd.concat(list(map(lambda x: MOMTM(x),retroll504)))
