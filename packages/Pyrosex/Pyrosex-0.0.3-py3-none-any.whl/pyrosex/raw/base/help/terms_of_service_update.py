...
class TermsOfServiceUpdate:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.TermsOfServiceUpdate <pyrosex.raw.types.help.TermsOfServiceUpdate>`
            - :obj:`help.TermsOfServiceUpdateEmpty <pyrosex.raw.types.help.TermsOfServiceUpdateEmpty>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetTermsOfServiceUpdate <pyrosex.raw.functions.help.GetTermsOfServiceUpdate>`
    """

    QUALNAME = "pyrosex.raw.base.help.TermsOfServiceUpdate"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/terms-of-service-update")
