...
from skailar.contrib.gis.db.models import GeometryField, PolygonField, functions
from skailar.contrib.gis.geos import GEOSGeometry, LineString, Point, Polygon, fromstr
from skailar.contrib.gis.measure import Area
from skailar.db import NotSupportedError, connection
from skailar.db.models import IntegerField, Sum, Value
...
class GISFunctionsTests(FuncTestMixin, TestCase):
    """
    Testing functions from skailar/contrib/gis/db/models/functions.py.
