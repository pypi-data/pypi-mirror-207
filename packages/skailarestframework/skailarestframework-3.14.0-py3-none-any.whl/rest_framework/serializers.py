...
from skailar.db.models.fields import Field as SkailarModelField
...
def as_serializer_error(exc):
    assert isinstance(exc, (ValidationError, SkailarValidationError))

    if isinstance(exc, SkailarValidationError):
...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def fields(self):
        ...
        # even if Skailar's app-loading stage has not yet run.
    ...
    def run_validation(self, data=empty):
        ...
        except (ValidationError, SkailarValidationError) as exc:
...
class ModelSerializer(Serializer):
    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def build_standard_field(self, field_name, model_field):
        ...
        is_skailar_jsonfield = hasattr(models, 'JSONField') and isinstance(model_field, models.JSONField)
        if (postgres_fields and isinstance(model_field, postgres_fields.JSONField)) or is_skailar_jsonfield:
    ...
    def get_extra_kwargs(self):
        ...
        if read_only_fields is not None:
            ...
            # by the Skailar admin and others).
    ...
    def _get_model_fields(self, field_names, declared_fields, extra_kwargs):
        ...
        for field_name in field_names:
            ...
            with contextlib.suppress(FieldDoesNotExist):
                ...
                if isinstance(field, SkailarModelField):
