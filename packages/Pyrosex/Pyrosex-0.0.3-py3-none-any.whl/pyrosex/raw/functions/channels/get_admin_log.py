...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel: :obj:`InputChannel <pyrosex.raw.base.InputChannel>`
        q: ``str``
        max_id: ``int`` ``64-bit``
        min_id: ``int`` ``64-bit``
        limit: ``int`` ``32-bit``
        events_filter (optional): :obj:`ChannelAdminLogEventsFilter <pyrosex.raw.base.ChannelAdminLogEventsFilter>`
        admins (optional): List of :obj:`InputUser <pyrosex.raw.base.InputUser>`

    Returns:
        :obj:`channels.AdminLogResults <pyrosex.raw.base.channels.AdminLogResults>`
    """
