...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/rocsolver/rocsolver-export.h by using #include <rocsolver/rocsolver-export.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.5.0/include/rocsolver/rocsolver-export.h by using #include <rocsolver/rocsolver-export.h>"
#endif
/* include file */
