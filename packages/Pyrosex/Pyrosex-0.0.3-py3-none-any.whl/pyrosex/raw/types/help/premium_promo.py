...
class PremiumPromo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        status_text: ``str``
        status_entities: List of :obj:`MessageEntity <pyrosex.raw.base.MessageEntity>`
        video_sections: List of ``str``
        videos: List of :obj:`Document <pyrosex.raw.base.Document>`
        currency: ``str``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPremiumPromo <pyrosex.raw.functions.help.GetPremiumPromo>`
    """
