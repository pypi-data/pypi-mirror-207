...
from skailar.db.models.functions import Abs, Cast, Length, Substr
...
from skailar.test.utils import isolate_apps, register_lookup
...
class LookupTests(TestCase):
    ...
    def test_escaping(self):
        ...
        # underlying SQL code, but Skailar handles the quoting of them automatically.
