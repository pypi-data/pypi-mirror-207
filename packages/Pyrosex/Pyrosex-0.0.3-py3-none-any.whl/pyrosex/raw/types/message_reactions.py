...
class MessageReactions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.MessageReactions`.
    ...
    Parameters:
        results: List of :obj:`ReactionCount <pyrosex.raw.base.ReactionCount>`
        min (optional): ``bool``
        can_see_list (optional): ``bool``
        recent_reactions (optional): List of :obj:`MessagePeerReaction <pyrosex.raw.base.MessagePeerReaction>`
    """
