...
# body param
SchemaForRequestBodyApplicationJson = Disclosure1


request_body_disclosure1 = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Disclosure1
...
class BaseApi(api_client.Api):
    ...
    def _create_disclosure1_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_disclosure1.serialize(body, content_type)
...
class CreateDisclosure1(BaseApi):
    ...
    def create_disclosure1(
        ...
        return self._create_disclosure1_oapg(
            body=body,
