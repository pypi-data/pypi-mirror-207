...
class MessageReactionsList:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.MessageReactionsList <pyrosex.raw.types.messages.MessageReactionsList>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetMessageReactionsList <pyrosex.raw.functions.messages.GetMessageReactionsList>`
    """

    QUALNAME = "pyrosex.raw.base.messages.MessageReactionsList"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/message-reactions-list")
