...
def sum_fertilisers(cycle: dict):
    ...
    return reduce(group_inputs(fertilisers), FERTILISER_COLUMNS, {})
...
def sum_pesticides(cycle: dict, brandname_to_ai: dict = {}):
    ...
    return _nansum(_sum_input_values(pestAIs), _sum_input_values(pestBrandNames, pestAI_percentages))
...
def sum_water(cycle: dict):
    ...
    return _sum_input_values(waters)
