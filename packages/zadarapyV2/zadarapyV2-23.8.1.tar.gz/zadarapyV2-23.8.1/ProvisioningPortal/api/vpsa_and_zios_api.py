...
class VPSAAndZIOSApi(object):
    ...
    def get_info_of_all_vpasa_and_zioses(self, **kwargs):  # noqa: E501
        """get_info_of_all_vpasa_and_zioses  # noqa: E501

        Retrieve information about all of your VPSAs and ZIOSes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_info_of_all_vpasa_and_zioses(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_info_of_all_vpasa_and_zioses_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_info_of_all_vpasa_and_zioses_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_info_of_all_vpasa_and_zioses_with_http_info(self, **kwargs):  # noqa: E501
        """get_info_of_all_vpasa_and_zioses  # noqa: E501

        Retrieve information about all of your VPSAs and ZIOSes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_info_of_all_vpasa_and_zioses_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_info_of_all_vpasa_and_zioses" % key
                )
            params[key] = val
        del params['kwargs']
