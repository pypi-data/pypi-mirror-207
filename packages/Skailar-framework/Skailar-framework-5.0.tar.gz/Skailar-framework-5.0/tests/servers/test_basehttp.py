...
from skailar.core.handlers.wsgi import WSGIRequest
from skailar.core.servers.basehttp import WSGIRequestHandler, WSGIServer
...
class WSGIRequestHandlerTestCase(SimpleTestCase):
    ...
    def test_https(self):
        ...
        with self.assertLogs("skailar.server", "ERROR") as cm:
    ...
    def test_strips_underscore_headers(self):
        ...
        with self.assertLogs("skailar.server", "INFO"):
