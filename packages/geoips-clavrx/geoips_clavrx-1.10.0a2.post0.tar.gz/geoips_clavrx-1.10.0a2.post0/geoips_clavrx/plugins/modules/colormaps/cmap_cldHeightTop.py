...
"""Colormap for Plotting Cloud Top Height."""
import logging
...
def call(data_range=[0, 20]):
    ...
    Parameters
    ----------
    data_range : list of float, default=[0, 20]
    ...
    if min_tb >= 1 or max_tb <= 10:
        raise ("cloud hieght_top range MUST include 1 and 10")
    ...
    mpl_cmap = create_linear_segmented_colormap(
        "cmap_cldHeightTop", min_tb, max_tb, transition_vals, transition_colors
    )
    ...
    cbar_label = "Cloud Hieght Top (km)"
