...
class Command(BaseCommand):
    help = """Displays differences between the current settings.py and Skailar's
    default settings."""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "empty to compare against Skailar's default settings."
            ),
        )
        parser.add_argument(
            "--output",
    ...
    def handle(self, **options):
        from skailar.conf import Settings, global_settings, settings
