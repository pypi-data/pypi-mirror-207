...
from skailar.core.serializers import SerializerDoesNotExist
...
from skailar.test import SimpleTestCase, override_settings, skipUnlessDBFeature
...
@override_settings(
    SERIALIZATION_MODULES={
        "json2": "skailar.core.serializers.json",
    }
)
class SerializerRegistrationTests(SimpleTestCase):
    ...
    def test_register(self):
        ...
        serializers.register_serializer("json3", "skailar.core.serializers.json")
...
class SerializersTestBase:
    ...
    def test_deserialize_force_insert(self):
        ...
        with mock.patch("skailar.db.models.Model") as mock_model:
