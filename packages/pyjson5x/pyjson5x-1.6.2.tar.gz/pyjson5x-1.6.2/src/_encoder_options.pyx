...
cdef class Options:
    '''
    Customizations for the :func:`encoder_*(...) <pyjson5x.encoder>` function family.

    Immutable. Use :meth:`Options.update(**kw) <pyjson5x.Options.update>` to create a **new** Options instance.
