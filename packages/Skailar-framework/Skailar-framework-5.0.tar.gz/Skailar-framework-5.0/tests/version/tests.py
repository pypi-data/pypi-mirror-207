...
class VersionTests(SimpleTestCase):
    ...
    @skipUnless(
        hasattr(skailar.utils.version, "__file__"),
    ...
    def test_development_no_file(self):
        get_git_changeset.cache_clear()
        version_file = skailar.utils.version.__file__
        try:
            del skailar.utils.version.__file__
            self.test_development()
        finally:
            skailar.utils.version.__file__ = version_file
