...
class ActorRenderCompClient(BaseComponent):
    ...
    def CopyActorRenderMaterial(self, fromEntityId, toActorIdentifier, fromMaterialKey, newMaterialKey):
        # type: (str, str, str, str) -> bool
        """
        将渲染<a href="../../../../mcguide/20-玩法开发/15-自定义游戏内容/3-自定义生物/01-自定义基础生物.html#_3-自定义材质">材质</a>从某个实体拷贝到某个生物identifier上
        """
        pass
    ...
    def CopyActorGeometry(self, fromEntityId, toActorIdentifier, fromGeometryKey, newGeometryKey):
        # type: (str, str, str, str) -> bool
        """
        将渲染几何体从某个实体拷贝到某个生物identifier上
        """
        pass
    ...
    def CopyActorTexture(self, fromEntityId, toActorIdentifier, fromTextureKey, newTextureKey):
        # type: (str, str, str, str) -> bool
        """
        将贴图从某个实体拷贝到某个生物identifier上
        """
        pass
