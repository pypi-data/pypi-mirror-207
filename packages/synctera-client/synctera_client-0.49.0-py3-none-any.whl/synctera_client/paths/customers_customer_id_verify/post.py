...
# body param
SchemaForRequestBodyApplicationJson = CustomerVerification


request_body_customer_verification = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CustomerVerifyResponse
...
class BaseApi(api_client.Api):
    ...
    def _verify_customer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customer_verification.serialize(body, content_type)
...
class VerifyCustomer(BaseApi):
    ...
    def verify_customer(
        ...
        return self._verify_customer_oapg(
            body=body,
