...
class InputPhoto:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputPhoto <pyrosex.raw.types.InputPhoto>`
            - :obj:`InputPhotoEmpty <pyrosex.raw.types.InputPhotoEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.InputPhoto"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-photo")
