...
class EspressoConnect(object):
    ...
    # retrieve the client's public IP address using the get function from the requests module.
    # try:
    ...
    def get_access_token(self, api_key, request_token, vendor_key='', state=''):
