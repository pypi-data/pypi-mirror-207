...
SchemaFor200ResponseBodyApplicationJson = RiskRatingList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_customer_risk_ratings_oapg(
        self,
...
class GetAllCustomerRiskRatings(BaseApi):
    ...
    def get_all_customer_risk_ratings(
        ...
        return self._get_all_customer_risk_ratings_oapg(
