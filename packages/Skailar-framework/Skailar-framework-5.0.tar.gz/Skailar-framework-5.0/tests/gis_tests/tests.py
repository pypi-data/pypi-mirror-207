...
from skailar.db import ProgrammingError
from skailar.db.backends.base.base import NO_DB_ALIAS
...
class TestPostGISBackend(unittest.TestCase):
    def test_non_db_connection_classes(self):
        from skailar.contrib.gis.db.backends.postgis.base import DatabaseWrapper
        from skailar.db.backends.postgresql.features import DatabaseFeatures
        from skailar.db.backends.postgresql.introspection import DatabaseIntrospection
