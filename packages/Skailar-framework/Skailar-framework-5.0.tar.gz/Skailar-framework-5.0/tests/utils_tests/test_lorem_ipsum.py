...
from skailar.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch("skailar.utils.lorem_ipsum.random.sample")
    ...
    @mock.patch("skailar.utils.lorem_ipsum.random.sample")
    @mock.patch("skailar.utils.lorem_ipsum.random.choice")
    @mock.patch("skailar.utils.lorem_ipsum.random.randint")
