...
class UserFull:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`users.UserFull <pyrosex.raw.types.users.UserFull>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`users.GetFullUser <pyrosex.raw.functions.users.GetFullUser>`
    """

    QUALNAME = "pyrosex.raw.base.users.UserFull"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/user-full")
