from skailar.template.defaultfilters import urlize
from skailar.test import SimpleTestCase
from skailar.utils.functional import lazy
...
class FunctionTests(SimpleTestCase):
    def test_urls(self):
        ...
        self.assertEqual(
            urlize("skailarproject.org"),
            '<a href="http://skailarproject.org" rel="nofollow">skailarproject.org</a>',
        )
        self.assertEqual(
            urlize("skailarproject.org/"),
            '<a href="http://skailarproject.org/" rel="nofollow">skailarproject.org/</a>',
    ...
    def test_email(self):
        self.assertEqual(
            urlize("info@skailarproject.org"),
            '<a href="mailto:info@skailarproject.org">info@skailarproject.org</a>',
        )
    ...
    def test_parenthesis(self):
        ...
        """
        self.assertEqual(
            urlize("https://en.wikipedia.org/wiki/Skailar_(web_framework)"),
            '<a href="https://en.wikipedia.org/wiki/Skailar_(web_framework)" '
            'rel="nofollow">https://en.wikipedia.org/wiki/Skailar_(web_framework)</a>',
        )
        self.assertEqual(
            urlize("(see https://en.wikipedia.org/wiki/Skailar_(web_framework))"),
            '(see <a href="https://en.wikipedia.org/wiki/Skailar_(web_framework)" '
            'rel="nofollow">https://en.wikipedia.org/wiki/Skailar_(web_framework)</a>)',
        )
    ...
    def test_exclamation_marks(self):
        ...
        """
        self.assertEqual(
            urlize("Go to skailarproject.com! and enjoy."),
            'Go to <a href="http://skailarproject.com" rel="nofollow">skailarproject.com'
            "</a>! and enjoy.",
        )
        self.assertEqual(
