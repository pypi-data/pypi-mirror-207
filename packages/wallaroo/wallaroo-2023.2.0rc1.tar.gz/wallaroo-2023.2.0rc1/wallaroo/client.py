...
class Client(object):
    ...
    def upload_model(
        ...
        with path.open("rb") as f:
            ...
            return self._upload_model_and_convert(path.name, payload, f, convert_wait)
    ...
    def _upload_model_and_convert(
        ...
        """
        Upload and convert a model defined by a file as a new model variant. If convert_wait is True, the method will
        wait for about 10min for the conversion to finish before returning. If convert_wait is False,
        ...
        headers = {"User-Agent": _user_agent}
        endpoint = posixpath.join(self.api_endpoint, "v1/api/models/upload_and_convert")
    ...
    def _should_stop_log_collection(
        ...
        if dir_size >= data_size_limit_in_bytes:
            sys.stderr.write(
    ...
    def _export_logs(
        ...
        while iterator is not None:
            ...
            write_to_file(sliced_table, writer, arrow)
    ...
    def get_logs(
        ...
        data_size_limit: Optional[str] = None,
        arrow: Optional[bool] = False,
    ) -> Tuple[Union[pa.Table, pd.DataFrame, LogEntries], Optional[str]]:
        """
    ...
    def list_tasks(self):
        ...
        return Task.list_tasks(self, self.get_current_workspace().id())
