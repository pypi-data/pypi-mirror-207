...
class BankCardData(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.payments.BankCardData`.
    ...
    Parameters:
        title: ``str``
        open_urls: List of :obj:`BankCardOpenUrl <pyrosex.raw.base.BankCardOpenUrl>`
