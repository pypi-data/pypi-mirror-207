...
class AdminLogResults:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`channels.AdminLogResults <pyrosex.raw.types.channels.AdminLogResults>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetAdminLog <pyrosex.raw.functions.channels.GetAdminLog>`
    """

    QUALNAME = "pyrosex.raw.base.channels.AdminLogResults"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/admin-log-results")
