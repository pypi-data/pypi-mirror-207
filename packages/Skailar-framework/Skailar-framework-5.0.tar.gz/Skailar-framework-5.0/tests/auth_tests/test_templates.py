...
from skailar.contrib.auth.tokens import PasswordResetTokenGenerator
...
from skailar.test import RequestFactory, TestCase, override_settings
...
class AuthTemplateTests(TestCase):
    ...
    def test_password_reset_view(self):
        ...
        self.assertContains(
            response, "<title>Password reset | Skailar site admin</title>"
        )
    ...
    def test_password_reset_done_view(self):
        ...
        self.assertContains(
            response, "<title>Password reset sent | Skailar site admin</title>"
        )
    ...
    def test_password_reset_confirm_view_invalid_token(self):
        ...
        self.assertContains(
            response, "<title>Password reset unsuccessful | Skailar site admin</title>"
        )
    ...
    def test_password_reset_confirm_view_valid_token(self):
        ...
        response = client.get(url)
        self.assertContains(
            response, "<title>Enter new password | Skailar site admin</title>"
        )
    ...
    def test_password_reset_confirm_view_custom_username_hint(self):
        ...
        self.assertContains(
            response,
            "<title>Enter new password | Skailar site admin</title>",
        )
        self.assertContains(response, "<h1>Enter new password</h1>")
    ...
    def test_password_reset_complete_view(self):
        ...
        self.assertContains(
            response, "<title>Password reset complete | Skailar site admin</title>"
        )
    ...
    def test_password_reset_change_view(self):
        ...
        self.assertContains(
            response, "<title>Password change | Skailar site admin</title>"
        )
    ...
    def test_password_change_done_view(self):
        ...
        self.assertContains(
            response, "<title>Password change successful | Skailar site admin</title>"
        )
