...
class TradeLens:
    ...
    @staticmethod
    def plot_pnl(trade_data, check_date):
    ...
    def analyze_pnl(trades, start_date, end_date):
        trades = trades[trades.date_only >= start_date]
        trades = trades[trades.date_only <= end_date]
        ...
        for check_date in check_dates:
            TradeLens.plot_pnl(trade_data, str(check_date).split("T")[0])