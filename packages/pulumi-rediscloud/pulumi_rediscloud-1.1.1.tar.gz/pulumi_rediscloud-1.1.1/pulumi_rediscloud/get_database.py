...
def get_database(name: Optional[str] = None,
    ...
    return AwaitableGetDatabaseResult(
        ...
        data_eviction=__ret__.data_eviction,
        data_persistence=__ret__.data_persistence,
        hashing_policies=__ret__.hashing_policies,
        id=__ret__.id,
        memory_limit_in_gb=__ret__.memory_limit_in_gb,
        ...
        replica_ofs=__ret__.replica_ofs,
        replication=__ret__.replication,
        subscription_id=__ret__.subscription_id,
        support_oss_cluster_api=__ret__.support_oss_cluster_api,
        throughput_measurement_by=__ret__.throughput_measurement_by,
        throughput_measurement_value=__ret__.throughput_measurement_value)
