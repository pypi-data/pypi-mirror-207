...
class RequestWebView(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot: :obj:`InputUser <pyrosex.raw.base.InputUser>`
        from_bot_menu (optional): ``bool``
        silent (optional): ``bool``
        url (optional): ``str``
        start_param (optional): ``str``
        theme_params (optional): :obj:`DataJSON <pyrosex.raw.base.DataJSON>`
        reply_to_msg_id (optional): ``int`` ``32-bit``
        send_as (optional): :obj:`InputPeer <pyrosex.raw.base.InputPeer>`

    Returns:
        :obj:`WebViewResult <pyrosex.raw.base.WebViewResult>`
    """

    __slots__: List[str] = ["peer", "bot", "from_bot_menu", "silent", "url", "start_param", "theme_params", "reply_to_msg_id", "send_as"]

    ID = 0x91b15831
    QUALNAME = "functions.messages.RequestWebView"

    def __init__(self, *, peer: "raw.base.InputPeer", bot: "raw.base.InputUser", from_bot_menu: Optional[bool] = None, silent: Optional[bool] = None, url: Optional[str] = None, start_param: Optional[str] = None, theme_params: "raw.base.DataJSON" = None, reply_to_msg_id: Optional[int] = None, send_as: "raw.base.InputPeer" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "RequestWebView":
        ...
        return RequestWebView(peer=peer, bot=bot, from_bot_menu=from_bot_menu, silent=silent, url=url, start_param=start_param, theme_params=theme_params, reply_to_msg_id=reply_to_msg_id, send_as=send_as)
