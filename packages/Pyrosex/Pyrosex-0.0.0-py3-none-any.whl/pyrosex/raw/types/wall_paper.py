...
class WallPaper(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        slug: ``str``
        document: :obj:`Document <pyrosex.raw.base.Document>`
        creator (optional): ``bool``
        default (optional): ``bool``
        pattern (optional): ``bool``
        dark (optional): ``bool``
        settings (optional): :obj:`WallPaperSettings <pyrosex.raw.base.WallPaperSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetWallPaper <pyrosex.raw.functions.account.GetWallPaper>`
            - :obj:`account.UploadWallPaper <pyrosex.raw.functions.account.UploadWallPaper>`
            - :obj:`account.GetMultiWallPapers <pyrosex.raw.functions.account.GetMultiWallPapers>`
    """
