...
class SupportName:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.SupportName <pyrosex.raw.types.help.SupportName>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetSupportName <pyrosex.raw.functions.help.GetSupportName>`
    """

    QUALNAME = "pyrosex.raw.base.help.SupportName"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/support-name")
