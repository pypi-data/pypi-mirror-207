...
SchemaFor200ResponseBodyApplicationJson = RelationshipList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_account_relationship_oapg(
        self,
...
class ListAccountRelationship(BaseApi):
    ...
    def list_account_relationship(
        ...
        return self._list_account_relationship_oapg(
