...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key: :obj:`InputPrivacyKey <pyrosex.raw.base.InputPrivacyKey>`
        rules: List of :obj:`InputPrivacyRule <pyrosex.raw.base.InputPrivacyRule>`

    Returns:
        :obj:`account.PrivacyRules <pyrosex.raw.base.account.PrivacyRules>`
    """
