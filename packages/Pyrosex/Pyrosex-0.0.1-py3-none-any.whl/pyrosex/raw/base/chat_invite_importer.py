...
class ChatInviteImporter:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatInviteImporter <pyrosex.raw.types.ChatInviteImporter>`
    """

    QUALNAME = "pyrosex.raw.base.ChatInviteImporter"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-invite-importer")
