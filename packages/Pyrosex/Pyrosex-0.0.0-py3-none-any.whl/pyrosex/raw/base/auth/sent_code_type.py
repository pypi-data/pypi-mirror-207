...
class SentCodeType:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`auth.SentCodeTypeApp <pyrosex.raw.types.auth.SentCodeTypeApp>`
            - :obj:`auth.SentCodeTypeCall <pyrosex.raw.types.auth.SentCodeTypeCall>`
            - :obj:`auth.SentCodeTypeFlashCall <pyrosex.raw.types.auth.SentCodeTypeFlashCall>`
            - :obj:`auth.SentCodeTypeMissedCall <pyrosex.raw.types.auth.SentCodeTypeMissedCall>`
            - :obj:`auth.SentCodeTypeSms <pyrosex.raw.types.auth.SentCodeTypeSms>`
    """

    QUALNAME = "pyrosex.raw.base.auth.SentCodeType"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/sent-code-type")
