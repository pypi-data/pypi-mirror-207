...
SchemaFor200ResponseBodyApplicationJson = WatchlistSubscriptionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_watchlist_subscriptions_oapg(
        self,
...
class ListWatchlistSubscriptions(BaseApi):
    ...
    def list_watchlist_subscriptions(
        ...
        return self._list_watchlist_subscriptions_oapg(
