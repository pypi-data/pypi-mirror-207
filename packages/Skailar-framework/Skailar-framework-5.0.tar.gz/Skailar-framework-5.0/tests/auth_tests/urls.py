...
from skailar.contrib.auth.decorators import login_required, permission_required
from skailar.contrib.auth.forms import AuthenticationForm
from skailar.contrib.auth.urls import urlpatterns as auth_urlpatterns
from skailar.contrib.auth.views import LoginView
from skailar.contrib.messages.api import info
from skailar.http import HttpRequest, HttpResponse
from skailar.shortcuts import render
from skailar.template import RequestContext, Template
from skailar.urls import path, re_path, reverse_lazy
from skailar.views.decorators.cache import never_cache
from skailar.views.i18n import set_language
