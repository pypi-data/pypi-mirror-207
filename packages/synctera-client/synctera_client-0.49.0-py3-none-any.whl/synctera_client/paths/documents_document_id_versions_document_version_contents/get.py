...
DocumentVersionSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'document_id': typing.Union[DocumentIdSchema, str, uuid.UUID, ],
        'document_version': typing.Union[DocumentVersionSchema, decimal.Decimal, int, ],
    }
)
...
request_path_document_version = api_client.PathParameter(
...
SchemaFor200ResponseBody = schemas.BinarySchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_document_version_contents_oapg(
        self,
...
class GetDocumentVersionContents(BaseApi):
    ...
    def get_document_version_contents(
        ...
        return self._get_document_version_contents_oapg(
