...
class RabbitMQConsumer(object):
    ...
    def set_parent_options(self, task_id, task_name):
        ...
        try:
            os.environ["SPARROW_TASK_PARENT_OPTIONS"] = json.dumps(parent_options, ensure_ascii=False, cls=PythonObjectEncoder)
        except:
            pass
    ...
    def _get_jstr_from_cls(result, cls):
        ...
        """
        try:
            json_result = json.dumps(result, ensure_ascii=False, cls=cls)
            _t = ''
        except:
    ...
    def get_task_info(self, headers, body):
        ...
        task_info = {
                ...
                "task_args": json.dumps(json_body.get("args"), ensure_ascii=False, cls=PythonObjectEncoder), # from body.args
                "task_kwargs": json.dumps(json_body.get("kwargs"), ensure_ascii=False, cls=PythonObjectEncoder), # from body.kwargs
        ...
        return json.dumps(task_info, ensure_ascii=False, cls=PythonObjectEncoder)
