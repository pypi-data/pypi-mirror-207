...
class DifferenceSlice(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages: List of :obj:`Message <pyrosex.raw.base.Message>`
        new_encrypted_messages: List of :obj:`EncryptedMessage <pyrosex.raw.base.EncryptedMessage>`
        other_updates: List of :obj:`Update <pyrosex.raw.base.Update>`
        chats: List of :obj:`Chat <pyrosex.raw.base.Chat>`
        users: List of :obj:`User <pyrosex.raw.base.User>`
        intermediate_state: :obj:`updates.State <pyrosex.raw.base.updates.State>`
