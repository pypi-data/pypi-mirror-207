...
from skailar.core.exceptions import ImproperlyConfigured, ValidationError
from skailar.core.files import locks
from skailar.core.handlers.wsgi import WSGIHandler, get_path_info
from skailar.core.management import call_command
from skailar.core.management.color import no_style
from skailar.core.management.sql import emit_post_migrate_signal
from skailar.core.servers.basehttp import ThreadedWSGIServer, WSGIRequestHandler
from skailar.core.signals import setting_changed
from skailar.db import DEFAULT_DB_ALIAS, connection, connections, transaction
from skailar.forms.fields import CharField
from skailar.http import QueryDict
from skailar.http.request import split_domain_port, validate_host
from skailar.test.client import AsyncClient, Client
from skailar.test.html import HTMLParseError, parse_html
from skailar.test.signals import template_rendered
...
from skailar.utils.functional import classproperty
from skailar.views.static import serve

logger = logging.getLogger("skailar.test")
...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common Skailar test
    ...
    def assertRedirects(
        ...
        if hasattr(response, "redirect_chain"):
            ...
            if fetch_redirect_response:
                # netloc might be empty, or in cases where Skailar tests the
                ...
                if domain and not validate_host(domain, settings.ALLOWED_HOSTS):
                    raise ValueError(
                        ...
                        "If the host is served by Skailar, add '%s' to ALLOWED_HOSTS. "
                        "Otherwise, use "
    ...
    def assertFormsetError(self, *args, **kw):
        warnings.warn(
            ...
            category=RemovedInSkailar51Warning,
            stacklevel=2,
        )
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, Skailar will serialize the database
...
class FSFilesHandler(WSGIHandler):
    ...
    def serve(self, request):
        ...
        # Emulate behavior of skailar.contrib.staticfiles.views.serve() when it
