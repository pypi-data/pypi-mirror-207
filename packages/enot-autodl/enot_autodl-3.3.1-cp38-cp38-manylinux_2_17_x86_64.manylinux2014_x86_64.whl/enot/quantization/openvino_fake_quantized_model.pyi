...
class OpenvinoFakeQuantizedModel(FakeQuantizedModel):
    def __init__(self, model: nn.Module, leaf_modules: Optional[List[Union[Type[nn.Module], nn.Module]]] = ..., apply_avx2_fix: bool = ..., use_weight_scale_factors: bool = ..., use_bias_scale_factors: bool = ..., **kwargs) -> None: ...
