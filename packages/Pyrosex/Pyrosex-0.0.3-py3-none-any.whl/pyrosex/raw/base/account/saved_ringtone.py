...
class SavedRingtone:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.SavedRingtone <pyrosex.raw.types.account.SavedRingtone>`
            - :obj:`account.SavedRingtoneConverted <pyrosex.raw.types.account.SavedRingtoneConverted>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.SaveRingtone <pyrosex.raw.functions.account.SaveRingtone>`
    """

    QUALNAME = "pyrosex.raw.base.account.SavedRingtone"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/saved-ringtone")
