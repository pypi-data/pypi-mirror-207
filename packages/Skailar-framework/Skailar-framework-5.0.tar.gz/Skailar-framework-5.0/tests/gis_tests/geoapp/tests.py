...
from skailar.contrib.gis.db.models import Extent, MakeLine, Union, functions
...
from skailar.db import DatabaseError, NotSupportedError, connection
...
class GeoLookupTest(TestCase):
    ...
    def test_wkt_string_in_lookup(self):
        ...
        with self.assertNoLogs("skailar.contrib.gis", "ERROR"):
