...
RiskRatingIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customer_id': typing.Union[CustomerIdSchema, str, uuid.UUID, ],
        'risk_rating_id': typing.Union[RiskRatingIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_risk_rating_id = api_client.PathParameter(
    name="risk_rating_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RiskRatingIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = RiskRating
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_customer_risk_rating_oapg(
        self,
...
class GetCustomerRiskRating(BaseApi):
    ...
    def get_customer_risk_rating(
        ...
        return self._get_customer_risk_rating_oapg(
