...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        format: ``str``
        theme: :obj:`InputTheme <pyrosex.raw.base.InputTheme>`
        slug (optional): ``str``
        title (optional): ``str``
        document (optional): :obj:`InputDocument <pyrosex.raw.base.InputDocument>`
        settings (optional): List of :obj:`InputThemeSettings <pyrosex.raw.base.InputThemeSettings>`

    Returns:
        :obj:`Theme <pyrosex.raw.base.Theme>`
    """
