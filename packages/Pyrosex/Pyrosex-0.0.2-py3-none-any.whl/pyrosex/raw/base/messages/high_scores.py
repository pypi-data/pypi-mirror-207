...
class HighScores:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.HighScores <pyrosex.raw.types.messages.HighScores>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetGameHighScores <pyrosex.raw.functions.messages.GetGameHighScores>`
            - :obj:`messages.GetInlineGameHighScores <pyrosex.raw.functions.messages.GetInlineGameHighScores>`
    """

    QUALNAME = "pyrosex.raw.base.messages.HighScores"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/high-scores")
