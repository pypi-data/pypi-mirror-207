...
class ChatFull:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ChatFull <pyrosex.raw.types.messages.ChatFull>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetFullChat <pyrosex.raw.functions.messages.GetFullChat>`
            - :obj:`channels.GetFullChannel <pyrosex.raw.functions.channels.GetFullChannel>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ChatFull"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-full")
