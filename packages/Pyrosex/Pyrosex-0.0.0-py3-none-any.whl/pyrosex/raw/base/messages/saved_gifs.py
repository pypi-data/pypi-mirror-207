...
class SavedGifs:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.SavedGifs <pyrosex.raw.types.messages.SavedGifs>`
            - :obj:`messages.SavedGifsNotModified <pyrosex.raw.types.messages.SavedGifsNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSavedGifs <pyrosex.raw.functions.messages.GetSavedGifs>`
    """

    QUALNAME = "pyrosex.raw.base.messages.SavedGifs"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/saved-gifs")
