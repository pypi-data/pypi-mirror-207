...
class InputCheckPasswordSRP:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputCheckPasswordEmpty <pyrosex.raw.types.InputCheckPasswordEmpty>`
            - :obj:`InputCheckPasswordSRP <pyrosex.raw.types.InputCheckPasswordSRP>`
    """

    QUALNAME = "pyrosex.raw.base.InputCheckPasswordSRP"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-check-password-srp")
