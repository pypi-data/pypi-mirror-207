...
from skailar.core import signing
...
from skailar.core.files import uploadhandler
from skailar.http.multipartparser import (
    MultiPartParser,
    MultiPartParserError,
    TooManyFilesSent,
)
from skailar.utils.datastructures import (
    CaseInsensitiveMapping,
    ImmutableList,
    MultiValueDict,
)
from skailar.utils.encoding import escape_uri_path, iri_to_uri
from skailar.utils.functional import cached_property
from skailar.utils.http import is_same_domain, parse_header_parameters
...
class QueryDict(MultiValueDict):
    ...
    def __init__(self, query_string=None, mutable=False, encoding=None):
        ...
        try:
            ...
            # parse_qsl() is True. As that is not used by Skailar, assume that
...
# skailar.utils.encoding.force_str() for parsing URLs and form inputs. Thus,
