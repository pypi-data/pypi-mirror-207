...
from skailar.contrib.messages.storage.cookie import (
    CookieStorage,
    MessageDecoder,
    MessageEncoder,
    bisect_keep_left,
...
from skailar.utils.crypto import get_random_string
...
class CookieTests(BaseTests, SimpleTestCase):
    ...
    def test_safedata(self):
        ...
        self.assertIsInstance(
            self.encode_decode(mark_safe("<b>Hello Skailar!</b>")).message,
            SafeData,
        )
        self.assertNotIsInstance(
            self.encode_decode("<b>Hello Skailar!</b>").message,
            SafeData,
        )
