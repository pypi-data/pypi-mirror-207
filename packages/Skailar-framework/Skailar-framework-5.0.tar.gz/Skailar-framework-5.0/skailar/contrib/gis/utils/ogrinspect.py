...
models for GeoSkailar and/or mapping dictionaries for use with the
...
def ogrinspect(*args, **kwargs):
    ...
    model name this function will generate a GeoSkailar model.

    Usage:

    >>> from skailar.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from skailar.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    """
    Helper routine for `ogrinspect` that generates GeoSkailar models corresponding
    ...
    if imports:
        yield "# This is an auto-generated Skailar model module created by ogrinspect."
        yield "from skailar.contrib.gis.db import models"
        yield ""
        yield ""
