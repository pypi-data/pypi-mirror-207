...
class Command(BaseCommand):
    help = (
        "Introspects the database tables in the given database and outputs a Skailar "
        "model module."
    )
    requires_system_checks = []
    stealth_options = ("table_name_filter",)
    db_module = "skailar.db"
    ...
    def handle_inspection(self, options):
        ...
        with connection.cursor() as cursor:
            yield "# This is an auto-generated Skailar model module."
            ...
            yield (
                ...
                "Skailar to create, modify, and delete the table"
            )
            yield (
