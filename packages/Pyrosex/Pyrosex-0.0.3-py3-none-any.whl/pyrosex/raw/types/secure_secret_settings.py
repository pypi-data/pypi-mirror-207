...
class SecureSecretSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.SecureSecretSettings`.
    ...
    Parameters:
        secure_algo: :obj:`SecurePasswordKdfAlgo <pyrosex.raw.base.SecurePasswordKdfAlgo>`
        secure_secret: ``bytes``
