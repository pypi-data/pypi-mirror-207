...
class ChatInvite:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ChatInvite <pyrosex.raw.types.ChatInvite>`
            - :obj:`ChatInviteAlready <pyrosex.raw.types.ChatInviteAlready>`
            - :obj:`ChatInvitePeek <pyrosex.raw.types.ChatInvitePeek>`
    ...
    QUALNAME = "pyrosex.raw.base.ChatInvite"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/chat-invite")
