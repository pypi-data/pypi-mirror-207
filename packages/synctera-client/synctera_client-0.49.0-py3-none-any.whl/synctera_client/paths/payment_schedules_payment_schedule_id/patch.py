...
# Path params
PaymentScheduleIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'payment_schedule_id': typing.Union[PaymentScheduleIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_payment_schedule_id = api_client.PathParameter(
    name="payment_schedule_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PaymentScheduleIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PatchPaymentSchedule


request_body_patch_payment_schedule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PaymentSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_payment_schedule_oapg(
        self,
    ...
    def _patch_payment_schedule_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_payment_schedule_id,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_payment_schedule.serialize(body, content_type)
...
class PatchPaymentSchedule(BaseApi):
    ...
    def patch_payment_schedule(
        ...
        return self._patch_payment_schedule_oapg(
            body=body,
