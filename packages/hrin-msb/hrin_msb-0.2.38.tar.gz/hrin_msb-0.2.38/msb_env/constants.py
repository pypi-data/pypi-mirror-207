...
class PathConst:
	...
	BASE_FIXTURES_DIR_PATH = FIXTURES_DIR_PATH.joinpath(NameConst.DEFAULT_FIXTURE_DIR_NAME).resolve(),
	PROD_FIXTURES_DIR_PATH = FIXTURES_DIR_PATH.joinpath(NameConst.PROD_FIXTURE_DIR_NAME).resolve(),
	TEST_FIXTURES_DIR_PATH = FIXTURES_DIR_PATH.joinpath(NameConst.TEST_FIXTURE_DIR_NAME).resolve(),
	...
	FIXTURE_DIRS_LIST = [
		BASE_FIXTURES_DIR_PATH[0],PROD_FIXTURES_DIR_PATH[0],TEST_FIXTURES_DIR_PATH[0]
	]
