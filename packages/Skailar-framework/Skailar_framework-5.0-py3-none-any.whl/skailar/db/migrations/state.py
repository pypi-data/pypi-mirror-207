...
from skailar.db.migrations.utils import field_is_referenced, get_references
from skailar.db.models import NOT_PROVIDED
from skailar.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from skailar.db.models.options import DEFAULT_NAMES, normalize_together
from skailar.db.models.utils import make_model_tuple
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        # which is called whenever Skailar duplicates a StateApps before
        # updating it.
        self._lock = None
        ...
        from skailar.core.checks.model_checks import _check_lazy_references
            ...
            while unrendered_models:
                ...
                if len(new_unrendered_models) == len(unrendered_models):
                    raise InvalidBasesError(
                        ...
                        "https://docs.skailarproject.com/en/%s/topics/migrations/"
...
class ModelState:
    """
    Represent a Skailar Model. Don't use the actual Model class as it's not
