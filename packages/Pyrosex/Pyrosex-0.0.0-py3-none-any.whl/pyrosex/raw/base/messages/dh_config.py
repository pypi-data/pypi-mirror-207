...
class DhConfig:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.DhConfig <pyrosex.raw.types.messages.DhConfig>`
            - :obj:`messages.DhConfigNotModified <pyrosex.raw.types.messages.DhConfigNotModified>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDhConfig <pyrosex.raw.functions.messages.GetDhConfig>`
    """

    QUALNAME = "pyrosex.raw.base.messages.DhConfig"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/dh-config")
