...
# body param
SchemaForRequestBodyApplicationJson = AuthRequestModel


request_body_auth_request_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _simulate_authorization_oapg(
        self,
    ...
    def _simulate_authorization_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_auth_request_model.serialize(body, content_type)
...
class SimulateAuthorization(BaseApi):
    ...
    def simulate_authorization(
        ...
        return self._simulate_authorization_oapg(
            body=body,
