"""
 ...
 Example:
  >>> from skailar.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from skailar.contrib.gis.gdal import OGRGeomType
...
from skailar.contrib.gis.gdal.base import GDALBase
from skailar.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from skailar.contrib.gis.gdal.error import GDALException, SRSException
from skailar.contrib.gis.gdal.geomtype import OGRGeomType
from skailar.contrib.gis.gdal.prototypes import geom as capi
from skailar.contrib.gis.gdal.prototypes import srs as srs_api
from skailar.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from skailar.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
...
class OGRGeometry(GDALBase):
    ...
    # #### Output Methods ####
    def _geos_ptr(self):
        from skailar.contrib.gis.geos import GEOSGeometry
...
class Point(OGRGeometry):
    def _geos_ptr(self):
        from skailar.contrib.gis import geos
