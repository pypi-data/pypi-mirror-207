...
R7Z6_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R7Z6Cluster(GenericK8sCluster):
    """ R7Z6 Cluster Overrides """

    allowed_instances: Instances = R7Z6_INSTANCES
