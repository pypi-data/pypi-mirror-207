...
class InputDocument:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputDocument <pyrosex.raw.types.InputDocument>`
            - :obj:`InputDocumentEmpty <pyrosex.raw.types.InputDocumentEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.InputDocument"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-document")
