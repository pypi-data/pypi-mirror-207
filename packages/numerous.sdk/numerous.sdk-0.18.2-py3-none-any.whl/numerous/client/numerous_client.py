...
class NumerousClient:
    ...
    def data_read_raw(
        ...
        yield from self.open_data_stream(tags, start, end, project, scenario, execution)
    ...
    def read_data(
        ...
        data_stream = self.open_data_stream(
            tags, start, end, project, scenario, execution, latest_execution, subscribe
        )
    ...
    def data_read_df(
        ...
        data_generator = self.read_data(
            tags, start, end, project, scenario, execution, execution is None
        )
    ...
    def read_data_stream(
        ...
        return self.read_data(tags, start, end, project, scenario, execution)
    ...
    def read_data_as_row(
        ...
        data_stream = self.open_data_stream(
            tags, start, end, project, scenario, execution, subscribe=subscribe
        )
