...
class SearchResultsPositions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        positions: List of :obj:`SearchResultsPosition <pyrosex.raw.base.SearchResultsPosition>`
