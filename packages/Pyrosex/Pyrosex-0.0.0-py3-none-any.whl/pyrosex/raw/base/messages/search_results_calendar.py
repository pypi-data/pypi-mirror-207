...
class SearchResultsCalendar:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.SearchResultsCalendar <pyrosex.raw.types.messages.SearchResultsCalendar>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchResultsCalendar <pyrosex.raw.functions.messages.GetSearchResultsCalendar>`
    """

    QUALNAME = "pyrosex.raw.base.messages.SearchResultsCalendar"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/search-results-calendar")
