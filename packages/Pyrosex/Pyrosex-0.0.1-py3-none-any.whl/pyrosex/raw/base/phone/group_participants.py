...
class GroupParticipants:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`phone.GroupParticipants <pyrosex.raw.types.phone.GroupParticipants>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupParticipants <pyrosex.raw.functions.phone.GetGroupParticipants>`
    """

    QUALNAME = "pyrosex.raw.base.phone.GroupParticipants"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/group-participants")
