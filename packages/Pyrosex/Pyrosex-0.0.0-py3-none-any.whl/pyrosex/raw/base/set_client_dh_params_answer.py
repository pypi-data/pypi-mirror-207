...
class SetClientDHParamsAnswer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`DhGenFail <pyrosex.raw.types.DhGenFail>`
            - :obj:`DhGenOk <pyrosex.raw.types.DhGenOk>`
            - :obj:`DhGenRetry <pyrosex.raw.types.DhGenRetry>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`SetClientDHParams <pyrosex.raw.functions.SetClientDHParams>`
    """

    QUALNAME = "pyrosex.raw.base.SetClientDHParamsAnswer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/set-client-dh-params-answer")
