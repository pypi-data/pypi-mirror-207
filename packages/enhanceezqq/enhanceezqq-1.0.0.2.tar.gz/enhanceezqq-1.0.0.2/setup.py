...
setup(
    ...
    license="BSD",
    py_modules=['enhanceezqq', 'basefund', 'ths', 'ttjj', 'akpack'],
    install_requires=['pandas~=1.5.2', 'numpy~=1.24.1', 'openpyxl', 'argparse', 'pathlib',
                      ...
                      'pyxlsb', 'jsonlines', 'easyquotation', 'Jinja2','bs4', 'dftrans'],
    data_files=init_data_files(),
    url='https://gitee.com/Frank_583983716/enhanceezqq',
    entry_points={
        'console_scripts': [
            'eezqq = enhanceezqq:enhanceezqq_main'
        ]
    }
    # classifiers=[
    #     # 发展时期,常见的如下
