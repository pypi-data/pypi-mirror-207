"use strict";
(self["webpackChunk_datalayer_jupyter_ux"] = self["webpackChunk_datalayer_jupyter_ux"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_ux', // API Namespace
    endPoint);
    let response;
    try {
...
const IJupyterDocker = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_4__.Token('@datalayer/jupyter-ux:plugin');
const jupyterDocker = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-ux-widget';
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_ux server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_9__.connect)('ws://localhost:8888/jupyter_ux/echo', true);
...
//# sourceMappingURL=lib_index_js.2b53d51b180185a7229d.js.map