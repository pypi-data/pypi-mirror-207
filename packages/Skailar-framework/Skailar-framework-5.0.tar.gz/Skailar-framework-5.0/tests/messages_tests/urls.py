...
from skailar.contrib.messages.views import SuccessMessageMixin
from skailar.http import HttpResponse, HttpResponseRedirect
from skailar.template import engines
from skailar.template.response import TemplateResponse
from skailar.urls import path, re_path, reverse
from skailar.views.decorators.cache import never_cache
from skailar.views.generic.edit import DeleteView, FormView
...
@never_cache
def show(request):
    template = engines["skailar"].from_string(TEMPLATE)
