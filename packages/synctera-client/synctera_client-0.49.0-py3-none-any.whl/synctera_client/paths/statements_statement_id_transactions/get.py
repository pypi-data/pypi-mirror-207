...
# Path params
StatementIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'statement_id': typing.Union[StatementIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_statement_id = api_client.PathParameter(
    name="statement_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StatementIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = TransactionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_statement_transactions_oapg(
        self,
...
class GetStatementTransactions(BaseApi):
    ...
    def get_statement_transactions(
        ...
        return self._get_statement_transactions_oapg(
