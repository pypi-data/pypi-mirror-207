"""
Tests for skailar.core.servers.
"""
import errno
import os
import socket
...
from skailar.core.servers.basehttp import ThreadedWSGIServer, WSGIServer
from skailar.db import DEFAULT_DB_ALIAS, connection, connections
from skailar.test import LiveServerTestCase, override_settings
from skailar.test.testcases import LiveServerThread, QuietWSGIRequestHandler
...
class LiveServerTestCloseConnectionTest(LiveServerBase):
    ...
    def _make_connections_override(cls):
        ...
        # Skailar from closing the connection and allows testing that
