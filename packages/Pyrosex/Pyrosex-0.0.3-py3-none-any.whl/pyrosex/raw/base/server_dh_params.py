...
class ServerDHParams:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ServerDHParamsFail <pyrosex.raw.types.ServerDHParamsFail>`
            - :obj:`ServerDHParamsOk <pyrosex.raw.types.ServerDHParamsOk>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`ReqDHParams <pyrosex.raw.functions.ReqDHParams>`
    """

    QUALNAME = "pyrosex.raw.base.ServerDHParams"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/server-dh-params")
