...
class TranslatedText:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.TranslateNoResult <pyrosex.raw.types.messages.TranslateNoResult>`
            - :obj:`messages.TranslateResultText <pyrosex.raw.types.messages.TranslateResultText>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.TranslateText <pyrosex.raw.functions.messages.TranslateText>`
    """

    QUALNAME = "pyrosex.raw.base.messages.TranslatedText"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/translated-text")
