...
from skailar.db import connection, connections, models
from skailar.db.models.functions import Abs, Lower, Round
from skailar.db.models.signals import post_init
from skailar.test import SimpleTestCase, TestCase, ignore_warnings, skipUnlessDBFeature
from skailar.test.utils import isolate_apps, override_settings, register_lookup
...
class OtherModelTests(SimpleTestCase):
    ...
    @isolate_apps("skailar.contrib.auth", kwarg_name="apps")
