...
class User(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.User`.
    ...
    Parameters:
        ...
        phone (optional): ``str``
        photo (optional): :obj:`UserProfilePhoto <pyrosex.raw.base.UserProfilePhoto>`
        status (optional): :obj:`UserStatus <pyrosex.raw.base.UserStatus>`
        bot_info_version (optional): ``int`` ``32-bit``
        restriction_reason (optional): List of :obj:`RestrictionReason <pyrosex.raw.base.RestrictionReason>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.UpdateProfile <pyrosex.raw.functions.account.UpdateProfile>`
            - :obj:`account.UpdateUsername <pyrosex.raw.functions.account.UpdateUsername>`
            - :obj:`account.ChangePhone <pyrosex.raw.functions.account.ChangePhone>`
            - :obj:`users.GetUsers <pyrosex.raw.functions.users.GetUsers>`
    """
