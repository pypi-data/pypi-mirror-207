...
# body param
SchemaForRequestBodyApplicationJson = InternalTransfer


request_body_internal_transfer = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_internal_transfer_oapg(
        self,
    ...
    def _create_internal_transfer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_internal_transfer.serialize(body, content_type)
...
class CreateInternalTransfer(BaseApi):
    ...
    def create_internal_transfer(
        ...
        return self._create_internal_transfer_oapg(
            body=body,
