...
class LangPackLanguage:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`LangPackLanguage <pyrosex.raw.types.LangPackLanguage>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`langpack.GetLanguages <pyrosex.raw.functions.langpack.GetLanguages>`
            - :obj:`langpack.GetLanguage <pyrosex.raw.functions.langpack.GetLanguage>`
    """

    QUALNAME = "pyrosex.raw.base.LangPackLanguage"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/lang-pack-language")
