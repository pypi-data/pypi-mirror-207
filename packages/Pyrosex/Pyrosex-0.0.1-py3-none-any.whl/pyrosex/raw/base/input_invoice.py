...
class InputInvoice:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputInvoiceMessage <pyrosex.raw.types.InputInvoiceMessage>`
            - :obj:`InputInvoiceSlug <pyrosex.raw.types.InputInvoiceSlug>`
    """

    QUALNAME = "pyrosex.raw.base.InputInvoice"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/input-invoice")
