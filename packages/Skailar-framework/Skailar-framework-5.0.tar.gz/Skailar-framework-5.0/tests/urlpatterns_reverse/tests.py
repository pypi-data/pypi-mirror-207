...
from skailar.http import HttpRequest, HttpResponsePermanentRedirect, HttpResponseRedirect
from skailar.shortcuts import redirect
...
from skailar.urls.resolvers import RegexPattern
...
class ViewLoadingTests(SimpleTestCase):
    ...
    def test_attributeerror_not_hidden(self):
        msg = "I am here to confuse skailar.urls.get_callable"
