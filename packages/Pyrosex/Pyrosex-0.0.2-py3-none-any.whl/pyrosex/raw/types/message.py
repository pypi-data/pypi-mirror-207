...
class Message(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.Message`.
    ...
    Parameters:
        id: ``int`` ``32-bit``
        peer_id: :obj:`Peer <pyrosex.raw.base.Peer>`
        date: ``int`` ``32-bit``
        message: ``str``
        out (optional): ``bool``
        ...
        from_id (optional): :obj:`Peer <pyrosex.raw.base.Peer>`
        ...
        reply_markup (optional): :obj:`ReplyMarkup <pyrosex.raw.base.ReplyMarkup>`
        ...
        replies (optional): :obj:`MessageReplies <pyrosex.raw.base.MessageReplies>`
        edit_date (optional): ``int`` ``32-bit``
        post_author (optional): ``str``
        grouped_id (optional): ``int`` ``64-bit``
        reactions (optional): :obj:`MessageReactions <pyrosex.raw.base.MessageReactions>`
