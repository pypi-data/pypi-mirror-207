...
from skailar.core.exceptions import DisallowedHost, ImproperlyConfigured
from skailar.http import HttpHeaders, UnreadablePostError
from skailar.urls import get_callable
from skailar.utils.cache import patch_vary_headers
from skailar.utils.crypto import constant_time_compare, get_random_string
from skailar.utils.deprecation import MiddlewareMixin
from skailar.utils.functional import cached_property
from skailar.utils.http import is_same_domain
from skailar.utils.log import log_response
from skailar.utils.regex_helper import _lazy_re_compile

logger = logging.getLogger("skailar.security.csrf")
...
class CsrfViewMiddleware(MiddlewareMixin):
    ...
    def _get_secret(self, request):
        ...
        if csrf_secret is None:
            return None
        # Skailar versions before 4.0 masked the secret before storing.
