...
class Found(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results: List of :obj:`Peer <pyrosex.raw.base.Peer>`
        results: List of :obj:`Peer <pyrosex.raw.base.Peer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.Search <pyrosex.raw.functions.contacts.Search>`
    """
