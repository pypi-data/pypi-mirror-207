...
from skailar.contrib.auth.backends import RemoteUserBackend
from skailar.contrib.auth.middleware import RemoteUserMiddleware
from skailar.contrib.auth.models import User
from skailar.middleware.csrf import _get_new_csrf_string, _mask_cipher_secret
from skailar.test import Client, TestCase, modify_settings, override_settings


@override_settings(ROOT_URLCONF="auth_tests.urls")
class RemoteUserTest(TestCase):
    middleware = "skailar.contrib.auth.middleware.RemoteUserMiddleware"
    backend = "skailar.contrib.auth.backends.RemoteUserBackend"
    header = "REMOTE_USER"
    ...
    def test_csrf_validation_passes_after_process_request_login(self):
        ...
        # This request will call skailar.contrib.auth.login() which will call
        # skailar.middleware.csrf.rotate_token() thus changing the value of
...
class AllowAllUsersRemoteUserBackendTest(RemoteUserTest):
    ...
    backend = "skailar.contrib.auth.backends.AllowAllUsersRemoteUserBackend"
...
class PersistentRemoteUserTest(RemoteUserTest):
    ...
    middleware = "skailar.contrib.auth.middleware.PersistentRemoteUserMiddleware"
