...
from skailar.contrib.staticfiles import utils
from skailar.contrib.staticfiles.views import serve
from skailar.core.handlers.asgi import ASGIHandler
from skailar.core.handlers.exception import response_for_exception
...
class ASGIStaticFilesHandler(StaticFilesHandlerMixin, ASGIHandler):
    ...
    files, passing them off to Skailar's static file serving.
    """
