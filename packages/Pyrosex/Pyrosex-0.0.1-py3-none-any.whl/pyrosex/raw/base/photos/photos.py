...
class Photos:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`photos.Photos <pyrosex.raw.types.photos.Photos>`
            - :obj:`photos.PhotosSlice <pyrosex.raw.types.photos.PhotosSlice>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`photos.GetUserPhotos <pyrosex.raw.functions.photos.GetUserPhotos>`
    """

    QUALNAME = "pyrosex.raw.base.photos.Photos"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/photos")
