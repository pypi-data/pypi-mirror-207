...
from skailar.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
...
from skailar.db.backends.sqlite3.operations import DatabaseOperations
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def spatial_version(self):
        ...
        if version < (4, 3, 0):
            raise ImproperlyConfigured("GeoSkailar supports SpatiaLite 4.3.0 and above.")
        return version
    ...
    def geometry_columns(self):
        from skailar.contrib.gis.db.backends.spatialite.models import (
