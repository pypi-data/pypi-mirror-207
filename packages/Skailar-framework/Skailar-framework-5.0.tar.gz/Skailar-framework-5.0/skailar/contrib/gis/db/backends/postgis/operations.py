...
from skailar.contrib.gis.db.backends.base.operations import BaseSpatialOperations
from skailar.contrib.gis.db.backends.utils import SpatialOperator
from skailar.contrib.gis.db.models import GeometryField, RasterField
from skailar.contrib.gis.gdal import GDALRaster
from skailar.contrib.gis.geos.geometry import GEOSGeometryBase
from skailar.contrib.gis.geos.prototypes.io import wkb_r
from skailar.contrib.gis.measure import Distance
from skailar.core.exceptions import ImproperlyConfigured
from skailar.db import NotSupportedError, ProgrammingError
from skailar.db.backends.postgresql.operations import DatabaseOperations
from skailar.db.backends.postgresql.psycopg_any import is_psycopg3
from skailar.db.models import Func, Value
        ...
        if hasattr(settings, "POSTGIS_VERSION"):
            ...
            try:
                ...
                raise ImproperlyConfigured(
                    ...
                    "GeoSkailar requires at least PostGIS version 2.5. "
