...
class OneshotExec:
    """ 
        Attributes:
            ...
            maximum_replicas (Union[Unset, None, int]):
            prewarmed_replicas (Union[Unset, None, int]):
     """
    ...
    maximum_replicas: Union[Unset, None, int] = UNSET
    prewarmed_replicas: Union[Unset, None, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if maximum_replicas is not UNSET:
            field_dict["maximum_replicas"] = maximum_replicas
        if prewarmed_replicas is not UNSET:
            field_dict["prewarmed_replicas"] = prewarmed_replicas
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        maximum_replicas = d.pop("maximum_replicas", UNSET)

        prewarmed_replicas = d.pop("prewarmed_replicas", UNSET)
