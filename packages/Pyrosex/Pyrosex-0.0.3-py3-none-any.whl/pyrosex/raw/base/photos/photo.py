...
class Photo:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`photos.Photo <pyrosex.raw.types.photos.Photo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`photos.UpdateProfilePhoto <pyrosex.raw.functions.photos.UpdateProfilePhoto>`
            - :obj:`photos.UploadProfilePhoto <pyrosex.raw.functions.photos.UploadProfilePhoto>`
    """

    QUALNAME = "pyrosex.raw.base.photos.Photo"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/photo")
