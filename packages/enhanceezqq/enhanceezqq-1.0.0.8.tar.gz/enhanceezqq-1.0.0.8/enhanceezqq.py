...
from psgspecialelements import sys_data_files_copy
...
ENHACNEEZQQ_SYSTEM_DATA_FILES = [STOCK_RESEARCH_CONFIG]
...
def enhanceezqq_main(*args, **kwargs):
    ...
    * -o -outputfile (结果输出文件，json？ excel？)
    ...
    datasourcelist = [
        ...
        'hkquote',          # 港股 00001
        'ttjj',             # 天天基金, 实时基金估值， 则为获取基金历史数据
        'ths',              # 同花顺基金, 实时基金估值， 则为获取基金历史数据
    ...
    result = sys_data_files_copy(ENHACNEEZQQ_SYSTEM_DATA_FILES)
