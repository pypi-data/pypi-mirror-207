...
EmploymentIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customer_id': typing.Union[CustomerIdSchema, str, uuid.UUID, ],
        'employment_id': typing.Union[EmploymentIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = Employment


request_body_employment = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Employment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_party_employment_oapg(
        self,
    ...
    def _update_party_employment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_employment.serialize(body, content_type)
...
class UpdatePartyEmployment(BaseApi):
    ...
    def update_party_employment(
        ...
        return self._update_party_employment_oapg(
            body=body,
