...
from skailar.contrib.admin.actions import delete_selected
...
class SiteEachContextTest(TestCase):
    ...
    def test_each_context(self):
        ctx = self.ctx
        self.assertEqual(ctx["site_header"], "Skailar administration")
        self.assertEqual(ctx["site_title"], "Skailar site admin")
