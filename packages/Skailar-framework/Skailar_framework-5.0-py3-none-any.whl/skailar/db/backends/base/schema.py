...
from skailar.db.backends.ddl_references import (
    Columns,
    Expressions,
    ForeignKeyName,
    IndexName,
...
from skailar.db.backends.utils import names_digest, split_identifier, truncate_name
from skailar.db.models import Deferrable, Index
...
logger = logging.getLogger("skailar.db.backends.schema")
...
class BaseDatabaseSchemaEditor:
    ...
    def add_field(self, model, field):
        ...
        # (Skailar usually does not use in-database defaults)
        if (
