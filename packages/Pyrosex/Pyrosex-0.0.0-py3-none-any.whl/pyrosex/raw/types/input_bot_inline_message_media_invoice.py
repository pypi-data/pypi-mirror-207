...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrosex.raw.base.InputBotInlineMessage`.
    ...
    Parameters:
        ...
        payload: ``bytes``
        provider: ``str``
        provider_data: :obj:`DataJSON <pyrosex.raw.base.DataJSON>`
        photo (optional): :obj:`InputWebDocument <pyrosex.raw.base.InputWebDocument>`
