...
from skailar.core.paginator import Page
from skailar.template import engines, loader
from skailar.urls import NoReverseMatch
from skailar.utils.html import mark_safe
...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        """
        Renders data to HTML, using Skailar's standard template rendering.
    ...
    def get_exception_template(self, response):
        ...
        try:
            ...
            template = engines['skailar'].from_string(body)
            return template
...
class MultiPartRenderer(BaseRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        from skailar.test.client import encode_multipart
