...
from skailar.utils.html import escape, format_html, smart_urlquote
...
def add_class(value, css_class):
    """
    https://stackoverflow.com/questions/4124220/skailar-adding-css-classes-when-rendering-form-fields-in-a-template
...
def items(value):
    ...
    have a key 'items' which is resolved first in Skailar template dot-notation
    lookup.  See issue #4931
    Also see: https://stackoverflow.com/questions/15416662/skailar-template-loop-over-dictionary-items-with-items-as-key
    """
    if value is None:
