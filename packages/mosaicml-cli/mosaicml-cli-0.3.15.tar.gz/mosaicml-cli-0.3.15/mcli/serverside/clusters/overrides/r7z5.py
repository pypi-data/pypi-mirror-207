...
R7Z5_INSTANCES = LocalInstances(gpu_configurations=[a100_config, cpu_config])


class R7Z5Cluster(GenericK8sCluster):
    """ R7Z5 Cluster Overrides """

    allowed_instances: Instances = R7Z5_INSTANCES
