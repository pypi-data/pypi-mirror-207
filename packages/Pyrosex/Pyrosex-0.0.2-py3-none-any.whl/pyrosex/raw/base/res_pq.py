...
class ResPQ:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`ResPQ <pyrosex.raw.types.ResPQ>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`ReqPq <pyrosex.raw.functions.ReqPq>`
            - :obj:`ReqPqMulti <pyrosex.raw.functions.ReqPqMulti>`
    """

    QUALNAME = "pyrosex.raw.base.ResPQ"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/res-pq")
