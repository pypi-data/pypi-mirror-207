...
class CheckedHistoryImportPeer:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.CheckedHistoryImportPeer <pyrosex.raw.types.messages.CheckedHistoryImportPeer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.CheckHistoryImportPeer <pyrosex.raw.functions.messages.CheckHistoryImportPeer>`
    """

    QUALNAME = "pyrosex.raw.base.messages.CheckedHistoryImportPeer"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/checked-history-import-peer")
