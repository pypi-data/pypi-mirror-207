...
class GeoPoint:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`GeoPoint <pyrosex.raw.types.GeoPoint>`
            - :obj:`GeoPointEmpty <pyrosex.raw.types.GeoPointEmpty>`
    """

    QUALNAME = "pyrosex.raw.base.GeoPoint"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/geo-point")
