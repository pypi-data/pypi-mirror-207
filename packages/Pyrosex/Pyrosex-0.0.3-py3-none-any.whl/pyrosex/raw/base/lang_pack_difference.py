...
class LangPackDifference:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`LangPackDifference <pyrosex.raw.types.LangPackDifference>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`langpack.GetLangPack <pyrosex.raw.functions.langpack.GetLangPack>`
            - :obj:`langpack.GetDifference <pyrosex.raw.functions.langpack.GetDifference>`
    """

    QUALNAME = "pyrosex.raw.base.LangPackDifference"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/lang-pack-difference")
