...
class ExportedChatInvite:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.ExportedChatInvite <pyrosex.raw.types.messages.ExportedChatInvite>`
            - :obj:`messages.ExportedChatInviteReplaced <pyrosex.raw.types.messages.ExportedChatInviteReplaced>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetExportedChatInvite <pyrosex.raw.functions.messages.GetExportedChatInvite>`
            - :obj:`messages.EditExportedChatInvite <pyrosex.raw.functions.messages.EditExportedChatInvite>`
    """

    QUALNAME = "pyrosex.raw.base.messages.ExportedChatInvite"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/exported-chat-invite")
