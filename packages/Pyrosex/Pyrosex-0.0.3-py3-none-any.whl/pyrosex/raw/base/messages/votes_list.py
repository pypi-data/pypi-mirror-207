...
class VotesList:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`messages.VotesList <pyrosex.raw.types.messages.VotesList>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetPollVotes <pyrosex.raw.functions.messages.GetPollVotes>`
    """

    QUALNAME = "pyrosex.raw.base.messages.VotesList"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/votes-list")
