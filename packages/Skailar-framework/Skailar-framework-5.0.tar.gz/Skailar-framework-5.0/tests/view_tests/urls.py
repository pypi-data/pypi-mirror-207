...
from skailar.views import defaults, i18n, static
...
urlpatterns = [
    ...
    # i18n views
    path("i18n/", include("skailar.conf.urls.i18n")),
    ...
    path(
        "jsi18n_admin/",
        i18n.JavaScriptCatalog.as_view(packages=["skailar.contrib.admin", "view_tests"]),
    ),
