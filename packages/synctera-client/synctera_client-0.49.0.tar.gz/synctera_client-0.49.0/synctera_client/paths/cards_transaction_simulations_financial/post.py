...
# body param
SchemaForRequestBodyApplicationJson = FinancialRequestModel


request_body_financial_request_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _simulate_financial_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_financial_request_model.serialize(body, content_type)
...
class SimulateFinancial(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def simulate_financial(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def simulate_financial(
        ...
        return self._simulate_financial_oapg(
            body=body,
