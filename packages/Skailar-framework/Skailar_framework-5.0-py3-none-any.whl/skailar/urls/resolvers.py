...
from skailar.core.checks import Error, Warning
from skailar.core.checks.urls import check_resolver
from skailar.core.exceptions import ImproperlyConfigured, ViewDoesNotExist
from skailar.utils.datastructures import MultiValueDict
from skailar.utils.functional import cached_property
from skailar.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from skailar.utils.regex_helper import _lazy_re_compile, normalize
...
def _route_to_regex(route, is_endpoint=False):
    ...
    and {'pk': <skailar.urls.converters.IntConverter>}.
    """
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to skailar.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLPattern:
    ...
    def _check_callback(self):
        from skailar.views import View
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # skailar.conf.urls imports this file.
            from skailar.conf import urls
