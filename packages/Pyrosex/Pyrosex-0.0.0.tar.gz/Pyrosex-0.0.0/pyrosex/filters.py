...
from pyrosex.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyrosex.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyrosex.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyrosex.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrosex.types.Message`; in a :obj:`~pyrosex.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrosex.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrosex.filters.command` or :meth:`~pyrosex.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrosex.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrosex.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrosex.types.Message`.
    ...
    async def func(flt, client: pyrosex.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrosex.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrosex.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrosex.types.InlineQuery`: The filter will match ``query``.
