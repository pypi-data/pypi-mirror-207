...
def initialize_spin_lattice(sp_lat,start_conf='as_input',q_for_Potts=3):
    ...
    if start_conf.lower() == 'xfm':  sp_lat[...,:]= [1,0,0]
    if start_conf.lower() == 'yfm':  sp_lat[...,:]= [0,1,0]
    if start_conf.lower() == 'zfm':  sp_lat[...,:]= [0,0,1]
    return sp_lat
