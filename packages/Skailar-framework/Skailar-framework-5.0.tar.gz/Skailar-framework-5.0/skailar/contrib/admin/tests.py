...
from skailar.contrib.staticfiles.testing import StaticLiveServerTestCase
from skailar.test import modify_settings
...
@modify_settings(MIDDLEWARE={"append": "skailar.contrib.admin.tests.CSPMiddleware"})
