...
from skailar.contrib.gis import forms, gdal
from skailar.contrib.gis.db.models.proxy import SpatialProxy
...
from skailar.db.models import Field
...
def get_srid_info(srid, connection):
    ...
    """
    from skailar.contrib.gis.gdal import SpatialReference
...
class RasterField(BaseSpatialField):
    """
    Raster field for GeoSkailar -- evaluates into GDALRaster objects.
    """
    ...
    def get_transform(self, name):
        from skailar.contrib.gis.db.models.lookups import RasterBandTransform
