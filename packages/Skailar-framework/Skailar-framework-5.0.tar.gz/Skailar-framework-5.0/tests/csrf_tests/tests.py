...
from skailar.contrib.sessions.backends.cache import SessionStore
from skailar.core.exceptions import ImproperlyConfigured
from skailar.http import HttpRequest, HttpResponse, UnreadablePostError
...
from skailar.views.decorators.csrf import csrf_exempt, requires_csrf_token
...
class CsrfViewMiddlewareTestMixin(CsrfFunctionTestMixin):
    ...
    def _check_bad_or_missing_cookie(self, cookie, expected):
        ...
        mw.process_request(req)
        with self.assertLogs("skailar.security.csrf", "WARNING") as cm:
    ...
    def test_ensures_csrf_cookie_no_logging(self):
        ...
        """
        with self.assertNoLogs("skailar.request", "WARNING"):
            req = self._get_request()
