...
class RelatedResourceIdSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
RelatedResourceTypeSchema = RelatedResourceType1
AuthorUserIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'related_resource_id': typing.Union[RelatedResourceIdSchema, list, tuple, ],
        'related_resource_type': typing.Union[RelatedResourceTypeSchema, ],
        'author_user_id': typing.Union[AuthorUserIdSchema, str, uuid.UUID, ],
...
request_query_related_resource_id = api_client.QueryParameter(
    name="related_resource_id",
    style=api_client.ParameterStyle.FORM,
    schema=RelatedResourceIdSchema,
)
request_query_related_resource_type = api_client.QueryParameter(
    name="related_resource_type",
    style=api_client.ParameterStyle.FORM,
    schema=RelatedResourceTypeSchema,
    explode=True,
)
request_query_author_user_id = api_client.QueryParameter(
    name="author_user_id",
    style=api_client.ParameterStyle.FORM,
    schema=AuthorUserIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = NoteList
...
class BaseApi(api_client.Api):
    ...
    def _list_notes_oapg(
        ...
        for parameter in (
            request_query_id,
            request_query_related_resource_id,
            request_query_related_resource_type,
            request_query_author_user_id,
