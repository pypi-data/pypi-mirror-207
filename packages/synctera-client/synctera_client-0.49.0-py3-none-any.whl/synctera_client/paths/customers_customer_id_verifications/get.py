...
SchemaFor200ResponseBodyApplicationJson = CustomerVerificationResultList
...
class ListVerifications(BaseApi):
    ...
    def list_verifications(
        ...
        return self._list_verifications_oapg(
