...
class GroupCallStreamRtmpUrl:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`phone.GroupCallStreamRtmpUrl <pyrosex.raw.types.phone.GroupCallStreamRtmpUrl>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCallStreamRtmpUrl <pyrosex.raw.functions.phone.GetGroupCallStreamRtmpUrl>`
    """

    QUALNAME = "pyrosex.raw.base.phone.GroupCallStreamRtmpUrl"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyrosex.org/telegram/base/group-call-stream-rtmp-url")
